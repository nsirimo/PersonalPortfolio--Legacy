...
<html lang="en">
  <head>
    <!-- Title -->
    <title>Multipage - Real Estate Forgot Password Page | Unify - Responsive Website Template</title>
        ...
        <div class="row justify-content-center">
          <div class="col-sm-7 col-md-6 col-lg-4 text-center g-mb-70">
            ...
            <form class="g-mb-30">
              ...
              <button class="btn btn-block u-btn-primary g-color-white g-bg-primary-dark-v1--hover g-font-weight-600 g-font-size-12 text-uppercase rounded-0 g-px-25 g-py-15" type="submit">Reset Password</button>
            </form>
            <!-- End Login Form -->

            <a class="d-block g-mb-10" href="page-login-1.html">Cancel</a>
          </div>
        </div>
      </div>
      <!-- Login -->
