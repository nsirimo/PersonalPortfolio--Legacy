...
<html lang="en">
  <head>
    <!-- Title -->
    <title>Multipage - Real Estate Register Page | Unify - Responsive Website Template</title>
  ...
  <body>
    ...
    <main>
      ...
      <div class="g-max-width-645 text-center g-pt-100 mx-auto g-mb-80">
        <h1 class="mb-4">Make it your Real Estate</h1>
        <p class="lead">Tailor your experience with England’s greatest property resource. Access the best market insights and comprehensive auction results.</p>
      </div>
      <!-- End Login - Heading -->
      ...
      <div class="container g-pb-30">
        <div class="row justify-content-center">
          <div class="col-md-6 col-lg-4 text-center g-mb-70">
            <h2 class="h5 mb-4">Create your free account today!</h2>

            <!-- Login Form -->
            <form class="g-mb-30">
              <div class="g-mb-20">
                <input class="form-control g-color-black g-bg-white g-bg-white--focus g-brd-gray-light-v3 g-brd-primary--hover rounded-0 g-py-13 g-px-15" type="email" placeholder="Email Address">
              </div>

              <div class="g-mb-20">
                <input class="form-control g-color-black g-bg-white g-bg-white--focus g-brd-gray-light-v3 g-brd-primary--hover rounded-0 g-py-13 g-px-15" type="password" placeholder="Create a Password">
              </div>

              <button class="btn btn-block u-btn-primary g-color-white g-bg-primary-dark-v1--hover g-font-weight-600 g-font-size-12 text-uppercase rounded-0 g-px-25 g-py-15" type="submit">Create Account</button>
            </form>
            <!-- End Login Form -->

            <a class="d-block g-mb-10" href="page-login-1.html">Already have an account? Sign in</a>
            <p class="g-font-size-12">Please view our <a class="g-color-text g-text-underline" href="#">Personal Information Collection Statement</a></p>
          </div>

          <div class="col-md-6 col-lg-5 ml-lg-5 g-mb-70">
            <!-- Icon Block -->
            <div class="media g-mb-30">
              <div class="d-flex mr-3">
                <span class="u-icon-v1 u-icon-size--lg g-color-text">
                  <i class="icon-medical-022 u-line-icon-pro"></i>
                </span>
              </div>
              <div class="media-body">
                <h3 class="h5">Don’t miss a thing</h3>
                <p>Save your dream homes and stay updated on your favourite searches, across any device.</p>
              </div>
            </div>
            <!-- End Icon Block -->
            ...
            <div class="media g-mb-30">
              ...
              <div class="media-body">
                <h3 class="h5">Get organised</h3>
                <p>Receive open for inspection planners and our comprehensive weekly auction results.</p>
              </div>
            </div>
            <!-- End Icon Block -->
            ...
            <div class="media">
              ...
              <div class="media-body">
                <h3 class="h5">Make the most of your home</h3>
                <p>Claim your home and access insights and tools to help you understand the market.</p>
              </div>
            </div>
            <!-- End Icon Block -->
          </div>
