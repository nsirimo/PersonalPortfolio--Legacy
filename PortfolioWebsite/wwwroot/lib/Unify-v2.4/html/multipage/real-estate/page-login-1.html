...
<html lang="en">
  <head>
    <!-- Title -->
    <title>Multipage - Real Estate Login Page | Unify - Responsive Website Template</title>
        ...
        <div class="row justify-content-center">
          <div class="col-md-6 col-lg-4 text-center g-mb-70">
            ...
            <form class="g-mb-30">
              ...
              <div class="g-mb-20">
                <input class="form-control g-color-black g-bg-white g-bg-white--focus g-brd-gray-light-v3 g-brd-primary--hover rounded-0 g-py-13 g-px-15" type="password" placeholder="Enter your Password">
              </div>

              <button class="btn btn-block u-btn-primary g-color-white g-bg-primary-dark-v1--hover g-font-weight-600 g-font-size-12 text-uppercase rounded-0 g-px-25 g-py-15" type="submit">Sign In</button>
            </form>
            <!-- End Login Form -->

            <div class="d-flex justify-content-between g-mb-10">
              <a class="d-block g-mb-10" href="page-register-1.html">Create an account</a>
              <a class="d-block g-mb-10" href="page-forgot-password-1.html">Forgot Password?</a>
            </div>
