...
<html lang="en">
  <head>
    <!-- Title -->
    <title>E-commerce Category No Sidebar Page 2 | Unify - Responsive Website Template</title>
  ...
  <body>
    <main>
        ...
        <div class="container">
          <ul class="u-list-inline">
            ...
            <li class="list-inline-item g-color-primary">
              <span>Category No Sidebar Page 2</span>
            </li>
          </ul>
        </div>
      </section>
      ...
      <div class="container g-pb-100">
        <!-- Banner -->
        <div class="g-bg-size-cover g-bg-pos-center g-py-40 g-mt-50" style="background-image: url(assets/img-temp/900x450/img1.jpg);">
