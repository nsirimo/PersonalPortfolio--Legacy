...
<html lang="en">
  <head>
    <!-- Title -->
    <title>E-commerce Gift Card Page | Unify - Responsive Website Template</title>
    ...
    <main>
      ...
      <div class="container g-py-100">
        <div class="text-center g-mb-70">
          <h2 class="h1">Gift Card</h2>
          <span class="g-color-primary g-font-size-25">$50 - $500</span>
        </div>

        <div class="row justify-content-center">
          <div class="col-md-6 col-lg-4 g-mb-50">
            <div class="g-px-60">
              <img class="img-fluid" src="assets/img-temp/400x475/img1.png" alt="Image Description">
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4 g-mb-50">
              ...
              <ul class="list-inline mb-0">
                <li class="list-inline-item g-mr-1">
                  <label class="form-check-inline u-check">
                    ...
                    <span class="d-block u-check-icon-checkbox-v1 g-width-100 g-height-auto g-brd-gray-light-v3 text-center g-py-10">
                      $50.00
                    </span>
                  </label>
                </li>
            ...
            <button class="btn u-btn-primary g-font-size-12 text-uppercase g-py-12 g-px-25 g-mb-50" type="submit">Add to Bag</button>
          </div>
        </div>

        <h3>Treat someone with a Gift</h3>
        <p>Shopping for someone else but not sure what to give them? Give them the gift of choice with a Unify gift card.</p>
        <p>Our gift cards are delivered by email, which you can then print or forward directly to a lucky recipient. They never expire and can be used over multiple purchases. We'll automatically apply your balance to eligible orders when you checkout. If you would rather not use your balance, you can deselect it in the Payment Selection step of checkout.</p>
        <p><span class="g-font-weight-700">Limitations:</span> Your Gift Card Balance cannot be transferred to other accounts or used to purchase other gift cards.</p>
        <p>Need some help? Read our <a href="page-faq-1.html">Gift Card FAQ</a>.</p>
      </div>
