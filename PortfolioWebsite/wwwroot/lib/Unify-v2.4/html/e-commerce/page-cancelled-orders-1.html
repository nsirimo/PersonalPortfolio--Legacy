...
<html lang="en">
  <head>
    <!-- Title -->
    <title>E-commerce Cancelled Orders Page | Unify - Responsive Website Template</title>
          ...
          <div class="col-lg-3 g-mb-50">
            <aside class="g-brd-around g-brd-gray-light-v4 rounded g-px-20 g-py-30">
              ...
              <ul class="list-unstyled mb-0">
                ...
                <li class="g-py-3">
                  <a class="d-block align-middle active u-link-v5 g-color-text g-color-primary--hover g-bg-gray-light-v5--hover g-color-primary--parent-active g-bg-gray-light-v5--active rounded g-pa-3" href="page-cancelled-orders-1.html">
          ...
          <div class="col-lg-9 g-mb-50">
              ...
              <div class="col-md-7 g-mb-30">
                ...
                <form class="input-group g-pos-rel">
                  ...
                  <div class="input-group-addon g-brd-none g-py-0">
                    <button class="btn u-btn-black g-font-size-13 rounded g-px-18 g-py-10" type="submit">Search Orders</button>
                  </div>
                </form>
                <!-- End Search Form -->
              </div>
            ...
            <ul class="list-inline g-brd-bottom--sm g-brd-gray-light-v3 mb-5">
              <li class="list-inline-item g-pb-10 g-pr-10 g-mb-20 g-mb-0--sm">
                <a class="g-brd-bottom g-brd-2 g-brd-transparent g-color-main g-color-gray-dark-v4 g-color-primary--hover g-text-underline--none--hover g-px-10 g-pb-13" href="page-orders-1.html">Orders</a>
              </li>
              ...
              <li class="list-inline-item g-pb-10 g-pl-10 g-mb-20 g-mb-0--sm">
                <a class="g-brd-bottom g-brd-2 g-brd-primary g-color-main g-color-black g-font-weight-600 g-text-underline--none--hover g-px-10 g-pb-13" href="page-cancelled-orders-1.html">Cancelled Orders</a>
              </li>
            </ul>
            <!-- End Links -->
                  ...
                  <div class="col-md-8 col-lg-9">
                    ...
                    <div class="row">
                      <div class="col-4 col-sm-3 g-mb-30">
                        <img class="img-fluid" src="assets/img-temp/150x150/img8.jpg" alt="Image Description">
                      </div>
              ...
              <div class="g-pa-20">
                <div class="row">
                  <div class="col-md-8 col-lg-9">
                    ...
                    <div class="row">
                      <div class="col-4 col-sm-3 g-mb-30">
                        <img class="img-fluid" src="assets/img-temp/150x150/img5.jpg" alt="Image Description">
                      </div>
