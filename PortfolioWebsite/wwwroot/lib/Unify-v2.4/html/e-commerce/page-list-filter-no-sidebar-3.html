...
<html lang="en">
  <head>
    <!-- Title -->
    <title>E-commerce List Filter No Sidebar Page 3 | Unify - Responsive Website Template</title>
          ...
          <div class="d-flex justify-content-end">
            <ul class="u-list-inline g-bg-gray-dark-v1 g-font-weight-300 g-rounded-50 g-py-5 g-px-20">
              ...
              <li class="list-inline-item g-color-primary g-font-weight-400">
                <span>Grid List No Sidebar 3</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div class="u-shadow-v19 g-bg-gray-light-v5">
        <div class="container g-py-60">
          ...
          <div class="row g-mb-0 g-mb-30--md">
            <div class="col-sm-6 col-lg-4 g-mb-30 g-mb-50--sm">
              <!-- Size -->
            ...
            <div class="col-sm-6 col-lg-5 g-mb-30 g-mb-50--sm">
              <!-- Brand -->
            ...
            <div class="col-sm-6 col-lg-3 g-mb-30 g-mb-50--sm">
              <!-- Pricing -->
              <h4 class="h6 text-center g-mb-40">$(<span id="rangeSliderAmount3">0</span>)</h4>
