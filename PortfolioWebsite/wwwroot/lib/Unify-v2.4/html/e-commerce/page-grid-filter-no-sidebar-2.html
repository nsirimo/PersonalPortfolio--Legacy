...
<html lang="en">
  <head>
    <!-- Title -->
    <title>E-commerce Grid Filter No Sidebar Page 2 | Unify - Responsive Website Template</title>
  ...
  <body>
    <main>
      ...
      <!-- Promo Block -->
      <div class="g-bg-size-cover" style="background-image: url(assets/img-temp/1920x1080/img4.jpg);">
        ...
        <div class="container">
          <ul class="u-list-inline">
            ...
            <li class="list-inline-item g-color-primary">
              <span>Grid Filter No Sidebar 2</span>
            </li>
          </ul>
        </div>
      </section>
