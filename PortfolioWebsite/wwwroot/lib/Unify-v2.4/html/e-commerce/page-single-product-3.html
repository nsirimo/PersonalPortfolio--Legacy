...
<html lang="en">
  <head>
    <!-- Title -->
    <title>E-commerce Single Product Page 3 | Unify - Responsive Website Template</title>
              ...
              <div class="col-9">
                ...
                <div id="carouselCus1" class="js-carousel g-pt-10 g-mb-10"
                  ...
                  <div class="js-slide g-bg-cover g-bg-black-opacity-0_1--after">
                    <img class="img-fluid w-100" src="assets/img-temp/700x1145/img1.jpg" alt="Image Description">
                  </div>
                  <div class="js-slide g-bg-cover g-bg-black-opacity-0_1--after">
                    <img class="img-fluid w-100" src="assets/img-temp/700x1145/img2.jpg" alt="Image Description">
                  </div>
                  <div class="js-slide g-bg-cover g-bg-black-opacity-0_1--after">
                    <img class="img-fluid w-100" src="assets/img-temp/700x1145/img3.jpg" alt="Image Description">
                  </div>
                </div>
              </div>
            </div>
