...
<html lang="en">
  <head>
    <!-- Title -->
    <title>E-commerce List Filter No Sidebar Page 2 | Unify - Responsive Website Template</title>
  ...
  <body>
    <main>
      ...
      <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall" data-options='{direction: "fromtop", animation_duration: 25, direction: "reverse"}'>
        <div class="divimage dzsparallaxer--target w-100" style="height: 140%; background-image: url(assets/img-temp/1920x1080/img4.jpg);"></div>

        <div class="container g-py-100">
          <div class="row">
            <div class="col-lg-7">
              <div class="g-bg-white g-pa-40 rounded">
                <h2 class="mb-5">Show Results For:</h2>

                <div class="row">
                  <div class="col-sm-6 col-lg-6 g-mb-30 g-mb-50--sm">
                    <!-- Size -->
                    <h4 class="h6 mb-3">Size</h4>

                    <ul class="list-inline mb-0">
                      <li class="list-inline-item mr-2">
                        <label class="form-check-inline u-check d-block u-link-v5 g-color-gray-dark-v4 g-color-primary--hover g-pl-25">
                          <input class="g-hidden-xs-up g-pos-abs g-top-0 g-left-0" type="checkbox">
                          <span class="d-block u-check-icon-checkbox-v4 g-absolute-centered--y g-left-0" checked>
                  ...
                  <div class="col-sm-6 col-lg-6 g-mb-30 g-mb-50--sm">
                    <!-- Pricing -->
                    <h4 class="h6 text-center g-mb-30">$(<span id="rangeSliderAmount3">0</span>)</h4>
                    <div id="rangeSlider1" class="u-slider-v1-3"
                         data-result-container="rangeSliderAmount3"
                         data-range="true"
                         data-default="125, 375"
                         data-min="0"
                         data-max="500">
                    </div>
                    <!-- End Pricing -->
                ...
                <div class="text-right">
                  <button class="btn u-btn-primary g-font-size-12 text-uppercase g-py-12 g-px-25" type="button">Search</button>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="container">
          <ul class="u-list-inline">
            ...
            <li class="list-inline-item g-color-primary">
              <span>List Filter No Sidebar 2</span>
            </li>
          </ul>
        </div>
      </section>
                ...
                <div class="col-6 col-sm-7 col-lg-8 g-mb-15">
                  ...
                  <div class="g-mb-30">
                    ...
                    <div class="mb-4">
                      ...
                      <s class="g-color-lightred g-font-weight-500 g-font-size-13">$101.00</s>
                    </div>
                    <p>Alongside our classic parka, we make modern clothing and outerwear that withstands the weather and the changes in fashion. We use only the best fabrics to keep you warm and dry, while the designs look good now and tomorrow. In essence, our coats are built to last.</p>
                  </div>
                  <!-- End Product Info -->
            ...
            <div class="g-brd-bottom g-brd-gray-light-v4 g-pb-70 g-mb-60">
              <div class="row g-pt-30">
                <figure class="col-6 col-sm-5 col-lg-4 g-mb-30">
                  ...
                  <span class="u-ribbon-v1 g-width-40 g-height-40 g-color-white g-bg-primary g-font-size-13 text-center text-uppercase g-rounded-50x g-top-10 g-right-0 g-px-2 g-py-10">-40%</span>
                </figure>
