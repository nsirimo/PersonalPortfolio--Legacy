...
<html lang="en">
  <head>
    <!-- Title -->
    <title>E-commerce List Filter No Sidebar Page 4 | Unify - Responsive Website Template</title>
          ...
          <div class="d-flex justify-content-end">
            <ul class="u-list-inline g-bg-gray-dark-v1 g-font-weight-300 g-rounded-50 g-py-5 g-px-20">
              ...
              <li class="list-inline-item g-color-primary g-font-weight-400">
                <span>List Filter No Sidebar 4</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="row align-items-center g-pt-40 g-pb-10">
          ...
          <div class="col-md-6 col-lg-4 g-mb-30">
            <h3 class="h6 mb-3">Category:</h3>

            <ul class="list-inline mb-0">
              <li class="list-inline-item mr-2">
                <label class="form-check-inline u-check d-block u-link-v5 g-color-text g-color-primary--hover g-pl-25 mb-0">
          ...
          <!-- Size -->
          <div class="col-md-6 col-lg-4 g-mb-30">
            <h3 class="h6 mb-3">Size:</h3>

            <ul class="list-inline mb-0">
              <li class="list-inline-item mr-2">
                <label class="form-check-inline u-check d-block u-link-v5 g-color-text g-color-primary--hover g-pl-25 mb-0">
                  <input class="g-hidden-xs-up g-left-0" type="checkbox">
                  <span class="d-block u-check-icon-checkbox-v4 g-absolute-centered--y g-left-0" checked>
                    <i class="fa" data-check-icon="&#xf00c"></i>
                  </span>
                  S
        ...
        <div class="g-brd-y g-brd-gray-light-v4 g-pt-40 g-pb-10">
          <div class="row align-items-center">
            <!-- Show -->
            <div class="col-sm-3 col-md-2 g-mb-30">
              <h2 class="h6 mb-3">Show:</h2>
            ...
            <!-- Sort By -->
            <div class="col-sm-6 col-md-12 col-lg-2 text-right g-mb-30">
              <ul class="list-inline mb-0">
                <li class="list-inline-item">
