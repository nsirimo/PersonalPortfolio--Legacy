...
<html lang="en">
  <head>
    <!-- Title -->
    <title>E-commerce Payment Options Page | Unify - Responsive Website Template</title>
          ...
          <div class="col-lg-3 g-mb-50">
            <aside class="g-brd-around g-brd-gray-light-v4 rounded g-px-20 g-py-30">
              ...
              <ul class="list-unstyled mb-0">
                ...
                <li class="g-py-3">
                  <a class="d-block align-middle active u-link-v5 g-color-text g-color-primary--hover g-bg-gray-light-v5--hover g-color-primary--parent-active g-bg-gray-light-v5--active rounded g-pa-3" href="page-payment-options-1.html">
              ...
              <div class="col-md-8 col-lg-6 g-mb-70 g-mb-0--md">
                <div class="mb-4">
                  ...
                  <div class="d-flex justify-content-between align-items-center mb-3">
                    <img class="g-width-40" src="assets/img-temp/50x35/img1.jpg" alt="Image Description">
                  ...
                  <form class="row justify-content-between g-mb-30">
                    ...
                    <div class="col-5 col-sm-4">
                      ...
                      <div class="input-group g-pos-rel">
                        ...
                        <div class="g-brd-gray-light-v3 g-pos-abs g-top-5 g-right-5 g-z-index-3 p-0">
                          <img class="g-width-30" src="assets/img-temp/50x25/img1.jpg" alt="Image Description">
                        </div>
                      </div>
                    </div>
                    <!-- End Security Code -->
