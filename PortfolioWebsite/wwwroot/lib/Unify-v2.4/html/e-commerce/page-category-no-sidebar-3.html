...
<html lang="en">
  <head>
    <!-- Title -->
    <title>E-commerce Category No Sidebar Page 3 | Unify - Responsive Website Template</title>
  ...
  <body>
    <main>
          ...
          <div class="d-flex justify-content-end">
            <ul class="u-list-inline g-bg-gray-dark-v1 g-font-weight-300 g-rounded-50 g-py-5 g-px-20">
              ...
              <li class="list-inline-item g-color-primary g-font-weight-400">
                <span>Category No Sidebar Page 3</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div class="container g-pb-100">
        <!-- Banner -->
        <div class="g-bg-size-cover g-bg-pos-center g-py-40 g-mt-60" style="background-image: url(assets/img-temp/900x450/img1.jpg);">
