...
<head>
  <!-- Title -->
  <title>Blog Grid Classic 4 | | Unify - Responsive Website Template</title>
  ...
  <main>
    ...
    <section class="g-bg-gray-light-v5 g-py-80">
      <div class="container text-center">
        <h2 class="h2 g-color-black g-font-weight-600">Blog grid classic 4</h2>
