...
<head>
  <!-- Title -->
  <title>Blog Grid Classic 4 Fullwidth | | Unify - Responsive Website Template</title>
  ...
  <main>
    ...
    <section class="g-bg-gray-light-v5 g-py-80">
      <div class="container text-center">
        <h2 class="h2 g-color-black g-font-weight-600">Blog grid classic 4 fullwidth</h2>
        ...
        <ul class="u-list-inline">
          ...
          <li class="list-inline-item g-color-primary">
            <span>Blog grid classic 4 fullwidth</span>
          </li>
        </ul>
      </div>
    </section>
    ...
    <!-- Blog Classic Blocks -->
    <div class="container-fluid g-px-30 g-pt-100">
        ...
        <div class="masonry-grid-item col-sm-6 col-lg-3 g-mb-30">
          ...
          <article class="u-shadow-v11">
            ...
            <div class="g-bg-white g-pa-20">
              ...
              <p class="g-color-gray-dark-v4 g-line-height-1_8">At Wake, our mission has always been focused on bringing openness and transparency to the design process.</p>
              <a class="g-font-size-13" href="#!">Read more...</a>
        ...
        <div class="masonry-grid-item col-sm-6 col-lg-3 g-mb-30">
          ...
          <article class="u-shadow-v11">
            ...
            <div class="g-bg-white g-pa-20">
              ...
              <p class="g-color-gray-dark-v4 g-line-height-1_8">In an attempt to answer those questions, I poured over the biggest collections of design principles.</p>
              <a class="g-font-size-13" href="#!">Read more...</a>
        ...
        <div class="masonry-grid-item col-sm-6 col-lg-3 g-mb-30">
          ...
          <article class="u-shadow-v11">
            ...
            <div class="g-bg-white g-pa-20">
              ...
              <p class="g-color-gray-dark-v4 g-line-height-1_8">In an attempt to answer those questions, I poured over the biggest collections of design principles on the internet [1][2], and came to the following conclusion.</p>
              <a class="g-font-size-13" href="#!">Read more...</a>
              ...
              <ul class="list-inline d-flex justify-content-between mb-0">
                ...
                <li class="list-inline-item g-color-gray-dark-v4">
                  <i class="align-middle g-color-primary g-font-size-default mr-1 icon-medical-022 u-line-icon-pro"></i>
                  <a class="d-inline-block g-color-gray-dark-v4 g-font-size-13 g-cursor-pointer g-text-underline--none--hover" href="#!">99</a>
                </li>
              </ul>
            </div>
          </article>
        ...
        <div class="masonry-grid-item col-sm-6 col-lg-3 g-mb-30">
          ...
          <article class="u-shadow-v11">
            ...
            <div class="g-bg-white g-pa-20">
              ...
              <p class="g-color-gray-dark-v4 g-line-height-1_8">Apple Watch now has fitness algorithms designed for wheelchair users. Instead of steps, the Workout.</p>
              <a class="g-font-size-13" href="#!">Read more...</a>
              ...
              <ul class="list-inline d-flex justify-content-between mb-0">
                ...
                <li class="list-inline-item g-color-gray-dark-v4">
                  <i class="align-middle g-color-primary g-font-size-default mr-1 icon-medical-022 u-line-icon-pro"></i>
                  <a class="d-inline-block g-color-gray-dark-v4 g-font-size-13 g-cursor-pointer g-text-underline--none--hover" href="#!">46</a>
                </li>
              </ul>
            </div>
          </article>
        ...
        <div class="masonry-grid-item col-sm-6 col-lg-3 g-mb-30">
          ...
          <article class="u-shadow-v11">
            ...
            <div class="g-bg-white g-pa-20">
              ...
              <p class="g-color-gray-dark-v4 g-line-height-1_8">Once someone starts using your app, they need to know.</p>
              <a class="g-font-size-13" href="#!">Read more...</a>
        ...
        <div class="masonry-grid-item col-sm-6 col-lg-3 g-mb-30">
          ...
          <article class="u-shadow-v11">
            ...
            <div class="g-bg-white g-pa-20">
              <span class="d-block g-color-gray-dark-v4 g-font-weight-600 g-font-size-12 text-uppercase mb-2">29 May 2017</span>
              <h2 class="h5 g-color-black g-font-weight-600 mb-3">
                  <a class="u-link-v5 g-color-black g-color-primary--hover g-cursor-pointer" href="#!">#c0ffee is the color</a>
                </h2>
              <p class="g-color-gray-dark-v4 g-line-height-1_8">What real worlds are actually valid CSS HEX colors? Pasring an English dictionary...</p>
              <a class="g-font-size-13" href="#!">Read more...</a>
        ...
        <div class="masonry-grid-item col-sm-6 col-lg-3 g-mb-30">
          ...
          <article class="u-shadow-v11">
            ...
            <div class="g-bg-white g-pa-20">
              <span class="d-block g-color-gray-dark-v4 g-font-weight-600 g-font-size-12 text-uppercase mb-2">29 May 2017</span>
              <h2 class="h5 g-color-black g-font-weight-600 mb-3">
                  <a class="u-link-v5 g-color-black g-color-primary--hover g-cursor-pointer" href="#!">New Rolls Royce Wraith coupe</a>
                </h2>
              <p class="g-color-gray-dark-v4 g-line-height-1_8">I’ve made exceptions a handful of times over the years.</p>
              <a class="g-font-size-13" href="#!">Read more...</a>
