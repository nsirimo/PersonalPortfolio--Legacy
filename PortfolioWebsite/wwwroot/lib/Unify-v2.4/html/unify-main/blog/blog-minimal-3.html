...
<head>
  <!-- Title -->
  <title>Blog Minimal 3 | | Unify - Responsive Website Template</title>
  ...
  <main>
    ...
    <section class="g-bg-gray-light-v5 g-py-80">
      <div class="container text-center">
        <h2 class="h2 g-color-black g-font-weight-600">Blog minimal 3</h2>
      ...
      <div class="row justify-content-center">
        <div class="col-lg-7">
          ...
          <article class="g-mb-100">
            <img class="img-fluid w-100 g-rounded-5 g-mb-25" src="../../assets/img-temp/740x380/img4.jpg" alt="Image Description">
            ...
            <div class="px-4">
              <ul class="d-flex justify-content-start align-items-end list-inline g-color-gray-dark-v5 g-font-size-13 g-mt-minus-45 g-mb-25">
                <li class="list-inline-item mr-5">
                  ...
                  <h4 class="h6 g-font-weight-600 g-font-size-13 mb-0">
                      <a class="g-color-gray-dark-v4" href="#!">Alex Teseira</a>
                    </h4>
                </li>
              ...
              <h2 class="h5 g-color-black g-font-weight-600"><a class="u-link-v5 g-color-black g-color-primary--hover" href="#!">Exclusive interview with InVision's CEO</a></h2>
              ...
              <a class="g-font-weight-700 g-font-size-13" href="#!">read more</a>
            </div>
          </article>
          ...
          <!-- Blog Minimal Blocks -->
          <article class="g-mb-100">
            <img class="img-fluid w-100 g-rounded-5 g-mb-25" src="../../assets/img-temp/740x380/img5.jpg" alt="Image Description">
            ...
            <div class="px-4">
              <ul class="d-flex justify-content-start align-items-end list-inline g-color-gray-dark-v5 g-font-size-13 g-mt-minus-45 g-mb-25">
                <li class="list-inline-item mr-5">
                  ...
                  <h4 class="h6 g-font-weight-600 g-font-size-13 mb-0">
                      <a class="g-color-gray-dark-v4" href="#!">Sara Kajevnikova</a>
                    </h4>
                </li>
                <li class="list-inline-item">
                  <span class="g-font-size-12">June 1, 2017</span>
                </li>
                <li class="list-inline-item ml-auto">
                  <a class="g-color-gray-dark-v5 g-color-primary--hover g-font-size-default g-transition-0_3 g-text-underline--none--hover" href="#!">
                    <i class="align-middle mr-1 icon-medical-022 u-line-icon-pro"></i>
                ...
                <li class="list-inline-item ml-3">
                  ...
                  <span class="g-color-gray-dark-v5">8</span>
                </li>
              </ul>

              <h2 class="h5 g-color-black g-font-weight-600"><a class="u-link-v5 g-color-black g-color-primary--hover" href="#!">Announcing a free plan for small teams</a></h2>
          ...
          <!-- Blog Minimal Blocks -->
          <article class="g-mb-100">
            <img class="img-fluid w-100 g-rounded-5 g-mb-25" src="../../assets/img-temp/740x380/img6.jpg" alt="Image Description">
            ...
            <div class="px-4">
              <ul class="d-flex justify-content-start align-items-end list-inline g-color-gray-dark-v5 g-font-size-13 g-mt-minus-45 g-mb-25">
                ...
                <li class="list-inline-item">
                  <span class="g-font-size-12">June 2, 2017</span>
                </li>
                <li class="list-inline-item ml-auto">
                  <a class="g-color-gray-dark-v5 g-color-primary--hover g-font-size-default g-transition-0_3 g-text-underline--none--hover" href="#!">
                    <i class="align-middle mr-1 icon-medical-022 u-line-icon-pro"></i>
                ...
                <li class="list-inline-item ml-3">
                  ...
                  <span class="g-color-gray-dark-v5">2</span>
                </li>
              </ul>

              <h2 class="h5 g-color-black g-font-weight-600"><a class="u-link-v5 g-color-black g-color-primary--hover" href="#!">In the future, design principles won’t be about design</a></h2>
              <p class="g-color-gray-dark-v4">In an attempt to answer those questions, I poured over the biggest collections of design principles on the internet [1][2], and came to the following conclusion: corporate design principles are a set of shared guidelines that reflect the
