...
<head>
  <!-- Title -->
  <title>Blog Masonry Grid 2 | | Unify - Responsive Website Template</title>
  ...
  <main>
      ...
      <div class="container">
        <div class="d-sm-flex text-center">
          <div class="align-self-center">
            <h2 class="h3 g-font-weight-300 w-100 g-mb-10 g-mb-0--md">Masonry Grid 2</h2>
          </div>
    ...
    <div class="container g-pt-100 g-pb-70">
      <div class="masonry-grid row g-mb-70">
          ...
          <article class="u-shadow-v11 g-bg-cover g-bg-size-cover g-bg-pos-top-center g-bg-purple-gradient-opacity-v1--after" style="background-image: url(../../assets/img-temp/500x450/img11.jpg);">
            <div class="g-pos-rel g-z-index-1 g-px-50 g-py-60">
              <div class="mb-5">
                ...
                <h4 class="h4 g-color-white-opacity-0_9">Exclusive interview with InVision's CEO</h4>
              </div>
        ...
        <div class="masonry-grid-item col-lg-6 g-mb-30">
          <!-- Article -->
          <article class="u-shadow-v11 g-bg-cover g-bg-size-cover g-bg-pos-center g-bg-purple-gradient-opacity-v1--after" style="background-image: url(../../assets/img-temp/600x450/img6.jpg);">
            <div class="g-pos-rel g-z-index-1 g-px-50 g-py-60">
        ...
        <div class="masonry-grid-item col-sm-6 col-lg-6 g-mb-30">
          ...
          <article class="u-shadow-v11 g-bg-white g-pos-rel g-pa-30">
            <h3 class="h4 g-color-black g-font-weight-600 text-capitalize mb-4">
            ...
            <div class="d-flex justify-content-start">
              <img class="d-block align-self-center g-width-30 g-height-30 rounded-circle mr-3" src="../../assets/img-temp/100x100/img4.jpg" alt="Image Description">
              <a class="align-self-center g-color-gray-dark-v5 g-color-black--hover g-text-underline--none--hover" href="#!">Kate</a>
            </div>
          </article>
          <!-- End Article -->
        </div>
