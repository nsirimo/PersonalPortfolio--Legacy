...
<head>
  <!-- Title -->
  <title>Blog Grid Background Overlay 4 | | Unify - Responsive Website Template</title>
  ...
  <main>
    ...
    <section class="g-bg-gray-light-v5 g-py-80">
      <div class="container text-center">
        <h2 class="h2 g-color-black g-font-weight-600">Blog grid background overlay 4</h2>
        ...
        <ul class="u-list-inline">
          ...
          <li class="list-inline-item g-color-primary">
            <span>Blog grid background overlay 4</span>
          </li>
        </ul>
      </div>
    </section>
    ...
    <div class="container g-py-100">
      <div class="masonry-grid row g-mb-70 g-mx-minus-10">
        <div class="masonry-grid-sizer col-sm-1"></div>

        <div class="masonry-grid-item col-sm-6 col-lg-3 g-px-10 g-mb-15">
          <!-- Blog Background Overlay Blocks -->
          <article class="u-block-hover">
            <div class="g-bg-cover g-bg-white-gradient-opacity-v1--after">
              <img class="u-block-hover__main--mover-down" src="../../assets/img-temp/500x650/img1.jpg" alt="Image Description">
            </div>
            ...
            <div class="u-block-hover__additional--partially-slide-up g-z-index-1">
              <div class="u-block-hover__visible g-pa-25">
                ...
                <p class="g-color-white-opacity-0_7 mb-0">At Wake, our mission has always been focused on...</p>
              </div>
        ...
        <div class="masonry-grid-item col-sm-6 col-lg-3 g-px-10 g-mb-15">
          ...
          <article class="u-block-hover">
            <div class="g-bg-cover g-bg-white-gradient-opacity-v1--after">
              <img class="d-flex align-items-end u-block-hover__main--mover-down" src="../../assets/img-temp/500x650/img9.jpg" alt="Image Description">
            </div>
            <div class="u-block-hover__additional--partially-slide-up text-center g-z-index-1 mt-auto">
              <div class="u-block-hover__visible g-pa-25">
                ...
                <h2 class="h4 g-color-white g-font-weight-600 mb-3">
                    <a class="u-link-v5 g-color-white g-color-primary--hover g-cursor-pointer" href="#!">Stunning Man's Capture</a>
                  </h2>
        ...
        <div class="masonry-grid-item col-sm-6 col-lg-3 g-px-10 g-mb-15">
          ...
          <article class="u-block-hover">
            <div class="g-bg-cover g-bg-white-gradient-opacity-v1--after">
              <img class="d-flex align-items-end u-block-hover__main--mover-down" src="../../assets/img-temp/500x650/img2.jpg" alt="Image Description">
            </div>
            <div class="u-block-hover__additional--partially-slide-up text-center g-z-index-1 mt-auto">
              <div class="u-block-hover__visible g-pa-25">
                <span class="d-block g-color-white-opacity-0_7 g-font-weight-600 g-font-size-12 mb-2">photography</span>
                <h2 class="h4 g-color-white g-font-weight-600 mb-3">
                    <a class="u-link-v5 g-color-white g-color-primary--hover g-cursor-pointer" href="#!">Time to Travel</a>
                  </h2>
                <h4 class="d-inline-block g-color-white-opacity-0_7 g-font-size-11 mb-0">
                    By,
                    <a class="g-color-white-opacity-0_7 text-uppercase" href="#!">Dan Shaw</a>
        ...
        <div class="masonry-grid-item col-sm-6 col-lg-3 g-px-10 g-mb-15">
          ...
          <article class="u-block-hover">
            <div class="g-bg-cover g-bg-white-gradient-opacity-v1--after">
              <img class="d-flex align-items-end u-block-hover__main--mover-down" src="../../assets/img-temp/500x650/img13.jpg" alt="Image Description">
            </div>
            <div class="u-block-hover__additional--partially-slide-up text-center g-z-index-1 mt-auto">
              <div class="u-block-hover__visible g-pa-25">
                <span class="d-block g-color-white-opacity-0_7 g-font-weight-600 g-font-size-12 mb-2">photography</span>
                <h2 class="h4 g-color-white g-font-weight-600 mb-3">
                    <a class="u-link-v5 g-color-white g-color-primary--hover g-cursor-pointer" href="#!">The Strong Woman</a>
                  </h2>
                <h4 class="d-inline-block g-color-white-opacity-0_7 g-font-size-11 mb-0">
                    By,
                    <a class="g-color-white-opacity-0_7 text-uppercase" href="#!">Dan Shaw</a>
        ...
        <div class="masonry-grid-item col-sm-6 col-lg-3 g-px-10 g-mb-15">
          ...
          <article class="u-block-hover">
            <div class="g-bg-cover g-bg-white-gradient-opacity-v1--after">
              <img class="d-flex align-items-end u-block-hover__main--mover-down" src="../../assets/img-temp/500x650/img11.jpg" alt="Image Description">
            </div>
            <div class="u-block-hover__additional--partially-slide-up text-center g-z-index-1 mt-auto">
              <div class="u-block-hover__visible g-pa-25">
                <span class="d-block g-color-white-opacity-0_7 g-font-weight-600 g-font-size-12 mb-2">photography</span>
        ...
        <div class="masonry-grid-item col-sm-6 col-lg-3 g-px-10 g-mb-15">
          ...
          <article class="u-block-hover">
            <div class="g-bg-cover g-bg-white-gradient-opacity-v1--after">
              <img class="u-block-hover__main--mover-down" src="../../assets/img-temp/500x650/img12.jpg" alt="Image Description">
            </div>
            <div class="g-pos-abs g-top-0 g-right-0 g-z-index-1 g-pa-35">
              <span class="d-block g-color-white g-font-weight-600 g-font-size-12">June 1, 2017</span>
            </div>
            <div class="u-block-hover__additional--partially-slide-up g-z-index-1">
              <div class="u-block-hover__visible g-pa-25">
                <span class="d-block g-color-white-opacity-0_7 g-font-weight-600 g-font-size-12 mb-2">web design</span>
                <h2 class="h4 g-color-white g-font-weight-600 mb-3">
                    <a class="u-link-v5 g-color-white g-color-primary--hover g-cursor-pointer" href="#!">Talking Why Him?</a>
                  </h2>
                <p class="g-color-white-opacity-0_7 mb-0">At Wake, our mission has always been focused on...</p>
              </div>
        ...
        <div class="masonry-grid-item col-sm-6 col-lg-3 g-px-10 g-mb-15">
          ...
          <article class="u-block-hover">
            <div class="g-bg-cover g-bg-white-gradient-opacity-v1--after">
              <img class="u-block-hover__main--mover-down" src="../../assets/img-temp/500x650/img10.jpg" alt="Image Description">
            </div>
            <div class="g-pos-abs g-top-0 g-right-0 g-z-index-1 g-pa-35">
              <span class="d-block g-color-white g-font-weight-600 g-font-size-12">June 1, 2017</span>
            </div>
            <div class="u-block-hover__additional--partially-slide-up g-z-index-1">
              <div class="u-block-hover__visible g-pa-25">
                <span class="d-block g-color-white-opacity-0_7 g-font-weight-600 g-font-size-12 mb-2">web design</span>
                <h2 class="h4 g-color-white g-font-weight-600 mb-3">
                    <a class="u-link-v5 g-color-white g-color-primary--hover g-cursor-pointer" href="#!">Seeking for a Perfect Working Room</a>
                  </h2>
                <p class="g-color-white-opacity-0_7 mb-0">At Wake, our mission has always been focused on...</p>
              </div>
        ...
        <div class="masonry-grid-item col-sm-6 col-lg-3 g-px-10 g-mb-15">
          ...
          <article class="u-block-hover">
            <div class="g-bg-cover g-bg-white-gradient-opacity-v1--after">
              <img class="u-block-hover__main--mover-down" src="../../assets/img-temp/500x650/img14.jpg" alt="Image Description">
            </div>
            <div class="g-pos-abs g-top-0 g-right-0 g-z-index-1 g-pa-35">
              <span class="d-block g-color-white g-font-weight-600 g-font-size-12">June 1, 2017</span>
            </div>
            <div class="u-block-hover__additional--partially-slide-up g-z-index-1">
              <div class="u-block-hover__visible g-pa-25">
                <span class="d-block g-color-white-opacity-0_7 g-font-weight-600 g-font-size-12 mb-2">web design</span>
                <h2 class="h4 g-color-white g-font-weight-600 mb-3">
                    <a class="u-link-v5 g-color-white g-color-primary--hover g-cursor-pointer" href="#!">The Maddening and Brilliant Alisa Watson</a>
                  </h2>
                <p class="g-color-white-opacity-0_7 mb-0">At Wake, our mission has always been focused on...</p>
              </div>
