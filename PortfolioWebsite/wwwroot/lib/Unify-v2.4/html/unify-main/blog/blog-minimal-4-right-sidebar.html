...
<head>
  <!-- Title -->
  <title>Blog Minimal 4 Right Sidebar | | Unify - Responsive Website Template</title>
  ...
  <main>
    ...
    <section class="g-bg-gray-light-v5 g-py-80">
      <div class="container text-center">
        <h2 class="h2 g-color-black g-font-weight-600">Blog minimal 4 right sidebar</h2>
        ...
        <ul class="u-list-inline">
          ...
          <li class="list-inline-item g-color-primary">
            <span>Blog minimal 4 right sidebar</span>
          </li>
        </ul>
      </div>
    </section>
          ...
          <div class="g-pr-20--lg">
            ...
            <article class="g-mx-15 u-block-hover">
              ...
              <div class="g-overflow-hidden">
                <img class="img-fluid w-100 u-block-hover__main--mover-down" src="../../assets/img-temp/900x400/img1.jpg" alt="Image Description">
              </div>
              <div class="g-px-100--md g-py-30--md">
                <div class="mb-4">
            ...
            <article class="row align-items-center u-block-hover">
              <div class="col-md-6 g-mb-30">
                <div class="g-overflow-hidden">
                  <img class="img-fluid w-100 u-block-hover__main--mover-down g-mb-minus-6" src="../../assets/img-temp/400x270/img9.jpg" alt="Image Description">
                </div>
              </div>
              <div class="col-md-6 g-mb-30">
            ...
            <article class="row align-items-center u-block-hover">
              <div class="col-md-6 g-mb-30">
                <div class="g-overflow-hidden">
                  <img class="img-fluid w-100 u-block-hover__main--mover-down g-mb-minus-6" src="../../assets/img-temp/400x270/img15.jpg" alt="Image Description">
                </div>
              </div>
              <div class="col-md-6 g-mb-30">
                <div class="g-pa-30--md">
            ...
            <article class="g-mx-15 u-block-hover">
              ...
              <div class="g-overflow-hidden">
                <img class="img-fluid w-100 u-block-hover__main--mover-down" src="../../assets/img-temp/900x400/img2.jpg" alt="Image Description">
              </div>
              <div class="g-px-100--md g-py-30--md">
                <div class="mb-4">
                  <p class="g-font-size-18 g-line-height-2 mb-0">Working together on the daily requires each individual to let the greater good of the team’s work surface above their own ego. It’s important to stay detail oriented with every project we tackle.</p>
            ...
            <article class="row align-items-center u-block-hover">
              <div class="col-md-6 g-mb-30">
                <div class="g-overflow-hidden">
                  <img class="img-fluid w-100 u-block-hover__main--mover-down g-mb-minus-6" src="../../assets/img-temp/400x270/img16.jpg" alt="Image Description">
                </div>
              </div>
              <div class="col-md-6 g-mb-30">
                <div class="g-pa-30--md">
            ...
            <article class="row align-items-center u-block-hover">
              <div class="col-md-6 g-mb-30">
                <div class="g-overflow-hidden">
                  <img class="img-fluid w-100 u-block-hover__main--mover-down g-mb-minus-6" src="../../assets/img-temp/400x270/img2.jpg" alt="Image Description">
                </div>
              </div>
              <div class="col-md-6 g-mb-30">
                <div class="g-pa-30--md">
