...
<head>
  <!-- Title -->
  <title>Light Style | Unify - Responsive Website Template</title>
  ...
  <!-- CSS Unify -->
  <link rel="stylesheet" href="assets/css/styles.light-style.css">
  ...
  <main>
        ...
        <nav class="navbar navbar-expand-lg">
          <div class="container">
            ...
            <div class="collapse navbar-collapse align-items-center flex-sm-row g-pt-10 g-pt-3--lg g-mr-40--lg" id="navBar">
              <ul id="js-scroll-nav" class="navbar-nav text-uppercase g-pos-rel g-font-weight-400 g-letter-spacing-0_5 ml-auto">
            ...
            <div class="d-inline-block g-hidden-xs-down g-pos-rel g-valign-middle g-pl-30 g-pl-0--lg">
              <a class="btn u-btn-primary g-font-size-13 g-font-weight-400 g-letter-spacing-0_5 text-uppercase g-py-10 g-px-15" href="https://wrapbootstrap.com/theme/unify-responsive-website-template-WB0412697?ref=htmlstream" target="_blank">Purchase now</a>
            </div>
          </div>
        </nav>
      </div>
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall" data-options='{direction: "reverse", settings_mode_oneelement_max_offset: "150"}'>
      ...
      <div class="container g-py-200">
        <div class="row">
          <div class="col-md-6">
            <h3 class="g-color-black g-font-weight-300 g-font-size-45 g-line-height-1_2 mb-4">Have an easy<br>website with Unify
            </h3>
        ...
        <div class="row no-gutters">
          <div class="col-lg-4 g-px-40 g-mb-50 g-mb-0--lg">
            ...
            <div class="text-center">
              ...
              <h3 class="g-font-size-18 g-color-gray-dark-v2 g-font-weight-400 mb-2">Invest To Us</h3>
          ...
          <div class="col-lg-4 g-brd-left--lg g-brd-gray-light-v4 g-px-40 g-mb-50 g-mb-0--lg">
            ...
            <div class="text-center">
              ...
              <h3 class="g-font-size-18 g-color-gray-dark-v2 g-font-weight-400 mb-2">Increase Income</h3>
              <p class="mb-0">We strive to embrace and drive change in our industry which allows us to keep our clients relevant.</p>
            </div>
            <!-- End Icon Blocks -->
          </div>
          ...
          <div class="col-lg-4 g-brd-left--lg g-brd-gray-light-v4 g-px-40">
            ...
            <div class="text-center">
              ...
              <h3 class="g-font-size-18 g-color-gray-dark-v2 g-font-weight-400 mb-2">Collect Cash</h3>
              <p class="mb-0">We strive to embrace and drive change in our industry which allows us to keep our clients relevant.</p>
            </div>
            <!-- End Icon Blocks -->
          </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-5 order-2 g-ml-30--lg g-mb-40">
            <h2 class="h2 g-color-gray-dark-v2 g-font-weight-300 mb-4">About Our Company</h2>

            <p class="g-font-size-16 mb-3">The time has come to bring those ideas and plans to life. This is where we really begin to visualize your napkin sketches and make them into beautiful pixels.</p>
            <p class="g-font-size-16 mb-3">Now that your brand is all dressed up and ready to party, it's time to release it to the world. By the way, let's celebrate already.</p>
    ...
    <section id="projects-section" class="g-py-100">
      <div class="container">
        <header class="g-mb-50">
          <h2 class="h2 g-color-gray-dark-v2 g-font-weight-300 mb-4">Our Recent Projects</h2>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 g-mb-30 g-mb-0--lg">
            <article class="u-block-hover u-shadow-v21 rounded">
              ...
              <header class="u-bg-overlay__inner g-pos-abs g-top-30 g-right-30 g-left-30 g-color-white">
                <h3 class="g-font-size-18 g-color-gray-dark-v2 g-font-weight-400 mb-2"><a class="g-color-white" href="#!">Nulla ipsum dolor sit</a></h3>
          ...
          <div class="col-lg-4 col-md-6 g-mb-30 g-mb-0--lg">
            <article class="u-block-hover u-shadow-v21 rounded">
              ...
              <header class="u-bg-overlay__inner g-pos-abs g-top-30 g-right-30 g-left-30 g-color-white">
                <h3 class="g-font-size-18 g-color-gray-dark-v2 g-font-weight-400 mb-2"><a class="g-color-white" href="#!">Adipiscing elitut</a></h3>
                <p>Consectetur adipiscing elitut eleifend nisl</p>
              </header>
          ...
          <div class="col-lg-4 col-md-6">
            <article class="u-block-hover u-shadow-v21 rounded">
              ...
              <header class="u-bg-overlay__inner g-pos-abs g-top-30 g-right-30 g-left-30 g-color-white">
                <h3 class="g-font-size-18 g-color-gray-dark-v2 g-font-weight-400 mb-2"><a class="g-color-white" href="#!">Hac habitasse platea</a></h3>
                <p>Consectetur adipiscing elitut eleifend nisl</p>
              </header>
      ...
      <div class="container u-bg-overlay__inner g-py-80">
        <div class="row">
          ...
          <div class="col-lg-6 order-2 order-sm-1 g-mb-0 g-mb-100--sm g-mb-0--lg">
            <h2 class="h2 g-color-gray-dark-v2 g-font-weight-300 mb-4">Most Quality Solution</h2>
            ...
            <a class="btn u-btn-primary g-font-size-13 g-font-weight-400 g-letter-spacing-0_5 text-uppercase g-py-10 g-px-15 g-mr-15 g-mb-15 g-mb-5--sm" href="#!">Buy Full Version</a>
...
<div class="col-lg-6 align-self-center g-pl-30--lg">
  <header class="g-mb-30">
    <h2 class="h2 g-color-gray-dark-v2 g-font-weight-300 mb-4">Our Environment</h2>
  ...
  <a class="btn u-btn-primary g-font-size-13 g-font-weight-400 g-letter-spacing-0_5 text-uppercase g-py-10 g-px-15 g-mr-15 g-mb-15 g-mb-5--sm" href="#!">Check It Now</a>
...
<section class="g-brd-top g-brd-bottom g-brd-gray-light-v4 g-pt-50">
  <div class="container">
    <div class="row text-center g-letter-spacing-0_5">
...
<section id="news-section" class="g-py-100">
  <div class="container">
    <header class="g-mb-50">
      <h2 class="h2 g-color-gray-dark-v2 g-font-weight-300 mb-4">Our Latest News</h2>
    ...
    <div class="row">
      <div class="col-lg-4 g-mb-30 g-mb-0--lg">
        ...
        <article class="u-shadow-v11 rounded">
          <div class="g-pa-30">
            <h3 class="g-font-size-20 g-font-weight-300 mb-3"><a class="u-link-v5 g-color-gray-dark-v2 g-color-primary--hover" href="#!">Focused on helping our clients to build a great business</a></h3>
      ...
      <div class="col-lg-4 g-mb-30 g-mb-0--lg">
        ...
        <article class="u-shadow-v11 rounded">
          <div class="g-pa-30">
            <h3 class="g-font-size-20 g-font-weight-300 mb-3"><a class="u-link-v5 g-color-gray-dark-v2 g-color-primary--hover" href="#!">We build your website to realise your vision, project and more</a></h3>
            <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores.</p>
          </div>
      ...
      <div class="col-lg-4">
        ...
        <article class="u-shadow-v11 rounded">
          <div class="g-pa-30">
            <h3 class="g-font-size-20 g-font-weight-300 mb-3"><a class="u-link-v5 g-color-gray-dark-v2 g-color-primary--hover" href="#!">Praesentium to website realise imperdiet demore elementum</a></h3>
...
<section class="g-bg-primary g-color-white g-pa-30" style="background-image: url(../../../../assets/img/bg/pattern5.png);">
  <div class="d-md-flex justify-content-md-center text-center">
    ...
    <div class="align-self-md-center">
      <a class="btn u-btn-white g-font-size-13 g-font-weight-400 g-letter-spacing-0_5 text-uppercase g-py-10 g-px-15" target="_blank" href="https://wrapbootstrap.com/theme/unify-responsive-website-template-WB0412697?ref=htmlstream">Purchase Now</a>
    </div>
  </div>
</section>
<!-- End Call To Action -->
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-3 col-md-6 g-mb-40 g-mb-0--lg">
        <h3 class="g-font-size-16 g-font-weight-400 g-letter-spacing-0_5 mb-4">About Us</h3>
      ...
      <!-- Footer Content -->
      <div class="col-lg-3 col-md-6 g-mb-40 g-mb-0--lg">
        <h3 class="g-font-size-16 g-font-weight-400 g-letter-spacing-0_5 mb-4">Latest Posts</h3>
      ...
      <!-- Footer Content -->
      <div class="col-lg-3 col-md-6 g-mb-40 g-mb-0--lg">
        <h3 class="g-font-size-16 g-font-weight-400 g-letter-spacing-0_5 mb-4">Useful Links</h3>
      ...
      <div class="col-lg-3 col-md-6">
        <h3 class="g-font-size-16 g-font-weight-400 g-letter-spacing-0_5 mb-4">Our Contacts</h3>
