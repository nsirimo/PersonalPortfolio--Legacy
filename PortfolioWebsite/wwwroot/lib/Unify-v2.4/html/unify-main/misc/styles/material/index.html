...
<head>
  <!-- Title -->
  <title>Material Style | Unify - Responsive Website Template</title>
  ...
  <!-- Google Fonts -->
  <link href="//fonts.googleapis.com/css?family=Open+Sans:400,300,500,600,700" rel="stylesheet">
  ...
  <!-- CSS Unify -->
  <link rel="stylesheet" href="assets/css/styles.material-style.css">
...
<body id="home-section">
  <main>
    ...
    <header id="js-header" class="u-header u-header--static u-header--show-hide u-header--change-appearance"
      ...
      <div class="u-header__section u-header__section--light g-bg-white g-transition-0_3 g-py-5"
            data-header-fix-moment-exclude="g-py-5"
            data-header-fix-moment-classes="u-shadow-v18 g-py-2">
        <nav class="navbar navbar-expand-lg">
          <div class="container">
            <!-- Responsive Toggle Button -->
            <button class="navbar-toggler navbar-toggler-right btn g-line-height-1 g-brd-none g-pa-0 g-pos-abs g-top-minus-1 g-top-3--sm g-right-0" type="button" aria-label="Toggle navigation" aria-expanded="false" aria-controls="navBar" data-toggle="collapse" data-target="#navBar">
              ...
              <svg width="86px" height="32px" viewBox="0 0 86 32" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                  <g transform="translate(-78.000000, -19.000000)">
                    <g transform="translate(78.000000, 19.000000)">
                      <path d="M0,0 L19.2941176,0 L19.2941176,0 C23.7123956,-8.11624501e-16 27.2941176,3.581722 27.2941176,8 L27.2941176,27.2941176 L8,27.2941176 L8,27.2941176 C3.581722,27.2941176 5.41083001e-16,23.7123956 0,19.2941176 L0,0 Z" fill="#F44336"></path>
            ...
            <!-- Navigation -->
            <div class="collapse navbar-collapse align-items-center flex-sm-row g-pt-10 g-pt-3--lg g-ml-15--lg g-ml-30--xl" id="navBar">
              <ul id="js-scroll-nav" class="navbar-nav text-uppercase g-pos-rel g-font-weight-500 mr-auto">
                <li class="nav-item g-mx-15--lg active">
                  <a href="#home-section" class="nav-link px-0">Home</a>
                </li>
                <li class="nav-item g-mx-15--lg">
                  <a href="#about-section" class="nav-link px-0">About</a>
                </li>
                <li class="nav-item g-mx-15--lg">
                  <a href="#projects-section" class="nav-link px-0">Projects</a>
                </li>
                <li class="nav-item g-mx-15--lg">
                  <a href="#environment-section" class="nav-link px-0">Environment</a>
                </li>
                <li class="nav-item g-mx-15--lg">
                  <a href="#news-section" class="nav-link px-0">News</a>
                </li>
                <li class="nav-item g-ml-15--lg g-mr-0--lg">
                  <a href="#contacts-section" class="nav-link px-0">Contacts</a>
                </li>
              </ul>
            </div>
            <!-- End Navigation -->
            ...
            <div class="d-inline-block g-hidden-xs-down g-pos-rel g-valign-middle g-pl-30 g-pl-0--lg">
              <a href="#!" class="btn text-uppercase u-btn-primary u-btn-raised u-waves-effect u-waves-light g-brd-none g-font-size-13 g-rounded-50 g-font-weight-700 g-py-15 g-px-30">Purchase now</a>
            </div>
          </div>
        </nav>
      </div>
      ...
      <div class="container g-py-200">
        <div class="row">
          <div class="col-lg-6">
            ...
            <a class="js-fancybox btn btn-md u-btn-white u-btn-raised u-btn-floating u-btn-floating--large u-waves-effect u-waves-dark g-color-black g-brd-none mr-2" href="javascript:;"
        ...
        <div class="row no-gutters">
          <div class="col-lg-4 g-px-40 g-mb-50 g-mb-0--lg">
            ...
            <div class="text-center">
              <span class="u-icon-v1 u-icon-size--2xl g-color-primary mb-3">
                <i class="icon-finance-086 u-line-icon-pro"></i>
              </span>
              <h3 class="h4 mb-2">Invest To Us</h3>
          ...
          <div class="col-lg-4 g-brd-left--lg g-brd-gray-light-v4 g-px-40 g-mb-50 g-mb-0--lg">
            ...
            <div class="text-center">
              ...
              <h3 class="h4 mb-2">Increase Income</h3>
              <p class="mb-0">We strive to embrace and drive change in our industry which allows us to keep our clients relevant.</p>
            </div>
            <!-- End Icon Blocks -->
          </div>
          ...
          <div class="col-lg-4 g-brd-left--lg g-brd-gray-light-v4 g-px-40">
            ...
            <div class="text-center">
              ...
              <h3 class="h4 mb-2">Collect Cash</h3>
              <p class="mb-0">We strive to embrace and drive change in our industry which allows us to keep our clients relevant.</p>
            </div>
            <!-- End Icon Blocks -->
          </div>
    ...
    <!-- About Our Company -->
    <section id="about-section" class="g-pt-100 g-pb-60">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-5 order-2 g-ml-30--lg g-mb-40">
            <h2 class="h2 g-color-gray-dark-v2 mb-3">About Our Company</h2>

            <p class="g-font-size-17 mb-3">The time has come to bring those ideas and plans to life. This is where we really begin to visualize your napkin sketches and make them into beautiful pixels.</p>
          ...
          <div class="col-lg-6 order-1 g-mb-40">
            <div class="masonry-grid row g-mx-minus-5">
              <div class="masonry-grid-sizer col-sm-1"></div>

              <div class="masonry-grid-item col-sm-5 g-px-5 g-mb-10">
                <img class="img-fluid w-100" src="../../../../assets/img-temp/492x780/img1.jpg" alt="Image description">
              </div>

              <div class="masonry-grid-item col-sm-7 g-hidden-xs-down g-px-5 g-mb-10">
                <img class="img-fluid w-100" src="../../../../assets/img-temp/700x350/img1.jpg" alt="Image description">
              </div>

              <div class="masonry-grid-item col-sm-3 g-hidden-xs-down g-px-5 g-mb-10">
                <img class="img-fluid w-100" src="../../../../assets/img-temp/350x500/img1.jpg" alt="Image description">
              </div>

              <div class="masonry-grid-item col-sm-4 g-hidden-xs-down g-px-5 g-mb-10">
                <img class="img-fluid w-100" src="../../../../assets/img-temp/475x500/img1.jpg" alt="Image description">
              </div>

              <div class="masonry-grid-item col-sm-8 g-hidden-xs-down g-px-5 g-mb-10">
                <img class="img-fluid w-100" src="../../../../assets/img-temp/700x350/img2.jpg" alt="Image description">
              </div>

              <div class="masonry-grid-item col-sm-4 g-hidden-xs-down g-px-5 g-mb-10">
                <img class="img-fluid w-100" src="../../../../assets/img-temp/490x500/img1.jpg" alt="Image description">
              </div>
            </div>
          </div>
        </div>
    ...
    <!-- Our Recent Projects -->
    <section id="projects-section" class="g-py-100">
      <div class="container">
        <header class="g-mb-50">
          <h2 class="h2 g-color-gray-dark-v2 mb-3">Our Recent Projects</h2>
          ...
          <div class="col-lg-4 col-md-6 g-mb-30 g-mb-0--lg">
            <article class="u-block-hover u-shadow-v21 rounded">
              ...
              <header class="u-bg-overlay__inner g-pos-abs g-top-30 g-right-30 g-left-30 g-color-white">
                <h3 class="h4"><a class="g-color-white" href="#!">Nulla ipsum dolor sit</a></h3>
              ...
              <ul class="list-inline u-bg-overlay__inner g-pos-abs g-bottom-10 g-left-30 g-opacity-0_8">
                ...
                <li class="list-inline-item g-color-white">+21</li>
              </ul>
            </article>
          </div>
          ...
          <div class="col-lg-4 col-md-6 g-mb-30 g-mb-0--lg">
            <article class="u-block-hover u-shadow-v21 rounded">
              ...
              <ul class="list-inline u-bg-overlay__inner g-pos-abs g-bottom-10 g-left-30 g-opacity-0_8">
                ...
                <li class="list-inline-item g-color-white">+8</li>
              </ul>
            </article>
          </div>
          ...
          <div class="col-lg-4 col-md-6">
            <article class="u-block-hover u-shadow-v21 rounded">
              ...
              <ul class="list-inline u-bg-overlay__inner g-pos-abs g-bottom-10 g-left-30 g-opacity-0_8">
                ...
                <li class="list-inline-item g-color-white">+13</li>
              </ul>
            </article>
          </div>
        </div>
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading" data-options='{direction: "reverse", settings_mode_oneelement_max_offset: "150"}'>
      ...
      <div class="container u-bg-overlay__inner g-py-80">
        <div class="row">
          <!-- Section Content -->
          <div class="col-lg-6 order-2 order-sm-1 g-mb-0 g-mb-100--sm g-mb-0--lg">
            <h2 class="h2 g-color-gray-dark-v2 mb-3">Most Quality Solution</h2>
            ...
            <a href="#!" class="btn text-uppercase u-btn-primary u-btn-raised u-waves-effect u-waves-light g-brd-none g-font-size-13 g-rounded-50 g-font-weight-700 g-py-15 g-px-30 g-mr-15 g-mb-15 g-mb-5--sm">Buy Full Version</a>
    ...
    <!-- Our Environment -->
    <section id="environment-section" class="g-py-100">
      <div class="container">
        <div class="row">
          <!-- Carousel -->
          ...
          <div class="col-lg-6 align-self-center g-pl-30--lg">
            <header class="g-mb-30">
              <h2 class="h2 g-color-gray-dark-v2 mb-3">Our Environment</h2>
              <p class="g-font-size-16">Unify <strong>creative</strong> technology company providing key digital services. Focused on helping our clients to build a <strong>successful</strong> business on web and mobile.</p>
            </header>
            ...
            <a href="#!" class="btn text-uppercase u-btn-primary u-btn-raised u-waves-effect u-waves-light g-brd-none g-font-size-13 g-rounded-50 g-font-weight-700 g-py-15 g-px-30 g-mr-15 g-mb-15 g-mb-5--sm">Check It Now</a>
      ...
      <div class="container">
        <div class="row text-center text-uppercase">
          <div class="col-lg-3 col-sm-6 g-brd-right g-brd-gray-light-v4 g-mb-50">
            <div class="js-counter g-color-gray-dark-v2 g-font-size-35 g-font-weight-300 g-mb-7">52 147</div>
            <h4 class="h6 g-color-gray-dark-v5">Code Lines</h4>
          </div>

          <div class="col-lg-3 col-sm-6 g-brd-right--lg g-brd-gray-light-v4 g-mb-50">
            <div class="js-counter g-color-gray-dark-v2 g-font-size-35 g-font-weight-300 g-mb-7">24 583</div>
            <h4 class="h6 g-color-gray-dark-v5">Projects</h4>
          </div>

          <div class="col-lg-3 col-sm-6 g-brd-right g-brd-gray-light-v4 g-mb-50">
            <div class="js-counter g-color-gray-dark-v2 g-font-size-35 g-font-weight-300 g-mb-7">7 348</div>
            <h4 class="h6 g-color-gray-dark-v5">Working Hours</h4>
          </div>

          <div class="col-lg-3 col-sm-6 g-mb-50">
            <div class="js-counter g-color-gray-dark-v2 g-font-size-35 g-font-weight-300 g-mb-7">87 904</div>
    ...
    <!-- Latest News -->
    <section id="news-section" class="g-py-100">
      <div class="container">
        <header class="g-mb-50">
          <h2 class="h2 g-color-gray-dark-v2 mb-3">Our Latest News</h2>
        ...
        <div class="row">
          <div class="col-lg-4 g-mb-30 g-mb-0--lg">
            <div class="card u-shadow-v30 g-brd-none">
              <figure class="g-pos-rel u-bg-overlay g-bg-black-opacity-0_5--after">
                <img class="img-fluid w-100" src="../../../../assets/img-temp/900x600/img7.jpg" height="600" width="900" alt="Image Description">
                <figcaption class="g-pos-abs g-bottom-20 g-left-20 g-right-20 g-z-index-2">
                  <h4 class="card-title g-color-white g-mb-0"><a class="u-link-v5 g-color-white" href="#!">Focused on helping our clients to build a great business</a></h4>
                </figcaption>

                <a href="#!" class="btn btn-md u-btn-primary u-btn-raised u-btn-floating u-halfway-fab u-waves-effect u-waves-light g-brd-none"><i class="material-icons">arrow_forward</i></a>

                <div class="dropdown g-pos-abs g-top-5 g-right-5 g-z-index-2">
                  <a href="#!" class="btn btn-md u-btn-flat u-btn-floating g-color-white-opacity-0_5 g-brd-none" id="basicImageCardLulya_2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="material-icons">more_vert</i></a>
                  <div class="dropdown-menu dropdown-menu-right" aria-labelledby="basicImageCardLulya_2" x-placement="bottom-end" style="position: absolute; transform: translate3d(42px, 42px, 0px); top: 0px; left: 0px; will-change: transform;">
              ...
              <div class="card-body g-pt-30">
                ...
                <div class="media g-font-size-12 g-brd-top g-brd-gray-light-v4 g-pt-20">
          ...
          <div class="col-lg-4 g-mb-30 g-mb-0--lg">
            <div class="card u-shadow-v30 g-brd-none">
              <figure class="g-pos-rel u-bg-overlay g-bg-black-opacity-0_5--after">
                <img class="img-fluid w-100" src="../../../../assets/img-temp/900x600/img5.jpg" height="600" width="900" alt="Image Description">
                <figcaption class="g-pos-abs g-bottom-20 g-left-20 g-right-20 g-z-index-2">
                  <h4 class="card-title g-color-white g-mb-0"><a class="u-link-v5 g-color-white" href="#!">We build your website to realise your vision, project and more</a></h4>
                </figcaption>
          ...
          <div class="col-lg-4">
            <div class="card u-shadow-v30 g-brd-none">
              <figure class="g-pos-rel u-bg-overlay g-bg-black-opacity-0_5--after">
                <img class="img-fluid w-100" src="../../../../assets/img-temp/900x600/img4.jpg" height="600" width="900" alt="Image Description">
                <figcaption class="g-pos-abs g-bottom-20 g-left-20 g-right-20 g-z-index-2">
                  <h4 class="card-title g-color-white g-mb-0"><a class="u-link-v5 g-color-white" href="#!">Praesentium to website realise imperdiet demore elementum</a></h4>
                </figcaption>
              ...
              <div class="card-body g-pt-30">
                <p class="card-text">Nullam elementum tincidunt massa, a pulvinar leo ultricies ut. Ut fringilla lectus tellusimp imperdiet molestie est volutpat at. Sed viverra cursus nibh.</p>
                <div class="media g-font-size-12 g-brd-top g-brd-gray-light-v4 g-pt-20">
                  <img class="d-flex mr-2 rounded-circle g-width-20 g-height-20" src="../../../../assets/img-temp/100x100/img4.jpg" alt="Image description">
                  <div class="media-body align-self-center">
                    <a class="u-link-v5 g-color-gray-dark-v2 g-color-primary--hover" href="#!">Anastasia Sh.</a>
    ...
    <section class="g-bg-primary g-color-white g-pa-30" style="background-image: url(../../../../assets/img/bg/pattern5.png);">
      <div class="d-md-flex justify-content-md-center text-center">
        <div class="align-self-md-center">
          <h4 class="h5 g-mr-20--md g-mb-15 g-mb-0--md">We offer best in class service for your needs</h4>
        </div>
        <div class="align-self-md-center">
          <a href="#!" class="btn text-uppercase u-btn-white u-btn-raised u-waves-effect u-waves-dark g-brd-none g-font-size-13 g-rounded-50 g-font-weight-700 g-py-15 g-px-30">Purchase Now</a>
        </div>
      </div>
    </section>
    <!-- End Call To Action -->
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 g-mb-40 g-mb-0--md">
            <h3 class="h4 mb-4">Our Contacts</h3>
            ...
            <address class="g-bg-no-repeat g-font-size-12 mb-0" style="background-image: url(../../../../assets/img/maps/map2.png);">
              ...
              <div class="d-flex g-mb-20">
                <div class="g-mr-10">
                  <span class="u-icon-v3 u-icon-size--xs g-bg-white-opacity-0_1 g-color-white-opacity-0_6">
                    <i class="material-icons g-font-size-13">place</i>
                  </span>
                </div>
              ...
              <div class="d-flex g-mb-20">
                <div class="g-mr-10">
                  <span class="u-icon-v3 u-icon-size--xs g-bg-white-opacity-0_1 g-color-white-opacity-0_6">
                    <i class="material-icons g-font-size-13">call</i>
                  </span>
                </div>
              ...
              <div class="d-flex g-mb-20">
                <div class="g-mr-10">
                  <span class="u-icon-v3 u-icon-size--xs g-bg-white-opacity-0_1 g-color-white-opacity-0_6">
                    <i class="material-icons g-font-size-13">language</i>
                  </span>
                </div>
                <p class="mb-0">
          ...
          <div class="col-md-6">
            ...
            <form>
              <div class="form-group g-mb-40">
                <div class="u-input-group-v4">
                  <input id="footerContactName" class="form-control form-control-md rounded-0 g-px-0" name="footerContactName" type="text">
                  <label class="g-color-white-opacity-0_7" for="footerContactName">Your name</label>
                </div>
              </div>

              <div class="form-group g-mb-40">
                <div class="u-input-group-v4">
                  <input id="footerContactPhone" class="form-control form-control-md rounded-0 g-px-0" name="footerContactPhone" type="text">
                  <label class="g-color-white-opacity-0_7" for="footerContactPhone">Your phone</label>
                </div>
              </div>
              <div class="form-group g-mb-40">
                <div class="u-input-group-v4">
                  <textarea id="footerContactMessage" class="form-control form-control-md rounded-0 g-resize-none g-px-0" name="footerContactMessage" rows="2"></textarea>
                  <label class="g-color-white-opacity-0_7" for="footerContactMessage">Message</label>
                </div>
              </div>
              <button class="btn text-uppercase u-btn-primary u-btn-raised u-waves-effect u-waves-light g-brd-none g-font-size-13 g-rounded-50 g-font-weight-700 g-py-15 g-px-30" type="submit" role="button">
                Send Message
              </button>
            </form>
          </div>
    ...
    <div class="u-fixed-action-btn g-pos-fix g-bottom-20 g-right-20">
      <a href="#!" class="btn btn-md u-btn-lightred u-btn-raised u-btn-floating u-btn-floating--large u-waves-effect u-waves-light g-brd-none"><i class="material-icons">share</i></a>
      <ul>
        <li><a href="#!" class="btn btn-md u-btn-facebook u-btn-raised u-btn-floating g-brd-none"><i class="fa fa-facebook g-font-size-13"></i></a></li>
        <li><a href="#!" class="btn btn-md u-btn-google-plus u-btn-raised u-btn-floating g-brd-none"><i class="fa fa-google-plus g-font-size-13"></i></a></li>
        <li><a href="#!" class="btn btn-md u-btn-twitter u-btn-raised u-btn-floating g-brd-none"><i class="fa fa-twitter g-font-size-13"></i></a></li>
        <li><a href="#!" class="btn btn-md u-btn-vk u-btn-raised u-btn-floating g-brd-none"><i class="fa fa-vk g-font-size-13"></i></a></li>
      </ul>
    </div>
  </main>
  ...
  <script src="../../../../assets/vendor/materialize/js/velocity.min.js"></script>
  <script src="../../../../assets/vendor/materialize/js/waves.js"></script>
  <script src="../../../../assets/vendor/materialize/js/buttons.js"></script>
