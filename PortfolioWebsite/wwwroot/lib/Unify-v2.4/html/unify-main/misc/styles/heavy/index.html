...
<head>
  <!-- Title -->
  <title>Heavy Style | Unify - Responsive Website Template</title>
  ...
  <!-- Google Fonts -->
  <link href="//fonts.googleapis.com/css?family=Roboto:400,100,300,400italic,500,700,900" rel="stylesheet">
  <link href="//fonts.googleapis.com/css?family=Raleway:400,100,200,300,600,500,700,800,900" rel="stylesheet">
  ...
  <!-- CSS Unify -->
  <link rel="stylesheet" href="assets/css/styles.heavy-style.css">
  ...
  <main>
      ...
      <div class="u-header__section u-header__section--light g-bg-white g-transition-0_3 g-py-5"
        ...
        <nav class="navbar navbar-expand-lg">
          <div class="container">
            ...
            <!-- Navigation -->
            <div class="collapse navbar-collapse align-items-center flex-sm-row g-pt-10 g-pt-3--lg g-mr-40--lg" id="navBar">
              <ul id="js-scroll-nav" class="navbar-nav text-uppercase g-pos-rel g-font-weight-600 ml-auto g-letter-spacing-0_5">
            ...
            <div class="d-inline-block g-hidden-xs-down g-pos-rel g-valign-middle g-pl-30 g-pl-0--lg">
              <a class="btn u-btn-outline-primary g-font-weight-900 g-letter-spacing-1 text-uppercase g-py-10 g-px-15 rounded-0" href="https://wrapbootstrap.com/theme/unify-responsive-website-template-WB0412697?ref=htmlstream" target="_blank">Purchase now</a>
            </div>
          </div>
        </nav>
      </div>
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall" data-options='{direction: "reverse", settings_mode_oneelement_max_offset: "150"}'>
      ...
      <div class="container g-py-200">
        <div class="row">
          <div class="col-md-7">
            <h3 class="g-font-size-45 mb-4">Have an easy<br>website with Unify</h3>
            ...
            <a class="js-fancybox u-link-v5 g-color-black" href="javascript:;"
              ...
              <span class="align-middle u-icon-v3 u-block-hover--scale g-bg-white g-color-primary--hover g-rounded-50x g-cursor-pointer mr-2">
        ...
        <div class="row no-gutters">
          <div class="col-lg-4 g-px-40 g-mb-50 g-mb-0--lg">
            ...
            <div class="text-center">
              ...
              <h3 class="h5 mb-3">Invest To Us</h3>
          ...
          <div class="col-lg-4 g-brd-left--lg g-brd-gray-light-v4 g-px-40 g-mb-50 g-mb-0--lg">
            ...
            <div class="text-center">
              ...
              <h3 class="h5 mb-3">Increase Income</h3>
              <p class="mb-0">We strive to embrace and drive change in our industry which allows us to keep our clients relevant.</p>
            </div>
            <!-- End Icon Blocks -->
          </div>
          ...
          <div class="col-lg-4 g-brd-left--lg g-brd-gray-light-v4 g-px-40">
            ...
            <div class="text-center">
              ...
              <h3 class="h5 mb-3">Collect Cash</h3>
              <p class="mb-0">We strive to embrace and drive change in our industry which allows us to keep our clients relevant.</p>
            </div>
            <!-- End Icon Blocks -->
          </div>
        ...
        <div class="row align-items-center">
          <div class="col-lg-5 order-2 g-ml-30--lg g-mb-40">
            <header class="u-heading-v2-3--bottom g-brd-primary g-mb-20">
              <h2 class="u-heading-v2__title">About Our Company</h2>
            </header>

            <p class="g-font-size-17 mb-4">The time has come to bring those ideas and plans to life. This is where we really begin to visualize your napkin sketches and make them into beautiful pixels.</p>
            <p class="g-font-size-17 mb-4">Now that your brand is all dressed up and ready to party, it's time to release it to the world. By the way, let's celebrate already.</p>

            <ul class="list-unstyled g-color-gray-dark-v3 mb-0">
          ...
          <div class="col-lg-6 order-1 g-mb-40">
            <div class="masonry-grid row g-mx-minus-5">
              ...
              <div class="masonry-grid-item col-sm-7 g-px-5 g-hidden-xs-down g-mb-10">
                <img class="img-fluid w-100" src="../../../../assets/img-temp/700x350/img1.jpg" alt="Image description">
              </div>

              <div class="masonry-grid-item col-sm-3 g-px-5 g-hidden-xs-down g-mb-10">
                <img class="img-fluid w-100" src="../../../../assets/img-temp/350x500/img1.jpg" alt="Image description">
              </div>

              <div class="masonry-grid-item col-sm-4 g-px-5 g-hidden-xs-down g-mb-10">
                <img class="img-fluid w-100" src="../../../../assets/img-temp/475x500/img1.jpg" alt="Image description">
              </div>

              <div class="masonry-grid-item col-sm-8 g-px-5 g-hidden-xs-down g-mb-10">
      ...
      <div class="container">
        <header class="g-mb-50">
          <div class="u-heading-v2-3--bottom g-brd-primary g-mb-20">
            <h2 class="u-heading-v2__title">Our Recent Projects</h2>
          </div>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 g-mb-30 g-mb-0--lg">
            <article class="u-block-hover u-shadow-v21">
              ...
              <header class="u-bg-overlay__inner g-pos-abs g-top-20 g-right-20 g-left-20 g-color-white">
                <h3 class="h5">
                  <a class="g-color-white" href="#!">Nulla ipsum dolor</a>
                </h3>
                <p>Consectetur adipiscing elitut eleifend nisl</p>
              </header>

              <ul class="list-inline u-bg-overlay__inner g-pos-abs g-bottom-10 g-left-20 g-opacity-0_8">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 order-2 order-sm-1 g-mb-0 g-mb-100--sm g-mb-0--lg">
            <div class="u-heading-v2-3--bottom g-brd-primary g-mb-30">
              <h2 class="u-heading-v2__title">Most Quality Solution</h2>
            </div>
            ...
            <a class="btn u-btn-outline-primary g-font-weight-900 g-letter-spacing-1 text-uppercase g-py-10 g-px-15 rounded-0 g-mr-15 g-mb-15 g-mb-5--sm" href="#!">Buy Full Version</a>
            <small class="d-block d-sm-inline-block g-color-gray-dark-v3 g-font-size-13">* Exclusive item on Wrapboostrap Marketpalce</small>
          </div>
          <!-- End Section Content -->
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6 g-mb-50 g-mb-0--lg">
            ...
            data-arrow-left-classes="fa fa-angle-left g-left-0" data-arrow-right-classes="fa fa-angle-right g-right-0" data-nav-for="#carouselCus2">
              ...
              <div class="js-slide">
                <a class="js-fancybox d-block g-pos-rel" href="javascript:;"
                  ...
                  <img class="img-fluid w-100" data-lazy="../../../../assets/img-temp/600x450/img6.jpg" alt="Image description">
                </a>
              </div>
              ...
              <div class="js-slide">
                <a class="js-fancybox d-block g-pos-rel" href="javascript:;"
                   ...
                   data-overlay-blur-bg="true"
                   data-caption="Lightbox Gallery">
                  <img class="img-fluid w-100" data-lazy="../../../../assets/img-temp/600x450/img3.jpg" alt="Image description">
                </a>
              </div>
              ...
              <div class="js-slide">
                <a class="js-fancybox d-block g-pos-rel" href="javascript:;"
                   ...
                   data-overlay-blur-bg="true"
                   data-caption="Lightbox Gallery">
                  <img class="img-fluid w-100" data-lazy="../../../../assets/img-temp/600x450/img4.jpg" alt="Image description">
                </a>
              </div>
              ...
              <div class="js-slide">
                <a class="js-fancybox d-block g-pos-rel" href="javascript:;"
                   ...
                   data-overlay-blur-bg="true"
                   data-caption="Lightbox Gallery">
                  <img class="img-fluid w-100" data-lazy="../../../../assets/img-temp/600x450/img5.jpg" alt="Image description">
                </a>
              </div>
              ...
              <div class="js-slide">
                <a class="js-fancybox d-block g-pos-rel" href="javascript:;"
                   ...
                   data-overlay-blur-bg="true"
                   data-caption="Lightbox Gallery">
                  <img class="img-fluid w-100" data-lazy="../../../../assets/img-temp/600x450/img7.jpg" alt="Image description">
                </a>
              </div>
            </div>
          ...
          <div class="col-lg-6 align-self-center g-pl-30--lg">
            <header class="g-mb-30">
              <div class="u-heading-v2-3--bottom g-brd-primary g-mb-30">
                <h2 class="u-heading-v2__title">Our Environment</h2>
              </div>
            ...
            <a class="btn u-btn-outline-primary g-font-weight-900 g-letter-spacing-1 text-uppercase g-py-10 g-px-15 rounded-0 g-mr-15 g-mb-10 g-mb-5--sm" href="#!">Check It Now</a>
            <small class="d-block d-sm-inline-block g-color-gray-dark-v3 g-font-size-13">* Sponsored by Unify team in Htmlstream</small>
          </div>
          <!-- End Section Content -->
        </div>
      </div>
    ...
    <section class="g-brd-top g-brd-bottom g-brd-gray-light-v4 g-pt-50">
      <div class="container">
        <div class="row text-center text-uppercase g-letter-spacing-1">
          <div class="col-lg-3 col-sm-6 g-brd-right g-brd-gray-light-v4 g-mb-50">
            <div class="js-counter g-font-size-45 g-font-weight-900 g-mb-7 g-letter-spacing-2">52 147</div>
            <h4 class="h6 g-color-gray-dark-v3">Code Lines</h4>
          </div>

          <div class="col-lg-3 col-sm-6 g-brd-right--lg g-brd-gray-light-v4 g-mb-50">
            <div class="js-counter g-font-size-45 g-font-weight-900 g-mb-7 g-letter-spacing-2">24 583</div>
            <h4 class="h6 g-color-gray-dark-v3">Projects</h4>
          </div>

          <div class="col-lg-3 col-sm-6 g-brd-right g-brd-gray-light-v4 g-mb-50">
            <div class="js-counter g-font-size-45 g-font-weight-900 g-mb-7 g-letter-spacing-2">7 348</div>
            <h4 class="h6 g-color-gray-dark-v3">Working Hours</h4>
          </div>

          <div class="col-lg-3 col-sm-6 g-mb-50">
            <div class="js-counter g-font-size-45 g-font-weight-900 g-mb-7 g-letter-spacing-2">87 904</div>
            <h4 class="h6 g-color-gray-dark-v3">Job Offers</h4>
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="news-section" class="g-py-100">
      <div class="container">
        <header class="g-mb-50">
          <div class="u-heading-v2-3--bottom g-brd-primary g-mb-20">
            <h2 class="u-heading-v2__title">Our Latest News</h2>
          </div>
        ...
        <div class="row">
          <div class="col-lg-4 g-mb-30 g-mb-0--lg">
            ...
            <article class="u-shadow-v11">
              <div class="g-pa-30">
                <h3 class="h5">
                  <a class="g-color-black" href="#!">Focused on helping our clients to build a great business</a>
                </h3>
              ...
              <div class="media g-font-size-12 g-brd-top g-brd-gray-light-v4 g-pa-15-30">
                ...
                <div class="align-self-center">
                  <a class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover g-mr-10" href="#!">
                    <i class="icon-bubbles g-pos-rel g-top-1 mr-1"></i> 24
                  </a>
                  <a class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover" href="#!">
                    <i class="icon-eye g-pos-rel g-top-1 mr-1"></i> 108
                  </a>
                </div>
              </div>
            </article>
          ...
          <div class="col-lg-4 g-mb-30 g-mb-0--lg">
            ...
            <article class="u-shadow-v11">
              <div class="g-pa-30">
                <h3 class="h5">
                  <a class="g-color-black" href="#!">We build your website to realise your vision, project and more</a>
                </h3>
                <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores.</p>
              </div>
              ...
              <div class="media g-font-size-12 g-brd-top g-brd-gray-light-v4 g-pa-15-30">
                ...
                <div class="media-body align-self-center">
                  <a class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover" href="#!">Anastasia Sh.</a>
                </div>

                <div class="align-self-center">
                  <a class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover g-mr-10" href="#!">
                    <i class="icon-bubbles g-pos-rel g-top-1 mr-1"></i> 16
                  </a>
                  <a class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover" href="#!">
                    <i class="icon-eye g-pos-rel g-top-1 mr-1"></i> 124
                  </a>
                </div>
              </div>
            </article>
          ...
          <div class="col-lg-4">
            ...
            <article class="u-shadow-v11">
              <div class="g-pa-30">
                <h3 class="h5">
                  <a class="g-color-black" href="#!">Praesentium to website realise imperdiet demore elementum</a>
                </h3>
              ...
              <div class="media g-font-size-12 g-brd-top g-brd-gray-light-v4 g-pa-15-30">
                ...
                <div class="media-body align-self-center">
                  <a class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover" href="#!">James Dalglish</a>
                </div>

                <div class="align-self-center">
                  <a class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover g-mr-10" href="#!">
                    <i class="icon-bubbles g-pos-rel g-top-1 mr-1"></i> 41
                  </a>
                  <a class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover" href="#!">
                    <i class="icon-eye g-pos-rel g-top-1 mr-1"></i> 219
                  </a>
                </div>
              </div>
            </article>
    ...
    <section class="g-bg-primary g-color-white g-pa-30" style="background-image: url(../../../../assets/img/bg/pattern5.png);">
      <div class="d-md-flex justify-content-md-center text-center">
        <div class="align-self-md-center">
          <p class="lead text-uppercase g-font-weight-900 g-font-secondary g-letter-spacing-0_5 g-mr-20--md g-mb-15 g-mb-0--md">We offer best in class service for your needs</p>
        </div>
        <div class="align-self-md-center">
          <a class="btn u-btn-white g-font-weight-900 g-letter-spacing-1 text-uppercase g-py-10 g-px-15 rounded-0" target="_blank" href="https://wrapbootstrap.com/theme/unify-responsive-website-template-WB0412697?ref=htmlstream">Purchase Now</a>
        </div>
      </div>
    </section>
    <!-- End Call To Action -->
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 g-mb-40 g-mb-0--lg">
            <div class="u-heading-v2-3--bottom g-brd-white-opacity-0_8 g-mb-20">
              <h2 class="h5 u-heading-v2__title text-uppercase mb-0">About Us</h2>
            </div>
          ...
          <div class="col-lg-3 col-md-6 g-mb-40 g-mb-0--lg">
            <div class="u-heading-v2-3--bottom g-brd-white-opacity-0_8 g-mb-20">
              <h2 class="h5 u-heading-v2__title text-uppercase mb-0">Latest Posts</h2>
            </div>

            <article>
              <h3 class="h6 g-font-weight-700 g-mb-2">
          ...
          <div class="col-lg-3 col-md-6 g-mb-40 g-mb-0--lg">
            <div class="u-heading-v2-3--bottom g-brd-white-opacity-0_8 g-mb-20">
              <h2 class="h5 u-heading-v2__title text-uppercase mb-0">Useful Links</h2>
            </div>

            <nav>
              <ul class="list-unstyled g-mt-minus-10 mb-0">
                <li class="g-pos-rel g-brd-bottom g-brd-white-opacity-0_1 g-py-10">
                  <h4 class="h6 g-font-weight-700 g-pr-20 mb-0">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="u-heading-v2-3--bottom g-brd-white-opacity-0_8 g-mb-20">
              <h2 class="h5 u-heading-v2__title text-uppercase mb-0">Our Contacts</h2>
            </div>
