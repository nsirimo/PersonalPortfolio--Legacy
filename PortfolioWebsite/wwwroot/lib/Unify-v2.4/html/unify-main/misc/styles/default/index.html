...
<head>
  <!-- Title -->
  <title>Default Style | Unify - Responsive Website Template</title>
        ...
        <nav class="navbar navbar-expand-lg">
          <div class="container">
            ...
            <div class="collapse navbar-collapse align-items-center flex-sm-row g-pt-10 g-pt-3--lg g-mr-40--lg" id="navBar">
              <ul id="js-scroll-nav" class="navbar-nav text-uppercase g-pos-rel g-font-weight-600 ml-auto">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6 align-self-center g-pl-30--lg">
            ...
            <a class="btn btn-xl u-btn-primary text-uppercase g-font-weight-600 g-font-size-12 rounded g-mr-15 g-mb-10 g-mb-5--sm" href="#!">Check It Now</a>
