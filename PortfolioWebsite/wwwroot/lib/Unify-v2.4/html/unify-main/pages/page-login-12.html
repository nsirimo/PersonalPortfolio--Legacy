...
<head>
  <!-- Title -->
  <title>Login Page 12 | | Unify - Responsive Website Template</title>
            ...
            <form class="g-py-15">
              <div class="mb-4">
                <div class="input-group g-brd-primary--focus">
                  ...
                  <input class="form-control g-color-black g-brd-gray-light-v3 g-py-15 g-px-15" type="email" placeholder="Email Adress">
                </div>
              </div>
      ...
      <div class="container g-pt-25 g-pb-10">
        <div class="row justify-content-between align-items-center">
          <div class="col-sm-6 col-md-8 g-mb-15">
            <h3 class="h4 g-color-white g-font-weight-300 text-uppercase">Subscribe to our weekly <span class="g-font-weight-600">Newsletter</span></h3>
          </div>
