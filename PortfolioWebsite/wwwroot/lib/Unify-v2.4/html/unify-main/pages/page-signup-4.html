...
<head>
  <!-- Title -->
  <title>Signup Page 4 | | Unify - Responsive Website Template</title>
        ...
        <div class="col-sm-10 col-md-9 col-lg-6">
          <div class="g-brd-around g-brd-gray-light-v4 rounded g-py-40 g-px-30">
            ...
            <form class="g-py-15">
              ...
              <div class="row">
                <div class="col-xs-12 col-sm-6 mb-4">
                  <div class="input-group">
                    ...
                    <input class="form-control g-color-black g-bg-white g-bg-white--focus g-brd-gray-light-v4 g-brd-primary--hover g-py-15 g-px-15" type="password" placeholder="********">
                  </div>
                </div>
              ...
              <div class="row justify-content-between mb-5">
                ...
                <div class="col-4 align-self-center text-right">
                  <button class="btn btn-md u-btn-primary g-py-13 g-px-25" type="button">Signup</button>
                </div>
              </div>
            </form>
            <!-- End Form -->
            ...
            <footer class="text-center">
              <p class="g-color-gray-dark-v5 g-font-size-13 mb-0">Already have an account? <a class="g-font-weight-600" href="page-signup4.html">signin</a>
              </p>
            </footer>
          </div>
        </div>
