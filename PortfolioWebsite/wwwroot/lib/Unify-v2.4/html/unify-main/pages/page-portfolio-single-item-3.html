...
<head>
  <!-- Title -->
  <title>Portfolio Single Item 3 | | Unify - Responsive Website Template</title>
...
<body>
  <main>
      ...
      <div class="container">
        <div class="d-sm-flex text-center">
          <div class="align-self-center">
            <h2 class="h3 g-font-weight-300 w-100 g-mb-10 g-mb-0--md">Portfolio Single Item 3</h2>
          </div>
          ...
          <div class="align-self-center ml-auto">
            <ul class="u-list-inline">
              ...
              <li class="list-inline-item g-color-primary">
                <span>Portfolio Single Item 3</span>
              </li>
            </ul>
          </div>
        </div>
    ...
    <section class="container g-py-100">
      ...
      <img class="img-fluid w-100 g-mb-50" src="../../assets/img-temp/800x500/img3.jpg" alt="Image Description">
