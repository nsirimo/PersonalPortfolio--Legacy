      ...
      <div class="row no-gutters align-items-center">
        <div class="col-lg-6">
          ...
          <div class="js-carousel" data-autoplay="true" data-infinite="true" data-fade="true" data-speed="5000">
            <div class="js-slide g-bg-size-cover g-min-height-100vh" style="background-image: url(../../assets/img-temp/900x900/img3.jpg);" data-calc-target="#js-header"></div>

            <div class="js-slide g-bg-size-cover g-min-height-100vh" style="background-image: url(../../assets/img-temp/900x900/img4.jpg);" data-calc-target="#js-header"></div>
          </div>
