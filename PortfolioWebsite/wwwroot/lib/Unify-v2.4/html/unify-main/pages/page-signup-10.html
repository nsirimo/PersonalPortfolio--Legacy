...
<head>
  <!-- Title -->
  <title>Signup Page 10 | | Unify - Responsive Website Template</title>
        ...
        <div class="row justify-content-between">
          <div class="col-md-6 col-lg-5 flex-md-unordered align-self-center g-mb-80">
            <div class="u-shadow-v21 g-bg-white rounded g-pa-50">
              ...
              <form class="g-py-15">
                <div class="mb-4">
                  <input class="form-control g-color-black g-bg-white g-bg-white--focus g-brd-gray-light-v4 g-brd-primary--hover rounded g-py-15 g-px-15" type="text" placeholder="John Doe">
                </div>
                ...
                <div class="g-mb-30">
                  <input class="form-control g-color-black g-bg-white g-bg-white--focus g-brd-gray-light-v4 g-brd-primary--hover rounded g-py-15 g-px-15" type="tel" placeholder="Password">
                </div>
              ...
              <footer class="text-center">
                <p class="g-color-gray-dark-v5 mb-0">Already have an account? <a class="g-font-weight-600" href="page-login-10.html">signin</a>
                </p>
              </footer>
            </div>
          </div>
          ...
          <div class="col-md-6 flex-md-first align-self-center g-mb-80">
            ...
            <div class="row">
              <div class="col-md-11 col-lg-9">
                ...
                <!-- Testimonials -->
                <blockquote class="u-blockquote-v1 g-color-gray-dark-v5 rounded g-pl-60 g-pr-30 g-py-25 g-mb-40">Look no further you came to the right place. Unify offers everything you have dreamed of in one package.</blockquote>
                <div class="media">
