...
<head>
  <!-- Title -->
  <title>Portfolio Single Item 2 | | Unify - Responsive Website Template</title>
      ...
      <div class="container">
        <div class="d-sm-flex text-center">
          <div class="align-self-center">
            <h2 class="h3 g-font-weight-300 w-100 g-mb-10 g-mb-0--md">Portfolio Single Item 2</h2>
          </div>
          ...
          <div class="align-self-center ml-auto">
            <ul class="u-list-inline">
              ...
              <li class="list-inline-item g-color-primary">
                <span>Portfolio Single Item 2</span>
              </li>
            </ul>
          </div>
        </div>
    ...
    <section class="container g-pt-100 g-pb-70">
      <div class="row g-mb-70">
        <div class="col-lg-8 g-mb-30">
          <!-- Carousel Images -->
          <div class="js-carousel g-mb-30" data-arrows-classes="u-arrow-v1 g-absolute-centered--y g-width-40 g-height-40 g-font-size-default g-color-gray-dark-v5 g-bg-white g-color-white--hover g-bg-primary--hover rounded" data-arrow-left-classes="fa fa-angle-left g-left-20"
          data-arrow-right-classes="fa fa-angle-right g-right-20">
            <img class="img-fluid" src="../../assets/img-temp/800x800/img2.jpg" alt="Image Description">
            <img class="img-fluid" src="../../assets/img-temp/800x800/img3.jpg" alt="Image Description">
            <img class="img-fluid" src="../../assets/img-temp/800x800/img4.jpg" alt="Image Description">
          </div>
          <!-- End Carousel Images -->
        </div>
