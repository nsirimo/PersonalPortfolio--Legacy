...
<head>
  <!-- Title -->
  <title>Login Page 4 | | Unify - Responsive Website Template</title>
        ...
        <div class="col-sm-8 col-lg-6">
          <div class="g-brd-around g-brd-gray-light-v4 rounded g-py-40 g-px-30">
            ...
            <form class="g-py-15">
              <div class="mb-4">
                <div class="input-group g-brd-primary--focus">
                  ...
                  <input class="form-control g-color-black g-bg-white g-brd-gray-light-v4 g-py-15 g-px-15" type="email" placeholder="johndoe@gmail.com">
                </div>
              </div>
              ...
              <div class="g-mb-35">
                <div class="input-group g-brd-primary--focus mb-4">
                  ...
                  <input class="form-control g-color-black g-bg-white g-brd-gray-light-v4 g-py-15 g-px-15" type="password" placeholder="Password">
                </div>
            ...
            <footer class="text-center">
              <p class="g-color-gray-dark-v5 g-font-size-13 mb-0">Don't have an account? <a class="g-font-weight-600" href="page-signup4.html">signup</a>
              </p>
            </footer>
          </div>
        </div>
