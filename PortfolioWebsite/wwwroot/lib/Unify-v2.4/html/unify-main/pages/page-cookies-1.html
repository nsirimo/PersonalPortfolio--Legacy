...
<head>
  <!-- Title -->
  <title>Cookies Page | | Unify - Responsive Website Template</title>
      ...
      <div class="container g-py-150">
        <div class="row">
          <div class="col-lg-6">
            ...
            <h2 class="g-color-black g-font-weight-700 g-font-size-50 g-line-height-1 mb-4">Cookies Policy</h2>
            <p class="mb-0">This is where we sit down, grab a cup of coffee and dial in the details. Understanding the task at hand and ironing out the wrinkles is key. Now that we've aligned the details, it's time to get things mapped out and organized. This part is
