...
<body>
  <main>
      ...
      <div class="container">
        <div class="d-sm-flex text-center">
          <div class="align-self-center">
            <h2 class="h3 g-font-weight-300 w-100 g-mb-10 g-mb-0--md">About Me</h2>
          </div>
      ...
      <figure class="row">
        ...
        <div class="col-lg-8">
          <div class="d-flex justify-content-between g-mb-10">
            <div class="g-mb-20">
              <h4 class="h5 g-mb-5">Ketey Reyes</h4>
          ...
          <div class="g-mb-50">
            ...
            <p>As creatives, it's important that I strive to do work outside of obligation. This lets us stay ahead of the curve for our clients and internal projects. At the end of the day, it's important to not let being busy distract us from having fun.
              Smiling, laughing, and hanging helps us work together to achieve this.</p>
          </div>
          <!-- End Info -->
    ...
    <!-- Testimonials -->
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading g-bg-cover g-bg-white-opacity-0_9--after">
          ...
          <div class="col-lg-9">
            <div class="text-center g-z-index-1 text-uppercase">
              <blockquote class="g-font-size-28 g-mb-20">If you can design one thing
                <span class="g-color-primary g-font-weight-700">you can design</span> everything. Just believe it.
              </blockquote>
    ...
    <section class="container g-py-50">
      <div class="d-flex justify-content-between">
        ...
        <a class="align-self-center btn btn-xl u-btn-outline-black g-font-weight-600 g-font-size-default g-px-35" href="#!">Hire Me</a>
      </div>
    </section>
