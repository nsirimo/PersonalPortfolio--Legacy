...
<head>
  <!-- Title -->
  <title>Shortcodes | Unify - Responsive Website Template</title>
      ...
      <section class="container-fluid g-px-50 g-py-70">
        <div class="row justify-content-start align-items-center g-mx-minus-25">
          <div class="col-md-6 col-lg-5 flex-md-unordered g-px-25 g-mb-30">
            ...
            <p class="lead mb-4">The most powerful and premium plugins that are extended with data attributes. Transform your static screens into clickable, interactive prototypes in under 5 minutes with the power to customize even tiniest details of your website appearance,
              like:</p>
