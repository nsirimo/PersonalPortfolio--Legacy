...
<head>
  <!-- Title -->
  <title>Alerts | Unify - Responsive Website Template</title>
  ...
  <main>
      ...
      <div class="u-header__sections-container">
        <div class="u-sidebar-navigation-inner">
          ...
          <ul class="js-shortcode-filter-result nav flex-column u-sidebar-navigation-list">
            ...
            <li class="js-shortcode-filter__item nav-item bases">
              <a href="../../unify-main/shortcodes/shortcode-base-alerts.html" class="nav-link active">Alerts</a>
            </li>
            <li class="js-shortcode-filter__item nav-item bases">
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall" data-options="{direction: 'reverse', settings_mode_oneelement_max_offset: '150'}">
      ...
      <div class="container g-z-index-1 g-py-100">
        <h1 class="g-font-weight-300 g-letter-spacing-1 g-mb-15">Alerts</h1>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="media">
                          ...
                          <div class="media-body">
                            <div class="d-flex justify-content-between">
                              <p class="m-0"><strong>Albert Heller</strong>
                              </p>
                      ...
                      <div class="alert fade show g-brd-around g-brd-red rounded-0" role="alert">
                        ...
                        <div class="media">
                          ...
                          <div class="media-body">
                            <div class="d-flex justify-content-between">
                              <p class="m-0"><strong>James Coolman</strong>
                              </p>
                    ...
                    <div class="col-lg-6">
                      ...
                      <div class="alert fade show g-brd-around g-brd-gray-dark-v2 rounded-0" role="alert">
                        ...
                        <div class="media">
                          ...
                          <div class="media-body">
                            <div class="d-flex justify-content-between">
                              <p class="m-0"><strong>Alberta Watson</strong>
                              </p>
                      ...
                      <div class="alert fade show g-brd-around g-brd-primary rounded-0" role="alert">
                        ...
                        <div class="media">
                          ...
                          <div class="media-body">
                            <div class="d-flex justify-content-between">
                              <p class="m-0"><strong>David Lee</strong>
                              </p>
                              <span class="align-self-center small text-nowrap">Just Now</span>
                            </div>
                  ...
                  <div class="row">
                      ...
                      <div class="alert fade show u-shadow-v1-3 g-pa-20" role="alert">
                        ...
                        <div class="media">
                          <div class="d-flex g-mr-15">
                            <img class="g-width-40 g-height-40" src="../../assets/img-temp/100x100/img5.jpg" alt="Image Description">
                          </div>
                          <div class="media-body">
                            <p class="m-0"><strong>Jasica Coolman</strong> saved your pin.</p>
                            <span class="g-font-size-12">5 minutes ago</span>
                    ...
                    <div class="col-lg-6">
                      ...
                      <div class="alert fade show g-brd-around g-brd-gray-light-v4 g-pa-20" role="alert">
                        ...
                        <div class="media">
                          <div class="d-flex g-mr-10">
                            <img class="g-width-40 g-height-40" src="../../assets/img-temp/100x100/img1.jpg" alt="Image Description">
                          </div>
                          <div class="media-body">
                            <div class="d-flex justify-content-between">
                              <p class="m-0"><strong>Albert Watson</strong>
                              </p>
                              <span class="align-self-center small text-nowrap">2 min ago</span>
                            </div>
                            <p class="m-0 g-font-size-14">Your friend request has been accepted.</p>
      ...
      <section class="g-py-50 g-pb-100">
        <div class="container">
          ...
          <header class="g-mb-80">
            ...
            <div class="g-line-height-2 g-pl-90">
              <p>Provide contextual feedback messages for typical user actions with the handful of available and flexible alert messages. By default Bootstrap includes 4 state alerts such as "Success", "Info", "Warning" and "Danger". Check out the offecial
                Bootstrap Alerts page for more details
          ...
          <div class="row">
            <div class="col-md-3">
              ...
              <p>You may use any heading tags and classes for the titles e.g.
                <code class="text-nowrap">&lt;h4 class="h5"&gt;</code>
              </p>
            </div>
