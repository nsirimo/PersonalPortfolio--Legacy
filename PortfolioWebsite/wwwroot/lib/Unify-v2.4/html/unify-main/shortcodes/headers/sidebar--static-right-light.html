...
<head>
  <!-- Title -->
  <title>Sidebar Navigation - Static - Right Side | Unify - Responsive Website Template</title>
...
<body class="u-body--header-side-static-right">
  <main>
    <!-- Sidebar Navigation -->
    <div id="js-header" class="u-header u-header--side" data-header-position="right" data-header-breakpoint="lg">
      <div class="u-header__sections-container g-bg-white g-brd-left--lg g-brd-gray-light-v5 g-py-10 g-py-40--lg g-px-14--lg">
