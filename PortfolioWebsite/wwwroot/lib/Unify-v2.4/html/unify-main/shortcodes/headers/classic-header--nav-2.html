...
<head>
  <!-- Title -->
  <title>Classic Header - Design of a active / hover Items – 2 | Unify - Responsive Website Template</title>
                ...
                <li class="nav-item hs-has-sub-menu g-mx-2--md g-mx-5--xl g-mb-5 g-mb-0--lg">
                  ...
                  <ul class="hs-sub-menu list-unstyled g-mt-17--lg g-mt-7--lg--scrolling" id="nav-submenu-1" aria-labelledby="nav-link-1">
                    ...
                    <li class="active hs-has-sub-menu">
                      <a href="#!" id="nav-link-2" aria-haspopup="true" aria-expanded="false" aria-controls="nav-submenu-2">Page 2</a>
                      <!-- Submenu (level 2) -->
                      <ul class="hs-sub-menu list-unstyled" id="nav-submenu-2" aria-labelledby="nav-link-2">
                        <li class="dropdown-item active"><a href="#!">Page 2-1</a>
                        </li>
                        <li class="dropdown-item"><a href="#!">Page 2-2</a>
                        </li>
                        <li class="dropdown-item"><a href="#!">Page 2-3</a>
                        </li>
                        <li class="dropdown-item"><a href="#!">Page 2-4</a>
                        </li>
                        <li class="dropdown-item"><a href="#!">Page 2-5</a>
                        </li>
                      </ul>
                      <!-- End Submenu (level 2) -->
                    </li>
