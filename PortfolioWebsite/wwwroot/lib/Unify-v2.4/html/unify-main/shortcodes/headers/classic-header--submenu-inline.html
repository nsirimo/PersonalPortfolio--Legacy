...
<head>
  <!-- Title -->
  <title>Classic Header - Inline Submenu | Unify - Responsive Website Template</title>
            ...
            <div class="collapse navbar-collapse align-items-center flex-sm-row g-pt-10 g-pt-5--lg" id="navBar">
              <ul class="navbar-nav text-uppercase g-font-weight-600 ml-auto">
                ...
                <li class="nav-item dropdown g-mx-20--lg">
                  <a href="#!" class="nav-link dropdown-toggle g-px-0" id="nav-link-1" aria-haspopup="true" aria-expanded="false" aria-controls="section-home-submenu" data-toggle="dropdown" data-appear-speed="200" data-appear-easing="linear">Pages
                
              </a>
                  <!-- Submenu (Bootstrap) -->
                  <ul class="dropdown-menu font-weight-normal rounded-0 g-text-transform-none g-brd-none g-brd-top g-brd-primary g-brd-top-1 g-mt-20 g-mt-10--lg--scrolling" id="nav-submenu-1" aria-labelledby="nav-link-1">
                    <li class="active g-mx-5--lg">
                      <a class="nav-link g-color-primary--hover" href="#!">Page 1</a>
                    </li>
                    <li class="g-mx-5--lg">
                      <a class="nav-link g-color-primary--hover" href="#!">Page 2</a>
                    </li>
                    <li class="g-mx-5--lg">
                      <a class="nav-link g-color-primary--hover" href="#!">Page 3</a>
                    </li>
                  </ul>
