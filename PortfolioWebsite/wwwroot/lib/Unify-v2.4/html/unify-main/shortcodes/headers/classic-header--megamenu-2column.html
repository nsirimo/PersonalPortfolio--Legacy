...
<head>
  <!-- Title -->
  <title>Classic Header - Megamenu 2 Column | Unify - Responsive Website Template</title>
          ...
          <div class="container">
            ...
            <div class="collapse navbar-collapse align-items-center flex-sm-row g-pt-10 g-pt-5--lg" id="navBar">
              <ul class="navbar-nav text-uppercase g-font-weight-600 ml-auto">
                ...
                <!-- Mega Menu Item -->
                <li class="hs-has-mega-menu nav-item g-mx-20--lg active" data-animation-in="fadeIn" data-animation-out="fadeOut" data-max-width="50%" data-position="right">
                      ...
                      <div class="col-lg-6">
                        <section class="g-pa-20">
                          <ul class="list-unstyled">
                            ...
                            <li>
                              <a href="#!" class="nav-link active g-px-0 g-color-primary--hover">Blockquote Blocks</a>
                            </li>
                            <li>
