...
<head>
  <!-- Title -->
  <title>Fullscreen Navigation - Bottom-Right | Unify - Responsive Website Template</title>
...
<body>
  <main>
    <!-- Logo -->
    <a class="navbar-brand g-pos-abs g-top-20 g-left-20 g-z-index-2" href="../../../index.html">
      <img src="../../../assets/img/logo/logo-2.png" alt="Image Description">
    </a>
    <!-- End Logo -->

    <!-- Responsive Toggle Button -->
    <button class="btn u-header-toggler u-header-toggler--bottom-right g-pa-0" id="header-toggler" aria-haspopup="true" aria-expanded="false" aria-controls="js-header" aria-label="Toggle Header" data-target="#js-header">
    ...
    <!-- Header -->
    <div id="js-header" class="u-header u-header--fullscreen--bottom-right" aria-labelledby="header-toggler" data-overlay-classes="g-bg-black-opacity-0_8">
