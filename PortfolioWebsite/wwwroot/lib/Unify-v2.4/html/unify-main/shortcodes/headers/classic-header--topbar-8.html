...
<head>
  <!-- Title -->
  <title>Classic Header - Top Bar 8 | Unify - Responsive Website Template</title>
              ...
              <div class="row flex-row align-items-start align-items-lg-center justify-content-lg-end text-uppercase g-font-weight-600 u-header--hidden-element g-color-gray-dark-v2 g-font-size-13 text-lg-right g-mt-minus-10 g-mb-20">
                ...
                <i class="fa fa-angle-down g-ml-3"></i>
                  ...
                  <ul id="languages-dropdown-2" class="list-unstyled text-left u-shadow-v23 g-pos-abs g-left-0 g-bg-white g-width-160 g-py-20 g-pb-15 g-mt-5 g-z-index-2" aria-labelledby="languages-dropdown-invoker-2">
                    <li>
                      <a class="d-flex align-items-center g-color-main g-color-primary--hover g-text-underline--none--hover g-py-8 g-px-20" href="#!">
