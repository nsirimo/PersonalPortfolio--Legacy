...
<head>
  <!-- Title -->
  <title>Classic Header - Absolute 2-nd Screen | Unify - Responsive Website Template</title>
...
<body>
  <main>
    <!-- Header -->
    <header id="js-header" class="u-header u-header--abs-top-2nd-screen u-header--change-appearance" data-header-fix-moment="100">
