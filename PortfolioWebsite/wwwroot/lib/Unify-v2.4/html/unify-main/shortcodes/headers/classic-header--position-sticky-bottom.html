...
<head>
  <!-- Title -->
  <title>Classic Header - Sticky Bottom | Unify - Responsive Website Template</title>
...
<body>
  <main>
    <!-- Header -->
    <header id="js-header" class="u-header u-header--sticky-bottom u-header--change-appearance" data-header-fix-moment="300">
      <div class="u-header__section u-header__section--dark g-bg-black-opacity-0_7 g-transition-0_3 g-py-5" data-header-fix-moment-exclude="g-bg-black-opacity-0_7 g-py-5" data-header-fix-moment-classes="g-bg-black g-py-0">
