...
<head>
  <!-- Title -->
  <title>Classic Header - Absolute Top | Unify - Responsive Website Template</title>
...
<body>
  <main>
    ...
    <header id="js-header" class="u-header u-header--abs-top u-header--show-hide u-header--change-appearance" data-header-fix-moment="500" data-header-fix-effect="slide">
      <div class="u-header__section u-header__section--dark g-bg-black-opacity-0_7 g-transition-0_3 g-py-5" data-header-fix-moment-exclude="g-bg-black-opacity-0_7" data-header-fix-moment-classes="g-bg-black">
