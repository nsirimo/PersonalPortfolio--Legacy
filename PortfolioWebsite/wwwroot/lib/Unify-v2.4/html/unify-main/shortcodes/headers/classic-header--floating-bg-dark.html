...
<head>
  <!-- Title -->
  <title>Classic Header - Floating Header with White Background | Unify - Responsive Website Template</title>
...
<body>
  <main>
    <!-- Header -->
    <header id="js-header" class="u-header u-header--static u-header--floating g-mt-40--lg" data-header-fix-moment-classes="g-bg-black">
      <div class="container">
        <div class="u-header__section u-header__section--dark g-bg-black g-transition-0_3 g-py-10" data-header-fix-moment-exclude="g-bg-black g-py-10" data-header-fix-moment-classes="g-py-5">
          <nav class="navbar navbar-expand-lg">
            ...
            <div class="d-inline-block g-pos-rel g-valign-middle g-ml-30 g-ml-0--lg">
              ...
              <!-- Search Form -->
              <form id="searchform-1" class="u-searchform-v1 u-dropdown--css-animation u-dropdown--hidden g-bg-black g-box-shadow-none g-pa-10 g-mt-25--lg g-mt-20--lg--scrolling">
