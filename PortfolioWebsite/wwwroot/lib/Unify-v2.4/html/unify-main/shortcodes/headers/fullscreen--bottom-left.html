...
<head>
  <!-- Title -->
  <title>Fullscreen Navigation - Bottom-Left | Unify - Responsive Website Template</title>
...
<body>
  <main>
    ...
    <button class="btn u-header-toggler u-header-toggler--bottom-left g-pa-0" id="header-toggler" aria-haspopup="true" aria-expanded="false" aria-controls="js-header" aria-label="Toggle Header" data-target="#js-header">
    ...
    <!-- Header -->
    <div id="js-header" class="u-header u-header--fullscreen--bottom-left" aria-labelledby="header-toggler" data-overlay-classes="g-bg-black-opacity-0_8">
