...
<head>
  <!-- Title -->
  <title>Classic Header - Layout #2 | Unify - Responsive Website Template</title>
...
<body>
  <main>
    <!-- Header -->
    <header id="js-header" class="u-header u-header--static u-header--show-hide u-header--has-hidden-element" data-header-fix-moment="500" data-header-fix-effect="slide">
      <!-- Top Bar -->
          ...
          <div class="col-auto col-lg-4 text-lg-right g-px-15">
            <div class="g-mt-minus-10 g-mx-minus-10">
              ...
              <div class="u-basket d-inline-block g-valign-middle g-color-main g-mt-10 g-mx-10">
                <a href="#!" id="basket-bar-invoker-9" class="g-color-gray-dark-v4 g-font-size-16 g-text-underline--none--hover g-valign-middle" aria-controls="basket-bar-9" aria-haspopup="true" aria-expanded="false" data-bage-info="12" data-dropdown-event="hover" data-dropdown-target="#basket-bar-9"
                data-dropdown-type="css-animation" data-dropdown-duration="300" data-dropdown-hide-on-scroll="false" data-dropdown-animation-in="fadeIn" data-dropdown-animation-out="fadeOut">
                  <i class="icon-basket-loaded"></i>
                </a>

                <div id="basket-bar-9" class="u-basket__bar u-dropdown--css-animation u-dropdown--hidden g-brd-top g-brd-2 g-brd-primary g-color-main g-mt-20" aria-labelledby="basket-bar-invoker">
        ...
        <form id="searchform-9" class="u-searchform-v3 g-font-size-25 g-color-gray-dark-v2 g-brd-2 g-brd-y g-brd-gray-light-v4 g-bg-white g-px-15">
          <div class="input-group g-brd-primary--focus">
            ...
            <div class="input-group-addon p-0">
              <button class="text-right px-0 g-color-gray-dark-v2 g-color-gray-light-v2--hover g-font-size-14 g-letter-spacing-2" type="button" aria-haspopup="true" aria-expanded="false" aria-controls="searchform-9" data-dropdown-type="css-animation" data-dropdown-duration="300"
        ...
        <nav class="navbar navbar-expand-lg justify-content-lg-between">
          ...
          <div class="collapse navbar-collapse align-items-center flex-sm-row g-width-auto" id="navBar">
            <ul class="navbar-nav text-uppercase g-font-weight-600 mx-auto">
              <li class="nav-item g-mx-5 g-mx-15--xl">
              ...
              <li class="nav-item g-mx-5 g-mx-15--xl active">
          ...
          <a class="d-inline-block g-color-white g-color-white-opacity-0_9--hover g-text-underline--none--hover g-pa-10" href="#!" aria-haspopup="true" aria-expanded="false" aria-controls="searchform-9" data-dropdown-type="css-animation" data-dropdown-duration="300"
          data-dropdown-target="#searchform-9">
