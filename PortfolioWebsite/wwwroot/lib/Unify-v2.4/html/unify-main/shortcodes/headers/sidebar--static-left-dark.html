...
<head>
  <!-- Title -->
  <title>Sidebar Navigation - Static - Left Side (Dark) | Unify - Responsive Website Template</title>
...
<body class="u-body--header-side-static-left g-bg-black g-color-white">
  <main>
    <!-- Sidebar Navigation -->
    <div id="js-header" class="u-header u-header--side" data-header-position="left" data-header-breakpoint="lg">
      <div class="u-header__sections-container g-bg-black g-py-10 g-py-40--lg g-px-14--lg">
        <div class="u-header__section u-header__section--dark">
          <nav class="navbar navbar-expand-lg">
            <div class="js-mega-menu container">
              ...
              <div class="text-center g-hidden-lg-down g-color-white">
                <ul class="list-inline g-mb-10">
                  <li class="list-inline-item g-mx-10" data-toggle="tooltip" data-placement="top" title="" data-original-title="Facebook">
                    <a href="#!" class="g-color-white g-color-primary--hover">
