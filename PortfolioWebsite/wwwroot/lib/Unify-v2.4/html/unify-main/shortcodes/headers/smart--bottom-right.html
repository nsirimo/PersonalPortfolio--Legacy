...
<head>
  <!-- Title -->
  <title>Smart Navigation - Bottom-Right | Unify - Responsive Website Template</title>
...
<body>
  <main>
    ...
    <!-- Smart Menu -->
    <div class="js-smart-menu u-smart-nav u-smart-nav--bottom-right g-transition-0_3" data-fix-moment="300">
      <!-- Smart Menu Toggle Button -->
      <button class="u-smart-nav__toggler btn u-btn-white g-pa-0" id="u-smart-menu-toggler-1" aria-label="Toggle navigation" aria-haspopup="true" aria-expanded="false" aria-controls="smart-menu-1">
