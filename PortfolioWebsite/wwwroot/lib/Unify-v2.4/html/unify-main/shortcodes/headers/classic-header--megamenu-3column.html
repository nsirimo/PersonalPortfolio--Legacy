...
<head>
  <!-- Title -->
  <title>Classic Header - Megamenu 3 Column | Unify - Responsive Website Template</title>
                      ...
                      <div class="col-lg-4 g-brd-left--lg g-brd-gray-light-v5">
                        <section class="g-pa-20 g-pl-5--lg">
                          <ul class="list-unstyled">
                            ...
                            <li>
                              <a href="#!" class="nav-link active g-px-0 g-color-primary--hover">Loading &amp; Hover Effects</a>
                            </li>
                            <li>
