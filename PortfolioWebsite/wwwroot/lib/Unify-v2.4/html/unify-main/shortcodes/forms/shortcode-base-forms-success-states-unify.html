...
<head>
  <!-- Title -->
  <title>Unify Forms Success States | Unify - Responsive Website Template</title>
  ...
  <main>
            ...
            <li class="js-shortcode-filter__item nav-item dropdown bases">
              ...
              <div class="dropdown-menu u-dropdown-static">
                <ul class="nav flex-column">
                  ...
                  <li class="js-shortcode-filter__item nav-item bases">
                    <a href="../../../unify-main/shortcodes/forms/shortcode-base-forms-success-states-unify.html" class="nav-link active">Forms Success States unify</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item bases">
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall" data-options="{direction: 'reverse', settings_mode_oneelement_max_offset: '150'}">
      ...
      <div class="container g-z-index-1 g-py-100">
        <h1 class="g-font-weight-300 g-letter-spacing-1 g-mb-15">Unify Forms Success States</h1>
            ...
            <div class="shortcode-html">
              ...
              <form class="g-brd-around g-brd-gray-light-v4 g-pa-30 g-mb-30">
                ...
                <div class="form-group u-has-success-v1-1 g-mb-20">
                  ...
                  <input id="autocomplete2" class="form-control form-control-md rounded-0" type="text" data-url="../../../assets/include/ajax/autocomplete-data-1.json">
                  <small class="form-control-feedback">This is a required field.</small>
                </div>
                ...
                <div class="form-group u-has-success-v1-1 g-mb-20">
                  ...
                  <input id="autocomplete3" class="form-control form-control-md rounded-0" type="text" data-url="../../../assets/include/ajax/autocomplete-data-1.json">
                  <small class="form-control-feedback d-block g-bg-primary g-color-white g-font-size-12 g-px-14 g-py-3 mt-0">This is a required field.</small>
                </div>
                <!-- End Input with Autocomplete -->
                ...
                <div class="form-group u-has-success-v1-2 g-mb-20">
                  ...
                  <input id="autocomplete4" class="form-control form-control-md rounded-0" type="text" data-url="../../../assets/include/ajax/autocomplete-data-1.json">
                  <small class="form-control-feedback d-block g-pos-abs g-top-0 g-right-0 g-bg-primary g-color-white g-font-size-12 g-px-14 g-py-3 mt-0">This is a required field.</small>
                </div>
                <!-- End Input with Autocomplete -->
