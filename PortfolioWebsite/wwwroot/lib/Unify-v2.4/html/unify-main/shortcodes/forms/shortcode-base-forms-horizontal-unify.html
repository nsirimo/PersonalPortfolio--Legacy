...
<head>
  <!-- Title -->
  <title>Unify Horizontal Forms | Unify - Responsive Website Template</title>
  ...
  <main>
            ...
            <li class="js-shortcode-filter__item nav-item dropdown bases">
              ...
              <div class="dropdown-menu u-dropdown-static">
                <ul class="nav flex-column">
                  ...
                  <li class="js-shortcode-filter__item nav-item bases">
                    <a href="../../../unify-main/shortcodes/forms/shortcode-base-forms-horizontal-unify.html" class="nav-link active">Forms Horizontal Unify</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item bases">
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall" data-options="{direction: 'reverse', settings_mode_oneelement_max_offset: '150'}">
      ...
      <div class="container g-z-index-1 g-py-100">
        <h1 class="g-font-weight-300 g-letter-spacing-1 g-mb-15">Unify Horizontal Forms</h1>
        ...
        <div class="col-md-10">
          <div id="shortcode2">
            ...
            <div class="shortcode-scripts">
              ...
              <script type="text/plain" src="../../../assets/vendor/jquery-ui.core.min.js"></script>
