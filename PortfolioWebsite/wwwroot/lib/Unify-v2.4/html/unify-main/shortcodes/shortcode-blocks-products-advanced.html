...
<head>
  <!-- Title -->
  <title>Product Blocks - Advanced | Unify - Responsive Website Template</title>
  ...
  <main>
      ...
      <div class="u-header__sections-container">
        <div class="u-sidebar-navigation-inner">
          ...
          <ul class="js-shortcode-filter-result nav flex-column u-sidebar-navigation-list">
            ...
            <li class="js-shortcode-filter__item nav-item dropdown blocks">
              <a class="nav-link dropdown-toggle active" href="#!" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Products</a>
              <div class="dropdown-menu u-dropdown-static">
                <ul class="nav flex-column">
                  <li class="js-shortcode-filter__item nav-item blocks">
                  ...
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../unify-main/shortcodes/shortcode-blocks-products-advanced.html" class="nav-link active">Products Advanced</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item blocks">
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall g-overflow-hidden" data-options="{direction: 'reverse', settings_mode_oneelement_max_offset: '150'}">
      ...
      <div class="container g-z-index-1 g-py-100">
        <h1 class="g-font-weight-300 g-letter-spacing-1 g-mb-15">Product Blocks - Advanced</h1>
    ...
    <section>
      ...
      <section class="container g-py-100">
        ...
        <div id="shortcode01">
          <div class="shortcode-html">
            ...
            <div class="g-mx-minus-15">
              <div class="js-carousel g-pb-90" data-slides-show="2" data-slides-scroll="2" data-infinite="true" data-arrows-classes="u-arrow-v1 g-pos-abs g-bottom-0 g-width-45 g-height-45 g-font-size-default g-color-gray-dark-v5 g-bg-gray-light-v5 g-color-white--hover g-bg-primary--hover rounded"
              data-arrow-left-classes="fa fa-angle-left g-left-35x--lg g-left-15" data-arrow-right-classes="fa fa-angle-right g-right-35x--lg g-right-15" data-pagi-classes="u-carousel-indicators-v1 g-absolute-centered--x g-bottom-20 text-center">
                <div class="js-slide g-px-15">
                  <!-- Article -->
                  <article class="g-bg-size-cover g-pos-rel" data-bg-img-src="../../assets/img-temp/900x600/img1.jpg">
                    <!-- Article Content -->
                    <div class="ml-auto g-width-50x--sm g-bg-black-opacity-0_7 g-pa-30">
                      ...
                      <a class="btn btn-md btn-block u-btn-primary g-font-weight-600 g-font-size-11 text-uppercase" href="#!">
                        <i class="g-font-size-18 g-pos-rel g-top-2 g-mr-5 fa fa-heart"></i>
                        Donate Now
                      </a>
                    </div>
                    <!-- End Article Content -->
                ...
                <div class="js-slide g-px-15">
                  <!-- Article -->
                  <article class="g-bg-size-cover g-pos-rel" data-bg-img-src="../../assets/img-temp/900x600/img6.jpg">
                    <!-- Article Content -->
                    <div class="ml-auto g-width-50x--sm g-bg-black-opacity-0_7 g-pa-30">
                      <div class="g-mb-45">
                ...
                <div class="js-slide g-px-15">
                  <!-- Article -->
                  <article class="g-bg-size-cover g-pos-rel" data-bg-img-src="../../assets/img-temp/900x600/img4.jpg">
                    <!-- Article Content -->
                    <div class="ml-auto g-width-50x--sm g-bg-black-opacity-0_7 g-pa-30">
                      <div class="g-mb-45">
                        <h3 class="h4 g-color-white g-mb-15">Water Project</h3>
                      ...
                      <div class="g-pos-rel g-mb-20">
                        <div class="js-hr-progress-bar progress g-height-4 g-bg-black rounded-0 g-overflow-visible g-mb-20">
                          <div class="js-hr-progress-bar-indicator progress-bar g-pos-rel" role="progressbar" style="width: 84%;" aria-valuenow="84" aria-valuemin="0" aria-valuemax="100">
                            <div class="text-center u-progress__pointer-v2 g-font-size-11 g-color-white g-bg-primary">84%</div>
                          </div>
                        </div>
                      </div>
                      <!-- End Progress Bar -->
                ...
                <div class="js-slide g-px-15">
                  <!-- Article -->
                  <article class="g-bg-size-cover g-pos-rel" data-bg-img-src="../../assets/img-temp/900x600/img5.jpg">
                    <!-- Article Content -->
                    <div class="ml-auto g-width-50x--sm g-bg-black-opacity-0_7 g-pa-30">
                      <div class="g-mb-45">
                        <h3 class="h4 g-color-white g-mb-15">Education Project</h3>
                      ...
                      <div class="g-pos-rel g-mb-20">
                        <div class="js-hr-progress-bar progress g-height-4 g-bg-black rounded-0 g-overflow-visible g-mb-20">
                          <div class="js-hr-progress-bar-indicator progress-bar g-pos-rel" role="progressbar" style="width: 91%;" aria-valuenow="91" aria-valuemin="0" aria-valuemax="100">
                            <div class="text-center u-progress__pointer-v2 g-font-size-11 g-color-white g-bg-primary">91%</div>
                          </div>
                        </div>
                      </div>
                      <!-- End Progress Bar -->
          ...
          <div class="shortcode-scripts">
            ...
            <script type="text/plain" src="../../assets/js/components/hs.progress-bar.js"></script>
        ...
        <div class="g-font-size-12 g-my-30 ">
          <a class="js-modal-markup u-link-v5 g-color-main g-color-primary--hover g-mr-15" href="#!" data-content-target="#shortcode01" data-modal-target="#modalMarkup" data-modal-effect="fadein">
            <i class="fa fa-code"></i>
            Show code
          </a>
          <a class="js-copy u-link-v5 g-color-main g-color-primary--hover" href="#!" data-content-target="#shortcode01" data-success-text="Copied">
        ...
        <div class="container">
          ...
          <div id="shortcode02">
            <div class="shortcode-html">
              <!-- Products Block -->
              <div class="g-mx-minus-15">
                <div class="js-carousel g-pb-90" data-slides-show="4" data-slides-scroll="4" data-arrows-classes="u-arrow-v1 g-pos-abs g-bottom-0 g-width-45 g-height-45 g-font-size-default g-color-gray-dark-v5 g-bg-gray-light-v5 g-color-white--hover g-bg-primary--hover rounded"
                data-arrow-left-classes="fa fa-angle-left g-left-35x--lg g-left-15" data-arrow-right-classes="fa fa-angle-right g-right-35x--lg g-right-15" data-pagi-classes="u-carousel-indicators-v1 g-absolute-centered--x g-bottom-20 text-center" data-responsive='[{
                  ...
                  <div class="js-slide g-px-15">
                    ...
                    <article class="u-shadow-v19 g-bg-white text-center rounded g-px-20 g-py-40 g-mb-5">
                      <!-- Article Image -->
                      <img class="d-inline-block img-fluid mb-4" src="../../assets/img-temp/425x250/img1.png" alt="Image Description">
                      <!-- End Article Image -->
                  ...
                  <div class="js-slide g-px-15">
                    ...
                    <article class="u-shadow-v19 g-bg-white text-center rounded g-px-20 g-py-40 g-mb-5">
                      <!-- Article Image -->
                      <img class="d-inline-block img-fluid mb-4" src="../../assets/img-temp/425x250/img2.png" alt="Image Description">
                      <!-- End Article Image -->
                  ...
                  <div class="js-slide g-px-15">
                    ...
                    <article class="u-shadow-v19 g-bg-white text-center rounded g-px-20 g-py-40 g-mb-5">
                      <!-- Article Image -->
                      <img class="d-inline-block img-fluid mb-4" src="../../assets/img-temp/425x250/img10.png" alt="Image Description">
                      <!-- End Article Image -->
                  ...
                  <div class="js-slide g-px-15">
                    ...
                    <article class="u-shadow-v19 g-bg-white text-center rounded g-px-20 g-py-40 g-mb-5">
                      <!-- Article Image -->
                      <img class="d-inline-block img-fluid mb-4" src="../../assets/img-temp/425x250/img4.png" alt="Image Description">
                      <!-- End Article Image -->
                  ...
                  <div class="js-slide g-px-15">
                    ...
                    <article class="u-shadow-v19 g-bg-white text-center rounded g-px-20 g-py-40 g-mb-5">
                      <!-- Article Image -->
                      <img class="d-inline-block img-fluid mb-4" src="../../assets/img-temp/425x250/img6.png" alt="Image Description">
                      <!-- End Article Image -->
                  ...
                  <div class="js-slide g-px-15">
                    ...
                    <article class="u-shadow-v19 g-bg-white text-center rounded g-px-20 g-py-40 g-mb-5">
                      <!-- Article Image -->
                      <img class="d-inline-block img-fluid mb-4" src="../../assets/img-temp/425x250/img7.png" alt="Image Description">
                      <!-- End Article Image -->
                  ...
                  <div class="js-slide g-px-15">
                    ...
                    <article class="u-shadow-v19 g-bg-white text-center rounded g-px-20 g-py-40 g-mb-5">
                      <!-- Article Image -->
                      <img class="d-inline-block img-fluid mb-4" src="../../assets/img-temp/425x250/img8.png" alt="Image Description">
                      <!-- End Article Image -->
                  ...
                  <div class="js-slide g-px-15">
                    ...
                    <article class="u-shadow-v19 g-bg-white text-center rounded g-px-20 g-py-40 g-mb-5">
                      <!-- Article Image -->
                      <img class="d-inline-block img-fluid mb-4" src="../../assets/img-temp/425x250/img9.png" alt="Image Description">
                      <!-- End Article Image -->
          ...
          <!-- Show Code -->
          <div class="g-font-size-12 g-my-30 ">
            <a class="js-modal-markup u-link-v5 g-color-main g-color-primary--hover g-mr-15" href="#!" data-content-target="#shortcode02" data-modal-target="#modalMarkup" data-modal-effect="fadein">
              <i class="fa fa-code"></i>
              Show code
            </a>
            <a class="js-copy u-link-v5 g-color-main g-color-primary--hover" href="#!" data-content-target="#shortcode02" data-success-text="Copied">
              <i class="fa fa-clone"></i>
              Copy code
            </a>
          </div>
      ...
      <section class="container g-py-100">
        ...
        <div id="shortcode03">
          <div class="shortcode-html">
            ...
            data-arrow-left-classes="fa fa-angle-left g-left-35x--lg g-left-15" data-arrow-right-classes="fa fa-angle-right g-right-35x--lg g-right-15" data-pagi-classes="u-carousel-indicators-v1 g-absolute-centered--x g-bottom-20 text-center" data-responsive='[{
              ...
              <div class="js-slide g-px-15">
                ...
                <article class="info-v5-6 g-pos-rel g-bg-gray-dark-v2 g-bg-primary--hover g-color-white g-rounded-4 g-transition-0_3">
                  <!-- Article Image -->
                  <img class="w-100" src="../../assets/img-temp/500x450/img2.jpg" alt="Image Description">
                  <!-- End Article Image -->
              ...
              <div class="js-slide g-px-15">
                ...
                <article class="info-v5-6 g-pos-rel g-bg-gray-dark-v2 g-bg-primary--hover g-color-white g-rounded-4 g-transition-0_3">
                  <!-- Article Image -->
                  <img class="w-100" src="../../assets/img-temp/500x450/img3.jpg" alt="Image Description">
                  <!-- End Article Image -->
              ...
              <div class="js-slide g-px-15">
                ...
                <article class="info-v5-6 g-pos-rel g-bg-gray-dark-v2 g-bg-primary--hover g-color-white g-rounded-4 g-transition-0_3">
                  <!-- Article Image -->
                  <img class="w-100" src="../../assets/img-temp/500x450/img10.jpg" alt="Image Description">
                  <!-- End Article Image -->
              ...
              <div class="js-slide g-px-15">
                ...
                <article class="info-v5-6 g-pos-rel g-bg-gray-dark-v2 g-bg-primary--hover g-color-white g-rounded-4 g-transition-0_3">
                  <!-- Article Image -->
                  <img class="w-100" src="../../assets/img-temp/500x450/img11.jpg" alt="Image Description">
                  <!-- End Article Image -->
              ...
              <div class="js-slide g-px-15">
                ...
                <article class="info-v5-6 g-pos-rel g-bg-gray-dark-v2 g-bg-primary--hover g-color-white g-rounded-4 g-transition-0_3">
                  <!-- Article Image -->
                  <img class="w-100" src="../../assets/img-temp/500x450/img5.jpg" alt="Image Description">
                  <!-- End Article Image -->
          ...
          <div class="shortcode-scripts">
            ...
            <!-- JS Unify -->
            <script type="text/plain" src="../../assets/js/components/hs.rating.js"></script>
            <script type="text/plain" src="../../assets/js/components/hs.carousel.js"></script>
        ...
        <!-- Show Code -->
        <div class="g-font-size-12 g-my-30 ">
          <a class="js-modal-markup u-link-v5 g-color-main g-color-primary--hover g-mr-15" href="#!" data-content-target="#shortcode03" data-modal-target="#modalMarkup" data-modal-effect="fadein">
            <i class="fa fa-code"></i>
            Show code
          </a>
          <a class="js-copy u-link-v5 g-color-main g-color-primary--hover" href="#!" data-content-target="#shortcode03" data-success-text="Copied">
            <i class="fa fa-clone"></i>
            Copy code
          </a>
        </div>
        ...
        <div class="container">
          ...
          <div id="shortcode04">
            <div class="shortcode-html">
              <!-- Products Block -->
              <div class="g-mx-minus-15">
                <div class="js-carousel g-pb-90" data-slides-show="4" data-slides-scroll="4" data-arrows-classes="u-arrow-v1 g-pos-abs g-bottom-0 g-width-45 g-height-45 g-font-size-default g-color-gray-dark-v5 g-bg-white g-color-white--hover g-bg-primary--hover rounded"
                data-arrow-left-classes="fa fa-angle-left g-left-35x--lg g-left-15" data-arrow-right-classes="fa fa-angle-right g-right-35x--lg g-right-15" data-pagi-classes="u-carousel-indicators-v1 g-absolute-centered--x g-bottom-20 text-center" data-responsive='[{
                       "breakpoint": 1350,
                       "settings": {
                         "slidesToShow": 5
                  ...
                  <div class="js-slide g-px-15">
                    ...
                    <article class="u-shadow-v19 g-bg-white text-center rounded g-mb-5">
                      ...
                      <!-- Article Image -->
                      <img class="w-100" src="../../assets/img-temp/400x270/img6.jpg" alt="Image Description">
                      <!-- End Article Image -->
                  ...
                  <div class="js-slide g-px-15">
                    ...
                    <article class="u-shadow-v19 g-bg-white text-center rounded g-mb-5">
                      ...
                      <!-- Article Image -->
                      <img class="w-100" src="../../assets/img-temp/400x270/img2.jpg" alt="Image Description">
                      <!-- End Article Image -->
                  ...
                  <div class="js-slide g-px-15">
                    ...
                    <article class="u-shadow-v19 g-bg-white text-center rounded g-mb-5">
                      ...
                      <!-- Article Image -->
                      <img class="w-100" src="../../assets/img-temp/400x270/img3.jpg" alt="Image Description">
                      <!-- End Article Image -->
                  ...
                  <div class="js-slide g-px-15">
                    ...
                    <article class="u-shadow-v19 g-bg-white text-center rounded g-mb-5">
                      ...
                      <!-- Article Image -->
                      <img class="w-100" src="../../assets/img-temp/400x270/img5.jpg" alt="Image Description">
                      <!-- End Article Image -->
                  ...
                  <div class="js-slide g-px-15">
                    ...
                    <article class="u-shadow-v19 g-bg-white text-center rounded g-mb-5">
                      ...
                      <!-- Article Image -->
                      <img class="w-100" src="../../assets/img-temp/400x270/img4.jpg" alt="Image Description">
                      <!-- End Article Image -->
          ...
          <!-- Show Code -->
          <div class="g-font-size-12 g-my-30 ">
            <a class="js-modal-markup u-link-v5 g-color-main g-color-primary--hover g-mr-15" href="#!" data-content-target="#shortcode04" data-modal-target="#modalMarkup" data-modal-effect="fadein">
              <i class="fa fa-code"></i>
              Show code
            </a>
            <a class="js-copy u-link-v5 g-color-main g-color-primary--hover" href="#!" data-content-target="#shortcode04" data-success-text="Copied">
              <i class="fa fa-clone"></i>
              Copy code
            </a>
          </div>
      ...
      <section class="container g-py-100">
          ...
          <div class="shortcode-html">
            ...
            <div class="g-mx-minus-15">
              ...
              data-arrow-left-classes="fa fa-angle-left g-left-35x--lg g-left-15" data-arrow-right-classes="fa fa-angle-right g-right-35x--lg g-right-15" data-pagi-classes="u-carousel-indicators-v1 g-absolute-centered--x g-bottom-20 text-center" data-responsive='[{
                ...
                <div class="js-slide g-px-15 g-pt-20">
                  <!-- Article -->
                  <article class="u-block-hover u-block-hover--uncroped text-center">
                    ...
                    <a class="d-block u-block-hover__additional--jump g-mb-10" href="#!">
                      <img class="w-100" src="../../assets/img-temp/425x250/img1.png" alt="Image Description">
                    </a>
                    <!-- End Article Image -->
                ...
                <div class="js-slide g-px-15 g-pt-20">
                  ...
                  <article class="u-block-hover u-block-hover--uncroped text-center">
                    <!-- Article Image -->
                    <a class="d-block u-block-hover__additional--jump g-mb-10" href="#!">
                      <img class="w-100" src="../../assets/img-temp/425x250/img2.png" alt="Image Description">
                    </a>
                    <!-- End Article Image -->
                ...
                <div class="js-slide g-px-15 g-pt-20">
                  ...
                  <article class="u-block-hover u-block-hover--uncroped text-center">
                    <!-- Article Image -->
                    <a class="d-block u-block-hover__additional--jump g-mb-10" href="#!">
                      <img class="w-100" src="../../assets/img-temp/425x250/img7.png" alt="Image Description">
                    </a>
                    <!-- End Article Image -->
                ...
                <div class="js-slide g-px-15 g-pt-20">
                  ...
                  <article class="u-block-hover u-block-hover--uncroped text-center">
                    <!-- Article Image -->
                    <a class="d-block u-block-hover__additional--jump g-mb-10" href="#!">
                      <img class="w-100" src="../../assets/img-temp/425x250/img10.png" alt="Image Description">
                    </a>
                    <!-- End Article Image -->
                ...
                <div class="js-slide g-px-15 g-pt-20">
                  ...
                  <article class="u-block-hover u-block-hover--uncroped text-center">
                    <!-- Article Image -->
                    <a class="d-block u-block-hover__additional--jump g-mb-10" href="#!">
                      <img class="w-100" src="../../assets/img-temp/425x250/img6.png" alt="Image Description">
                    </a>
                    <!-- End Article Image -->
        ...
        <!-- Show Code -->
        <div class="g-font-size-12 g-my-30 ">
          <a class="js-modal-markup u-link-v5 g-color-main g-color-primary--hover g-mr-15" href="#!" data-content-target="#shortcode05" data-modal-target="#modalMarkup" data-modal-effect="fadein">
            <i class="fa fa-code"></i>
            Show code
          </a>
          <a class="js-copy u-link-v5 g-color-main g-color-primary--hover" href="#!" data-content-target="#shortcode05" data-success-text="Copied">
            <i class="fa fa-clone"></i>
            Copy code
          </a>
        </div>
        ...
        <div class="container">
          ...
          <div id="shortcode06">
            <div class="shortcode-html">
              <!-- Products Block -->
              <div class="g-mx-minus-15">
                <div class="js-carousel" data-arrows-classes="u-arrow-v1 g-absolute-centered--y g-width-50 g-height-50 g-font-size-default g-color-gray-dark-v5 g-bg-white g-color-white--hover g-bg-primary--hover rounded" data-arrow-left-classes="fa fa-angle-left g-left-minus-10"
                data-arrow-right-classes="fa fa-angle-right g-right-minus-10" data-slides-show="3" data-responsive='[{
                       "breakpoint": 992,
                       "settings": {
                         "slidesToShow": 3
                       }
                  ...
                  <div class="js-slide g-px-20">
                    ...
                    <article class="u-shadow-v19 g-bg-white">
                      <!-- Article Image -->
                      <img class="w-100" src="../../assets/img-temp/400x270/img1.jpg" alt="Image Description">
                      <!-- End Article Image -->
                      ...
                      <div class="g-rounded-bottom-3 g-pa-30">
                        ...
                        <h3 class="h6 g-color-black g-font-weight-700 text-uppercase g-mb-20">Unify template</h3>
                  ...
                  <div class="js-slide g-px-20">
                    ...
                    <article class="u-shadow-v19 g-bg-white">
                      ...
                      <div class="g-rounded-bottom-3 g-pa-30">
                        <em class="d-block g-color-primary g-font-style-normal g-font-size-11 text-uppercase g-mb-5">Template</em>
                        <h3 class="h6 g-color-black g-font-weight-700 text-uppercase g-mb-25">Unify template</h3>
                        <p class="g-mb-20">Curabitur eget tortor sed urna faucibus iaculis id et nulla. Aliquam erat volutpat.</p>
                        <span class="g-color-primary g-font-weight-700 g-font-size-16">$12.99</span>
                      </div>
                      <!-- End Article Content -->
                    </article>
          ...
          <!-- Show Code -->
          <div class="g-font-size-12 g-my-30 ">
            <a class="js-modal-markup u-link-v5 g-color-main g-color-primary--hover g-mr-15" href="#!" data-content-target="#shortcode06" data-modal-target="#modalMarkup" data-modal-effect="fadein">
              <i class="fa fa-code"></i>
              Show code
            </a>
            <a class="js-copy u-link-v5 g-color-main g-color-primary--hover" href="#!" data-content-target="#shortcode06" data-success-text="Copied">
              <i class="fa fa-clone"></i>
              Copy code
            </a>
          </div>
      ...
      <section class="container g-py-100">
            ...
            <div class="js-carousel" data-vertical="true" data-pagi-classes="u-carousel-indicators-v28 text-center">
              <div class="js-slide">
                ...
                <article class="row text-center">
                  ...
                  <div class="col-lg-6 g-mb-50">
                    <!-- Article Image -->
                    <img class="img-fluid" src="../../assets/img-temp/525x300/img1.png" alt="Image Description">
                    <!-- End Article Image -->
                  </div>
                </article>
                <!-- End Article -->
              ...
              <div class="js-slide">
                ...
                <article class="row text-center">
                  ...
                  <div class="col-lg-6 g-mb-50">
                    <!-- Article Image -->
                    <img class="img-fluid mx-auto g-width-60x" src="../../assets/img-temp/725x725/img1.png" alt="Image Description">
                    <!-- End Article Image -->
                  </div>
                </article>
                <!-- End Article -->
        ...
        <!-- Show Code -->
        <div class="g-font-size-12 g-my-30 ">
          <a class="js-modal-markup u-link-v5 g-color-main g-color-primary--hover g-mr-15" href="#!" data-content-target="#shortcode07" data-modal-target="#modalMarkup" data-modal-effect="fadein">
            <i class="fa fa-code"></i>
            Show code
          </a>
          <a class="js-copy u-link-v5 g-color-main g-color-primary--hover" href="#!" data-content-target="#shortcode07" data-success-text="Copied">
            <i class="fa fa-clone"></i>
            Copy code
          </a>
        </div>
        ...
        <div class="container">
          ...
          <div id="shortcode08">
            <div class="shortcode-html">
              <!-- Products Block -->
              <div class="g-mx-minus-15">
                <div class="js-carousel g-pb-90" data-slides-show="3" data-slides-scroll="3" data-arrows-classes="u-arrow-v1 g-pos-abs g-bottom-0 g-width-45 g-height-45 g-font-size-default g-color-gray-dark-v5 g-bg-white g-color-white--hover g-bg-primary--hover rounded"
                data-arrow-left-classes="fa fa-angle-left g-left-35x--lg g-left-15" data-arrow-right-classes="fa fa-angle-right g-right-35x--lg g-right-15" data-pagi-classes="u-carousel-indicators-v1 g-absolute-centered--x g-bottom-20 text-center" data-responsive='[{
                       "breakpoint": 992,
                       "settings": {
                         "slidesToShow": 3
                  ...
                  <div class="js-slide g-px-15">
                    ...
                    <article class="info-v5-3 g-parent g-pos-rel">
                      ...
                      <div class="g-bg-cover g-bg-black-opacity-0_4--after">
                        <img class="w-100" src="../../assets/img-temp/500x650/img1.jpg" alt="Image Description">
                      </div>
                      <!-- End Article Image -->
                  ...
                  <div class="js-slide g-px-15">
                    ...
                    <article class="info-v5-3 g-parent g-pos-rel">
                      <!-- Article Image -->
                      <div class="g-bg-cover g-bg-black-opacity-0_4--after">
                        <img class="w-100" src="../../assets/img-temp/500x650/img2.jpg" alt="Image Description">
                      </div>
                      <!-- End Article Image -->
                  ...
                  <div class="js-slide g-px-15">
                    ...
                    <article class="info-v5-3 g-parent g-pos-rel">
                      <!-- Article Image -->
                      <div class="g-bg-cover g-bg-black-opacity-0_4--after">
                        <img class="w-100" src="../../assets/img-temp/500x650/img3.jpg" alt="Image Description">
                      </div>
                      <!-- End Article Image -->
                  ...
                  <div class="js-slide g-px-15">
                    ...
                    <article class="info-v5-3 g-parent g-pos-rel">
                      <!-- Article Image -->
                      <div class="g-bg-cover g-bg-black-opacity-0_4--after">
                        <img class="w-100" src="../../assets/img-temp/500x650/img4.jpg" alt="Image Description">
                      </div>
                      <!-- End Article Image -->

                      <a class="u-ribbon-v1 g-color-main g-bg-white g-color-white--hover g-bg-primary--hover g-font-weight-700 g-font-size-11 text-uppercase g-top-30 g-left-30 g-text-underline--none--hover rounded g-transition-0_5" href="#!">Design</a>
                      ...
                      <div class="info-v5-3__info g-pos-rel g-pa-30 g-mt-minus-80 g-transition-0_5">
                        ...
                        <header class="g-pos-rel g-color-white g-mb-40">
                          <span class="info-v5-3__info-price g-font-size-16 g-transition-0_5">
                            From
                            <span class="g-font-weight-700">$280</span>
                          <span class="g-font-size-12">Per Course</span>
                          </span>
                          <h3 class="info-v5-3__info-title g-color-white g-font-size-16 g-transition-0_5">
                            <a class="g-color-white g-color-white--hover" href="#!">Creative Photographs</a>
                          </h3>
                        </header>
                        <!-- End Article Header -->
                  ...
                  <div class="js-slide g-px-15">
                    ...
                    <article class="info-v5-3 g-parent g-pos-rel">
                      <!-- Article Image -->
                      <div class="g-bg-cover g-bg-black-opacity-0_4--after">
                        <img class="w-100" src="../../assets/img-temp/500x650/img5.jpg" alt="Image Description">
                      </div>
                      <!-- End Article Image -->
                  ...
                  <div class="js-slide g-px-15">
                    ...
                    <article class="info-v5-3 g-parent g-pos-rel">
                      <!-- Article Image -->
                      <div class="g-bg-cover g-bg-black-opacity-0_4--after">
                        <img class="w-100" src="../../assets/img-temp/500x650/img6.jpg" alt="Image Description">
                      </div>
                      <!-- End Article Image -->
          ...
          <!-- Show Code -->
          <div class="g-font-size-12 g-my-30 ">
            <a class="js-modal-markup u-link-v5 g-color-main g-color-primary--hover g-mr-15" href="#!" data-content-target="#shortcode08" data-modal-target="#modalMarkup" data-modal-effect="fadein">
              <i class="fa fa-code"></i>
              Show code
            </a>
            <a class="js-copy u-link-v5 g-color-main g-color-primary--hover" href="#!" data-content-target="#shortcode08" data-success-text="Copied">
              <i class="fa fa-clone"></i>
              Copy code
            </a>
          </div>
      ...
      <section class="container g-py-100">
              ...
              data-arrow-left-classes="fa fa-angle-left g-left-35x--lg g-left-15" data-arrow-right-classes="fa fa-angle-right g-right-35x--lg g-right-15" data-pagi-classes="u-carousel-indicators-v1 g-absolute-centered--x g-bottom-20 text-center" data-responsive='[{
                ...
                <div class="js-slide g-px-15">
                  ...
                  <article class="g-color-gray-dark-v4">
                    <!-- Article Image -->
                    <a class="d-block text-center g-mb-10" href="#!">
                      <img class="w-100" src="../../assets/img-temp/425x250/img4.png" alt="Image Description">
                    </a>
                    <!-- End Article Image -->
                ...
                <div class="js-slide g-px-15">
                  ...
                  <article>
                    <!-- Article Image -->
                    <a href="#!" class="d-block g-mb-10">
                      <img class="w-100" src="../../assets/img-temp/425x250/img5.png" alt="Image Description">
                    </a>
                    <!-- End Article Image -->
                ...
                <div class="js-slide g-px-15">
                  ...
                  <article class="g-color-gray-dark-v4">
                    <!-- Article Image -->
                    <a class="d-block text-center g-mb-10" href="#!">
                      <img class="w-100" src="../../assets/img-temp/425x250/img11.png" alt="Image Description">
                    </a>
                    <!-- End Article Image -->
        ...
        <!-- Show Code -->
        <div class="g-font-size-12 g-my-30 ">
          <a class="js-modal-markup u-link-v5 g-color-main g-color-primary--hover g-mr-15" href="#!" data-content-target="#shortcode09" data-modal-target="#modalMarkup" data-modal-effect="fadein">
            <i class="fa fa-code"></i>
            Show code
          </a>
          <a class="js-copy u-link-v5 g-color-main g-color-primary--hover" href="#!" data-content-target="#shortcode09" data-success-text="Copied">
            <i class="fa fa-clone"></i>
            Copy code
          </a>
        </div>
                ...
                <div class="col-lg-6">
                  <div class="g-flex-middle h-100 g-bg-black">
                    <div class="g-flex-middle-item">
                      <!-- Products Carousel -->
                      <div class="js-carousel" data-infinite="true" data-fade="true" data-arrows-classes="u-arrow-v1 g-pos-abs g-left-75 g-bottom-30 g-width-45 g-height-45 g-font-size-default g-color-gray-dark-v5 g-bg-white g-color-white--hover g-bg-primary--hover rounded"
                      data-arrow-left-classes="fa fa-angle-left g-ml-minus-45" data-arrow-right-classes="fa fa-angle-right g-ml-5">
                        <!-- Article -->
                        <article class="g-bg-cover g-bg-black-opacity-0_3--after">
                          <!-- Article Image -->
                          <img class="w-100" src="../../assets/img-temp/500x650/img5.jpg" alt="Image Description">
                          <!-- End Article Image -->
                        ...
                        <article class="g-bg-cover g-bg-black-opacity-0_3--after">
                          ...
                          <!-- Article Content -->
                          <div class="w-100 g-color-white-opacity-0_8 g-pos-abs g-left-0 g-bottom-0 g-z-index-1 g-px-30 g-pb-100--sm g-pb-70">
                            <span class="d-block g-font-weight-700 g-font-size-20 g-color-primary">$10.30</span>
                            <h3 class="h3 g-font-weight-700 text-uppercase g-color-white">Template with vegetables</h3>
                            <p>Understanding who you are and what you want is our strategy for your health.</p>
                          </div>
                          <!-- End Article Content -->
                        </article>
                  ...
                  <div class="g-flex-middle h-100 g-bg-black">
                    <div class="g-flex-middle-item">
                      ...
                      data-arrow-left-classes="fa fa-angle-left g-ml-minus-45" data-arrow-right-classes="fa fa-angle-right g-ml-5">
                        ...
                        <article class="g-bg-cover g-bg-black-opacity-0_3--after">
                          <!-- Article Image -->
                          <img class="w-100" src="../../assets/img-temp/500x650/img10.jpg" alt="Image Description">
                          <!-- End Article Image -->

                          <!-- Article Content -->
                          <div class="w-100 g-color-white-opacity-0_8 g-pos-abs g-left-0 g-bottom-0 g-z-index-1 g-px-30 g-pb-100--sm g-pb-70">
                            <span class="d-block g-font-weight-700 g-font-size-20 g-color-primary">$9.50</span>
                            <h3 class="h3 g-font-weight-700 text-uppercase g-color-white">Template with special sauce</h3>
                            <p>Understanding who you are and what you want is our strategy for your health.</p>
                          </div>
                          <!-- End Article Content -->
                        </article>
      ...
      <section class="container g-py-100">
        ...
        <div id="shortcode11">
            ...
            <article class="row justify-content-between g-color-gray-dark-v5">
              <div class="col-lg-5 g-mb-30">
                ...
                data-nav-for="#js-carousel-11-nav">
                  <div class="js-slide">
                    <img class="w-100" src="../../assets/img-temp/650x750/img1.jpg" alt="Image Description">
                  </div>
                  <div class="js-slide">
                    <img class="w-100" src="../../assets/img-temp/650x750/img2.jpg" alt="Image Description">
                  </div>
                  <div class="js-slide">
                    <img class="w-100" src="../../assets/img-temp/650x750/img3.jpg" alt="Image Description">
                  </div>
                </div>
                <!-- End Carousel Images -->
              ...
              <div class="col-lg-6 g-mb-30">
                <header class="d-flex justify-content-between">
                  <!-- Article Icons -->
                  <h2 class="h2 g-color-black mb-0">Corinna Foley</h2>
                ...
                <div class="g-mb-30">
                  ...
                  <span class="g-color-gray-dark-v5">
                    ...
                    |
                    <a class="g-color-gray-dark-v5" href="#!">Add Review</a>
                  </span>
                </div>
                <!-- End Article Review -->

                <p class="g-mb-25">Whether through commerce or just an experience to tell your brand's story, the time has come to start using development languages that fit your projects needs.</p>
                ...
                <form>
                  <div class="d-flex justify-content-start">
                    <!-- Article Size -->
                    <fieldset class="g-mr-60 g-mb-25">
                      <legend class="h6 g-color-main text-uppercase g-mb-15">Size:</legend>
                      <input type="radio" id="size-s" name="size" value="s" class="u-checkbox-v1--checked-color-primary u-checkbox-v1--checked-brd-primary">
                      <label for="size-s" class="d-inline-block text-center g-width-40 g-height-40 g-brd-around g-brd-2 g-brd-gray-light-v3 g-color-gray-light-v3 g-brd-primary--hover g-color-primary--hover g-font-size-18 g-transition-0_3 g-py-4 g-mr-3">S</label>
                      <input type="radio" id="size-m" name="size" value="m" class="u-checkbox-v1--checked-color-primary u-checkbox-v1--checked-brd-primary">
                      <label for="size-m" class="d-inline-block text-center g-width-40 g-height-40 g-brd-around g-brd-2 g-brd-gray-light-v3 g-color-gray-light-v3 g-brd-primary--hover g-color-primary--hover g-font-size-18 g-transition-0_3 g-py-4 g-mr-3">M</label>
                      <input type="radio" id="size-l" name="size" value="l" checked class="u-checkbox-v1--checked-color-primary u-checkbox-v1--checked-brd-primary">
                      <label for="size-l" class="d-inline-block text-center g-width-40 g-height-40 g-brd-around g-brd-2 g-brd-gray-light-v3 g-color-gray-light-v3 g-brd-primary--hover g-color-primary--hover g-font-size-18 g-transition-0_3 g-py-4 g-mr-3">L</label>
                      <input type="radio" id="size-xl" name="size" value="xl" class="u-checkbox-v1--checked-color-primary u-checkbox-v1--checked-brd-primary">
                      <label for="size-xl" class="d-inline-block text-center g-width-40 g-height-40 g-brd-around g-brd-2 g-brd-gray-light-v3 g-color-gray-light-v3 g-brd-primary--hover g-color-primary--hover g-font-size-18 g-transition-0_3 g-py-4 g-mr-3">XL</label>
                    </fieldset>
                    <!-- End Article Size -->

                    <!-- Article Color -->
                    <fieldset class="g-mb-25">
                      <legend class="h6 g-color-main text-uppercase g-mb-15">Color:</legend>
                      <input type="radio" id="color-gray" name="color" value="s" checked class="u-checkbox-v1--checked-brd-primary">
                      <label for="color-gray" class="d-inline-block text-center g-width-40 g-height-40 g-brd-gray g-brd-around g-brd-2 g-bg-secondary g-font-size-24 g-transition-0_3 g-mr-3"></label>
                      <input type="radio" id="color-red" name="color" value="m" class="u-checkbox-v1--checked-brd-primary">
                      <label for="color-red" class="d-inline-block text-center g-width-40 g-height-40 g-brd-around g-brd-2 g-bg-red g-brd-red g-font-size-24 g-transition-0_3 g-mr-3"></label>
                      <input type="radio" id="color-pink" name="color" value="l" class="u-checkbox-v1--checked-brd-primary">
                      <label for="color-pink" class="d-inline-block text-center g-width-40 g-height-40 g-brd-around g-brd-2 g-brd-pink g-bg-pink g-font-size-24 g-transition-0_3 g-mr-3"></label>
                    </fieldset>
                    <!-- End Article Color -->
                  </div>
                  ...
                  <fieldset class="g-mb-40">
                    <legend class="h6 g-color-main text-uppercase g-mb-15">Quantity</legend>
                    <div class="g-mx-minus-15">
          ...
          <div class="shortcode-scripts">
            ...
            <!-- JS Unify -->
            <script type="text/plain" src="../../assets/js/components/hs.rating.js"></script>
            <script type="text/plain" src="../../assets/js/components/hs.count-qty.js"></script>
            <script type="text/plain" src="../../assets/js/components/hs.carousel.js"></script>
      ...
      <section class="g-bg-secondary g-py-100">
        <div class="container">
          ...
          <div id="shortcode12">
            <div class="shortcode-html">
              <div class="js-carousel g-pb-100 g-mx-minus-10" data-infinite="true" data-slides-show="4" data-arrows-classes="u-arrow-v1 g-pos-abs g-bottom-0 g-width-45 g-height-45 g-font-size-default g-color-gray-dark-v5 g-bg-white g-color-white--hover g-bg-primary--hover rounded"
              data-arrow-left-classes="fa fa-angle-left g-left-10" data-arrow-right-classes="fa fa-angle-right g-right-10" data-pagi-classes="u-carousel-indicators-v1 g-absolute-centered--x g-bottom-20 text-center">
                <div class="js-slide">
                  <!-- Product -->
        ...
        <div id="shortcode13">
          <div class="shortcode-html">
            ...
            <div class="row">
              <div class="col-lg-7">
                <!-- Carousel -->
                <div id="carousel1" class="js-carousel g-pt-10 g-mb-10" data-infinite="true" data-fade="true" data-arrows-classes="u-arrow-v1 g-brd-around g-brd-white g-absolute-centered--y g-width-45 g-height-45 g-font-size-14 g-color-white g-color-primary--hover rounded-circle"
                data-arrow-left-classes="fa fa-angle-left g-left-40" data-arrow-right-classes="fa fa-angle-right g-right-40" data-nav-for="#carousel2">
              ...
              <div class="col-lg-5">
                <div class="g-px-40--lg g-py-70">
                  <!-- Product Info -->
                  <div class="g-mb-30">
                    <h1 class="g-font-weight-300 mb-4">Men's Water
                      <br>
                      Resistant Jacket
                    </h1>
                    <p>Dress is the "rain mac" version of our beloved essential the Unify Parka. Crafted from a water resistant fluid memory fabric to create an elegant draped effect when thrown on, this lightweight shell will take you from season to season
                      and protect you from that unexpected shower.</p>
                  </div>
                  <!-- End Product Info -->
              ...
              <div class="row g-mb-40">
                <div class="col-lg-8 g-mb-30">
                  ...
                  <article>
                    ...
                    <div class="js-carousel" data-infinite="true" data-arrows-classes="u-arrow-v1 g-pos-abs g-bottom-0 g-width-30 g-height-30 g-color-black g-bg-primary-opacity-0_4 g-bg-primary--hover g-color-white" data-arrow-left-classes="fa fa-angle-left g-right-30 g-brd-right g-brd-white-opacity-0_1"
                    data-arrow-right-classes="fa fa-angle-right g-right-0">
                      <div class="js-slide g-pos-rel">
                        <a class="js-fancybox d-block u-icon-v3 g-width-30 g-height-30 g-color-black g-bg-primary-opacity-0_6 g-bg-primary--hover g-color-white g-font-size-14 g-pos-abs g-bottom-0 g-right-65" href="javascript:;" data-fancybox="lightbox-gallery--01" data-src="../../assets/img-temp/900x400/img7.jpg"
                        data-caption="Lightbox Gallery">
                          <i class="icon-size-fullscreen"></i>
                        </a>
                        <img class="img-fluid" src="../../assets/img-temp/900x400/img7.jpg" alt="Image Description">
                      </div>
                      <div class="js-slide g-pos-rel">
                        <a class="js-fancybox d-block u-icon-v3 g-width-30 g-height-30 g-color-black g-bg-primary-opacity-0_6 g-bg-primary--hover g-color-white g-font-size-14 g-pos-abs g-bottom-0 g-right-65" href="javascript:;" data-fancybox="lightbox-gallery--01" data-src="../../assets/img-temp/900x400/img8.jpg"
                        data-caption="Lightbox Gallery">
                          <i class="icon-size-fullscreen"></i>
                        </a>
                        <img class="img-fluid" src="../../assets/img-temp/900x400/img8.jpg" alt="Image Description">
                      </div>
                      <div class="js-slide g-pos-rel">
                        <a class="js-fancybox d-block u-icon-v3 g-width-30 g-height-30 g-color-black g-bg-primary-opacity-0_6 g-bg-primary--hover g-color-white g-font-size-14 g-pos-abs g-bottom-0 g-right-65" href="javascript:;" data-fancybox="lightbox-gallery--01" data-src="../../assets/img-temp/900x400/img9.jpg"
                        data-caption="Lightbox Gallery">
                          <i class="icon-size-fullscreen"></i>
                        </a>
                        <img class="img-fluid" src="../../assets/img-temp/900x400/img9.jpg" alt="Image Description">
                      </div>
                    </div>
                    <!-- Products - Carousel Image -->
                    ...
                    <div class="g-brd-x g-brd-gray-light-v3 g-bg-white">
                      ...
                      <ul class="d-flex list-inline g-brd-y g-brd-gray-light-v3 mb-0">
                        <li class="list-inline-item col-4 g-font-weight-500 g-font-size-13 text-center g-px-0 g-py-17 mr-0">
                          <i class="align-middle g-color-gray-dark-v5 mr-1 icon-hotel-restaurant-022 u-line-icon-pro"></i>
                          7 Bed rm.
                        </li>
                        <li class="list-inline-item col-4 g-font-weight-500 g-font-size-13 text-center g-px-0 g-brd-x g-brd-gray-light-v3 g-py-17 mr-0">
                          <i class="align-middle g-color-gray-dark-v5 mr-1 icon-hotel-restaurant-008 u-line-icon-pro"></i>
                          5 Bath rm.
                        </li>
                        <li class="list-inline-item col-4 g-font-weight-500 g-font-size-13 text-center g-px-0 g-py-17 mr-0">
                          <i class="align-middle g-color-gray-dark-v5 mr-1 icon-real-estate-047 u-line-icon-pro"></i>
                          3,725 SQFT
                        </li>
                      </ul>
                      ...
                      <div class="g-pa-25">
                        ...
                        <p class="g-color-gray-dark-v5 g-font-weight-500 g-font-size-13 mb-1">Agency: <a class="g-color-gray-dark-v5 g-color-primary--hover g-font-weight-400 g-text-underline--none--hover" href="#">Real Estate State</a>
                        </p>
                        <p class="g-color-gray-dark-v5 g-font-weight-500 g-font-size-13 mb-0">Posted: <span class="g-color-gray-dark-v5 g-font-weight-400">12 days ago</a></p>
                      </div>
                      ...
                      <ul class="d-flex list-inline align-items-center g-brd-top g-brd-gray-light-v3 mb-0">
                        <li class="list-inline-item col-8 g-font-weight-600 g-font-size-17 text-center g-px-0 g-py-13 mr-0">
                          ...
                          <li class="list-inline-item col-2 g-px-0 mr-0">
                            <a class="d-block g-brd-x g-brd-gray-light-v3 g-color-gray-dark-v5 g-color-primary--hover g-font-weight-500 g-font-size-17 text-center g-text-underline--none--hover g-py-13" href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="Add to Compare">
                              <i class="icon-finance-149 u-line-icon-pro"></i>
                            </a>
                          </li>
                          <li class="list-inline-item col-2 g-px-0 mr-0">
                            <a class="d-block g-color-gray-dark-v5 g-color-primary--hover g-font-weight-500 g-font-size-17 text-center g-text-underline--none--hover g-py-13" href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="Save to Wishlist">
                              <i class="icon-medical-022 u-line-icon-pro"></i>
                            </a>
                          </li>
                          </ul>
                  ...
                  <div class="col-sm-6 col-lg-4 g-mb-30">
                    ...
                    <article>
                      ...
                      data-arrow-right-classes="fa fa-angle-right g-right-0">
                        <div class="js-slide g-pos-rel">
                          <a class="js-fancybox d-block u-icon-v3 g-width-30 g-height-30 g-color-black g-bg-primary-opacity-0_6 g-bg-primary--hover g-color-white g-font-size-14 g-pos-abs g-bottom-0 g-right-65" href="javascript:;" data-fancybox="lightbox-gallery--02" data-src="../../assets/img-temp/600x550/img1.jpg"
                          data-caption="Lightbox Gallery">
                            <i class="icon-size-fullscreen"></i>
                          </a>
                        ...
                        <div class="js-slide g-pos-rel">
                          <a class="js-fancybox d-block u-icon-v3 g-width-30 g-height-30 g-color-black g-bg-primary-opacity-0_6 g-bg-primary--hover g-color-white g-font-size-14 g-pos-abs g-bottom-0 g-right-65" href="javascript:;" data-fancybox="lightbox-gallery--02" data-src="../../assets/img-temp/600x550/img2.jpg"
                          data-caption="Lightbox Gallery">
                            <i class="icon-size-fullscreen"></i>
                          </a>
                        ...
                        <div class="js-slide g-pos-rel">
                          <a class="js-fancybox d-block u-icon-v3 g-width-30 g-height-30 g-color-black g-bg-primary-opacity-0_6 g-bg-primary--hover g-color-white g-font-size-14 g-pos-abs g-bottom-0 g-right-65" href="javascript:;" data-fancybox="lightbox-gallery--02" data-src="../../assets/img-temp/600x550/img3.jpg"
                          data-caption="Lightbox Gallery">
                            <i class="icon-size-fullscreen"></i>
                          </a>
                        ...
                        <div class="js-slide g-pos-rel">
                          <a class="js-fancybox d-block u-icon-v3 g-width-30 g-height-30 g-color-black g-bg-primary-opacity-0_6 g-bg-primary--hover g-color-white g-font-size-14 g-pos-abs g-bottom-0 g-right-65" href="javascript:;" data-fancybox="lightbox-gallery--02" data-src="../../assets/img-temp/600x550/img4.jpg"
                          data-caption="Lightbox Gallery">
                            <i class="icon-size-fullscreen"></i>
                          </a>
                      ...
                      <div class="g-brd-x g-brd-gray-light-v3 g-bg-white">
                        ...
                        <div class="g-pa-25">
                          ...
                          <p class="g-color-gray-dark-v5 g-font-weight-500 g-font-size-13 mb-1">Agency: <a class="g-color-gray-dark-v5 g-color-primary--hover g-font-weight-400 g-text-underline--none--hover" href="#">Excellent Estate</a>
                          </p>
                          <p class="g-color-gray-dark-v5 g-font-weight-500 g-font-size-13 mb-0">Posted: <span class="g-color-gray-dark-v5 g-font-weight-400">12 days ago</a></p>
                      </div>
                      <!-- End Products - Address -->
