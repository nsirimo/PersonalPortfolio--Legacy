...
<head>
  <!-- Title -->
  <title>Call To Action | Unify - Responsive Website Template</title>
  ...
  <main>
          ...
          <ul class="js-shortcode-filter-result nav flex-column u-sidebar-navigation-list">
            ...
            <li class="js-shortcode-filter__item nav-item dropdown blocks">
              ...
              <div class="dropdown-menu u-dropdown-static">
                <ul class="nav flex-column">
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../unify-main/shortcodes/shortcode-blocks-cta-boxed.html" class="nav-link active">Call To Action (boxed)</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item blocks">
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall g-overflow-hidden" data-options="{direction: 'reverse', settings_mode_oneelement_max_offset: '150'}">
      ...
      <div class="container g-z-index-1 g-py-100">
        <h1 class="g-font-weight-300 g-letter-spacing-1 g-mb-15">Call To Action</h1>
                ...
                <section>
                  <div class="row">
                    ...
                    <div class="col-md-3 align-self-center text-md-right">
                      <a class="btn btn-md u-btn-outline-darkgray g-brd-2 rounded-0" href="#!">Purchase Now</a>
                    </div>
                  </div>
                </section>
              </div>
      ...
      <section class="g-py-50">
        <div class="container">
          ...
          <div class="g-mb-50">
            <div id="shortcode10">
              <div class="shortcode-html">
                <section class="container g-brd-around g-brd-gray-light-v4 g-rounded-5 g-pa-25 g-py-50--md" style="background-image: url(../../assets/img/bg/pattern5.png);">
                  <form role="form">
                    <div class="row">
                      <div class="col-md-3">
          ...
          <div class="g-mb-50">
            <div id="shortcode11">
              <div class="shortcode-html">
                <section class="container g-bg-gray-light-v5 g-rounded-5 g-pa-25 g-py-50--md" style="background-image: url(../../assets/img/bg/pattern5.png);">
                  <form role="form">
                    <div class="row">
                      <div class="col-md-3">
                        <label class="input-group g-brd-primary--focus g-rounded-3 g-mb-0--md">
          ...
          <div class="g-mb-50">
            <div id="shortcode12">
              <div class="shortcode-html">
                <section class="container g-bg-gray-dark-v1 g-rounded-5 g-pa-25 g-py-50--md" style="background-image: url(../../assets/img/bg/pattern5.png);">
                  <form role="form">
                    <div class="row">
                      <div class="col-md-3">
          ...
          <div class="g-mb-50">
            <div id="shortcode13">
              <div class="shortcode-html">
                <section class="container g-bg-primary g-rounded-5 g-pa-25 g-py-50--md" style="background-image: url(../../assets/img/bg/pattern5.png);">
                  <form role="form">
                    <div class="row">
                      <div class="col-md-3">
                        <label class="input-group g-rounded-3 g-mb-0--md">
