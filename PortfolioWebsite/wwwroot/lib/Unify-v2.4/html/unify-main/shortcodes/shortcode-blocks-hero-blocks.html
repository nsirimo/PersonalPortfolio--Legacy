...
<head>
  <!-- Title -->
  <title>Hero Blocks | Unify - Responsive Website Template</title>
  ...
  <main>
      ...
      <div class="u-header__sections-container">
        <div class="u-sidebar-navigation-inner">
          ...
          <ul class="js-shortcode-filter-result nav flex-column u-sidebar-navigation-list">
            ...
            <li class="js-shortcode-filter__item nav-item dropdown blocks">
              <a class="nav-link dropdown-toggle active" href="#!" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Hero</a>
              <div class="dropdown-menu u-dropdown-static">
                <ul class="nav flex-column">
                  <li class="js-shortcode-filter__item nav-item blocks">
                  ...
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../unify-main/shortcodes/shortcode-blocks-hero-blocks.html" class="nav-link active">Hero Blocks</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item blocks">
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall g-overflow-hidden" data-options="{direction: 'reverse', settings_mode_oneelement_max_offset: '150'}">
      ...
      <div class="container g-z-index-1 g-py-100">
        <h1 class="g-font-weight-300 g-letter-spacing-1 g-mb-15">Hero Blocks</h1>
    ...
    <section>
      ...
      <section class="g-py-70">
        ...
        <section class="g-py-30">
          ...
          <!-- Nav tabs -->
          <ul class="nav justify-content-center u-nav-v2-1 u-nav-rounded-3 g-mb-50" role="tablist" data-target="hero-01" data-tabs-mobile-type="slide-up-down" data-btn-classes="btn btn-md btn-block u-btn-outline-primary">
            <li class="nav-item">
          ...
          <div id="hero-01" class="tab-content">
                  ...
                  <section class="g-flex-centered g-height-450 g-bg-gray-light-v5 g-py-30">
                    <div class="container">
                      <div class="row">
                        ...
                        <div class="col-md-6 align-self-center g-py-20">
                          <img class="w-100" src="../../assets/img-temp/400x270/img23.jpg" alt="Iamge Description">
                        </div>
                      </div>
                    </div>
                  </section>
                  ...
                  <section class="g-flex-centered g-height-450 g-bg-primary g-color-white-opacity-0_9 g-py-30">
                    <div class="container">
                      <div class="row">
                        ...
                        <div class="col-md-6 align-self-center g-py-20">
                          <img class="w-100" src="../../assets/img-temp/400x270/img2.jpg" alt="Iamge Description">
                        </div>
                      </div>
                    </div>
                  </section>
                  ...
                  <section class="g-flex-centered g-height-450 g-bg-darkgray-radialgradient-circle g-color-white-opacity-0_7 g-py-30">
                    <div class="container">
                      <div class="row">
                        ...
                        <div class="col-md-6 align-self-center g-py-20">
                          <img class="w-100" src="../../assets/img-temp/400x270/img3.jpg" alt="Iamge Description">
                        </div>
                      </div>
                    </div>
                  </section>
            ...
            <div id="hero-01-4" class="tab-pane fade" role="tabpanel">
                  ...
                  <section class="g-flex-centered g-height-450 g-bg-blue-radialgradient-circle g-color-white-opacity-0_7 g-py-30">
                    <div class="container">
                      <div class="row">
                        ...
                        <div class="col-md-6 align-self-center g-py-20">
                          <img class="w-100" src="../../assets/img-temp/400x270/img4.jpg" alt="Iamge Description">
                        </div>
                      </div>
                    </div>
                  </section>
              ...
              <!-- Show Code -->
              <div class="g-font-size-12 g-my-30 container">
                <a class="js-modal-markup u-link-v5 g-color-main g-color-primary--hover g-mr-15" href="#!" data-content-target="#shortcode1-4" data-modal-target="#modalMarkup" data-modal-effect="fadein">
                  <i class="fa fa-code"></i>
                  Show code
                </a>
                <a class="js-copy u-link-v5 g-color-main g-color-primary--hover" href="#!" data-content-target="#shortcode1-4" data-success-text="Copied">
                  <i class="fa fa-clone"></i>
                  Copy code
                </a>
              </div>
                  ...
                  <section class="g-flex-centered g-height-450 g-bg-pink-lineargradient-v2 g-color-white-opacity-0_9 g-py-30">
                    <div class="container">
                      <div class="row">
                        ...
                        <div class="col-md-6 align-self-center g-py-20">
                          <img class="w-100" src="../../assets/img-temp/400x270/img5.jpg" alt="Iamge Description">
                        </div>
                      </div>
                    </div>
                  </section>
        ...
        <section class="g-py-30">
          ...
          <!-- Nav tabs -->
          <ul class="nav justify-content-center u-nav-v2-1 u-nav-rounded-3 g-mb-50" role="tablist" data-target="hero-02" data-tabs-mobile-type="slide-up-down" data-btn-classes="btn btn-md btn-block u-btn-outline-primary">
            <li class="nav-item">
          ...
          <div id="hero-02" class="tab-content">
            <div id="hero-02-1" class="tab-pane fade show active" role="tabpanel">
              <div id="shortcode2-1">
                <div class="shortcode-html">
                  <section class="g-flex-centered g-height-500 g-bg-img-hero g-py-30" style="background-image: url(../../assets/img-temp/1920x1080/img12.jpg);">
                    <div class="container">
                      <div class="row">
                        <div class="col-md-6 align-self-center g-py-20">
                          <h2 class="h4 text-uppercase g-letter-spacing-1 g-mb-20">Content block</h2>
                        ...
                        <div class="col-md-6 align-self-center g-py-20">
                          <img class="w-100" src="../../assets/img-temp/400x270/img6.jpg" alt="Iamge Description">
                        </div>
                      </div>
                    </div>
                  </section>
            ...
            <div id="hero-02-2" class="tab-pane fade" role="tabpanel">
              <div id="shortcode2-2">
                <div class="shortcode-html">
                  <section class="g-flex-centered g-height-500 g-bg-img-hero g-color-white g-py-30" style="background-image: url(../../assets/img-temp/1920x1080/img5.jpg);">
                    <div class="container">
                      <div class="row">
                        <div class="col-md-6 align-self-center g-py-20">
                          <h2 class="h4 text-uppercase g-letter-spacing-1 g-mb-20">Content block</h2>
                        ...
                        <div class="col-md-6 align-self-center g-py-20">
                          <img class="w-100" src="../../assets/img-temp/400x270/img7.jpg" alt="Iamge Description">
                        </div>
                      </div>
                    </div>
                  </section>
            ...
            <div id="hero-02-3" class="tab-pane fade" role="tabpanel">
              <div id="shortcode2-3">
                <div class="shortcode-html">
                  <section class="g-flex-centered g-height-500 g-py-30" style="background-image: url(../../assets/img/bg/pattern/bricks-white.png);">
                    <div class="container">
                      <div class="row">
                        <div class="col-md-6 align-self-center g-py-20">
                          <h2 class="h4 text-uppercase g-letter-spacing-1 g-mb-20">Content block</h2>
                        ...
                        <div class="col-md-6 align-self-center g-py-20">
                          <img class="w-100" src="../../assets/img-temp/400x270/img8.jpg" alt="Iamge Description">
                        </div>
                      </div>
                    </div>
                  </section>
            ...
            <div id="hero-02-4" class="tab-pane fade" role="tabpanel">
              <div id="shortcode2-4">
                <div class="shortcode-html">
                  <section class="g-flex-centered g-height-500 g-color-white g-py-30" style="background-image: url(../../assets/img/bg/pattern/math-dark.png);">
                    <div class="container">
                      <div class="row">
                        <div class="col-md-6 align-self-center g-py-20">
                          <h2 class="h4 text-uppercase g-letter-spacing-1 g-mb-20">Content block</h2>
                        ...
                        <div class="col-md-6 align-self-center g-py-20">
                          <img class="w-100" src="../../assets/img-temp/400x270/img9.jpg" alt="Iamge Description">
                        </div>
                      </div>
                    </div>
                  </section>
        ...
        <section class="g-py-30">
          ...
          <!-- Nav tabs -->
          <ul class="nav justify-content-center u-nav-v2-1 u-nav-rounded-3 g-mb-50" role="tablist" data-target="hero-03" data-tabs-mobile-type="slide-up-down" data-btn-classes="btn btn-md btn-block u-btn-outline-primary">
            <li class="nav-item">
          ...
          <div id="hero-03" class="tab-content">
            <div id="hero-03-1" class="tab-pane fade show active" role="tabpanel">
              <div id="shortcode3-1">
                <div class="shortcode-html">
                  <section class="g-flex-centered g-height-500 g-bg-img-hero u-bg-overlay g-bg-black-opacity-0_7--after g-color-white-opacity-0_7 g-py-20" style="background-image: url(../../assets/img-temp/1920x1080/img47.jpg);">
                    <div class="container u-bg-overlay__inner">
                      <div class="row">
                        ...
                        <div class="col-md-6 align-self-center g-py-20">
                          <img class="w-100" src="../../assets/img-temp/400x270/img10.jpg" alt="Iamge Description">
                        </div>
                      </div>
                    </div>
                  </section>
            ...
            <div id="hero-03-2" class="tab-pane fade" role="tabpanel">
              <div id="shortcode3-2">
                <div class="shortcode-html">
                  <section class="g-flex-centered g-height-500 g-bg-img-hero u-bg-overlay g-bg-white-opacity-0_7--after g-py-20" style="background-image: url(../../assets/img-temp/1920x1080/img1.jpg);">
                    <div class="container u-bg-overlay__inner">
                      <div class="row">
                        <div class="col-md-6 align-self-center g-py-20">
                          <h2 class="h4 text-uppercase g-letter-spacing-1 g-mb-20">Content block</h2>
                        ...
                        <div class="col-md-6 align-self-center g-py-20">
                          <img class="w-100" src="../../assets/img-temp/400x270/img11.jpg" alt="Iamge Description">
                        </div>
                      </div>
                    </div>
                  </section>
            ...
            <div id="hero-03-3" class="tab-pane fade" role="tabpanel">
              <div id="shortcode3-3">
                <div class="shortcode-html">
                  <section class="g-flex-centered g-height-500 g-bg-img-hero u-bg-overlay g-bg-primary-opacity-0_6--after g-color-white g-py-20" style="background-image: url(../../assets/img-temp/1920x1080/img1.jpg);">
                    <div class="container u-bg-overlay__inner">
                      <div class="row">
                        <div class="col-md-6 align-self-center g-py-20">
                          <h2 class="h4 text-uppercase g-letter-spacing-1 g-mb-20">Content block</h2>
                        ...
                        <div class="col-md-6 align-self-center g-py-20">
                          <img class="w-100" src="../../assets/img-temp/400x270/img12.jpg" alt="Iamge Description">
                        </div>
                      </div>
                    </div>
                  </section>
        ...
        <section class="g-py-30">
          ...
          <!-- Nav tabs -->
          <ul class="nav justify-content-center u-nav-v2-1 u-nav-rounded-3 g-mb-50" role="tablist" data-target="hero-04" data-tabs-mobile-type="slide-up-down" data-btn-classes="btn btn-md btn-block u-btn-outline-primary">
            <li class="nav-item">
          ...
          <div id="hero-04" class="tab-content">
            <div id="hero-04-1" class="tab-pane fade show active" role="tabpanel">
              <div id="shortcode4-1">
                <div class="shortcode-html">
                  <section class="g-flex-centered g-height-500 g-bg-img-hero u-bg-overlay g-bg-grid-v1--before g-color-white g-py-20" style="background-image: url(../../assets/img-temp/1920x1080/img45.jpg);">
                    <div class="container u-bg-overlay__inner">
                      <div class="row">
                        <div class="col-md-6 align-self-center g-py-20">
                          <h2 class="h4 text-uppercase g-letter-spacing-1 g-mb-20">Content block</h2>
                        ...
                        <div class="col-md-6 align-self-center g-py-20">
                          <img class="w-100" src="../../assets/img-temp/400x270/img13.jpg" alt="Iamge Description">
                        </div>
                      </div>
                    </div>
                  </section>
            ...
            <div id="hero-04-2" class="tab-pane fade" role="tabpanel">
              <div id="shortcode4-2">
                <div class="shortcode-html">
                  <section class="g-flex-centered g-height-500 g-bg-img-hero u-bg-overlay g-bg-grid-v2--before g-color-white g-py-20" style="background-image: url(../../assets/img-temp/1920x1080/img6.jpg);">
                    <div class="container u-bg-overlay__inner">
                      <div class="row">
                        <div class="col-md-6 align-self-center g-py-20">
                          <h2 class="h4 text-uppercase g-letter-spacing-1 g-mb-20">Content block</h2>
                        ...
                        <div class="col-md-6 align-self-center g-py-20">
                          <img class="w-100" src="../../assets/img-temp/400x270/img14.jpg" alt="Iamge Description">
                        </div>
                      </div>
                    </div>
                  </section>
            ...
            <div id="hero-04-3" class="tab-pane fade" role="tabpanel">
              <div id="shortcode4-3">
                <div class="shortcode-html">
                  <section class="g-flex-centered g-height-500 g-bg-img-hero u-bg-overlay g-bg-grid-v5--before g-color-white g-py-20" style="background-image: url(../../assets/img-temp/1920x1080/img7.jpg);">
                    <div class="container u-bg-overlay__inner">
                      <div class="row">
                        <div class="col-md-6 align-self-center g-py-20">
                          <h2 class="h4 text-uppercase g-letter-spacing-1 g-mb-20">Content block</h2>
                        ...
                        <div class="col-md-6 align-self-center g-py-20">
                          <img class="w-100" src="../../assets/img-temp/400x270/img15.jpg" alt="Iamge Description">
                        </div>
                      </div>
                    </div>
                  </section>
            ...
            <div id="hero-04-4" class="tab-pane fade" role="tabpanel">
              <div id="shortcode4-4">
                <div class="shortcode-html">
                  <section class="g-flex-centered g-height-500 g-bg-img-hero u-bg-overlay g-bg-grid-v7--before g-color-white g-py-20" style="background-image: url(../../assets/img-temp/1920x1080/img1.jpg);">
                    <div class="container u-bg-overlay__inner">
                      <div class="row">
                        <div class="col-md-6 align-self-center g-py-20">
                          <h2 class="h4 text-uppercase g-letter-spacing-1 g-mb-20">Content block</h2>
                        ...
                        <div class="col-md-6 align-self-center g-py-20">
                          <img class="w-100" src="../../assets/img-temp/400x270/img16.jpg" alt="Iamge Description">
                        </div>
                      </div>
                    </div>
                  </section>
              ...
              <!-- Show Code -->
              <div class="g-font-size-12 g-my-30 container">
                <a class="js-modal-markup u-link-v5 g-color-main g-color-primary--hover g-mr-15" href="#!" data-content-target="#shortcode4-4" data-modal-target="#modalMarkup" data-modal-effect="fadein">
                  <i class="fa fa-code"></i>
                  Show code
                </a>
                <a class="js-copy u-link-v5 g-color-main g-color-primary--hover" href="#!" data-content-target="#shortcode4-4" data-success-text="Copied">
                  <i class="fa fa-clone"></i>
                  Copy code
                </a>
              </div>
        ...
        <section class="g-py-30">
          ...
          <!-- Nav tabs -->
          <ul class="nav justify-content-center u-nav-v2-1 u-nav-rounded-3 g-mb-50" role="tablist" data-target="hero-05" data-tabs-mobile-type="slide-up-down" data-btn-classes="btn btn-md btn-block u-btn-outline-primary">
            <li class="nav-item">
          ...
          <div id="hero-05" class="tab-content">
            <div id="hero-05-1" class="tab-pane fade show active" role="tabpanel">
              <div id="shortcode5-1">
                <div class="shortcode-html">
                  <section class="g-flex-centered g-height-500 g-bg-img-hero u-bg-overlay g-bg-grid-v1--before g-bg-black-opacity-0_2--after g-color-white g-py-20" style="background-image: url(../../assets/img-temp/1920x1080/img10.jpg);">
                    <div class="container u-bg-overlay__inner">
                      <div class="row">
                        <div class="col-md-6 align-self-center g-py-20">
                          <h2 class="h4 text-uppercase g-letter-spacing-1 g-mb-20">Content block</h2>
                        ...
                        <div class="col-md-6 align-self-center g-py-20">
                          <img class="w-100" src="../../assets/img-temp/400x270/img17.jpg" alt="Iamge Description">
                        </div>
                      </div>
                    </div>
                  </section>
            ...
            <div id="hero-05-2" class="tab-pane fade" role="tabpanel">
              <div id="shortcode5-2">
                <div class="shortcode-html">
                  <section class="g-flex-centered g-height-500 g-bg-img-hero u-bg-overlay g-bg-grid-v1--before g-bg-white-opacity-0_3--after g-py-20" style="background-image: url(../../assets/img-temp/1920x1080/img1.jpg);">
                    <div class="container u-bg-overlay__inner">
                      <div class="row">
                        <div class="col-md-6 align-self-center g-py-20">
                          <h2 class="h4 text-uppercase g-letter-spacing-1 g-mb-20">Content block</h2>
                        ...
                        <div class="col-md-6 align-self-center g-py-20">
                          <img class="w-100" src="../../assets/img-temp/400x270/img18.jpg" alt="Iamge Description">
                        </div>
                      </div>
                    </div>
                  </section>
            ...
            <div id="hero-05-3" class="tab-pane fade" role="tabpanel">
              <div id="shortcode5-3">
                <div class="shortcode-html">
                  <section class="g-flex-centered g-height-500 g-bg-img-hero u-bg-overlay g-bg-grid-v1--before g-bg-primary-opacity-0_6--after g-color-white g-py-20" style="background-image: url(../../assets/img-temp/1920x1080/img1.jpg);">
                    <div class="container u-bg-overlay__inner">
                      <div class="row">
                        <div class="col-md-6 align-self-center g-py-20">
                          <h2 class="h4 text-uppercase g-letter-spacing-1 g-mb-20">Content block</h2>
                        ...
                        <div class="col-md-6 align-self-center g-py-20">
                          <img class="w-100" src="../../assets/img-temp/400x270/img19.jpg" alt="Iamge Description">
                        </div>
                      </div>
                    </div>
                  </section>
            ...
            <div id="hero-05-4" class="tab-pane fade" role="tabpanel">
              <div id="shortcode5-4">
                <div class="shortcode-html">
                  <section class="g-flex-centered g-height-500 g-bg-img-hero u-bg-overlay u-bg-overlay--reverse g-bg-grid-v1--before g-bg-gray-light-gradient-v1--after g-z-index-before-after-2-1 g-py-20" style="background-image: url(../../assets/img-temp/1920x1080/img1.jpg);">
                    <div class="container u-bg-overlay__inner">
                      <div class="row">
                        <div class="col-md-6 align-self-center g-py-20">
                          <h2 class="h4 text-uppercase g-letter-spacing-1 g-mb-20">Content block</h2>
                        ...
                        <div class="col-md-6 align-self-center g-py-20">
                          <img class="w-100" src="../../assets/img-temp/400x270/img20.jpg" alt="Iamge Description">
                        </div>
                      </div>
                    </div>
                  </section>
        ...
        <section class="g-py-30">
          ...
          <!-- Nav tabs -->
          <ul class="nav justify-content-center u-nav-v2-1 u-nav-rounded-3 g-mb-50" role="tablist" data-target="hero-06" data-tabs-mobile-type="slide-up-down" data-btn-classes="btn btn-md btn-block u-btn-outline-primary">
            <li class="nav-item">
          ...
          <div id="hero-06" class="tab-content">
              ...
              <div id="shortcode6-1">
                <div class="shortcode-html">
                  <div class="dzsparallaxer auto-init height-is-based-on-content use-loading" data-options='{
                    ...
                    <!-- Parallax Image -->
                    <div class="divimage dzsparallaxer--target w-100" style="height: 140%; background-image: url(../../assets/img-temp/1920x1080/img11.jpg)"></div>
                    ...
                    <section class="g-flex-centered g-height-500 g-color-white u-bg-overlay g-bg-black-opacity-0_6--after g-py-20">
                      <div class="container u-bg-overlay__inner">
                        <div class="row">
                          ...
                          <div class="col-md-6 align-self-center g-py-20">
                            <img class="w-100" src="../../assets/img-temp/400x270/img21.jpg" alt="Iamge Description">
                          </div>
                        </div>
                      </div>
                    </section>
            ...
            <div id="hero-06-2" class="tab-pane fade" role="tabpanel">
              <div id="shortcode6-2">
                <div class="shortcode-html">
                  <div class="dzsparallaxer auto-init height-is-based-on-content use-loading g-height-500" style="position: relative;" data-options='{
                        mode_scroll: "fromtop",
                        animation_duration: 25,
                        direction: "reverse"
                       }'>
                    <!-- Parallax Video -->
                    <div class="dzsparallaxer--target w-100 u-bg-overlay g-bg-black-opacity-0_6--after" style="height: 130%;" data-forcewidth_ratio="1.77">
                      <div class="js-bg-video g-pos-abs w-100 h-100" data-hs-bgv-type="youtube" data-hs-bgv-id="w2iPKMP2a-U" data-hs-bgv-loop="1"></div>
                    </div>
                    <!-- End Parallax Video -->
                    ...
                    <section class="g-flex-centered g-height-500 g-color-white g-py-20">
                      <div class="container u-bg-overlay__inner">
                        <div class="row">
                          ...
                          <div class="col-md-6 align-self-center g-py-20">
                            <img class="w-100" src="../../assets/img-temp/400x270/img22.jpg" alt="Iamge Description">
                          </div>
                        </div>
                      </div>
                    </section>
                ...
                <div class="shortcode-styles">
                  ...
                  <link type="text/plain" rel="stylesheet" href="../../assets/vendor/hs-bg-video/hs-bg-video.css">
                </div>
                ...
                <div class="shortcode-scripts">
                  ...
                  <script type="text/plain" src="../../assets/vendor/dzsparallaxer/dzsscroller/scroller.js"></script>
                  <script type="text/plain" src="../../assets/vendor/dzsparallaxer/advancedscroller/plugin.js"></script>
                  <script type="text/plain" src="../../assets/vendor/hs-bg-video/hs-bg-video.js"></script>
                  <script type="text/plain" src="../../assets/vendor/hs-bg-video/vendor/player.min.js"></script>

                  <!-- JS Unify -->
                  <script type="text/plain" src="../../assets/js/helpers/hs.bg-video.js"></script>
        ...
        <section class="g-py-30">
          ...
          <!-- Nav tabs -->
          <ul class="nav justify-content-center u-nav-v2-1 u-nav-rounded-3 g-mb-50" role="tablist" data-target="hero-07" data-tabs-mobile-type="slide-up-down" data-btn-classes="btn btn-md btn-block u-btn-outline-primary">
            <li class="nav-item">
          ...
          <div id="hero-07" class="tab-content">
            <div id="hero-07-1" class="tab-pane fade show active" role="tabpanel">
              <div id="shortcode7-1">
                <div class="shortcode-html">
                  <section class="js-bg-video g-flex-centered g-height-500 g-color-white u-bg-overlay g-bg-black-opacity-0_6--after g-py-20 g-overflow-y-hidden" style="background-image: url(../../assets/img-temp/1920x1080/img1.jpg);" data-hs-bgv-type="youtube" data-hs-bgv-id="w2iPKMP2a-U"
                  data-hs-bgv-loop="1">
                    <div class="container u-bg-overlay__inner">
                      <div class="row">
                        <div class="col-md-6 align-self-center g-py-20">
            ...
            <div id="hero-07-2" class="tab-pane fade" role="tabpanel">
              <div id="shortcode7-2">
                <div class="shortcode-html">
                  <section class="js-bg-video g-flex-centered g-height-500 g-color-white u-bg-overlay g-bg-black-opacity-0_6--after g-py-20 g-overflow-y-hidden" style="background-image: url(../../assets/img-temp/1920x1080/img1.jpg);" data-hs-bgv-type="vimeo" data-hs-bgv-id="111939668"
                  data-hs-bgv-loop="1">
                    <div class="container u-bg-overlay__inner">
                      <div class="row">
                        <div class="col-md-6 align-self-center g-py-20">
            ...
            <div id="hero-07-3" class="tab-pane fade" role="tabpanel">
              <div id="shortcode7-3">
                <div class="shortcode-html">
                  <section class="js-bg-video g-flex-centered g-height-500 g-color-white u-bg-overlay g-bg-black-opacity-0_6--after g-py-20 g-overflow-y-hidden" style="background-image: url(../../assets/img-temp/1920x1080/img1.jpg);" data-hs-bgv-path="../../assets/media-temp/video-bg/video-bg"
                  data-hs-bgv-loop="1">
                    <div class="container u-bg-overlay__inner">
                      <div class="row">
                        <div class="col-md-6 align-self-center g-py-20">
        ...
        <section class="g-overflow-x-hidden g-py-30">
          ...
          <!-- Nav tabs -->
          <ul class="nav justify-content-center u-nav-v2-1 u-nav-rounded-3 g-mb-50" role="tablist" data-target="hero-08" data-tabs-mobile-type="slide-up-down" data-btn-classes="btn btn-md btn-block u-btn-outline-primary">
            <li class="nav-item">
          ...
          <div id="hero-08" class="tab-content">
            <div id="hero-08-1" class="tab-pane fade show active" role="tabpanel">
              <div id="shortcode8-1">
                <div class="shortcode-html">
                  <section class="g-flex-centered g-height-450 g-bg-gray-light-v5 g-py-30">
                    <div class="container">
                      <div class="row">
                        <div class="col-md-6 align-self-center g-py-20">
                          <h2 class="h4 text-uppercase g-letter-spacing-1 g-mb-20" data-animation="fadeInLeft" data-animation-delay="500" data-animation-duration="2000">Content block</h2>
                          <p class="lead mb-0 g-line-height-2" data-animation="fadeInLeft" data-animation-delay="500" data-animation-duration="2000">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin hendrerit rhoncus tempus. Donec id orci malesuada, finibus odio quis, tincidunt libero. Fusce in venenatis ligula. Etiam eget lacus id erat scelerisque tempor.</p>
                        </div>

                        <div class="col-md-6 align-self-center g-py-20">
                          <img class="w-100" src="../../assets/img-temp/400x270/img28.jpg" alt="Iamge Description" data-animation="fadeInRight" data-animation-delay="500" data-animation-duration="2000">
                        </div>
                      </div>
                    </div>
                  </section>
                ...
                <div class="shortcode-styles">
                  <!-- CSS Implementing Plugins -->
                  <link type="text/plain" rel="stylesheet" href="../../assets/vendor/animate.css">
                </div>
                ...
                <div class="shortcode-scripts">
                  ...
                  <!-- JS Unify -->
                  <script type="text/plain" src="../../assets/js/components/hs.onscroll-animation.js"></script>
                  ...
                  <section class="g-flex-centered g-height-450 g-bg-primary g-color-white-opacity-0_9 g-py-30">
                    <div class="container">
                      <div class="row">
                        ...
                        <div class="col-md-6 align-self-center g-py-20">
                          <img class="w-100" src="../../assets/img-temp/400x270/img12.jpg" alt="Iamge Description" data-animation="fadeInUp" data-animation-delay="1000" data-animation-duration="2000">
                        </div>
                      </div>
                    </div>
                  </section>
