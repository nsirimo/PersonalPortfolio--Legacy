...
<head>
  <!-- Title -->
  <title>Box Shadows | Unify - Responsive Website Template</title>
  ...
  <main>
      ...
      <div class="u-header__sections-container">
        <div class="u-sidebar-navigation-inner">
          ...
          <ul class="js-shortcode-filter-result nav flex-column u-sidebar-navigation-list">
            ...
            <li class="js-shortcode-filter__item nav-item bases">
              <a href="../../unify-main/shortcodes/shortcode-base-box-shadows.html" class="nav-link active">Box Shadow</a>
            </li>
            <li class="js-shortcode-filter__item nav-item bases">
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall" data-options="{direction: 'reverse', settings_mode_oneelement_max_offset: '150'}">
      ...
      <div class="container g-z-index-1 g-py-100">
        <h1 class="g-font-weight-300 g-letter-spacing-1 g-mb-15">Box Shadows</h1>
    ...
    <section>
          ...
          <div class="row">
              ...
              <div id="shortcode1">
                <div class="shortcode-html">
                  ...
                  <div class="u-shadow-v1-3 g-line-height-2 g-pa-40 g-mb-30" role="alert">
                    <h3 class="h2 g-font-weight-300 g-mb-20">Box Shadow</h3>
                    <p class="mb-0">Provide contextual feedback messages for typical user actions with the handful of available and flexible alert messages. Class name example with some code tags and others
                      <code>.class</code> example. Nulla ipsum dolor sit amet, consectetur adipiscing elitut eleifend nisl. In hac habitasse platea dictumst. Curabitur hendrerit. By default Bootstrap includes 4 state alerts such as "Success", "Info", "Warning"
                      and "Danger". Check out the offecial Bootstrap Alerts page for more details here.
                    </p>
                  </div>
                  <!-- End Box Shadow -->
                </div>
            ...
            <div class="col-lg">
              <div id="shortcode2">
                <div class="shortcode-html">
                  <!-- Box Shadow -->
                  <div class="u-shadow-v1-3 g-mb-30">
      ...
      <!-- Box Shadow #06 -->
      <section class="g-py-50 g-pb-100">
        <div class="container">
          <div class="text-center g-mb-50">
            <h2 class="h4">Box Shadow
          ...
          <div class="row">
            <div class="col-lg">
              <div id="shortcode11">
                <div class="shortcode-html">
                  <!-- Box Shadow -->
                  <div class="u-shadow-v5 g-bg-white g-brd-around g-brd-gray-light-v4 g-line-height-2 g-pa-40 g-mb-30" role="alert">
                    <h3 class="h2 g-font-weight-300 g-mb-20">Box Shadow</h3>
                    <p class="mb-0">Provide contextual feedback messages for typical user actions with the handful of available and flexible alert messages. Class name example with some code tags and others
                      <code>.class</code> example. Nulla ipsum dolor sit amet, consectetur adipiscing elitut eleifend nisl. In hac habitasse platea dictumst. Curabitur hendrerit. By default Bootstrap includes 4 state alerts such as "Success", "Info", "Warning"
                      and "Danger". Check out the offecial Bootstrap Alerts page for more details here.
