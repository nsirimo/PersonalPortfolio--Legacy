...
<head>
  <!-- Title -->
  <title>Comments | Unify - Responsive Website Template</title>
  ...
  <main>
      ...
      <div class="u-header__sections-container">
        <div class="u-sidebar-navigation-inner">
          ...
          <ul class="js-shortcode-filter-result nav flex-column u-sidebar-navigation-list">
            ...
            <li class="js-shortcode-filter__item nav-item blocks">
              <a href="../../unify-main/shortcodes/shortcode-blocks-comments.html" class="nav-link active">Comments</a>
            </li>
            <li class="js-shortcode-filter__item nav-item blocks">
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall g-overflow-hidden" data-options="{direction: 'reverse', settings_mode_oneelement_max_offset: '150'}">
      ...
      <div class="container g-z-index-1 g-py-100">
        <h1 class="g-font-weight-300 g-letter-spacing-1 g-mb-15">Comments</h1>
              ...
              <div id="shortcode2">
                <div class="shortcode-html">
                  <div class="media g-brd-around g-brd-gray-light-v4 g-pa-30 g-mb-20">
                    <img class="d-flex g-width-50 g-height-50 rounded-circle g-mt-3 g-mr-15" src="../../assets/img-temp/100x100/img7.jpg" alt="Image Description">
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-lg">
              <div id="shortcode4">
                <div class="shortcode-html">
                  <div class="js-scrollbar g-height-350 g-brd-around g-brd-gray-light-v4 rounded g-pa-20 g-mb-30">
                    <!-- Comments -->
                    <div class="media g-mb-30">
                      ...
                      <div class="media-body">
                        <div class="d-flex align-items-start g-mb-15 g-mb-10--sm">
                          ...
                          <div class="ml-auto">
                            <a class="u-link-v5 g-color-primary--hover g-font-weight-600 g-font-size-12 text-uppercase" href="#">Reply</a>
                          </div>
                        </div>

                        <p>This is where we really begin to visualize your napkin sketches and make them into beautiful pixels. Whether through commerce or just an experience to tell your brand's story, the time has come to start using development languages
                  ...
                  <form>
                    <div class="g-mb-30">
                      <textarea class="form-control g-bg-secondary g-brd-gray-light-v4 g-brd-primary--focus g-resize-none rounded-3 g-py-13 g-px-15" rows="5" placeholder="Your message..." disabled></textarea>
                    </div>

                    <div class="d-flex align-items-center">
                      <button class="btn u-btn-primary g-font-weight-600 g-font-size-12 text-uppercase g-py-12 g-px-25 mr-4" type="submit" role="button">Signin</button>
                ...
                <div class="shortcode-styles">
                  ...
                  <link type="text/plain" rel="stylesheet" href="../../assets/vendor/malihu-scrollbar/jquery.mCustomScrollbar.min.css">
                </div>
                ...
                <div class="shortcode-scripts">
                  ...
                  <!-- JS Unify -->
                  <script type="text/plain" src="../../assets/js/components/hs.scrollbar.js"></script>
