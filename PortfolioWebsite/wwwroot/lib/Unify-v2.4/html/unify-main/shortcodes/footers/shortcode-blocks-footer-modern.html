...
<head>
  <!-- Title -->
  <title>Modern Footers | Unify - Responsive Website Template</title>
  ...
  <main>
            ...
            <li class="js-shortcode-filter__item nav-item dropdown blocks">
              ...
              <div class="dropdown-menu u-dropdown-static">
                <ul class="nav flex-column">
                  ...
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../../unify-main/shortcodes/footers/shortcode-blocks-footer-modern.html" class="nav-link active">Footer Modern</a>
                  </li>
                </ul>
              </div>
            </li>
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall g-overflow-hidden" data-options="{direction: 'reverse', settings_mode_oneelement_max_offset: '150'}">
      ...
      <div class="container g-z-index-1 g-py-100">
        <h1 class="g-font-weight-300 g-letter-spacing-1 g-mb-15">Modern Footers</h1>
              ...
              <div class="container">
                <div class="row g-mb-50">
                  ...
                  <div class="col-lg-6">
                    <ul class="u-list-inline d-flex flex-wrap g-mr-minus-20 mb-0">
                      ...
                      <li class="list-inline-item g-mr-20 g-mb-20">
                        <a href="#!">
                          <img class="g-width-70 g-height-70" src="../../../assets/img-temp/100x100/img14.jpg" alt="Image Description">
                        </a>
                      </li>
                      <li class="list-inline-item g-mr-20 g-mb-20">
                        <a href="#!">
                          <img class="g-width-70 g-height-70" src="../../../assets/img-temp/100x100/img15.jpg" alt="Image Description">
                        </a>
                      </li>
                      <li class="list-inline-item g-mr-20 g-mb-20">
                        <a href="#!">
                          <img class="g-width-70 g-height-70" src="../../../assets/img-temp/100x100/img4.jpg" alt="Image Description">
                        </a>
                      </li>
                      <li class="list-inline-item g-mr-20 g-mb-20">
                        <a href="#!">
                          <img class="g-width-70 g-height-70" src="../../../assets/img-temp/100x100/img5.jpg" alt="Image Description">
                        </a>
                      </li>
                      <li class="list-inline-item g-mr-20 g-mb-20">
                        <a href="#!">
                          <img class="g-width-70 g-height-70" src="../../../assets/img-temp/100x100/img6.jpg" alt="Image Description">
                        </a>
                      </li>
                      <li class="list-inline-item g-mr-20 g-mb-20">
                        <a href="#!">
                          <img class="g-width-70 g-height-70" src="../../../assets/img-temp/100x100/img7.jpg" alt="Image Description">
                        </a>
                      </li>
                      <li class="list-inline-item g-mr-20 g-mb-20">
                        <a href="#!">
                ...
                <div class="row align-items-center">
                  <div class="col-md-6 g-mb-15 g-mb-0--md">
                    <small class="g-font-size-default mb-0">© 2017 All right reserved. Development by
                ...
                <div class="row">
                  ...
                  <div class="col-lg-3 g-mb-40 g-mb-0--lg">
                    <a class="d-block g-mb-20" href="index.html">
                      <img class="img-fluid g-opacity-0_6 g-mb-5" src="../../../assets/img/logo/logo-3.png" alt="Logo">
                    </a>
                  ...
                  <div class="col-lg-4 g-mb-40 g-mb-0--lg">
                    ...
                    <article class="media">
                      <a class="d-flex g-mt-4 mr-3" href="#!">
                        <img class="g-width-80 g-height-80" src="../../../assets/img-temp/100x100/img8.jpg" alt="Image Description">
                      </a>
                    ...
                    <article class="media">
                      <a class="d-flex g-mt-4 mr-3" href="#!">
                        <img class="g-width-80 g-height-80" src="../../../assets/img-temp/100x100/img9.jpg" alt="Image Description">
                      </a>
                    ...
                    <ul class="u-list-inline d-flex flex-wrap g-mr-minus-15">
                      <li class="list-inline-item g-mr-10 g-mb-10">
                        <a class="u-block-hover" href="#!">
                          <img class="u-block-hover__main--grayscale g-width-80 g-height-80" src="../../../assets/img-temp/100x100/img10.jpg" alt="Image Description">
                        </a>
                      </li>
                      <li class="list-inline-item g-mr-10 g-mb-10">
                        <a class="u-block-hover" href="#!">
                          <img class="u-block-hover__main--grayscale g-width-80 g-height-80" src="../../../assets/img-temp/100x100/img12.jpg" alt="Image Description">
                        </a>
                      </li>
                      <li class="list-inline-item g-mr-10 g-mb-10">
                        <a class="u-block-hover" href="#!">
                          <img class="u-block-hover__main--grayscale g-width-80 g-height-80" src="../../../assets/img-temp/100x100/img13.jpg" alt="Image Description">
                        </a>
                      </li>
                      <li class="list-inline-item g-mr-10 g-mb-10">
                        <a class="u-block-hover" href="#!">
                          <img class="u-block-hover__main--grayscale g-width-80 g-height-80" src="../../../assets/img-temp/100x100/img14.jpg" alt="Image Description">
                        </a>
                      </li>
                      <li class="list-inline-item g-mr-10 g-mb-10">
                        <a class="u-block-hover" href="#!">
                          <img class="u-block-hover__main--grayscale g-width-80 g-height-80" src="../../../assets/img-temp/100x100/img15.jpg" alt="Image Description">
                        </a>
                      </li>
                      <li class="list-inline-item g-mr-10 g-mb-10">
                        <a class="u-block-hover" href="#!">
                          <img class="u-block-hover__main--grayscale g-width-80 g-height-80" src="../../../assets/img-temp/100x100/img16.jpg" alt="Image Description">
                        </a>
                      </li>
                    </ul>
                  </div>
            ...
            <footer class="g-bg-black-opacity-0_9 g-color-white-opacity-0_8 text-center g-pt-60 g-pb-40">
              ...
              <div class="container">
                <a class="d-block g-width-200 g-opacity-0_5 mx-auto g-mb-30" href="index.html">
                  <img class="img-fluid" src="../../../assets/img/logo/logo-3.png" alt="Logo">
                </a>
              ...
              <!-- Copyright -->
              <div class="container">
                <small class="g-font-size-default">2017 All right reserved. Unify Development by
              ...
              <div class="container">
                ...
                <div class="row">
                  <div class="col-md-6 d-flex align-items-center g-mb-15 g-mb-0--md">
                    <small class="g-font-size-default"> 2017 All right reserved. Development by
                      <a class="g-color-white" href="#!">Htmlstream</a>
                    </small>
                  </div>
              ...
              <div class="container">
                ...
                <div class="row">
                  <div class="col-md-12 col-lg-4 g-mb-40 g-mb-0--lg">
                    <h2 class="h6 g-color-white text-uppercase g-font-weight-700 g-mb-20">About Us</h2>
                    <p class="g-mb-20">
                      <img class="img-fluid" src="../../../assets/img-temp/600x300/img1.jpg" alt="Image description">
                    </p>
