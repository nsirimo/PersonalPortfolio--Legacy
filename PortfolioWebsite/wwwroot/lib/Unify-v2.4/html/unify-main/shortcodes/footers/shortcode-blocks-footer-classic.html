...
<head>
  <!-- Title -->
  <title>Classic Footers | Unify - Responsive Website Template</title>
  ...
  <main>
      ...
      <div class="u-header__sections-container">
        <div class="u-sidebar-navigation-inner">
          ...
          <ul class="js-shortcode-filter-result nav flex-column u-sidebar-navigation-list">
            ...
            <li class="js-shortcode-filter__item nav-item dropdown blocks">
              <a class="nav-link dropdown-toggle active" href="#!" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Footers</a>
              <div class="dropdown-menu u-dropdown-static">
                <ul class="nav flex-column">
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../../unify-main/shortcodes/footers/shortcode-blocks-footer-classic.html" class="nav-link active">Footer Classic</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item blocks">
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall g-overflow-hidden" data-options="{direction: 'reverse', settings_mode_oneelement_max_offset: '150'}">
      ...
      <div class="container g-z-index-1 g-py-100">
        <h1 class="g-font-weight-300 g-letter-spacing-1 g-mb-15">Classic Footers</h1>
    ...
    <section>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-3 col-md-6">
                    ...
                    <address class="g-bg-no-repeat g-line-height-2 g-mt-minus-4" style="background-image: url(../../../assets/img/maps/map2.png);">
                      ...
                      <br>
                      Email:
                      <a href="mailto:info@htmlstream.com" class="">info@htmlstream.com</a>
                    </address>
                  </div>
                  <!-- End Footer Content -->
                </div>
        ...
        <div id="shortcode4">
          <div class="shortcode-html">
              ...
              <div class="container">
                <div class="row">
                  ...
                  <div class="col-lg-3 col-md-6 g-mb-40 g-mb-0--lg">
                    ...
                    <p>About Unify dolor sit amet, consec tetur adipiscing elit.</p>
            ...
            <footer class="g-bg-gray-dark-v1 g-color-white-opacity-0_8 text-center g-py-20">
              <div class="container">
                <small class="g-font-size-default g-mr-10 g-mb-10 g-mb-0--md">2017 © All Rights Reserved. Unify Template by
                  <a href="#!">Htmlstream</a>
                </small>
              </div>
            </footer>
            ...
            <div class="g-bg-black-opacity-0_9 g-color-white-opacity-0_8 g-py-60">
              <div class="container">
                <div class="row">
                  ...
                  <div class="col-lg-3 col-md-6 g-mb-40 g-mb-0--lg">
                    <div class="u-heading-v2-3--bottom g-brd-white-opacity-0_8 g-mb-20">
                      <h2 class="u-heading-v2__title h6 text-uppercase mb-0">Flickr Shots</h2>
                    </div>

                    <ul class="u-list-inline d-flex flex-wrap g-mr-minus-15">
                      <li class="list-inline-item g-mr-15 g-mb-15">
                        <a href="#!">
                          <img class="g-width-70 g-height-70" src="../../../assets/img-temp/100x100/img9.jpg" alt="Image Description">
                        </a>
                      </li>
                      <li class="list-inline-item g-mr-15 g-mb-15">
                        <a href="#!">
                      ...
                      <li class="list-inline-item g-mr-15 g-mb-15">
                        <a href="#!">
                          <img class="g-width-70 g-height-70" src="../../../assets/img-temp/100x100/img10.jpg" alt="Image Description">
                        </a>
                      </li>
                    </ul>
                  </div>
              ...
              <div class="container">
                <div class="row">
                  ...
                  <div class="col-lg-4 g-mb-60 g-mb-0--lg">
                    ...
                    <div class="g-mb-30">
                      <p>About Unify dolor sit amet, consectetur adipiscing elit. Maecenas eget nisl id libero tincidunt.</p>
                    </div>
                    ...
                    <address class="g-line-height-2 g-mt-minus-4">
                      <ul class="list-unstyled">
                        ...
                        <li class="d-flex align-items-baseline g-mb-5">
                          <i class="fa fa-angle-right g-mr-10"></i>
                          <span>Phone: 800 123 3456</span>
                        </li>
                        <li class="d-flex align-items-baseline g-mb-5">
                          <i class="fa fa-angle-right g-mr-10"></i>
                          <span>Fax: 800 123 3457</span>
                        </li>
                        <li class="d-flex align-items-baseline g-mb-5">
                          <i class="fa fa-angle-right g-mr-10"></i>
                          <span>Email:
                            <a class="g-color-white-opacity-0_8" href="mailto:info@htmlstream.com" class="">info@htmlstream.com</a>
                          </span>
                        </li>
                      </ul>
                    </address>
                  ...
                  <div class="col-lg-2 col-sm-3">
                    <h2 class="h6 text-uppercase g-font-weight-600 g-mb-15">Secciones</h2>
                    <ul class="list-unstyled g-mb-35">
                      <li class="g-mb-5">
                        <a class="g-color-white-opacity-0_8" href="#!">Ultima Hora</a>
                      </li>
                      <li class="g-mb-5">
                        <a class="g-color-white-opacity-0_8" href="#!">Exclusiva</a>
                      </li>
                      <li class="g-mb-5">
                        <a class="g-color-white-opacity-0_8" href="#!">Documentos</a>
                      </li>
                      <li class="g-mb-5">
                        <a class="g-color-white-opacity-0_8" href="#!">Francisco papa</a>
                      </li>
                      <li>...</li>
                    </ul>

                    <h2 class="h6 text-uppercase g-font-weight-600 g-mb-15">Temas</h2>
                  ...
                  <!-- Footer Content -->
                  <div class="col-lg-2 col-sm-3">
                    <h2 class="h6 text-uppercase g-font-weight-600 g-mb-15">Utilidades</h2>
                    <ul class="list-unstyled g-mb-35">
                      <li class="g-mb-5">
                        <a class="g-color-white-opacity-0_8" href="#!">Ultima Hora</a>
                      </li>
                    ...
                    <h2 class="h6 text-uppercase g-font-weight-600 g-mb-15">Documentos</h2>
                    <ul class="list-unstyled g-mb-35 g-mb-0--md">
                      <li class="g-mb-5">
                        <a class="g-color-white-opacity-0_8" href="#!">Ultima Hora</a>
                      </li>
                  ...
                  <!-- Footer Content -->
                  <div class="col-lg-2 col-sm-3">
                    <h2 class="h6 text-uppercase g-font-weight-600 g-mb-15">Publicidad</h2>
                    <ul class="list-unstyled g-mb-35">
                      <li class="g-mb-5">
                        <a class="g-color-white-opacity-0_8" href="#!">Ultima Hora</a>
                      </li>
                    ...
                    <h2 class="h6 text-uppercase g-font-weight-600 g-mb-15">Contacto</h2>
                    <ul class="list-unstyled g-mb-35 g-mb-0--md">
                      <li class="g-mb-5">
                        <a class="g-color-white-opacity-0_8" href="#!">Ultima Hora</a>
                      </li>
            ...
            <div class="g-bg-black-opacity-0_9 g-color-white-opacity-0_8 g-py-60">
              <div class="container">
                <div class="row">
                  ...
                  <div class="col-lg col-sm-4">
                    ...
                    <ul class="list-unstyled g-mb-35">
                      <li class="d-flex align-items-baseline g-mb-8">
                        ...
                        <a class="g-color-white-opacity-0_8" href="#!">Forum</a>
                      </li>
                      <li class="d-flex align-items-baseline g-mb-8">
                        <i class="fa fa-angle-right g-mr-5"></i>
                        <a class="g-color-white-opacity-0_8" href="#!">Careers</a>
                      </li>
                      <li class="d-flex align-items-baseline g-mb-8">
                        <i class="fa fa-angle-right g-mr-5"></i>
                        <a class="g-color-white-opacity-0_8" href="#!">Community</a>
                      </li>
                      <li class="d-flex align-items-baseline g-mb-8">
                        <i class="fa fa-angle-right g-mr-5"></i>
                        <a class="g-color-white-opacity-0_8" href="#!">Contact Us</a>
                      </li>
                      <li>...</li>
                    </ul>

                    <h2 class="h5 g-mb-15">Information Center</h2>
                    <ul class="list-unstyled g-mb-35 g-mb-0--md">
                      <li class="d-flex align-items-baseline g-mb-8">
                        <i class="fa fa-angle-right g-mr-5"></i>
                        <a class="g-color-white-opacity-0_8" href="#!">Help &amp; Support</a>
                      </li>
                      <li class="d-flex align-items-baseline g-mb-8">
                        <i class="fa fa-angle-right g-mr-5"></i>
                        <a class="g-color-white-opacity-0_8" href="#!">Customer Service</a>
                      </li>
                      <li class="d-flex align-items-baseline g-mb-8">
                        <i class="fa fa-angle-right g-mr-5"></i>
                        <a class="g-color-white-opacity-0_8" href="#!">New on Unify</a>
                      </li>
                      <li class="d-flex align-items-baseline g-mb-8">
                        <i class="fa fa-angle-right g-mr-5"></i>
                        <a class="g-color-white-opacity-0_8" href="#!">Tour the New Journey</a>
                      </li>
                      <li class="d-flex align-items-baseline g-mb-8">
                        <i class="fa fa-angle-right g-mr-5"></i>
                        <a class="g-color-white-opacity-0_8" href="#!">Registration Requirements</a>
                      </li>
                      <li>...</li>
                    </ul>
                  </div>
                  ...
                  <!-- Footer Content -->
                  <div class="col-lg col-sm-4">
                    <h2 class="h5 g-mb-15">Topics</h2>
                    <ul class="list-unstyled g-mb-35">
                      <li class="d-flex align-items-baseline g-mb-8">
                        <i class="fa fa-angle-right g-mr-5"></i>
                        <a class="g-color-white-opacity-0_8" href="#!">Bootstrap</a>
                      </li>
                      <li class="d-flex align-items-baseline g-mb-8">
                        <i class="fa fa-angle-right g-mr-5"></i>
                        <a class="g-color-white-opacity-0_8" href="#!">Unify Template</a>
                      </li>
                      <li class="d-flex align-items-baseline g-mb-8">
                        <i class="fa fa-angle-right g-mr-5"></i>
                        <a class="g-color-white-opacity-0_8" href="#!">WordPress</a>
                      </li>
                      <li class="d-flex align-items-baseline g-mb-8">
                        <i class="fa fa-angle-right g-mr-5"></i>
                        <a class="g-color-white-opacity-0_8" href="#!">Startups</a>
                      </li>
                      <li class="d-flex align-items-baseline g-mb-8">
                        <i class="fa fa-angle-right g-mr-5"></i>
                        <a class="g-color-white-opacity-0_8" href="#!">HS Freebies</a>
                      </li>
                      <li class="d-flex align-items-baseline g-mb-8">
                        <i class="fa fa-angle-right g-mr-5"></i>
                        <a class="g-color-white-opacity-0_8" href="#!">UX &amp; UI Design</a>
                      </li>
                      <li>...</li>
                    </ul>

                    <h2 class="h5 g-mb-15">Tools &amp; Formats</h2>
                    <ul class="list-unstyled g-mb-35 g-mb-0--md">
                      <li class="d-flex align-items-baseline g-mb-8">
                        <i class="fa fa-angle-right g-mr-5"></i>
                        <a class="g-color-white-opacity-0_8" href="#!">Flexbox Masterclass</a>
                      </li>
                      <li class="d-flex align-items-baseline g-mb-8">
                        <i class="fa fa-angle-right g-mr-5"></i>
                        <a class="g-color-white-opacity-0_8" href="#!">SASS Snippets</a>
                      </li>
                      <li class="d-flex align-items-baseline g-mb-8">
                        <i class="fa fa-angle-right g-mr-5"></i>
                        <a class="g-color-white-opacity-0_8" href="#!">Video Lessons</a>
                      </li>
                      <li>...</li>
                    </ul>
                  </div>
                  ...
                  <!-- Footer Content -->
                  <div class="col-lg col-sm-4">
                    <h2 class="h5 g-mb-15">Developers</h2>
                    <ul class="list-unstyled g-mb-35">
                      <li class="d-flex align-items-baseline g-mb-8">
                        <i class="fa fa-angle-right g-mr-5"></i>
                        <a class="g-color-white-opacity-0_8" href="#!">Web Development</a>
                      </li>
                      <li class="d-flex align-items-baseline g-mb-8">
                        <i class="fa fa-angle-right g-mr-5"></i>
                        <a class="g-color-white-opacity-0_8" href="#!">Android &amp; iOS</a>
                      </li>
                      <li class="d-flex align-items-baseline g-mb-8">
                        <i class="fa fa-angle-right g-mr-5"></i>
                        <a class="g-color-white-opacity-0_8" href="#!">AngularJS</a>
                      </li>
                      <li class="d-flex align-items-baseline g-mb-8">
                        <i class="fa fa-angle-right g-mr-5"></i>
                        <a class="g-color-white-opacity-0_8" href="#!">PHP &amp; MySQL</a>
                      </li>
                      <li class="d-flex align-items-baseline g-mb-8">
                        <i class="fa fa-angle-right g-mr-5"></i>
                        <a class="g-color-white-opacity-0_8" href="#!">Javascript</a>
                      </li>
                      <li>...</li>
                    </ul>
                    ...
                    <ul class="list-unstyled g-mb-35 g-mb-0--md">
                      <li class="d-flex align-items-baseline g-mb-8">
                        <i class="fa fa-angle-right g-mr-5"></i>
                        <a class="g-color-white-opacity-0_8" href="#!">Wrapbootstrap.com</a>
                      </li>
                      <li class="d-flex align-items-baseline g-mb-8">
                        <i class="fa fa-angle-right g-mr-5"></i>
                        <a class="g-color-white-opacity-0_8" href="#!">Htmlstream.com</a>
                      </li>
                      <li class="d-flex align-items-baseline g-mb-8">
                        <i class="fa fa-angle-right g-mr-5"></i>
                        <a class="g-color-white-opacity-0_8" href="#!">Pixeel.co.uk</a>
                      </li>
                      <li class="d-flex align-items-baseline g-mb-8">
                        <i class="fa fa-angle-right g-mr-5"></i>
                        <a class="g-color-white-opacity-0_8" href="#!">Getbootstrap.com</a>
                      </li>
                      <li class="d-flex align-items-baseline g-mb-8">
                        <i class="fa fa-angle-right g-mr-5"></i>
                        <a class="g-color-white-opacity-0_8" href="#!">Unsplash.com</a>
                      </li>
                      <li>...</li>
                    </ul>
                  </div>
                  ...
                  <div class="col-lg-3 col-md-6 g-mb-40 g-mb-0--lg">
                    ...
                    <article class="media">
                      <a class="d-flex g-mt-3 mr-3" href="#!">
                        <img class="g-width-60 g-height-60 rounded" src="../../../assets/img-temp/100x100/img8.jpg" alt="Image Description">
                      </a>
                    ...
                    <article class="media">
                      <a class="d-flex g-mt-3 mr-3" href="#!">
                        <img class="g-width-60 g-height-60 rounded" src="../../../assets/img-temp/100x100/img9.jpg" alt="Image Description">
                      </a>
                    ...
                    <article class="media">
                      <a class="d-flex g-mt-3 mr-3" href="#!">
                        <img class="g-width-60 g-height-60 rounded" src="../../../assets/img-temp/100x100/img13.jpg" alt="Image Description">
                      </a>
      ...
      <section class="g-pt-70">
        ...
        <div id="shortcode10">
          <div class="shortcode-html">
            <!-- Footer -->
            <footer class="u-bg-overlay g-bg-black-opacity-0_9--after g-color-white-opacity-0_8 g-bg-img-hero g-pt-60" style="background-image: url(../../../assets/img-temp/1920x1080/img3.jpg);">
              <div class="container u-bg-overlay__inner g-mb-60">
                <div class="row">
                  <!-- Footer Content -->
                  <div class="col-lg-3 col-md-6 g-mb-40 g-mb-0--lg">
                    <div class="u-heading-v2-3--bottom g-brd-white-opacity-0_8 g-mb-20">
          ...
          <div class="shortcode-html">
            ...
            <footer class="g-bg-bluegray-lineargradient g-color-white-opacity-0_8 g-bg-img-hero g-pt-60">
              ...
              <div class="g-bg-black-opacity-0_1 g-color-white-opacity-0_8 text-center g-py-20">
                <div class="container">
                  <small class="g-font-size-default g-mr-10 g-mb-10 g-mb-0--md">2017 © All Rights Reserved. Unify Template by
                    <a class="g-color-white-opacity-0_8" href="#!">Htmlstream</a>
                  </small>
                </div>
              </div>
              <!-- End Copyright Footer -->
            ...
            <footer id="contact-section" class="container">
              <div class="row g-pt-80">
                <div class="col-sm-6 col-lg-3 g-mb-50">
                  <h3 class="text-uppercase g-color-black g-font-weight-600 g-font-size-13 mb-3">About</h3>

                  <!-- Links -->
                  <ul class="list-unstyled">
                    <li class="g-py-6">
                      <a class="u-link-v5 g-color-gray-dark-v5" href="#!">About</a>
                    </li>
                    <li class="g-py-6">
                      <a class="u-link-v5 g-color-gray-dark-v5" href="#!">Services</a>
                    </li>
                  </ul>
                  <!-- End Links -->
                </div>
                ...
                <div class="col-sm-6 col-lg-3 g-mb-50">
                  <h3 class="text-uppercase g-color-black g-font-weight-600 g-font-size-13 mb-3">Departments</h3>

                  <!-- Links -->
                  <ul class="list-unstyled">
                    <li class="g-py-6">
                      <a class="u-link-v5 g-color-gray-dark-v5" href="#!">Sales Department</a>
                    </li>
                    <li class="g-py-6">
                      <a class="u-link-v5 g-color-gray-dark-v5" href="#!">Management</a>
                    </li>
                    <li class="g-py-6">
                      <a class="u-link-v5 g-color-gray-dark-v5" href="#!">Customer Department</a>
                    </li>
                  </ul>
                  <!-- End Links -->
                </div>
                ...
                <div class="col-sm-6 col-lg-3 g-mb-50">
                  <h3 class="text-uppercase g-color-black g-font-weight-600 g-font-size-13 mb-3">Hire</h3>

                  <!-- Links -->
                  <ul class="list-unstyled">
                    <li class="g-py-6">
                      <a class="u-link-v5 g-color-gray-dark-v5" href="#!">Apply for Unify Job</a>
                    </li>
                    <li class="g-py-6">
                      <a class="u-link-v5 g-color-gray-dark-v5" href="#!">How it Works for Employees</a>
                    </li>
                    <li class="g-py-6">
                      <a class="u-link-v5 g-color-gray-dark-v5" href="#!">Working Parameters</a>
                    </li>
                    <li class="g-py-6">
                      <a class="u-link-v5 g-color-gray-dark-v5" href="#!">General FAQs</a>
                    </li>
                  </ul>
                  <!-- End Links -->
                </div>
                ...
                <div class="col-sm-6 col-lg-3 g-mb-50">
                  ...
                  <!-- Forms -->
                  <form class="input-group g-brd-secondary-light-v2 g-brd-primary--focus g-rounded-30 g-mb-50 g-mb-30--sm">
                    <input class="form-control g-brd-right-none g-placeholder-text g-font-size-13 g-px-25 g-py-15" type="email" placeholder="Enter your email">
                    <span class="input-group-addon g-brd-left-none">
                      <button class="btn g-bg-white g-color-black g-color-primary--hover g-font-size-12 g-brd-none g-pa-10" type="submit">
                  ...
                  <h3 class="text-uppercase g-color-black g-font-weight-600 g-font-size-13 mb-3">Stay in Touch</h3>

                  <!-- Social Icons -->
                  <ul class="list-inline mb-0">
                    <li class="list-inline-item g-mx-2">
                      <a class="u-icon-v3 g-width-35 g-height-35 g-color-black g-bg-secondary g-color-white--hover g-bg-primary--hover g-font-size-13 rounded-circle" href="https://www.facebook.com/htmlstream">
                        <i class="fa fa-facebook"></i>
                      </a>
                    </li>
                    <li class="list-inline-item g-mx-2">
                      <a class="u-icon-v3 g-width-35 g-height-35 g-color-black g-bg-secondary g-color-white--hover g-bg-primary--hover g-font-size-13 rounded-circle" href="https://twitter.com/htmlstream">
                        <i class="fa fa-twitter"></i>
                      </a>
                    </li>
                    <li class="list-inline-item g-mx-2">
                      <a class="u-icon-v3 g-width-35 g-height-35 g-color-black g-bg-secondary g-color-white--hover g-bg-primary--hover g-font-size-13 rounded-circle" href="https://github.com/htmlstream">
                        <i class="fa fa-github"></i>
                      </a>
                    </li>
                    <li class="list-inline-item g-mx-2">
                      <a class="u-icon-v3 g-width-35 g-height-35 g-color-black g-bg-secondary g-color-white--hover g-bg-primary--hover g-font-size-13 rounded-circle" href="https://dribbble.com/htmlstream">
                        <i class="fa fa-dribbble"></i>
                      </a>
                    </li>
                  </ul>
                  ...
                  <div class="row">
                    <div class="col-6 col-md-3 g-mb-30">
                      ...
                      <ul class="list-unstyled mb-0">
                        <li>
                          <a class="u-link-v6 g-color-gray-dark-v5 g-color-primary--hover g-font-weight-500 g-text-underline--none--hover g-py-3" href="page-about-1.html">
                            About Unify Marketing
                            <span class="u-link-v6-arrow g-font-size-18">&rightarrow;</span>
                          </a>
                        </li>
                        <li>
                          <a class="u-link-v6 g-color-gray-dark-v5 g-color-primary--hover g-font-weight-500 g-text-underline--none--hover g-py-3" href="page-services-1.html">
                            Services
                            <span class="u-link-v6-arrow g-font-size-18">&rightarrow;</span>
                          </a>
                        </li>
                        <li>
                          <a class="u-link-v6 g-color-gray-dark-v5 g-color-primary--hover g-font-weight-500 g-text-underline--none--hover g-py-3" href="page-pricing-1.html">
                            Pricing Tables
                            <span class="u-link-v6-arrow g-font-size-18">&rightarrow;</span>
                          </a>
                        </li>
                        <li>
                          <a class="u-link-v6 g-color-gray-dark-v5 g-color-primary--hover g-font-weight-500 g-text-underline--none--hover g-py-3" href="page-hire-us-1.html">
                        ...
                        <li>
                          <a class="u-link-v6 g-color-gray-dark-v5 g-color-primary--hover g-font-weight-500 g-text-underline--none--hover g-py-3" href="page-contacts-1.html">
                            Contacts
                            <span class="u-link-v6-arrow g-font-size-18">&rightarrow;</span>
                          </a>
                        </li>
                ...
                <div class="container g-pt-30">
                  <div class="row align-items-center">
                    <div class="col-md-4 text-center text-md-left g-mb-30">
                      ...
                      <!-- End Logo -->
                      <p class="d-inline-block align-middle g-color-gray-dark-v5 g-font-size-13 mb-0">&#169; 2017 Htmlstream.
            ...
            <footer class="container g-pt-100 g-pb-70">
              <div class="row">
                <div class="col-md-3 text-center text-md-left g-mb-30">
                  <!-- Logo -->
                  <a class="d-inline-block g-text-underline--none--hover mr-4 mb-4" href="index.html">
                    <img class="g-width-95" src="../../../assets/img/logo/logo-1.png" alt="Logo">
                  </a>
                  <!-- End Logo -->

                  <!-- Button Group -->
                  <div class="btn-group dropup">
                    <button class="btn btn-black btn-lg g-brd-gray-light-v3 g-color-black g-color-primary--hover g-bg-white g-font-weight-500 g-font-size-default rounded-0" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      United Kingdom
                      <i class="g-font-size-12 ml-2 fa fa-caret-up"></i>
                    </button>
                    <div class="dropdown-menu g-brd-gray-light-v3 rounded-0">
                      <a class="dropdown-item g-color-black g-color-white--hover g-bg-primary--hover g-bg-primary--active g-py-10" href="#">
                        United Kingdom
                      </a>
                      <a class="dropdown-item g-color-black g-color-white--hover g-bg-primary--hover g-bg-primary--active g-py-10" href="#">
                        United States
                ...
                <div class="col-md-6 text-center g-mb-30">
                  <span class="d-block g-color-gray-dark-v5 g-font-size-13 mb-4">&#169; Htmlstream. All Rights Reserved. 2013 - 2017</span>

                  <!-- Footer - List -->
                  <ul class="list-inline mb-5">
                    <li class="list-inline-item mx-3"><a class="u-link-v5 g-color-black g-color-primary--hover g-font-weight-500" href="#">For Rent</a>
                    </li>
                    <li class="list-inline-item mx-3"><a class="u-link-v5 g-color-black g-color-primary--hover g-font-weight-500" href="#">For Sale</a>
                    </li>
                    <li class="list-inline-item mx-3"><a class="u-link-v5 g-color-black g-color-primary--hover g-font-weight-500" href="#">New Buildings</a>
                    </li>
                    <li class="list-inline-item mx-3"><a class="u-link-v5 g-color-black g-color-primary--hover g-font-weight-500" href="#">Agents</a>
                    </li>
                    <li class="list-inline-item mx-3"><a class="u-link-v5 g-color-black g-color-primary--hover g-font-weight-500" href="#">Help</a>
                    </li>
                    <li class="list-inline-item mx-3"><a class="u-link-v5 g-color-black g-color-primary--hover g-font-weight-500" href="#">Contact Us</a>
                    </li>
                  </ul>
                  <!-- End Footer - List -->
                ...
                <div class="col-md-3 text-center g-mb-30">
                  ...
                  <ul class="list-inline mb-0">
                    <li class="list-inline-item g-mx-2">
                      <a class="u-icon-v2 g-width-35 g-height-35 g-brd-gray-light-v3 g-brd-primary--hover g-color-gray-dark-v5 g-color-white--hover g-bg-transparent g-bg-primary--hover g-font-size-13" href="#">
                        <i class="fa fa-facebook"></i>
                      </a>
                    </li>
                    <li class="list-inline-item g-mx-2">
              ...
              <div class="container">
                <div class="row g-mb-40">
                  <div class="col-6 col-md-3 g-mb-20">
                    <!-- Footer Links -->
                    <ul class="list-unstyled">
                      <li class="g-py-5"><a class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover g-font-size-16" href="#">Future Students</a>
                      </li>
                      <li class="g-py-5"><a class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover g-font-size-16" href="#">Current Students</a>
                      </li>
                      <li class="g-py-5"><a class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover g-font-size-16" href="#">Alumni</a>
                      </li>
                      <li class="g-py-5"><a class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover g-font-size-16" href="#">Faculty &amp; Staff</a>
                      </li>
                      <li class="g-py-5"><a class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover g-font-size-16" href="#">Donors</a>
                      </li>
                    </ul>
                    <!-- End Footer Links -->
                  </div>
                  ...
                  <div class="col-6 col-md-3 g-mb-20">
                    <!-- Footer Links -->
                    <ul class="list-unstyled">
                      <li class="g-py-5"><a class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover g-font-size-16" href="#">News &amp; Media</a>
                      </li>
                      <li class="g-py-5"><a class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover g-font-size-16" href="#">Research &amp; Innovation</a>
                      </li>
                      <li class="g-py-5"><a class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover g-font-size-16" href="#">Academics</a>
                      </li>
                      <li class="g-py-5"><a class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover g-font-size-16" href="#">Programs of Study</a>
                      </li>
                      <li class="g-py-5"><a class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover g-font-size-16" href="#">University Life</a>
                      </li>
                    </ul>
                    <!-- End Footer Links -->
                  </div>
                  ...
                  <div class="col-6 col-md-3 g-mb-20">
                    <!-- Footer Links -->
                    <ul class="list-unstyled">
                      <li class="g-py-5"><a class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover g-font-size-16" href="#">Contacts</a>
                      </li>
                      <li class="g-py-5"><a class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover g-font-size-16" href="#">Careers</a>
                      </li>
                      <li class="g-py-5"><a class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover g-font-size-16" href="#">Accessibility</a>
                      </li>
                      <li class="g-py-5"><a class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover g-font-size-16" href="#">Privacy</a>
                      </li>
                      <li class="g-py-5"><a class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover g-font-size-16" href="#">Site Feedback</a>
                      </li>
                    </ul>
                    <!-- End Footer Links -->
                  </div>
                  ...
                  <div class="col-6 col-md-3 g-mb-20">
                    <!-- Footer Links -->
                    <ul class="list-unstyled">
                      <li class="g-py-5"><a class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover g-font-size-16" href="#">Downtown Ontario Campus</a>
                      </li>
                      <li class="g-py-5"><a class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover g-font-size-16" href="#">Mississauga Campus</a>
                      </li>
                      <li class="g-py-5"><a class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover g-font-size-16" href="#">Scarborough Campus</a>
                      </li>
                      <li class="g-py-5"><a class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover g-font-size-16" href="#">Campus Maps</a>
                      </li>
                      <li class="g-py-5"><a class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover g-font-size-16" href="#">Campus Safety</a>
                      </li>
                    </ul>
                    <!-- End Footer Links -->
                  </div>
                ...
                <div class="row justify-content-lg-center align-items-center text-center">
                  ...
                  <div class="col-md-4 col-lg-3 order-md-1 g-mb-30">
                    <p class="g-color-gray-dark-v4 mb-0">University of Unify - Since 1978</p>
                  </div>
                </div>
