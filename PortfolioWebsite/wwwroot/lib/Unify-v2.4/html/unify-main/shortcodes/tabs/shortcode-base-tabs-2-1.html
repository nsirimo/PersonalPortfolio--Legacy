...
<head>
  <!-- Title -->
  <title>Tabs v2-1 | Unify - Responsive Website Template</title>
  ...
  <main>
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall" data-options="{direction: 'reverse', settings_mode_oneelement_max_offset: '150'}">
      ...
      <div class="container g-z-index-1 g-py-100">
        <h1 class="g-font-weight-300 g-letter-spacing-1 g-mb-15">Tabs v2-1</h1>
          ...
          <div class="row">
            ...
            <div class="col-md-9">
              <div id="shortcode2">
                <div class="shortcode-html">
                  <!-- Nav tabs -->
                  <ul class="nav justify-content-center u-nav-v2-1 u-nav-rounded-3 g-mb-20" role="tablist" data-target="nav-2-1-default-hor-center" data-tabs-mobile-type="slide-up-down" data-btn-classes="btn btn-md btn-block u-btn-outline-lightgray g-mb-20">
                    <li class="nav-item">
          ...
          <div class="row">
            ...
            <div class="col-md-9">
              <div id="shortcode3">
                <div class="shortcode-html">
                  <!-- Nav tabs -->
                  <ul class="nav justify-content-end u-nav-v2-1 u-nav-dark g-mb-20" role="tablist" data-target="nav-2-1-default-hor-center" data-tabs-mobile-type="slide-up-down" data-btn-classes="btn btn-md btn-block rounded-0 u-btn-outline-darkgray g-mb-20">
                    <li class="nav-item">
          ...
          <div class="row">
            ...
            <div class="col-md-9">
              <div id="shortcode6">
                <div class="shortcode-html">
                  <!-- Nav tabs -->
                  <ul class="nav u-nav-v2-1 u-nav-primary g-mb-20" role="tablist" data-target="nav-2-1-primary-hor-seperate" data-tabs-mobile-type="slide-up-down" data-btn-classes="btn btn-md btn-block rounded-0 u-btn-outline-primary g-mb-20">
                    <li class="nav-item">
              ...
              <div id="shortcode7">
                <div class="shortcode-html">
                  <div class="row">
                    <div class="col-md-4">
                      <!-- Nav tabs -->
                      <ul class="nav flex-column u-nav-v2-1 u-nav-rounded-5" role="tablist" data-target="nav-2-1-primary-ver" data-tabs-mobile-type="slide-up-down" data-btn-classes="btn btn-md btn-block u-btn-outline-lightgray g-mb-20">
                        <li class="nav-item">
          ...
          <div class="row">
            ...
            <div class="col-md-9">
              <div id="shortcode8">
                <div class="shortcode-html">
                  <!-- Nav tabs -->
                  <ul class="nav u-nav-v2-1 g-mb-20" role="tablist" data-target="nav-2-1-default-hor-left-icons" data-tabs-mobile-type="slide-up-down" data-btn-classes="btn btn-md btn-block rounded-0 u-btn-outline-lightgray g-mb-20">
                    <li class="nav-item">
          ...
          <div class="row">
            ...
            <div class="col-md-9">
              <div id="shortcode9">
                <div class="shortcode-html">
                  <!-- Nav tabs -->
                  <ul class="nav text-center nav-justified u-nav-v2-1 g-mb-20" role="tablist" data-target="nav-2-1-default-hor-left-big-icons" data-tabs-mobile-type="slide-up-down" data-btn-classes="btn btn-md btn-block rounded-0 u-btn-outline-lightgray g-mb-20">
                    <li class="nav-item">
          ...
          <div class="row">
            ...
            <div class="col-md-9">
              <div id="shortcode10">
                <div class="shortcode-html">
                  <!-- Nav tabs -->
                  <ul class="nav text-center nav-justified u-nav-v2-1 g-mb-20" role="tablist" data-target="nav-2-1-default-hor-left-big-icons-notext" data-tabs-mobile-type="slide-up-down" data-btn-classes="btn btn-md btn-block rounded-0 u-btn-outline-lightgray g-mb-20">
                    <li class="nav-item">
              ...
              <div id="shortcode11">
                <div class="shortcode-html">
                  <div class="row">
                    <div class="col-md-3">
                      <!-- Nav tabs -->
                      <ul class="nav text-center flex-column u-nav-v2-1" role="tablist" data-target="nav-2-1-default-ver-big-icons" data-tabs-mobile-type="slide-up-down" data-btn-classes="btn btn-md btn-block rounded-0 u-btn-outline-lightgray g-mb-20">
                        <li class="nav-item">
          ...
          <div class="row">
            ...
            <div class="col-md-9">
              <div id="shortcode12">
                <div class="shortcode-html">
                  <!-- Nav tabs -->
                  <ul class="nav u-nav-v2-1 u-nav-primary g-mb-20" role="tablist" data-target="nav-2-1-accordion-primary-hor-left" data-tabs-mobile-type="accordion" data-btn-classes="btn btn-md btn-block rounded-0 u-btn-outline-primary g-mb-20">
                    <li class="nav-item">
          ...
          <div class="row">
            ...
            <div class="col-md-9">
              <div id="shortcode13">
                <div class="shortcode-html">
                  <!-- Nav tabs -->
                  <ul class="nav justify-content-center u-nav-v2-1 u-nav-rounded-3 g-mb-20" role="tablist" data-target="nav-2-1-accordion-default-hor-center" data-tabs-mobile-type="accordion" data-btn-classes="btn btn-md btn-block u-btn-outline-lightgray g-mb-20">
                    <li class="nav-item">
          ...
          <div class="row">
            ...
            <div class="col-md-9">
              <div id="shortcode14">
                <div class="shortcode-html">
                  <!-- Nav tabs -->
                  <ul class="nav justify-content-end u-nav-v2-1 u-nav-dark g-mb-20" role="tablist" data-target="nav-2-1-accordion-dark-hor-right" data-tabs-mobile-type="accordion" data-btn-classes="btn btn-md btn-block rounded-0 u-btn-outline-darkgray g-mb-20">
                    <li class="nav-item">
            ...
            <div class="col-md-9">
              <div id="shortcode15">
                <div class="shortcode-html">
                  <div class="g-bg-gray-dark-v2 g-color-white g-px-15 g-py-30">
                    <!-- Nav tabs -->
                    <ul class="nav nav-fill u-nav-v2-1 u-nav-light g-mb-20" role="tablist" data-target="nav-2-1-accordion-primary-hor-fill" data-tabs-mobile-type="accordion" data-btn-classes="btn btn-md btn-block rounded-0 u-btn-outline-white g-mb-20">
                      <li class="nav-item">
          ...
          <div class="row">
            ...
            <div class="col-md-9">
              <div id="shortcode17">
                <div class="shortcode-html">
                  <!-- Nav tabs -->
                  <ul class="nav u-nav-v2-1 u-nav-primary g-mb-20" role="tablist" data-target="nav-2-1-accordion-primary-hor-seperate" data-tabs-mobile-type="accordion" data-btn-classes="btn btn-md btn-block rounded-0 u-btn-outline-primary g-mb-20">
                    <li class="nav-item">
              ...
              <div id="shortcode18">
                <div class="shortcode-html">
                  <div class="row">
                    <div class="col-md-4">
                      <!-- Nav tabs -->
                      <ul class="nav flex-column u-nav-v2-1 u-nav-rounded-5" role="tablist" data-target="nav-2-1-accordion-primary-ver" data-tabs-mobile-type="accordion" data-btn-classes="btn btn-md btn-block u-btn-outline-lightgray g-mb-20">
                        <li class="nav-item">
          ...
          <div class="row">
            ...
            <div class="col-md-9">
              <div id="shortcode19">
                <div class="shortcode-html">
                  <!-- Nav tabs -->
                  <ul class="nav u-nav-v2-1 g-mb-20" role="tablist" data-target="nav-2-1-accordion-default-hor-left-icons" data-tabs-mobile-type="accordion" data-btn-classes="btn btn-md btn-block rounded-0 u-btn-outline-lightgray g-mb-20">
                    <li class="nav-item">
          ...
          <div class="row">
            ...
            <div class="col-md-9">
              <div id="shortcode20">
                <div class="shortcode-html">
                  <!-- Nav tabs -->
                  <ul class="nav text-center nav-justified u-nav-v2-1 g-mb-20" role="tablist" data-target="nav-2-1-accordion-default-hor-left-big-icons" data-tabs-mobile-type="accordion" data-btn-classes="btn btn-md btn-block rounded-0 u-btn-outline-lightgray g-mb-20">
                    <li class="nav-item">
          ...
          <div class="row">
            ...
            <div class="col-md-9">
              <div id="shortcode21">
                <div class="shortcode-html">
                  <!-- Nav tabs -->
                  <ul class="nav text-center nav-justified u-nav-v2-1 g-mb-20" role="tablist" data-target="nav-2-1-accordion-default-hor-left-big-icons-notext" data-tabs-mobile-type="accordion" data-btn-classes="btn btn-md btn-block rounded-0 u-btn-outline-lightgray g-mb-20">
                    <li class="nav-item">
              ...
              <div id="shortcode22">
                <div class="shortcode-html">
                  <div class="row">
                    <div class="col-md-3">
                      <!-- Nav tabs -->
                      <ul class="nav text-center flex-column u-nav-v2-1" role="tablist" data-target="nav-2-1-accordion-default-ver-big-icons" data-tabs-mobile-type="accordion" data-btn-classes="btn btn-md btn-block rounded-0 u-btn-outline-lightgray g-mb-20">
                        <li class="nav-item">
