...
<head>
  <!-- Title -->
  <title>Tabs v8-1 | Unify - Responsive Website Template</title>
  ...
  <main>
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall" data-options="{direction: 'reverse', settings_mode_oneelement_max_offset: '150'}">
      ...
      <div class="container g-z-index-1 g-py-100">
        <h1 class="g-font-weight-300 g-letter-spacing-1 g-mb-15">Tabs v8-1</h1>
            ...
            <div class="col-md-9">
              <div id="shortcode1">
                <div class="shortcode-html">
                  <!-- Nav tabs -->
                  <ul class="nav u-nav-v8-1" role="tablist" data-target="nav-8-1-default-hor-left" data-tabs-mobile-type="slide-up-down" data-btn-classes="btn btn-md btn-block rounded-0 u-btn-outline-lightgray">
                    <li class="nav-item">
          ...
          <div class="row">
            ...
            <div class="col-md-9">
              <div id="shortcode3">
                <div class="shortcode-html">
                  <!-- Nav tabs -->
                  <ul class="nav text-md-right justify-content-end u-nav-v8-1 u-nav-dark" role="tablist" data-target="nav-8-1-dark-hor-right" data-tabs-mobile-type="slide-up-down" data-btn-classes="btn btn-md btn-block rounded-0 u-btn-outline-darkgray">
                    <li class="nav-item">
              ...
              <div id="shortcode4">
                <div class="shortcode-html">
                  <div class="g-bg-gray-dark-v2 g-color-white g-px-15 g-py-50">
                    <!-- Nav tabs -->
                    <ul class="nav nav-fill u-nav-v8-1 u-nav-light" role="tablist" data-target="nav-8-1-primary-hor-fill" data-tabs-mobile-type="slide-up-down" data-btn-classes="btn btn-md btn-block rounded-0 u-btn-outline-white">
                      <li class="nav-item">
          ...
          <div class="row">
            ...
            <div class="col-md-9">
              <div id="shortcode6">
                <div class="shortcode-html">
                  <!-- Nav tabs -->
                  <ul class="nav text-center nav-justified u-nav-v8-1" role="tablist" data-target="nav-8-1-default-hor-nav-justified-big-icons-notext" data-tabs-mobile-type="slide-up-down" data-btn-classes="btn btn-md btn-block rounded-0 u-btn-outline-lightgray">
                    <li class="nav-item">
              ...
              <div id="shortcode7">
                <div class="shortcode-html">
                  <div class="row">
                    <div class="col-md-3">
                      <!-- Nav tabs -->
                      <ul class="nav text-center flex-column u-nav-v8-1" role="tablist" data-target="nav-8-1-default-ver-big-icons" data-tabs-mobile-type="slide-up-down" data-btn-classes="btn btn-md btn-block rounded-0 u-btn-outline-lightgray">
                        <li class="nav-item">
              ...
              <div id="shortcode8">
                <div class="shortcode-html">
                  <div class="row">
                    <div class="col-md-3">
                      <!-- Nav tabs -->
                      <ul class="nav text-center flex-column u-nav-v8-1" role="tablist" data-target="nav-8-1-default-ver-big-icons-notext" data-tabs-mobile-type="slide-up-down" data-btn-classes="btn btn-md btn-block rounded-0 u-btn-outline-lightgray">
                        <li class="nav-item">
          ...
          <div class="row">
            ...
            <div class="col-md-9">
              <div id="shortcode9">
                <div class="shortcode-html">
                  <!-- Nav tabs -->
                  <ul class="nav u-nav-v8-1" role="tablist" data-target="nav-8-1-accordion-hor-left" data-tabs-mobile-type="accordion" data-btn-classes="btn btn-md btn-block rounded-0 u-btn-outline-lightgray g-mb-20">
                    <li class="nav-item">
          ...
          <div class="row">
            ...
            <div class="col-md-9">
              <div id="shortcode10">
                <div class="shortcode-html">
                  <!-- Nav tabs -->
                  <ul class="nav text-center justify-content-center u-nav-v8-1" role="tablist" data-target="nav-8-1-accordion-primary-hor-center" data-tabs-mobile-type="accordion" data-btn-classes="btn btn-md btn-block u-btn-outline-primary g-mb-20">
                    <li class="nav-item">
          ...
          <div class="row">
            ...
            <div class="col-md-9">
              <div id="shortcode11">
                <div class="shortcode-html">
                  <!-- Nav tabs -->
                  <ul class="nav text-md-right justify-content-end u-nav-v8-1 u-nav-dark" role="tablist" data-target="nav-8-1-accordion-dark-hor-right" data-tabs-mobile-type="accordion" data-btn-classes="btn btn-md btn-block rounded-0 u-btn-outline-darkgray g-mb-20">
                    <li class="nav-item">
            ...
            <div class="col-md-9">
              <div id="shortcode12">
                <div class="shortcode-html">
                  <div class="g-bg-gray-dark-v2 g-color-white g-px-15 g-py-50">
                    <!-- Nav tabs -->
                    <ul class="nav nav-fill u-nav-v8-1 u-nav-light" role="tablist" data-target="nav-8-1-accordion-primary-hor-fill" data-tabs-mobile-type="accordion" data-btn-classes="btn btn-md btn-block rounded-0 u-btn-outline-white g-mb-20">
                      <li class="nav-item">
              ...
              <div id="shortcode13">
                <div class="shortcode-html">
                  <div class="row">
                    <div class="col-md-4">
                      <!-- Nav tabs -->
                      <ul class="nav flex-column u-nav-v8-1" role="tablist" data-target="nav-8-1-accordion-primary-ver" data-tabs-mobile-type="accordion" data-btn-classes="btn btn-md btn-block rounded-0 u-btn-outline-primary g-mb-20">
                        <li class="nav-item">
          ...
          <div class="row">
            ...
            <div class="col-md-9">
              <div id="shortcode14">
                <div class="shortcode-html">
                  <!-- Nav tabs -->
                  <ul class="nav text-center nav-justified u-nav-v8-1" role="tablist" data-target="nav-8-1-accordion-hor-nav-justified-big-icons-notext" data-tabs-mobile-type="accordion" data-btn-classes="btn btn-md btn-block rounded-0 u-btn-outline-lightgray g-mb-20">
                    <li class="nav-item">
              ...
              <div id="shortcode15">
                <div class="shortcode-html">
                  <div class="row">
                    <div class="col-md-3">
                      <!-- Nav tabs -->
                      <ul class="nav text-center flex-column u-nav-v8-1" role="tablist" data-target="nav-8-1-accordion-ver-big-icons" data-tabs-mobile-type="accordion" data-btn-classes="btn btn-md btn-block rounded-0 u-btn-outline-lightgray g-mb-20">
                        <li class="nav-item">
              ...
              <div id="shortcode16">
                <div class="shortcode-html">
                  <div class="row">
                    <div class="col-md-3">
                      <!-- Nav tabs -->
                      <ul class="nav text-center flex-column u-nav-v8-1" role="tablist" data-target="nav-8-1-accordion-ver-big-icons-notext" data-tabs-mobile-type="accordion" data-btn-classes="btn btn-md btn-block rounded-0 u-btn-outline-lightgray g-mb-20">
                        <li class="nav-item">
