...
<head>
  <!-- Title -->
  <title>Breadcrumbs | Unify - Responsive Website Template</title>
  ...
  <main>
      ...
      <div class="u-header__sections-container">
        <div class="u-sidebar-navigation-inner">
          ...
          <ul class="js-shortcode-filter-result nav flex-column u-sidebar-navigation-list">
            ...
            <li class="js-shortcode-filter__item nav-item bases">
              <a href="../../unify-main/shortcodes/shortcode-base-breadcrumbs.html" class="nav-link active">Breadcrumbs</a>
            </li>
            <li class="js-shortcode-filter__item nav-item bases">
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall" data-options="{direction: 'reverse', settings_mode_oneelement_max_offset: '150'}">
      ...
      <div class="container g-z-index-1 g-py-100">
        <h1 class="g-font-weight-300 g-letter-spacing-1 g-mb-15">Breadcrumbs</h1>
    ...
    <section>
      ...
      <section class="g-py-100">
        ...
        <!-- End Dark Breadcrumbs -->

        <!-- Primary Breadcrumbs -->
        <div class="g-mb-20">
          <div id="shortcode4">
            <div class="shortcode-html">
              <section class="g-bg-primary g-color-white g-py-50">
                <div class="container">
                  <div class="d-sm-flex text-center">
                    <div class="align-self-center">
                      <h2 class="h3 g-font-weight-300 w-100 g-mb-10 g-mb-0--md">Breadcrumbs</h2>
                    ...
                    <div class="align-self-center ml-auto">
                      <ul class="u-list-inline">
                        ...
                        <li class="list-inline-item g-mr-5">
                          <a class="u-link-v5 g-color-white g-color-black--hover" href="#!">Pages</a>
                          <i class="g-color-white g-ml-5">/</i>
                        </li>
        ...
        <!-- End Primary Breadcrumbs -->

        <!-- Light Pattern Breadcrumbs -->
        <div class="g-mb-20">
          <div id="shortcode5">
            <div class="shortcode-html">
        ...
        <!-- End Light Pattern Breadcrumbs -->

        <!-- Dark Pattern Breadcrumbs -->
        <div class="g-mb-20">
          <div id="shortcode6">
            <div class="shortcode-html">
              <section class="g-color-white g-bg-gray-dark-v1 g-py-50" style="background-image: url(../../assets/img/bg/pattern3.png);">
                <div class="container">
                  <div class="d-sm-flex text-center">
                    <div class="align-self-center">
                      <h2 class="h3 g-font-weight-300 w-100 g-mb-10 g-mb-0--md">Breadcrumbs</h2>
      ...
      <section class="g-py-100">
              ...
              <section class="g-bg-primary g-color-white g-py-50 g-mb-20">
                <div class="container g-bg-cover__inner">
                  <header class="g-mb-20">
                    <h3 class="h5 g-font-weight-300 g-mb-5">Breadcrumbs</h3>
                    <h2 class="h1 g-font-weight-300 text-uppercase">Maecenas
                      <span class="g-color-black">enim</span>
                      sapien
                    </h2>
                  </header>
        ...
        <div class="g-mb-20">
          <div id="shortcode11">
            <div class="shortcode-html">
              <section class="g-bg-size-cover g-bg-pos-center g-bg-cover g-bg-black-opacity-0_5--after g-color-white g-py-50 g-mb-20" style="background-image: url(../../assets/img-temp/1920x800/img4.jpg);">
                <div class="container g-bg-cover__inner">
                  <header class="g-mb-20">
                    <h3 class="h5 g-font-weight-300 g-mb-5">Breadcrumbs</h3>
                    <h2 class="h1 g-font-weight-300 text-uppercase">Maecenas
