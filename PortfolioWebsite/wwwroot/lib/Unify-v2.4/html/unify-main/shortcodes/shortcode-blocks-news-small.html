...
<head>
  <!-- Title -->
  <title>News Small | Unify - Responsive Website Template</title>
  ...
  <main>
            ...
            <li class="js-shortcode-filter__item nav-item dropdown blocks">
              ...
              <div class="dropdown-menu u-dropdown-static">
                <ul class="nav flex-column">
                  ...
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../unify-main/shortcodes/shortcode-blocks-news-small.html" class="nav-link active">News Small</a>
                  </li>
                </ul>
              </div>
            </li>
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall g-overflow-hidden" data-options="{direction: 'reverse', settings_mode_oneelement_max_offset: '150'}">
      ...
      <div class="container g-z-index-1 g-py-100">
        <h1 class="g-font-weight-300 g-letter-spacing-1 g-mb-15">News Small</h1>
            ...
            <div class="shortcode-html">
              <div class="row">
                <div class="col-lg-4">
                  ...
                  <article class="media g-mb-20">
                    <a class="d-flex mr-3" href="#!">
                      <img class="g-width-40 g-height-40 rounded-circle" src="../../assets/img-temp/100x100/img2.jpg" alt="Image Description">
                    </a>
                ...
                <div class="col-lg-4">
                  ...
                  <article class="media g-mb-20">
                    <a class="d-flex mr-3" href="#!">
                      <img class="g-width-40 g-height-40 rounded-circle" src="../../assets/img-temp/100x100/img3.jpg" alt="Image Description">
                    </a>
            ...
            <div class="shortcode-html">
              <div class="row">
                <div class="col-md-6 col-lg-4 g-mb-20">
                  ...
                  <article class="media g-mb-20">
                    <a class="d-flex mr-3" href="#!">
                      <img class="g-width-64 g-height-64" src="../../assets/img-temp/100x100/img8.jpg" alt="Image Description">
                    </a>
                  ...
                  <article class="media g-mb-20">
                    <a class="d-flex mr-3" href="#!">
                      <img class="g-width-64 g-height-64" src="../../assets/img-temp/100x100/img9.jpg" alt="Image Description">
                    </a>
                ...
                <div class="col-md-6 col-lg-4 g-mb-20">
                  ...
                  <article class="media g-mb-20">
                    <a class="d-flex mr-3" href="#!">
                      <img class="g-width-64 g-height-64" src="../../assets/img-temp/100x100/img10.jpg" alt="Image Description">
                    </a>
                  ...
                  <article class="media g-mb-20">
                    <a class="d-flex mr-3" href="#!">
                      <img class="g-width-64 g-height-64" src="../../assets/img-temp/100x100/img11.jpg" alt="Image Description">
                    </a>
                ...
                <div class="col-md-6 col-lg-4 g-mb-20">
                  ...
                  <article class="media g-mb-20">
                    <a class="d-flex mr-3" href="#!">
                      <img class="g-width-64 g-height-64" src="../../assets/img-temp/100x100/img12.jpg" alt="Image Description">
                    </a>
                  ...
                  <article class="media g-mb-20">
                    <a class="d-flex mr-3" href="#!">
                      <img class="g-width-64 g-height-64" src="../../assets/img-temp/100x100/img13.jpg" alt="Image Description">
                    </a>
            ...
            <div class="shortcode-html">
              <div class="row">
                <div class="col-md-6 col-lg-4 g-mb-20">
                  ...
                  <article class="media g-mb-20">
                    <a class="d-flex mr-3" href="#!">
                      <img class="rounded-circle g-width-64 g-height-64" src="../../assets/img-temp/100x100/img1.jpg" alt="Image Description">
                    </a>
                  ...
                  <article class="media g-mb-20">
                    <a class="d-flex mr-3" href="#!">
                      <img class="rounded-circle g-width-64 g-height-64" src="../../assets/img-temp/100x100/img8.jpg" alt="Image Description">
                    </a>
                ...
                <div class="col-md-6 col-lg-4 g-mb-20">
                  ...
                  <article class="media g-mb-20">
                    <a class="d-flex mr-3" href="#!">
                      <img class="rounded-circle g-width-64 g-height-64" src="../../assets/img-temp/100x100/img4.jpg" alt="Image Description">
                    </a>
                  ...
                  <article class="media g-mb-20">
                    <a class="d-flex mr-3" href="#!">
                      <img class="rounded-circle g-width-64 g-height-64" src="../../assets/img-temp/100x100/img13.jpg" alt="Image Description">
                    </a>
                ...
                <div class="col-md-6 col-lg-4 g-mb-20">
                  ...
                  <article class="media g-mb-20">
                    <a class="d-flex mr-3" href="#!">
                      <img class="rounded-circle g-width-64 g-height-64" src="../../assets/img-temp/100x100/img10.jpg" alt="Image Description">
                    </a>
                  ...
                  <article class="media g-mb-20">
                    <a class="d-flex mr-3" href="#!">
                      <img class="rounded-circle g-width-64 g-height-64" src="../../assets/img-temp/100x100/img11.jpg" alt="Image Description">
                    </a>
            ...
            <div class="shortcode-html">
              <div class="row">
                <div class="col-md-6 col-lg-4 g-mb-20">
                  ...
                  <article class="media g-mb-20">
                    <a class="d-flex mr-3" href="#!">
                      <img class="g-width-120 g-height-70" src="../../assets/img-temp/140x80/img1.jpg" alt="Image Description">
                    </a>
                  ...
                  <article class="media g-mb-20">
                    <a class="d-flex mr-3" href="#!">
                      <img class="g-width-120 g-height-70" src="../../assets/img-temp/140x80/img2.jpg" alt="Image Description">
                    </a>
                ...
                <div class="col-md-6 col-lg-4 g-mb-20">
                  ...
                  <article class="media g-mb-20">
                    <a class="d-flex mr-3" href="#!">
                      <img class="g-width-120 g-height-70" src="../../assets/img-temp/140x80/img3.jpg" alt="Image Description">
                    </a>
                  ...
                  <article class="media g-mb-20">
                    <a class="d-flex mr-3" href="#!">
                      <img class="g-width-120 g-height-70" src="../../assets/img-temp/140x80/img4.jpg" alt="Image Description">
                    </a>
                ...
                <div class="col-md-6 col-lg-4 g-mb-20">
                  ...
                  <article class="media g-mb-20">
                    <a class="d-flex mr-3" href="#!">
                      <img class="g-width-120 g-height-70" src="../../assets/img-temp/140x80/img5.jpg" alt="Image Description">
                    </a>
                  ...
                  <article class="media g-mb-20">
                    <a class="d-flex mr-3" href="#!">
                      <img class="g-width-120 g-height-70" src="../../assets/img-temp/140x80/img6.jpg" alt="Image Description">
                    </a>
            ...
            <div class="shortcode-html">
              <div class="row">
                <div class="col-md-6 col-lg-4 g-mb-20">
                  ...
                  <article class="media g-mb-20">
                    <figure class="d-flex mr-3 g-pos-rel">
                      <img class="g-width-140 g-height-80" src="../../assets/img-temp/140x80/img1.jpg" alt="Image Description">
                  ...
                  <article class="media g-mb-20">
                    <figure class="d-flex mr-3 g-pos-rel">
                      <img class="g-width-140 g-height-80" src="../../assets/img-temp/140x80/img2.jpg" alt="Image Description">
                ...
                <div class="col-md-6 col-lg-4 g-mb-20">
                  ...
                  <article class="media g-mb-20">
                    <figure class="d-flex mr-3 g-pos-rel">
                      <img class="g-width-140 g-height-80" src="../../assets/img-temp/140x80/img3.jpg" alt="Image Description">
                  ...
                  <article class="media g-mb-20">
                    <figure class="d-flex mr-3 g-pos-rel">
                      <img class="g-width-140 g-height-80" src="../../assets/img-temp/140x80/img4.jpg" alt="Image Description">
                ...
                <div class="col-md-6 col-lg-4 g-mb-20">
                  ...
                  <article class="media g-mb-20">
                    <figure class="d-flex mr-3 g-pos-rel">
                      <img class="g-width-140 g-height-80" src="../../assets/img-temp/140x80/img5.jpg" alt="Image Description">
                  ...
                  <article class="media g-mb-20">
                    <figure class="d-flex mr-3 g-pos-rel">
                      <img class="g-width-140 g-height-80" src="../../assets/img-temp/140x80/img6.jpg" alt="Image Description">
            ...
            <div class="shortcode-html">
              ...
              <div class="row g-mb-30">
                ...
                <div class="col-sm-6 col-lg-3 g-mb-30">
                  <!-- Fancybox Video -->
                  <div class="u-shadow-v36 g-brd-around g-brd-4 g-brd-white g-brd-primary--hover rounded g-pos-rel g-transition-0_2">
                    <img class="img-fluid" src="../../assets/img-temp/600x350/img6.jpg" alt="Image Description">
                    <a class="js-fancybox g-absolute-centered" href="javascript:;" data-src="//www.youtube.com/watch?v=FxiskmF16gU" data-speed="350" data-caption="Video">
                      <span class="u-icon-v3 u-icon-size--lg g-color-white g-color-primary--hover g-bg-transparent g-font-size-30 g-rounded-50x g-cursor-pointer">
                        <i class="g-pos-rel g-left-2 fa fa-play"></i>
                      </span>
                ...
                <div class="col-sm-6 col-lg-3 g-mb-30">
                  <!-- Fancybox Video -->
                  <div class="u-shadow-v36 g-brd-around g-brd-4 g-brd-white g-brd-primary--hover rounded g-pos-rel g-transition-0_2">
                    <img class="img-fluid" src="../../assets/img-temp/600x350/img7.jpg" alt="Image Description">
                    <a class="js-fancybox g-absolute-centered" href="javascript:;" data-src="//www.youtube.com/watch?v=FxiskmF16gU" data-speed="350" data-caption="Video">
                      <span class="u-icon-v3 u-icon-size--lg g-color-white g-color-primary--hover g-bg-transparent g-font-size-30 g-rounded-50x g-cursor-pointer">
                        <i class="g-pos-rel g-left-2 fa fa-play"></i>
                      </span>
