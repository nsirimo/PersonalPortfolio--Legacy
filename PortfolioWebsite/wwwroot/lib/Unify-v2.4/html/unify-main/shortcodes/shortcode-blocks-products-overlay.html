...
<head>
  <!-- Title -->
  <title>Product Blocks - Overlay | Unify - Responsive Website Template</title>
  ...
  <main>
            ...
            <li class="js-shortcode-filter__item nav-item dropdown blocks">
              ...
              <div class="dropdown-menu u-dropdown-static">
                <ul class="nav flex-column">
                  ...
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../unify-main/shortcodes/shortcode-blocks-products-overlay.html" class="nav-link active">Products Overlay</a>
                  </li>
                </ul>
              </div>
            </li>
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall g-overflow-hidden" data-options="{direction: 'reverse', settings_mode_oneelement_max_offset: '150'}">
      ...
      <div class="container g-z-index-1 g-py-100">
        <h1 class="g-font-weight-300 g-letter-spacing-1 g-mb-15">Product Blocks - Overlay</h1>
              ...
              <div class="row">
                <div class="col-md-6 col-lg-4 g-mb-30">
                  ...
                  <article class="u-block-hover g-bg-cover g-color-white g-bg-black-opacity-0_3--after text-center rounded">
                    <!-- Article Image -->
                    <img class="w-100 u-block-hover__main--zoom-v1" src="../../assets/img-temp/500x650/img10.jpg" alt="Image Description">
                    <!-- End Article Image -->
                ...
                <div class="col-lg-4 g-mb-30">
                  <div class="row">
                    ...
                    <div class="col-md-6 col-lg-12">
                      ...
                      <article class="u-block-hover g-bg-cover g-color-white g-bg-black-opacity-0_3--after text-center rounded">
                        <!-- Article Image -->
                        <img class="w-100 u-block-hover__main--zoom-v1" src="../../assets/img-temp/400x270/img2.jpg" alt="Image Description">
                        <!-- End Article Image -->
            ...
            <div class="shortcode-html">
              <div class="row">
                <div class="col-md-6 g-mb-30">
                  <!-- Article -->
                  <article class="g-bg-size-cover g-pos-rel" data-bg-img-src="../../assets/img-temp/700x350/img1.jpg">
                    <!-- Article Content -->
                ...
                <div class="col-md-6 g-mb-30">
                  <!-- Article -->
                  <article class="g-bg-size-cover g-pos-rel" data-bg-img-src="../../assets/img-temp/700x350/img2.jpg">
                    <!-- Article Content -->
                    <div class="ml-auto g-width-50x--sm g-bg-black-opacity-0_7 g-pa-30">
                      <div class="g-mb-45">
              ...
              <div class="row">
                <div class="col-lg-6 g-mb-30">
                  ...
                  <article class="u-block-hover">
                    <!-- Article Image -->
                    <div class="rounded">
                      <img class="w-100 u-block-hover__main--zoom-v1" src="../../assets/img-temp/500x383/img1.jpg" alt="Image Description">
                    </div>
                    <!-- End Article Image -->
                  ...
                  <div class="row">
                    <div class="col-sm-6 col-lg-12 g-mb-30">
                      ...
                      <article class="u-block-hover g-color-white text-center">
                        ...
                        <div class="g-bg-cover g-bg-black-opacity-0_3--after rounded">
                          <img class="w-100 u-block-hover__main--zoom-v1" src="../../assets/img-temp/600x450/img6.jpg" alt="Image Description">
                        </div>
                        <!-- End Article Image -->
                    ...
                    <div class="col-sm-6 col-lg-12 g-mb-30">
                      ...
                      <article class="u-block-hover g-color-white text-center">
                        <!-- Article Image -->
                        <div class="g-bg-cover g-bg-black-opacity-0_3--after rounded">
                          <img class="w-100 u-block-hover__main--zoom-v1" src="../../assets/img-temp/600x450/img3.jpg" alt="Image Description">
                        </div>
                        <!-- End Article Image -->
                  ...
                  <div class="row">
                    <div class="col-sm-6 col-lg-12 g-mb-30">
                      ...
                      <article class="u-block-hover g-color-white text-center">
                        <!-- Article Image -->
                        <div class="g-bg-cover g-bg-black-opacity-0_3--after rounded">
                          <img class="w-100 u-block-hover__main--zoom-v1" src="../../assets/img-temp/600x450/img2.jpg" alt="Image Description">
                        </div>
                        <!-- End Article Image -->
                    ...
                    <div class="col-sm-6 col-lg-12 g-mb-30">
                      ...
                      <article class="u-block-hover g-color-white text-center">
                        <!-- Article Image -->
                        <div class="g-bg-cover g-bg-black-opacity-0_3--after rounded">
                          <img class="w-100 u-block-hover__main--zoom-v1" src="../../assets/img-temp/600x450/img5.jpg" alt="Image Description">
                        </div>
                        <!-- End Article Image -->
