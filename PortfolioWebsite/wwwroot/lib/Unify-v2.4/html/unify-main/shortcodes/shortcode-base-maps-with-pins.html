            ...
            <li class="js-shortcode-filter__item nav-item dropdown bases">
              ...
              <div class="dropdown-menu u-dropdown-static">
                <ul class="nav flex-column">
                  ...
                  <li class="js-shortcode-filter__item nav-item bases">
                    <a href="../../unify-main/shortcodes/shortcode-base-maps-with-pins.html" class="nav-link active">Maps With Pins</a>
                  </li>
                </ul>
              </div>
            </li>
            ...
            <div class="col-md-12">
              <div id="shortcode1">
                <div class="shortcode-html">
                  <img class="js-pin-map img-fluid" src="../../assets/img/maps/map.png" easypin-id="map-pin">
