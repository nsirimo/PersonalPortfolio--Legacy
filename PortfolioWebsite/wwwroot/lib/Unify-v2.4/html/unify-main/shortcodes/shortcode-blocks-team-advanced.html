...
<head>
  <!-- Title -->
  <title>Team Advanced | Unify - Responsive Website Template</title>
  ...
  <main>
      ...
      <div class="u-header__sections-container">
        <div class="u-sidebar-navigation-inner">
          ...
          <ul class="js-shortcode-filter-result nav flex-column u-sidebar-navigation-list">
            ...
            <li class="js-shortcode-filter__item nav-item dropdown blocks">
              <a class="nav-link dropdown-toggle active" href="#!" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Team Blocks</a>
              <div class="dropdown-menu u-dropdown-static">
                <ul class="nav flex-column">
                  <li class="js-shortcode-filter__item nav-item blocks">
                  ...
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../unify-main/shortcodes/shortcode-blocks-team-advanced.html" class="nav-link active">Team Advanced</a>
                  </li>
                </ul>
              </div>
            </li>
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall g-overflow-hidden" data-options="{direction: 'reverse', settings_mode_oneelement_max_offset: '150'}">
      ...
      <div class="container g-z-index-1 g-py-100">
        <h1 class="g-font-weight-300 g-letter-spacing-1 g-mb-15">Team Advanced</h1>
    ...
    <section>
      ...
      <section class="container g-py-100">
        <div class="text-center g-mb-50">
          <h2 class="h4">Advanced Team Blocks
            ...
            <figure class="row flex-md-row align-items-center">
              ...
              <div class="col-md-6 px-0">
                <div class="u-ns-bg-v1-bottom u-ns-bg-v1-right--md g-bg-white g-py-30 g-px-50">
                  ...
                  <div class="g-mb-25">
                    <div class="g-mb-20">
                      <h4 class="h5 g-color-black g-mb-5">Daniel Wearne</h4>
                      <em class="d-block g-font-style-normal g-font-size-11 text-uppercase g-color-primary">Co-Founder / CEO</em>
                    </div>
                    <p>I am an ambitious workaholic, but apart from that, pretty simple person. Understanding who you are and what you want is my strategy for your brand. I am always figuring out ways to capture your vision, so people can get on board.</p>
                  </div>
                  <!-- End Figure Info -->
              ...
              <!-- Figure Image -->
              <div class="col-md-6 px-0">
                <img class="w-100" src="../../assets/img-temp/500x450/img7.jpg" alt="Image Description">
              </div>
              <!-- End Figure Image -->
            </figure>
            <!-- End Figure -->
            ...
            <figure class="row flex-md-row align-items-center">
              ...
              <div class="col-md-6 order-md-2 px-0">
                <div class="u-ns-bg-v1-bottom u-ns-bg-v1-left--md g-bg-white g-py-30 g-px-50">
                  ...
                  <div class="g-mb-25">
                    <div class="g-mb-20">
                      <h4 class="h5 g-color-black g-mb-5">Kate Metu</h4>
                      <em class="d-block g-font-style-normal g-font-size-11 text-uppercase g-color-primary">Co-Founder / UX Designer</em>
                    </div>
                    <p>I am an ambitious workaholic, but apart from that, pretty simple person. Understanding who you are and what you want is my strategy for your brand. I am always figuring out ways to capture your vision, so people can get on board.</p>
                  </div>
                  <!-- End Figure Info -->
          ...
          <div id="shortcode2">
            <div class="shortcode-html">
              ...
              <div class="cube-portfolio">
                ...
                <ul id="filter-container" class="text-center u-filter-v1 g-mb-40">
                  <li class="list-inline-item cbp-filter-item cbp-filter-item-active g-cursor-pointer g-transition-0_2" data-filter="*">All</li>
                  <li class="list-inline-item cbp-filter-item g-cursor-pointer g-transition-0_2" data-filter=".js-marketing">Marketing</li>
                  <li class="list-inline-item cbp-filter-item g-cursor-pointer g-transition-0_2" data-filter=".js-designer">Designer</li>
                  <li class="list-inline-item cbp-filter-item g-cursor-pointer g-transition-0_2" data-filter=".js-developer">Developer</li>
                  <li class="list-inline-item cbp-filter-item g-cursor-pointer g-transition-0_2" data-filter=".js-support">Support</li>
                </ul>
                <!-- End Cubeportfolio Filter -->

                <!-- Cubeportfolio container -->
                <div id="grid-container" class="cbp" data-controls="#filter-container" data-layout="grid" data-animation="slideLeft" data-caption-animation="fadeIn" data-x-gap="0" data-y-gap="0">
                  <div class="cbp-item js-marketing js-designer">
                    <!-- Figure -->
                    <figure class="u-info-v1-4 g-overflow-hidden mb-0">
                      <!-- Figure Image -->
                      <img class="w-100 u-info-v1-4__item-regular g-transition-0_2" src="../../assets/img-temp/400x450/img1.jpg" alt="Image Description">
                      <!-- End Figure Image-->

                      <a class="cbp-caption cbp-singlePageInline u-link-v2" href="../ajax/team/team_member_1.html"></a>

                      <!-- Figure Caption -->
                      <figcaption class="u-info-v1-4__item-hidden g-transition-0_2 g-bg-black g-color-white g-px-30 g-py-10">
                        <em class="d-block g-font-style-normal g-font-size-11 text-uppercase g-color-primary">Developer</em>
                        <h4 class="h5 g-font-weight-500 mb-0">Perry Flavius</h4>
                      </figcaption>
                      <!-- End Figure Caption-->
                    </figure>
                    <!-- End Figure -->
                  ...
                  <div class="cbp-item js-designer js-support">
                    <!-- Figure -->
                    <figure class="u-info-v1-4 g-overflow-hidden mb-0">
                      <!-- Figure Image -->
                      <img class="w-100 u-info-v1-4__item-regular g-transition-0_2" src="../../assets/img-temp/400x450/img2.jpg" alt="Image Description">
                      <!-- End Figure Image-->

                      <a class="cbp-caption cbp-singlePageInline u-link-v2" href="../ajax/team/team_member_2.html"></a>

                      <!-- Figure Caption -->
                      <figcaption class="u-info-v1-4__item-hidden g-transition-0_2 g-bg-black g-color-white g-px-30 g-py-10">
                        <em class="d-block g-font-style-normal g-font-size-11 text-uppercase g-color-primary">Designer</em>
                        <h4 class="h5 g-font-weight-500 mb-0">Kate Metu</h4>
                      </figcaption>
                      <!-- End Figure Caption-->
                    </figure>
                    <!-- End Figure -->
                  ...
                  <div class="cbp-item js-marketing js-designer">
                    ...
                    <figure class="u-info-v1-4 g-overflow-hidden mb-0">
                      <!-- Figure Image -->
                      <img class="w-100 u-info-v1-4__item-regular g-transition-0_2" src="../../assets/img-temp/400x450/img3.jpg" alt="Image Description">
                      <!-- End Figure Image-->

                      <a class="cbp-caption cbp-singlePageInline u-link-v2" href="../ajax/team/team_member_3.html"></a>

                      <!-- Figure Caption -->
                      <figcaption class="u-info-v1-4__item-hidden g-transition-0_2 g-bg-black g-color-white g-px-30 g-py-10">
                        <em class="d-block g-font-style-normal g-font-size-11 text-uppercase g-color-primary">Illustration</em>
                        <h4 class="h5 g-font-weight-500 mb-0">Daniel Wearne</h4>
                      </figcaption>
                      <!-- End Figure Caption-->
                    </figure>
                    <!-- End Figure -->
                  ...
                  <div class="cbp-item js-designer js-marketing">
                    <!-- Figure -->
                    <figure class="u-info-v1-4 g-overflow-hidden mb-0">
                      <!-- Figure Image -->
                      <img class="w-100 u-info-v1-4__item-regular g-transition-0_2" src="../../assets/img-temp/400x450/img4.jpg" alt="Image Description">
                      <!-- End Figure Image-->

                      <a class="cbp-caption cbp-singlePageInline u-link-v2" href="../ajax/team/team_member_4.html"></a>

                      <!-- Figure Caption -->
                      <figcaption class="u-info-v1-4__item-hidden g-transition-0_2 g-bg-black g-color-white g-px-30 g-py-10">
                        <em class="d-block g-font-style-normal g-font-size-11 text-uppercase g-color-primary">Financial Manager</em>
                        <h4 class="h5 g-font-weight-500 mb-0">Tina Krueger</h4>
                      </figcaption>
                      <!-- End Figure Caption-->
                    </figure>
                    <!-- End Figure -->
                  ...
                  <div class="cbp-item js-designer js-developer">
                    <!-- Figure -->
                    <figure class="u-info-v1-4 g-overflow-hidden mb-0">
                      <!-- Figure Image -->
                      <img class="w-100 u-info-v1-4__item-regular g-transition-0_2" src="../../assets/img-temp/400x450/img5.jpg" alt="Image Description">
                      <!-- End Figure Image-->

                      <a class="cbp-caption cbp-singlePageInline u-link-v2" href="../ajax/team/team_member_5.html"></a>

                      <!-- Figure Caption -->
                      <figcaption class="u-info-v1-4__item-hidden g-transition-0_2 g-bg-black g-color-white g-px-30 g-py-10">
                        <em class="d-block g-font-style-normal g-font-size-11 text-uppercase g-color-primary">Illustration</em>
                        <h4 class="h5 g-font-weight-500 mb-0">David Case</h4>
                      </figcaption>
                      <!-- End Figure Caption-->
                    </figure>
                    <!-- End Figure -->
                  ...
                  <div class="cbp-item js-marketing js-designer js-developer">
                    <!-- Figure -->
                    <figure class="u-info-v1-4 g-overflow-hidden mb-0">
                      <!-- Figure Image -->
                      <img class="w-100 u-info-v1-4__item-regular g-transition-0_2" src="../../assets/img-temp/400x450/img6.jpg" alt="Image Description">
                      <!-- End Figure Image-->

                      <a class="cbp-caption cbp-singlePageInline u-link-v2" href="../ajax/team/team_member_6.html"></a>

                      <!-- Figure Caption -->
                      <figcaption class="u-info-v1-4__item-hidden g-transition-0_2 g-bg-black g-color-white g-px-30 g-py-10">
                        <em class="d-block g-font-style-normal g-font-size-11 text-uppercase g-color-primary">Sales manager</em>
                        <h4 class="h5 g-font-weight-500 mb-0">Sara Lisbon</h4>
                      </figcaption>
                      <!-- End Figure Caption-->
                    </figure>
                    <!-- End Figure -->
          ...
          <div id="shortcode3">
            <div class="shortcode-html">
              ...
              <div class="g-mx-minus-9--sm">
                <div class="js-carousel_4-items g-pb-90" data-slides-show="4" data-slides-scroll="4" data-arrows-classes="u-arrow-v1 g-pos-abs g-bottom-0 g-width-45 g-height-45 g-font-size-default g-color-gray-dark-v5 g-bg-gray-light-v5 g-color-white--hover g-bg-primary--hover"
                data-arrow-left-classes="fa fa-angle-left g-left-35x--lg g-left-15" data-arrow-right-classes="fa fa-angle-right g-right-35x--lg g-right-15" data-pagi-classes="u-carousel-indicators-v1 g-absolute-centered--x g-bottom-20 text-center" data-responsive='[{
                  ...
                  <div class="js-slide">
                    <!-- Figure -->
                    <figure class="text-center g-px-15">
                      <!-- Figure Image -->
                      <img class="w-100 g-mb-20" src="../../assets/img-temp/400x450/img1.jpg" alt="Image Description">
                      <!-- End Figure Image -->

                      <!-- Figure Info -->
                      <div class="g-mb-15">
                        <h4 class="h5 g-color-black g-mb-5">Marina Olsson</h4>
                        <em class="d-block g-font-style-normal g-font-size-11 text-uppercase g-color-primary">Support</em>
                      </div>
                      <!-- End Figure Info -->
                  ...
                  <div class="js-slide">
                    ...
                    <figure class="text-center g-px-15">
                      <!-- Figure Image -->
                      <img class="w-100 g-mb-20" src="../../assets/img-temp/400x450/img2.jpg" alt="Image Description">
                      <!-- End Figure Image -->

                      <!-- Figure Info -->
                      <div class="g-mb-15">
                        <h4 class="h5 g-color-black g-mb-5">Katie Gonzalez</h4>
                        <em class="d-block g-font-style-normal g-font-size-11 text-uppercase g-color-primary">Support</em>
                      </div>
                      <!-- End Figure Info -->
                  ...
                  <div class="js-slide">
                    ...
                    <figure class="text-center g-px-15">
                      <!-- Figure Image -->
                      <img class="w-100 g-mb-20" src="../../assets/img-temp/400x450/img3.jpg" alt="Image Description">
                      <!-- End Figure Image -->

                      <!-- Figure Info -->
                      <div class="g-mb-15">
                        <h4 class="h5 g-color-black g-mb-5">John Brown</h4>
                        <em class="d-block g-font-style-normal g-font-size-11 text-uppercase g-color-primary">Financial Manager</em>
                      </div>
                      <!-- End Figure Info -->
                  ...
                  <div class="js-slide">
                    ...
                    <figure class="text-center g-px-15">
                      <!-- Figure Image -->
                      <img class="w-100 g-mb-20" src="../../assets/img-temp/400x450/img4.jpg" alt="Image Description">
                      <!-- End Figure Image -->

                      <!-- Figure Info -->
                      <div class="g-mb-15">
                        <h4 class="h5 g-color-black g-mb-5">Monica Gaudy</h4>
                        <em class="d-block g-font-style-normal g-font-size-11 text-uppercase g-color-primary">Head Manager</em>
                      </div>
                      <!-- End Figure Info -->
                  ...
                  <div class="js-slide">
                    ...
                    <figure class="text-center g-px-15">
                      <!-- Figure Image -->
                      <img class="w-100 g-mb-20" src="../../assets/img-temp/400x450/img5.jpg" alt="Image Description">
                      <!-- End Figure Image -->

                      <!-- Figure Info -->
                      <div class="g-mb-15">
                        <h4 class="h5 g-color-black g-mb-5">John Watson</h4>
                        <em class="d-block g-font-style-normal g-font-size-11 text-uppercase g-color-primary">Marketing manager</em>
                      </div>
                      <!-- End Figure Info -->
                  ...
                  <div class="js-slide">
                    ...
                    <figure class="text-center g-px-15">
                      <!-- Figure Image -->
                      <img class="w-100 g-mb-20" src="../../assets/img-temp/400x450/img6.jpg" alt="Image Description">
                      <!-- End Figure Image -->
        ...
        <div class="container">
          <div id="shortcode4">
            <div class="shortcode-html">
              <!-- Team Block -->
              <div class="g-mx-minus-9--sm">
                <div class="js-carousel_4-items" data-slides-show="3" data-arrows-classes="u-arrow-v1 g-absolute-centered--y g-width-45 g-height-45 g-font-size-default g-color-gray-dark-v5 g-bg-white g-color-white--hover g-bg-primary--hover" data-arrow-left-classes="fa fa-angle-left g-left-minus-25"
                data-arrow-right-classes="fa fa-angle-right g-right-minus-25" data-responsive='[{
                  ...
                  <div class="js-slide">
                    <div class="text-center u-block-hover g-transition-0_3 g-bg-white--hover g-pa-20">
                      <!-- Figure -->
                      <figure class="g-pos-rel g-mb-30">
                        <!-- Figure Image -->
                        <img class="w-100" src="../../assets/img-temp/400x550/img1.jpg" alt="Image Description">
                        <!-- End Figure Image -->

                        <!-- Figure Caption -->
                        <figcaption class="u-block-hover__additional--fade">
                          <ul class="list-unstyled g-transition-0_3 g-absolute-centered mb-0">
                            <li class="g-mb-5">
                              <a class="u-icon-v3 u-icon-size--sm g-bg-primary--hover g-color-white--hover" href="#!">
                                <i class="fa fa-twitter"></i>
                              </a>
                            </li>
                            <li class="g-mb-5">
                      ...
                      <!-- Info -->
                      <em class="d-block g-font-style-normal g-font-size-11 text-uppercase g-color-primary g-mb-5">Teacher, Piano</em>
                      <h4 class="h5 g-color-black g-mb-15">Marina
                        <br>
                        Rubapa
                      </h4>
                  ...
                  <div class="js-slide">
                    <div class="text-center u-block-hover g-transition-0_3 g-bg-white--hover g-pa-20">
                      ...
                      <figure class="g-pos-rel g-mb-30">
                        <!-- Figure Image -->
                        <img class="w-100" src="../../assets/img-temp/400x550/img2.jpg" alt="Image Description">
                        <!-- End Figure Image -->
                      ...
                      <!-- Info -->
                      <em class="d-block g-font-style-normal g-font-size-11 text-uppercase g-color-primary g-mb-5">Artist, Dancer</em>
                      <h4 class="h5 g-color-black g-mb-15">Leyla
                        <br>
                        Olsson
                      </h4>
                      <p>I am an ambitious workaholic, but apart from that, pretty simple person.</p>
                  ...
                  <div class="js-slide">
                    <div class="text-center u-block-hover g-transition-0_3 g-bg-white--hover g-pa-20">
                      ...
                      <figure class="g-pos-rel g-mb-30">
                        <!-- Figure Image -->
                        <img class="w-100" src="../../assets/img-temp/400x550/img3.jpg" alt="Image Description">
                        <!-- End Figure Image -->
                      ...
                      <!-- Info -->
                      <em class="d-block g-font-style-normal g-font-size-11 text-uppercase g-color-primary g-mb-5">Cook</em>
                      <h4 class="h5 g-color-black g-mb-15">John
                        <br>
                        Smith
                      </h4>
                      <p>I am an ambitious workaholic, but apart from that, pretty simple person.</p>
                  ...
                  <div class="js-slide">
                    <div class="text-center u-block-hover g-transition-0_3 g-bg-white--hover g-pa-20">
                      ...
                      <figure class="g-pos-rel g-mb-30">
                        <!-- Figure Image -->
                        <img class="w-100" src="../../assets/img-temp/400x550/img4.jpg" alt="Image Description">
                        <!-- End Figure Image -->
                      ...
                      <!-- Info -->
                      <em class="d-block g-font-style-normal g-font-size-11 text-uppercase g-color-primary g-mb-5">Artist, Sculptor</em>
                      <h4 class="h5 g-color-black g-mb-15">Samantha
                        <br>
                        Fox
                      </h4>
                      <p>I am an ambitious workaholic, but apart from that, pretty simple person.</p>
        ...
        <div class="container">
          ...
          <div id="shortcode5">
            <div class="shortcode-html">
              <!-- Team Block -->
              <div class="g-mx-minus-9--sm">
                <div class="js-carousel_3-items" data-arrows-classes="u-arrow-v1 g-absolute-centered--y g-width-50 g-height-50 g-font-size-default g-color-gray-dark-v5 g-bg-gray-light-v5 g-color-white--hover g-bg-primary--hover" data-arrow-left-classes="fa fa-angle-left g-left-minus-25"
                data-arrow-right-classes="fa fa-angle-right g-right-minus-25" data-slides-show="3" data-responsive='[{
                       "breakpoint": 992,
                       "settings": {
                         "slidesToShow": 2
                       }
                  ...
                  <div class="js-slide">
                    ...
                    <figure class="text-center g-px-5">
                      <!-- Figure Image -->
                      <img class="w-100 g-mb-35" src="../../assets/img-temp/400x450/img1.jpg" alt="Image Description">
                      <!-- End Figure Image -->

                      <!-- Figure Info -->
                      <div class="g-mb-20">
                        <em class="d-block g-font-style-normal g-font-size-11 text-uppercase g-color-primary g-mb-5">Technical Supervisor</em>
                        <h4 class="h5 g-color-black">Maria Olsson</h4>
                      </div>
                      <!-- End Figure Info -->
                      ...
                      <ul class="list-inline mb-0">
                        <li class="list-inline-item g-mx-3">
                          <a class="u-icon-v2 u-icon-size--sm g-font-size-default g-color-gray-dark-v5 g-bg-gray-light-v5 g-brd-gray-light-v5 g-bg-primary--hover g-color-white--hover rounded-circle" href="#!">
                            <i class="fa fa-facebook"></i>
                          </a>
                        </li>
                        <li class="list-inline-item g-mx-3">
                  ...
                  <div class="js-slide">
                    ...
                    <figure class="text-center g-px-5">
                      <!-- Figure Image -->
                      <img class="w-100 g-mb-35" src="../../assets/img-temp/400x450/img2.jpg" alt="Image Description">
                      <!-- End Figure Image -->

                      <!-- Figure Info -->
                      <div class="g-mb-20">
                        <em class="d-block g-font-style-normal g-font-size-11 text-uppercase g-color-primary g-mb-5">Technical Director</em>
                        <h4 class="h5 g-color-black">Catrina Wearner</h4>
                      </div>
                      <!-- End Figure Info -->
                  ...
                  <div class="js-slide">
                    ...
                    <figure class="text-center g-px-5">
                      <!-- Figure Image -->
                      <img class="w-100 g-mb-35" src="../../assets/img-temp/400x450/img3.jpg" alt="Image Description">
                      <!-- End Figure Image -->

                      <!-- Figure Info -->
                      <div class="g-mb-20">
                        <em class="d-block g-font-style-normal g-font-size-11 text-uppercase g-color-primary g-mb-5">Technical Manager</em>
                        <h4 class="h5 g-color-black">James Novel</h4>
                      </div>
                      <!-- End Figure Info -->
                  ...
                  <div class="js-slide">
                    ...
                    <figure class="text-center g-px-5">
                      <!-- Figure Image -->
                      <img class="w-100 g-mb-35" src="../../assets/img-temp/400x450/img4.jpg" alt="Image Description">
                      <!-- End Figure Image -->

                      <!-- Figure Info -->
                      <div class="g-mb-20">
                        <em class="d-block g-font-style-normal g-font-size-11 text-uppercase g-color-primary g-mb-5">Head of Secretory</em>
                        <h4 class="h5 g-color-black">Fiona Biloti</h4>
                      </div>
                      <!-- End Figure Info -->
        ...
        <div class="container">
          ...
          <div id="shortcode6">
            <div class="shortcode-html">
              <!-- Team Block -->
              <div class="g-mx-minus-9--sm">
                <div class="js-carousel_4-items g-pb-90" data-slides-show="4" data-slides-scroll="4" data-arrows-classes="u-arrow-v1 g-pos-abs g-bottom-0 g-width-45 g-height-45 g-font-size-default g-color-gray-dark-v5 g-bg-white g-color-white--hover g-bg-primary--hover"
                data-arrow-left-classes="fa fa-angle-left g-left-35x--lg g-left-15" data-arrow-right-classes="fa fa-angle-right g-right-35x--lg g-right-15" data-pagi-classes="u-carousel-indicators-v1 g-absolute-centered--x g-bottom-20 text-center" data-responsive='[{
                       "breakpoint": 1200,
                       "settings": {
                         "slidesToShow": 5
                  ...
                  <div class="js-slide g-px-15">
                    ...
                    <figure class="text-center u-block-hover g-color-white mb-0">
                      ...
                      <!-- Figure Caption -->
                      <figcaption class="u-block-hover__additional--fade g-bg-primary-opacity-0_9 g-flex-middle">
                        <div class="g-flex-middle-item g-pa-20">
                          <!-- Figure Info -->
                          <em class="d-block g-font-style-normal g-font-size-11 text-uppercase g-color-white-opacity-0_7 g-mb-5">Designer</em>
                          <h4 class="h5 g-mb-15">Maria Olsson</h4>
                          <p class="g-color-white-opacity-0_7 g-mb-20">I am an ambitious workaholic, but apart from that, pretty simple person.</p>
                          <!-- End Figure Info -->

                          <!-- Figure Social Icons -->
                          <ul class="list-inline mb-0">
                            <li class="list-inline-item g-mx-3">
                              <a class="u-icon-v3 u-icon-size--xs g-color-primary g-bg-white g-bg-black--hover" href="#!">
                                <i class="fa fa-twitter"></i>
                              </a>
                            </li>
                            <li class="list-inline-item g-mx-3">
                  ...
                  <div class="js-slide g-px-15">
                    ...
                    <figure class="text-center u-block-hover g-color-white mb-0">
                      ...
                      <figcaption class="u-block-hover__additional--fade g-bg-primary-opacity-0_9 g-flex-middle">
                        <div class="g-flex-middle-item g-pa-20">
                          <!-- Figure Info -->
                          <em class="d-block g-font-style-normal g-font-size-11 text-uppercase g-color-white-opacity-0_7 g-mb-5">Support</em>
                          <h4 class="h5 g-mb-15">Hilary Johnson</h4>
                          <p class="g-color-white-opacity-0_7 g-mb-20">I am an ambitious workaholic, but apart from that, pretty simple person.</p>
                          <!-- End Figure Info -->
                  ...
                  <div class="js-slide g-px-15">
                    ...
                    <figure class="text-center u-block-hover g-color-white mb-0">
                      ...
                      <figcaption class="u-block-hover__additional--fade g-bg-primary-opacity-0_9 g-flex-middle">
                        <div class="g-flex-middle-item g-pa-20">
                          <!-- Figure Info -->
                          <em class="d-block g-font-style-normal g-font-size-11 text-uppercase g-color-white-opacity-0_7 g-mb-5">Developer</em>
                          <h4 class="h5 g-mb-15">George Freeman</h4>
                          <p class="g-color-white-opacity-0_7 g-mb-20">I am an ambitious workaholic, but apart from that, pretty simple person.</p>
                          <!-- End Figure Info -->
                  ...
                  <div class="js-slide g-px-15">
                    ...
                    <figure class="text-center u-block-hover g-color-white mb-0">
                      ...
                      <figcaption class="u-block-hover__additional--fade g-bg-primary-opacity-0_9 g-flex-middle">
                        <div class="g-flex-middle-item g-pa-20">
                          <!-- Figure Info -->
                          <em class="d-block g-font-style-normal g-font-size-11 text-uppercase g-color-white-opacity-0_7 g-mb-5">Manager</em>
                          <h4 class="h5 g-mb-15">Alice Regen</h4>
                          <p class="g-color-white-opacity-0_7 g-mb-20">I am an ambitious workaholic, but apart from that, pretty simple person.</p>
                          <!-- End Figure Info -->
            ...
            <div class="shortcode-html">
              ...
              <div class="g-mx-minus-9--sm">
                ...
                data-arrow-left-classes="fa fa-angle-left g-left-35x--lg g-left-15" data-arrow-right-classes="fa fa-angle-right g-right-35x--lg g-right-15" data-pagi-classes="u-carousel-indicators-v1 g-absolute-centered--x g-bottom-20 text-center" data-responsive='[{
                  ...
                  <div class="js-slide g-px-15">
                    <!-- Figure -->
                    <figure class="u-block-hover g-bg-cover g-bg-black-opacity-0_3--hover--after g-bg-primary--hover g-color-white g-transition-0_2 mb-0">
                      <div class="g-pos-rel">
                        <!-- Figure Image -->
                        <img class="w-100" src="../../assets/img-temp/400x550/img1.jpg" alt="Image Description">
                        <!-- End Figure Image -->

                        <div class="u-block-hover__additional--fade g-flex-middle g-z-index-1">
                          <!-- Figure Social Icons -->
                          <ul class="list-inline text-center u-block-hover__additional--fade u-block-hover__additional--fade-down g-flex-middle-item--top g-mt-25">
                            <li class="list-inline-item g-mx-3">
                              <a class="u-icon-v2 u-icon-size--xs g-color-white g-color-white--hover g-brd-primary--hover g-bg-primary--hover rounded-circle" href="#!">
                                <i class="fa fa-twitter"></i>
                              </a>
                            </li>
                            <li class="list-inline-item g-mx-3">
                      ...
                      <!-- Figure Info -->
                      <div class="g-pa-20 g-pos-rel g-z-index-1">
                        <h4 class="h5 g-mb-0">Maria Olsson</h4>
                        <em class="g-font-style-normal g-font-size-11 text-uppercase g-color-white-opacity-0_7">Yoga, Cardio, Pilates, Crossfit</em>
                      </div>
                      <!-- End Figure Info-->
                    </figure>
                    <!-- End Figure -->
                  ...
                  <div class="js-slide g-px-15">
                    ...
                    <figure class="u-block-hover g-bg-cover g-bg-black-opacity-0_3--hover--after g-bg-primary--hover g-color-white g-transition-0_2 mb-0">
                      ...
                      <!-- Figure Info -->
                      <div class="g-pa-20 g-pos-rel g-z-index-1">
                        <h4 class="h5 g-mb-0">Sara Lisbon</h4>
                        <em class="g-font-style-normal g-font-size-11 text-uppercase g-color-white-opacity-0_7">Gym, Boxing, Crossfit, Cardio</em>
                      </div>
                      <!-- End Figure Info-->
                    </figure>
                    <!-- End Figure -->
                  ...
                  <div class="js-slide g-px-15">
                    ...
                    <figure class="u-block-hover g-bg-cover g-bg-black-opacity-0_3--hover--after g-bg-primary--hover g-color-white g-transition-0_2 mb-0">
                      ...
                      <!-- Figure Info -->
                      <div class="g-pa-20 g-pos-rel g-z-index-1">
                        <h4 class="h5 g-mb-0">Tammy Exon</h4>
                        <em class="g-font-style-normal g-font-size-11 text-uppercase g-color-white-opacity-0_7">Cardio, Pilates, Zymba</em>
                      </div>
                      <!-- End Figure Info-->
                    </figure>
                    <!-- End Figure -->
                  ...
                  <div class="js-slide g-px-15">
                    ...
                    <figure class="u-block-hover g-bg-cover g-bg-black-opacity-0_3--hover--after g-bg-primary--hover g-color-white g-transition-0_2 mb-0">
                      ...
                      <!-- Figure Info -->
                      <div class="g-pa-20 g-pos-rel g-z-index-1">
                        <h4 class="h5 g-mb-0">Monica Notrom</h4>
                        <em class="g-font-style-normal g-font-size-11 text-uppercase g-color-white-opacity-0_7">Box, Kickboxing, Gym, Crossfit</em>
                      </div>
                      <!-- End Figure Info-->
                    </figure>
                    <!-- End Figure -->
      ...
      <section class="g-bg-gray-light-v5 g-py-100">
        <div class="container">
          ...
          <div id="shortcode8">
            <div class="shortcode-html">
              <!-- Team Block -->
              <div class="u-carousel-v10 g-max-width-800 mx-auto">
                <div id="js-carousel-sync-for" class="js-carousel" data-slides-show="1" data-slides-scroll="1" data-infinite="true" data-fade="true" data-center-mode="true" data-pagi="true" data-adaptive-height="true" data-nav-for="#js-carousel-sync-nav">
                  <div class="js-slide">
                    <!-- Figure -->
                    <figure class="row">
                      <div class="col-sm-6 order-sm-2">
                        ...
                        <div class="g-mb-30">
                          ...
                          <em class="d-block u-info-v1-5__item g-color-primary g-font-style-normal g-font-size-11 text-uppercase">Phd in Healthcare</em>
                        </div>
                        <p>I am an ambitious workaholic, but apart from that, pretty simple person. Understanding who you are and what you want is my strategy for your brand. I am always figuring out ways to capture your vision, so people can get on board.</p>
                        <!-- End Figure Info -->
                      </div>
                      ...
                      <div class="col-sm-5 order-sm-1">
                        <img class="w-100" src="../../assets/img-temp/400x450/img1.jpg" alt="Image Description">
                      </div>
                      <!-- End Figure Image -->
                    </figure>
                    <!-- End Figure -->
                  ...
                  <div class="js-slide">
                    ...
                    <figure class="row">
                      ...
                      <!-- Figure Image -->
                      <div class="col-sm-5 order-sm-1">
                        <img class="w-100" src="../../assets/img-temp/400x450/img3.jpg" alt="Image Description">
                      </div>
                      <!-- End Figure Image -->
                    </figure>
                    <!-- End Figure -->
                  ...
                  <div class="js-slide">
                    ...
                    <figure class="row">
                      ...
                      <!-- Figure Image -->
                      <div class="col-sm-5 order-sm-1">
                        <img class="w-100" src="../../assets/img-temp/400x450/img4.jpg" alt="Image Description">
                      </div>
                      <!-- End Figure Image -->
                    </figure>
                    <!-- End Figure -->
                  ...
                  <div class="js-slide">
                    ...
                    <figure class="row">
                      ...
                      <!-- Figure Image -->
                      <div class="col-sm-5 order-sm-1">
                        <img class="w-100" src="../../assets/img-temp/400x450/img5.jpg" alt="Image Description">
                      </div>
                      <!-- End Figure Image -->
                    </figure>
                    <!-- End Figure -->
      ...
      <section class="container g-py-100">
        ...
        <div id="shortcode9">
          <div class="shortcode-html">
            <!-- Carousel -->
            <div id="carouselCus3" class="js-carousel g-mb-50--lg" data-infinite="true" data-fade="true" data-lazy-load="ondemand" data-arrows-classes="u-arrow-v1 g-absolute-centered--y g-width-45 g-height-45 g-font-size-30 g-color-gray-dark-v4 g-color-primary--hover"
            data-arrow-left-classes="fa fa-angle-left g-left-0 g-left-40--lg" data-arrow-right-classes="fa fa-angle-right g-right-0 g-right-40--lg" data-nav-for="#carouselCus4">
              <div class="js-slide">
                <!-- Team -->
                <div class="row justify-content-center align-items-center no-gutters">
                  <div class="col-sm-6 col-lg-4 g-bg-size-cover g-bg-pos-top-center g-min-height-400" data-bg-img-src="../../assets/img-temp/400x450/img1.jpg"></div>
                  <div class="col-sm-6 col-lg-4">
                    <div class="g-px-30 g-px-50--lg g-py-60">
                      <h3 class="h4 mb-1">Jessica Lisbon</h3>
                      <span class="d-block mb-4">Support Manager</span>
                      <p class="mb-4">I've got your front end and back end needs covered. I'm always looking for strategies to make your brand's needs fit with today's development languages.</p>
                      ...
                      <a class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover g-font-weight-700" href="#!">See Projects</a>
                    </div>
                  </div>
                </div>
                <!-- End Team -->
              ...
              <div class="js-slide">
                <!-- Team -->
                <div class="row justify-content-center align-items-center no-gutters">
                  <div class="col-sm-6 col-lg-4 g-bg-size-cover g-bg-pos-top-center g-min-height-400" data-bg-img-src="../../assets/img-temp/400x450/img3.jpg"></div>
                  <div class="col-sm-6 col-lg-4">
                    <div class="g-px-30 g-px-50--lg g-py-60">
                      <h3 class="h4 mb-1">David Case</h3>
                      <span class="d-block mb-4">Web Developer</span>
                      <p class="mb-4">I am a 32-year old man from Canada and I am passionate about everything related to web development. I strive to figure out the right solutions for your look to stand out amongst the rest.</p>
              ...
              <div class="js-slide">
                <!-- Team -->
                <div class="row justify-content-center align-items-center no-gutters">
                  <div class="col-sm-6 col-lg-4 g-bg-size-cover g-bg-pos-top-center g-min-height-400" data-bg-img-src="../../assets/img-temp/400x450/img4.jpg"></div>
                  <div class="col-sm-6 col-lg-4">
                    <div class="g-px-30 g-px-50--lg g-py-60">
                      <h3 class="h4 mb-1">Maria Olsson</h3>
                      <span class="d-block mb-4">Technical Director</span>
                      <p class="mb-4">I am an ambitious workaholic, but apart from that, pretty simple person. Whether it's branding, print, UI + UX I've got you covered.</p>
              ...
              <div class="js-slide">
                <!-- Team -->
                <div class="row justify-content-center align-items-center no-gutters">
                  <div class="col-sm-6 col-lg-4 g-bg-size-cover g-bg-pos-top-center g-min-height-400" data-bg-img-src="../../assets/img-temp/400x450/img2.jpg"></div>
                  <div class="col-sm-6 col-lg-4">
                    <div class="g-px-30 g-px-50--lg g-py-60">
                      <h3 class="h4 mb-1">Tina Krueger</h3>
                      <span class="d-block mb-4">Lead Designer</span>
                      <p class="mb-4">I'm Tina Krueger, an excitable lead designer. I live with an intense passion for web development.</p>
              ...
              <div class="js-slide">
                <!-- Team -->
                <div class="row justify-content-center align-items-center no-gutters">
                  <div class="col-sm-6 col-lg-4 g-bg-size-cover g-bg-pos-top-center g-min-height-400" data-bg-img-src="../../assets/img-temp/400x450/img5.jpg"></div>
                  <div class="col-sm-6 col-lg-4">
                    <div class="g-px-30 g-px-50--lg g-py-60">
                      <h3 class="h4 mb-1">John Watson</h3>
                      <span class="d-block mb-4">Marketing Manager</span>
                      <p class="mb-4">Understanding who you are and what you want is my strategy for your brand. I am always figuring out ways to capture your vision, so people can get on board.</p>
              ...
              <div class="js-slide">
                <!-- Team -->
                <div class="row justify-content-center align-items-center no-gutters">
                  <div class="col-sm-6 col-lg-4 g-bg-size-cover g-bg-pos-top-center g-min-height-400" data-bg-img-src="../../assets/img-temp/400x450/img6.jpg"></div>
                  <div class="col-sm-6 col-lg-4">
                    <div class="g-px-30 g-px-50--lg g-py-60">
                      <h3 class="h4 mb-1">Monica Gaudy</h3>
                      <span class="d-block mb-4">Sales Manager</span>
                      <p class="mb-4">I am Monica and I aim high at being focused on building relationships with our clients and community.</p>
        ...
        <div id="shortcode10">
          <div class="shortcode-html">
            ...
            <div class="clearfix">
              ...
              <div class="js-carousel" data-infinite="true" data-slides-show="3" data-slides-scroll="1" data-arrows-classes="u-icon-v3 g-width-45 g-height-45 g-absolute-centered--y g-color-white g-color-white--hover g-bg-black g-bg-primary--hover rounded g-pa-12" data-arrow-left-classes="fa fa-angle-left g-left-40"
              data-arrow-right-classes="fa fa-angle-right g-right-40" data-center-mode="true" data-center-padding="100px" data-responsive='[{
                     "breakpoint": 992,
                     "settings": {
                       "slidesToShow": 2,
                       "centerPadding": 30
                ...
                <div class="js-slide u-block-hover g-pb-10 g-mx-15">
                  <div class="g-overflow-hidden">
                    <img class="img-fluid w-100 u-block-hover__main--zoom-v1 g-transition-0_5" src="../../assets/img-temp/400x500/img10.jpg" alt="Image Description">
                  </div>
                  <div class="u-shadow-v32 g-bg-white g-pa-30">
                    <h3 class="h3 g-font-weight-500 mb-1">Alex Teseira</h3>
                    <span class="d-block g-color-gray-dark-v5">Professor in Ecosystem Ecology</span>
                  </div>
                ...
                <div class="js-slide u-block-hover g-pb-10 g-mx-15">
                  <div class="g-overflow-hidden">
                    <img class="img-fluid w-100 u-block-hover__main--zoom-v1 g-transition-0_5" src="../../assets/img-temp/400x500/img11.jpg" alt="Image Description">
                  </div>
                  <div class="u-shadow-v32 g-bg-white g-pa-30">
                    <h3 class="h3 g-font-weight-500 mb-1">Marina Rubapa</h3>
                    <span class="d-block g-color-gray-dark-v5">Associate Professor in Biology</span>
                  </div>
                  <a class="u-link-v2" href="#"></a>
                </div>
                <!-- End Faculty Professors -->
                ...
                <div class="js-slide u-block-hover g-pb-10 g-mx-15">
                  <div class="g-overflow-hidden">
                    <img class="img-fluid w-100 u-block-hover__main--zoom-v1 g-transition-0_5" src="../../assets/img-temp/400x500/img12.jpg" alt="Image Description">
                  </div>
                  <div class="u-shadow-v32 g-bg-white g-pa-30">
                    <h3 class="h3 g-font-weight-500 mb-1">John Smith</h3>
                    <span class="d-block g-color-gray-dark-v5">Assistant Professor</span>
                  </div>
                  <a class="u-link-v2" href="#"></a>
                </div>
                <!-- End Faculty Professors -->
                ...
                <div class="js-slide u-block-hover g-pb-10 g-mx-15">
                  <div class="g-overflow-hidden">
                    <img class="img-fluid w-100 u-block-hover__main--zoom-v1 g-transition-0_5" src="../../assets/img-temp/400x500/img13.jpg" alt="Image Description">
                  </div>
                  <div class="u-shadow-v32 g-bg-white g-pa-30">
                    <h3 class="h3 g-font-weight-500 mb-1">Samantha Fox</h3>
                    <span class="d-block g-color-gray-dark-v5">Professorship in Thoracic Surgery</span>
                  </div>
                  <a class="u-link-v2" href="#"></a>
                </div>
                <!-- End Faculty Professors -->
                ...
                <div class="js-slide u-block-hover g-pb-10 g-mx-15">
                  <div class="g-overflow-hidden">
                    <img class="img-fluid w-100 u-block-hover__main--zoom-v1 g-transition-0_5" src="../../assets/img-temp/400x500/img14.jpg" alt="Image Description">
                  </div>
                  <div class="u-shadow-v32 g-bg-white g-pa-30">
                    <h3 class="h3 g-font-weight-500 mb-1">James Novel</h3>
                    <span class="d-block g-color-gray-dark-v5">Teaching Assistant Professor</span>
                  </div>
                  <a class="u-link-v2" href="#"></a>
                </div>
                <!-- End Faculty Professors -->
                ...
                <div class="js-slide u-block-hover g-pb-10 g-mx-15">
                  <div class="g-overflow-hidden">
                    <img class="img-fluid w-100 u-block-hover__main--zoom-v1 g-transition-0_5" src="../../assets/img-temp/400x500/img15.jpg" alt="Image Description">
                  </div>
                  <div class="u-shadow-v32 g-bg-white g-pa-30">
                    <h3 class="h3 g-font-weight-500 mb-1">George Freeman</h3>
                    <span class="d-block g-color-gray-dark-v5">Health Educator</span>
                  </div>
                  <a class="u-link-v2" href="#"></a>
                </div>
                <!-- End Faculty Professors -->
