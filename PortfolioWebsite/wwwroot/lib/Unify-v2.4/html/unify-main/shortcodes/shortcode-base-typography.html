...
<head>
  <!-- Title -->
  <title>Typography | Unify - Responsive Website Template</title>
  ...
  <main>
      ...
      <div class="u-header__sections-container">
        <div class="u-sidebar-navigation-inner">
          ...
          <ul class="js-shortcode-filter-result nav flex-column u-sidebar-navigation-list">
            ...
            <li class="js-shortcode-filter__item nav-item bases">
              <a href="../../unify-main/shortcodes/shortcode-base-typography.html" class="nav-link active">Typography</a>
            </li>
            <li class="js-shortcode-filter__item nav-item bases">
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall" data-options="{direction: 'reverse', settings_mode_oneelement_max_offset: '150'}">
      ...
      <div class="container g-z-index-1 g-py-100">
        <h1 class="g-font-weight-300 g-letter-spacing-1 g-mb-15">Typography</h1>
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-3">
              ...
              <br>
              <p><em>"Google Fonts includes more than 600 fonts which can be used in Unify Template"</em>
              </p>
            </div>
            <div class="col-md-9">
              ...
              <div id="shortcode4">
                <div class="shortcode-html">
                  ...
                  <div class="g-font-size-16">
                    ...
                    <p><big>This line of text is meant to be treated as fine print.</big>
                    </p>
          ...
          <div class="row">
            ...
            <div class="col-md-9">
              <div id="shortcode5">
                <div class="shortcode-html">
                  <!-- Abbreviations -->
                  <p><abbr title="attribute">attr</abbr>
                  </p>
            ...
            <div class="col-md-9">
              <div id="shortcode12">
                ...
                <div class="shortcode-scripts">
                  ...
                  <script type="text/plain" src="../../assets/vendor/popper.min.js"></script>
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-3">
              ...
              <p>To remove the default styles of lists, add a class <code>list-unstyled</code>
              </p>
            </div>
          ...
          <div class="row">
            <div class="col-md-3">
              ...
              <p>Use circle lists with a class <code>g-list-style-circle</code>
              </p>
            </div>
