      ...
      <div class="u-header__sections-container">
        <div class="u-sidebar-navigation-inner">
          ...
          <ul class="js-shortcode-filter-result nav flex-column u-sidebar-navigation-list">
            ...
            <li class="js-shortcode-filter__item nav-item bases">
              <a href="../../unify-main/shortcodes/shortcode-base-modals.html" class="nav-link active">Modals</a>
            </li>
            <li class="js-shortcode-filter__item nav-item bases">
          ...
          <section>
            ...
            <div class="row">
              ...
              <div class="col-md-3 g-mb-30">
                ...
                <div id="shortcode1">
                  ...
                  <div class="shortcode-styles">
                    ...
                    <link type="text/plain" rel="stylesheet" href="../../assets/vendor/custombox/custombox.min.css">
                  </div>
              ...
              <div class="col-md-3 g-mb-30">
                ...
                <div id="shortcode2">
                  <div class="shortcode-html">
                    <a class="btn u-btn-primary" href="#modal2" data-modal-target="#modal2" data-modal-effect="slide">Launch Modal
                    </a>
              ...
              <div class="col-md-3 g-mb-30">
                ...
                <div id="shortcode3">
                  <div class="shortcode-html">
                    <a class="btn u-btn-primary" href="#modal3" data-modal-target="#modal3" data-modal-effect="newspaper">Launch Modal
                    </a>
              ...
              <div class="col-md-3 g-mb-30">
                ...
                <div id="shortcode4">
                  <div class="shortcode-html">
                    <a class="btn u-btn-primary" href="#modal4" data-modal-target="#modal4" data-modal-effect="fall">Launch Modal
                    </a>
            ...
            <div class="row">
              ...
              <div class="col-md-3 g-mb-30">
                ...
                <div id="shortcode5">
                  <div class="shortcode-html">
                    <a class="btn u-btn-primary" href="#modal5" data-modal-target="#modal5" data-modal-effect="sidefall">Launch Modal
                    </a>
              ...
              <div class="col-md-3 g-mb-30">
                ...
                <div id="shortcode6">
                  <div class="shortcode-html">
                    <a class="btn u-btn-primary" href="#modal6" data-modal-target="#modal6" data-modal-effect="blur">Launch Modal
                    </a>
              ...
              <div class="col-md-3 g-mb-30">
                ...
                <div id="shortcode7">
                  <div class="shortcode-html">
                    <a class="btn u-btn-primary" href="#modal7" data-modal-target="#modal7" data-modal-effect="flip">Launch Modal
                    </a>
              ...
              <div class="col-md-3 g-mb-30">
                ...
                <div id="shortcode8">
                  <div class="shortcode-html">
                    <a class="btn u-btn-primary" href="#modal8" data-modal-target="#modal8" data-modal-effect="sign">Launch Modal
                    </a>
            ...
            <div class="row">
              ...
              <div class="col-md-3 g-mb-30">
                ...
                <div id="shortcode9">
                  <div class="shortcode-html">
                    <a class="btn u-btn-primary" href="#modal9" data-modal-target="#modal9" data-modal-effect="superscaled">Launch Modal
                    </a>
              ...
              <div class="col-md-3 g-mb-30">
                ...
                <div id="shortcode10">
                  <div class="shortcode-html">
                    <a class="btn u-btn-primary" href="#modal10" data-modal-target="#modal10" data-modal-effect="slit">Launch Modal
                    </a>
              ...
              <div class="col-md-3 g-mb-30">
                ...
                <div id="shortcode11">
                  <div class="shortcode-html">
                    <a class="btn u-btn-primary" href="#modal11" data-modal-target="#modal11" data-modal-effect="rotate">Launch Modal
                    </a>
              ...
              <div class="col-md-3 g-mb-30">
                ...
                <div id="shortcode12">
                  <div class="shortcode-html">
                    <a class="btn u-btn-primary" href="#modal12" data-modal-target="#modal12" data-modal-effect="letmein">Launch Modal
                    </a>
            ...
            <div class="row">
              ...
              <div class="col-md-3 g-mb-30">
                ...
                <div id="shortcode13">
                  <div class="shortcode-html">
                    <a class="btn u-btn-primary" href="#modal13" data-modal-target="#modal13" data-modal-effect="makeway">Launch Modal
                    </a>
              ...
              <div class="col-md-3 g-mb-30">
                ...
                <div id="shortcode14">
                  <div class="shortcode-html">
                    <a class="btn u-btn-primary" href="#modal14" data-modal-target="#modal14" data-modal-effect="slip">Launch Modal
                    </a>
              ...
              <div class="col-md-3 g-mb-30">
                ...
                <div id="shortcode15">
                  <div class="shortcode-html">
                    <a class="btn u-btn-primary" href="#modal15" data-modal-target="#modal15" data-modal-effect="corner">Launch Modal
                    </a>
              ...
              <div class="col-md-3 g-mb-30">
                ...
                <div id="shortcode16">
                  <div class="shortcode-html">
                    <a class="btn u-btn-primary" href="#modal16" data-modal-target="#modal16" data-modal-effect="slidetogether">Launch Modal
                    </a>
            ...
            <div class="row">
              ...
              <div class="col-md-3 g-mb-30">
                ...
                <div id="shortcode17">
                  <div class="shortcode-html">
                    <a class="btn u-btn-primary" href="#modal17" data-modal-target="#modal17" data-modal-effect="scale">Launch Modal
                    </a>
              ...
              <div class="col-md-3 g-mb-30">
                ...
                <div id="shortcode18">
                  <div class="shortcode-html">
                    <a class="btn u-btn-primary" href="#modal18" data-modal-target="#modal18" data-modal-effect="door">Launch Modal
                    </a>
              ...
              <div class="col-md-3 g-mb-30">
                ...
                <div id="shortcode19">
                  <div class="shortcode-html">
                    <a class="btn u-btn-primary" href="#modal19" data-modal-target="#modal19" data-modal-effect="push">Launch Modal
                    </a>
              ...
              <div class="col-md-3 g-mb-30">
                ...
                <div id="shortcode20">
                  <div class="shortcode-html">
                    <a class="btn u-btn-primary" href="#modal20" data-modal-target="#modal20" data-modal-effect="contentscale">Launch Modal
                    </a>
            ...
            <div class="row">
              ...
              <div class="col-md-3 g-mb-30">
                ...
                <div id="shortcode21">
                  <div class="shortcode-html">
                    <a class="btn u-btn-primary" href="#modal21" data-modal-target="#modal21" data-modal-effect="swell">Launch Modal
                    </a>
              ...
              <div class="col-md-3 g-mb-30">
                ...
                <div id="shortcode22">
                  <div class="shortcode-html">
                    <a class="btn u-btn-primary" href="#modal22" data-modal-target="#modal22" data-modal-effect="rotatedown">Launch Modal
                    </a>
              ...
              <div class="col-md-3 g-mb-30">
                ...
                <div id="shortcode23">
                  <div class="shortcode-html">
                    <a class="btn u-btn-primary" href="#modal23" data-modal-target="#modal23" data-modal-effect="flash">Launch Modal
                    </a>
          ...
          <section>
            ...
            <div class="row">
              ...
              <div class="col-md-8">
                <div id="shortcode24">
                  <div class="shortcode-html">
                    <a class="btn u-btn-primary" href="#modal-type-aftersometime" data-modal-target="#modal-type-aftersometime" data-modal-effect="fadein">Trigger Modal
                    </a>

                    <!-- Demo modal window -->
                    <div id="modal-type-aftersometime" class="js-autonomous-popup text-left g-max-width-600 g-bg-white g-overflow-y-auto g-pa-20" style="display: none;" data-modal-type="aftersometime" data-open-effect="zoomIn" data-close-effect="zoomOut" data-delay="2000"
                    data-speed="500">
                      <button type="button" class="close" onclick="Custombox.modal.close();">
                        <i class="hs-icon hs-icon-close"></i>
                      </button>
            ...
            <div class="row">
              ...
              <div class="col-md-8">
                <div id="shortcode25">
                  <div class="shortcode-html">
                    <a class="btn u-btn-primary" href="#modal-type-onscroll" data-modal-target="#modal-type-onscroll" data-modal-effect="fadein">Trigger Modal
                    </a>
              ...
              <div class="col-md-8">
                <div id="shortcode26">
                  <div class="shortcode-html">
                    ...
                    <!-- Demo modal window -->
                    <div id="modal-type-ontarget" class="js-autonomous-popup text-left g-max-width-600 g-bg-white g-overflow-y-auto g-pa-20" style="display: none;" data-modal-type="ontarget" data-open-effect="flipInY" data-close-effect="flipOutY" data-target="#modal-anchor"
                    data-speed="500">
                      <button type="button" class="close" onclick="Custombox.modal.close();">
                        <i class="hs-icon hs-icon-close"></i>
                      </button>
              ...
              <div class="col-md-8">
                <div id="shortcode27">
                  <div class="shortcode-html">
                    ...
                    <!-- Demo modal window -->
                    <div id="modal-type-hashlink" class="js-autonomous-popup text-left g-max-width-600 g-bg-white g-overflow-y-auto g-pa-20" style="display: none;" data-modal-type="hashlink" data-open-effect="flipInY" data-close-effect="flipOutY" data-speed="500">
                      <button type="button" class="close" onclick="Custombox.modal.close();">
                        <i class="hs-icon hs-icon-close"></i>
                      </button>
            ...
            <div class="row">
              ...
              <div class="col-md-8">
                <div id="shortcode28">
                  <div class="shortcode-html">
                    <a class="btn u-btn-primary" href="#modal-type-beforeunload" data-modal-target="#modal-type-beforeunload" data-modal-effect="fadein">Trigger Modal
                    </a>

                    <!-- Demo modal window -->
                    <div id="modal-type-beforeunload" class="js-autonomous-popup text-left g-max-width-600 g-bg-white g-overflow-y-auto g-pa-20" style="display: none;" data-modal-type="beforeunload" data-open-effect="flipInY" data-close-effect="flipOutY" data-speed="500">
                      <button type="button" class="close" onclick="Custombox.modal.close();">
                        <i class="hs-icon hs-icon-close"></i>
                      </button>
