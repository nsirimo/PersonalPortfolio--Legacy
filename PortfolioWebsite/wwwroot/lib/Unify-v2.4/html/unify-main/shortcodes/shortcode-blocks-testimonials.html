...
<head>
  <!-- Title -->
  <title>Testimonials | Unify - Responsive Website Template</title>
  ...
  <main>
      ...
      <div class="u-header__sections-container">
        <div class="u-sidebar-navigation-inner">
          ...
          <ul class="js-shortcode-filter-result nav flex-column u-sidebar-navigation-list">
            ...
            <li class="js-shortcode-filter__item nav-item dropdown blocks">
              <a class="nav-link dropdown-toggle active" href="#!" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Testimonials</a>
              <div class="dropdown-menu u-dropdown-static">
                <ul class="nav flex-column">
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../unify-main/shortcodes/shortcode-blocks-testimonials.html" class="nav-link active">Testimonials</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item blocks">
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall g-overflow-hidden" data-options="{direction: 'reverse', settings_mode_oneelement_max_offset: '150'}">
      ...
      <div class="container g-z-index-1 g-py-100">
        <h1 class="g-font-weight-300 g-letter-spacing-1 g-mb-15">Testimonials</h1>
    ...
    <section>
              ...
              <div class="row no-gutters">
                <div class="col-md-6 col-lg-4 g-brd-right g-brd-gray-light-v4 g-mb-30">
                  ...
                  <div class="u-shadow-v20--hover g-bg-white--hover text-center g-rounded-4 g-transition-0_3 g-pa-30">
                    ...
                    <img class="img-thumbnail g-width-70 g-height-70 g-brd-gray-light-v7 rounded-circle g-mb-20" src="../../assets/img-temp/100x100/img14.jpg" alt="Image Description">
                ...
                <div class="col-md-6 col-lg-4 g-brd-right g-brd-gray-light-v4 g-mb-30">
                  ...
                  <div class="u-shadow-v20--hover g-bg-white--hover text-center g-rounded-4 g-transition-0_3 g-pa-30">
                    ...
                    <img class="img-thumbnail g-width-70 g-height-70 g-brd-gray-light-v7 rounded-circle g-mb-20" src="../../assets/img-temp/100x100/img5.jpg" alt="Image Description ">
                ...
                <div class="col-md-6 col-lg-4 g-mb-30">
                  ...
                  <div class="u-shadow-v20--hover g-bg-white--hover text-center g-rounded-4 g-transition-0_3 g-pa-30">
                    <blockquote class="lead u-blockquote-v6 g-font-style-italic g-mb-35 ">Your customer support is the best I have experienced with any theme I have purchased. You have a theme that far exceeds all others. Thanks for providing such a fantastic theme, all your efforts are greatly appreciated on our end.</blockquote>
                    <img class="img-thumbnail g-width-70 g-height-70 g-brd-gray-light-v7 rounded-circle g-mb-20" src="../../assets/img-temp/100x100/img7.jpg" alt="Image Description">
            ...
            <div class="shortcode-html">
              ...
              <div class="row">
                <div class="col-lg-6 g-mb-30">
                  ...
                  <div class="media g-brd-bottom g-brd-3 g-brd-gray-light-v4 g-brd-primary--hover g-bg-gray-light-v5 g-rounded-4 g-transition-0_3 g-pa-20">
                    <div class="d-flex mr-4">
                      <img class="g-width-70 g-height-70 rounded-circle" src="../../assets/img-temp/100x100/img14.jpg" alt="Image Description">
                    </div>
                ...
                <div class="col-lg-6 g-mb-30">
                  ...
                  <div class="media g-brd-bottom g-brd-3 g-brd-gray-light-v4 g-brd-primary--hover g-bg-gray-light-v5 g-rounded-4 g-transition-0_3 g-pa-20">
                    <div class="d-flex mr-4">
                      <img class="g-width-70 g-height-70 rounded-circle" src="../../assets/img-temp/100x100/img5.jpg" alt="Image Description">
                    </div>
                    <div class="media-body">
                ...
                <div class="col-lg-6 g-mb-30">
                  ...
                  <div class="media g-brd-bottom g-brd-3 g-brd-gray-light-v4 g-brd-primary--hover g-bg-gray-light-v5 g-rounded-4 g-transition-0_3 g-pa-20">
                    <div class="d-flex mr-4">
                      <img class="g-width-70 g-height-70 rounded-circle" src="../../assets/img-temp/100x100/img7.jpg" alt="Image Description">
                    </div>
                    <div class="media-body">
                      <blockquote class="lead g-mb-15">Hi there purchased a couple of days ago and the site looks great, big thanks to the htmlstream guys, they gave me some great.</blockquote>
                      <h4 class="h6 g-font-weight-700 g-mb-0">Alex Pottorf</h4>
                ...
                <div class="col-lg-6 g-mb-30">
                  ...
                  <div class="media g-brd-bottom g-brd-3 g-brd-gray-light-v4 g-brd-primary--hover g-bg-gray-light-v5 g-rounded-4 g-transition-0_3 g-pa-20">
                    <div class="d-flex mr-4">
                      <img class="g-width-70 g-height-70 rounded-circle" src="../../assets/img-temp/100x100/img6.jpg" alt="Image Description">
                    </div>
                    <div class="media-body">
                      <blockquote class="lead g-mb-15">Dear Htmlstream team, I just bought the Unify template some weeks ago. The template is really nice and offers quite a large set of options.</blockquote>
                      <h4 class="h6 g-font-weight-700 g-mb-0">Angela Danil</h4>
              ...
              <div class="row">
                <div class="col-lg-4 g-mb-30">
                  ...
                  <div class="g-brd-around g-brd-blue g-pa-40">
                    ...
                    <div class="d-flex justify-content-center">
                      <img class="align-self-center g-width-40 g-height-40 rounded-circle mr-3" src="../../assets/img-temp/100x100/img14.jpg" alt="Image Description">
                      <div>
                ...
                <div class="col-lg-4 g-mb-30">
                  ...
                  <div class="g-brd-around g-brd-pink g-pa-40">
                    ...
                    <div class="d-flex justify-content-center">
                      <img class="align-self-center g-width-40 g-height-40 rounded-circle mr-3" src="../../assets/img-temp/100x100/img5.jpg" alt="Image Description">
                      <div>
                ...
                <div class="col-lg-4 g-mb-30">
                  ...
                  <div class="g-brd-around g-brd-purple g-pa-40">
                    ...
                    <div class="d-flex justify-content-center">
                      <img class="align-self-center g-width-40 g-height-40 rounded-circle mr-3" src="../../assets/img-temp/100x100/img4.jpg" alt="Image Description">
                      <div>
              ...
              <div class="row justify-content-center">
                <div class="col-lg-8">
                  <div class="text-center">
                    <img class="g-width-120 g-height-120 g-brd-around g-brd-5 g-brd-white rounded-circle" src="../../assets/img-temp/125x125/img4.jpg" alt="Image Description">
                    <div class="g-py-25">
                      <h4 class="h5 g-color-black text-uppercase g-mb-0">Mary Brown</h4>
                      <em class="g-color-primary">Designer</em>
                    </div>
                    <blockquote class="lead g-line-height-1_8 g-mb-25">" Thanks a lot. You have no idea how much I appreciate all your help. You are not just a great designer but an amazing human being, because so many people won't give a rat ass about what happen to their clients AFTER THE SALE, and
                      you are not. Again, thanks a lot. "</blockquote>
        ...
        <div id="shortcode6">
          <div class="shortcode-html">
            <div class="dzsparallaxer auto-init height-is-based-on-content use-loading g-bg-cover g-bg-black-opacity-0_7--after">
              <div class="divimage dzsparallaxer--target w-100" style="height: 140%; background-image: url(../../assets/img-temp/1920x1080/img1.jpg);"></div>
                ...
                <div class="row">
                  <div class="col-md-6 col-lg-4">
                    ...
                    <div class="g-brd-around g-brd-1 g-brd-white-opacity-0_6 g-bg-white-opacity-0_2 g-color-white text-center rounded g-px-40 g-py-60 g-mb-30">
                      <img class="g-width-100 g-height-100 g-brd-3 g-brd-style-solid g-brd-white rounded-circle g-mb-30" src="../../assets/img-temp/100x100/img14.jpg" alt="Image Description">
                  ...
                  <div class="col-md-6 col-lg-4">
                    <!-- Testimonials -->
                    <div class="g-brd-around g-brd-1 g-brd-white-opacity-0_6 g-bg-white-opacity-0_2 g-color-white text-center rounded g-px-40 g-py-60 g-mb-30">
                      <img class="g-width-100 g-height-100 g-brd-3 g-brd-style-solid g-brd-white rounded-circle g-mb-30" src="../../assets/img-temp/100x100/img5.jpg" alt="Image Description">
                      <h4>Angela Danil</h4>
                  ...
                  <div class="col-md-6 col-lg-4">
                    <!-- Testimonials -->
                    <div class="g-brd-around g-brd-1 g-brd-white-opacity-0_6 g-bg-white-opacity-0_2 g-color-white text-center rounded g-px-40 g-py-60 g-mb-30">
                      <img class="g-width-100 g-height-100 g-brd-3 g-brd-style-solid g-brd-white rounded-circle g-mb-30" src="../../assets/img-temp/100x100/img17.jpg" alt="Image Description">
                      <h4>Sand Gogh</h4>
                      <em class="d-block g-color-primary g-font-style-normal g-mb-5">Software Developer</em>
            ...
            <div class="shortcode-html">
              ...
              <div class="row">
                <div class="col-md-4 g-mb-30">
                  ...
                  <div class="text-center">
                    <img class="g-width-75 g-height-75 g-brd-around g-brd-4 g-brd-blue rounded-circle g-mb-10" src="../../assets/img-temp/100x100/img6.jpg" alt="Image Description">
                ...
                <div class="col-md-4 g-mb-30">
                  ...
                  <div class="text-center">
                    <img class="g-width-75 g-height-75 g-brd-around g-brd-4 g-brd-blue rounded-circle g-mb-10" src="../../assets/img-temp/100x100/img14.jpg" alt="Image Description">
                ...
                <div class="col-md-4 g-mb-30">
                  ...
                  <div class="text-center">
                    <img class="g-width-75 g-height-75 g-brd-around g-brd-4 g-brd-blue rounded-circle g-mb-10" src="../../assets/img-temp/100x100/img17.jpg" alt="Image Description">
              ...
              <div class="row">
                <div class="col-lg-4 g-mb-30">
                  ...
                  <div class="u-shadow-v19 g-bg-white g-bg-cyan-gradient-opacity-v1 g-color-white text-center rounded g-px-40 g-py-60">
                    <img class="g-brd-around g-brd-3 g-brd-white g-width-80 g-height-80 rounded-circle g-mb-20" src="../../assets/img-temp/100x100/img7.jpg" alt="Image Description">
                ...
                <div class="col-lg-4 g-mb-30">
                  <!-- Testimonials -->
                  <div class="u-shadow-v19 g-bg-white g-bg-cyan-gradient-opacity-v1 g-color-white text-center rounded g-px-40 g-py-60">
                    <img class="g-brd-around g-brd-3 g-brd-white g-width-80 g-height-80 rounded-circle g-mb-20" src="../../assets/img-temp/100x100/img5.jpg" alt="Image Description">
                ...
                <div class="col-lg-4 g-mb-30">
                  <!-- Testimonials -->
                  <div class="u-shadow-v19 g-bg-white g-bg-cyan-gradient-opacity-v1 g-color-white text-center rounded g-px-40 g-py-60">
                    <img class="g-brd-around g-brd-3 g-brd-white g-width-80 g-height-80 rounded-circle g-mb-20" src="../../assets/img-temp/100x100/img14.jpg" alt="Image Description">
      ...
      <section class="g-py-50">
        ...
        <div id="shortcode10">
          <div class="shortcode-html">
            <div class="g-bg-cover g-bg-size-cover g-bg-pos-center g-bg-black-opacity-0_7--after" style="background-image: url(../../assets/img-temp/1920x1080/img2.jpg);">
              <div class="container g-bg-cover__inner g-py-120">
                <!-- Testimonials -->
                <div class="row justify-content-center">
                  <div class="col-lg-8">
                    <div class="d-flex justify-content-between">
                      <img class="align-self-center g-brd-around g-brd-4 g-brd-primary g-width-100 g-height-100 rounded-circle mr-5" src="../../assets/img-temp/125x125/img4.jpg" alt="Image Description">
              ...
              <div class="row">
                <div class="col-lg-4 g-mt-50 g-mb-90">
                  ...
                  <div class="u-shadow-v19 g-bg-white text-center rounded g-pb-40 g-px-30">
                    <img class="g-brd-7 g-brd-style-solid g-brd-white g-width-100 g-height-100 rounded-circle g-pull-50x-up" src="../../assets/img-temp/100x100/img6.jpg" alt="Image Description">
                ...
                <div class="col-lg-4 g-mt-50 g-mb-90">
                  <!-- Testimonials -->
                  <div class="u-shadow-v19 g-bg-white text-center rounded g-pb-40 g-px-30">
                    <img class="g-brd-7 g-brd-style-solid g-brd-white g-width-100 g-height-100 rounded-circle g-pull-50x-up" src="../../assets/img-temp/100x100/img4.jpg" alt="Image Description">
                    <div class="g-mt-minus-20">
                ...
                <div class="col-lg-4 g-mt-50">
                  <!-- Testimonials -->
                  <div class="u-shadow-v19 g-bg-white text-center rounded g-pb-40 g-px-30">
                    <img class="g-brd-7 g-brd-style-solid g-brd-white g-width-100 g-height-100 rounded-circle g-pull-50x-up" src="../../assets/img-temp/100x100/img5.jpg" alt="Image Description">
                    <div class="g-mt-minus-20">
              ...
              <div class="row">
                <div class="col-md-6 col-lg-4 g-mb-30">
                  ...
                  <div class="u-shadow-v19 g-bg-white text-center rounded g-pt-20 g-pb-40 g-px-40">
                    ...
                    <img class="g-width-70 g-height-70 g-brd-2 g-brd-style-solid g-brd-cyan rounded-circle g-mb-20" src="../../assets/img-temp/100x100/img14.jpg" alt="Image Description">
                ...
                <div class="col-md-6 col-lg-4 g-mb-30">
                  ...
                  <div class="u-shadow-v19 g-bg-white text-center rounded g-pt-20 g-pb-40 g-px-40">
                    ...
                    <img class="g-width-70 g-height-70 g-brd-2 g-brd-style-solid g-brd-pink rounded-circle g-mb-20" src="../../assets/img-temp/100x100/img5.jpg" alt="Image Description ">
                ...
                <div class="col-md-6 col-lg-4 g-mb-30">
                  ...
                  <div class="u-shadow-v19 g-bg-white text-center rounded g-pt-20 g-pb-40 g-px-40">
                    ...
                    <img class="g-width-70 g-height-70 g-brd-2 g-brd-style-solid g-brd-purple rounded-circle g-mb-20" src="../../assets/img-temp/100x100/img7.jpg" alt="Image Description">
              ...
              <div class="row">
                <div class="col-lg-4 g-mb-30">
                  ...
                  <div class="u-shadow-v19 g-brd-bottom g-brd-3 g-brd-cyan-gradient-opacity-v1 g-bg-white text-center g-px-35 g-py-60">
                    <img class="g-brd-x g-brd-y g-brd-3 g-brd-cyan-gradient-opacity-v1 g-width-80 g-height-80 g-mb-30" src="../../assets/img-temp/100x100/img7.jpg" alt="Image Description">
                ...
                <div class="col-lg-4 g-mb-30">
                  <!-- Testimonials -->
                  <div class="u-shadow-v19 g-brd-bottom g-brd-3 g-brd-cyan-gradient-opacity-v1 g-bg-white text-center g-px-35 g-py-60">
                    <img class="g-brd-x g-brd-y g-brd-3 g-brd-cyan-gradient-opacity-v1 g-width-80 g-height-80 g-mb-30" src="../../assets/img-temp/100x100/img5.jpg" alt="Image Description">
                ...
                <div class="col-lg-4 g-mb-30">
                  <!-- Testimonials -->
                  <div class="u-shadow-v19 g-brd-bottom g-brd-3 g-brd-cyan-gradient-opacity-v1 g-bg-white text-center g-px-35 g-py-60">
                    <img class="g-brd-x g-brd-y g-brd-3 g-brd-cyan-gradient-opacity-v1 g-width-80 g-height-80 g-mb-30" src="../../assets/img-temp/100x100/img14.jpg" alt="Image Description">
          ...
          <div class="shortcode-html">
            ...
            <div class="row align-items-stretch no-gutters g-bg-black text-center">
              <div class="col-lg-6 g-pa-60">
                <img class="g-width-70 g-height-70 g-brd-3 g-brd-style-solid g-brd-white rounded-circle g-mb-30" src="../../assets/img-temp/100x100/img6.jpg" alt="Image Description">
              ...
              <div class="col-lg-6 g-bg-size-cover g-min-height-300" data-bg-img-src="../../assets/img-temp/900x900/img1.jpg"></div>
            </div>
            <!-- End Testimonials -->
          </div>
        </div>
        ...
        <div id="shortcode22">
          <div class="shortcode-html">
            ...
            <div class="row justify-content-center g-pt-100--md">
              ...
              <div class="col-md-6 col-lg-4 g-hidden-sm-down g-bg-size-cover g-min-height-300 g-pos-rel g-top-minus-70 g-ml-minus-50" data-bg-img-src="../../assets/img-temp/900x900/img2.jpg"></div>
            </div>
            <!-- End Testimonials -->
          </div>
        </div>
        ...
        <div id="shortcode23">
          <div class="shortcode-html">
            <div class="dzsparallaxer auto-init height-is-based-on-content use-loading g-bg-cover g-bg-black-opacity-0_5--after">
              <div class="divimage dzsparallaxer--target w-100" style="height: 140%; background-image: url(../../assets/img-temp/1920x800/img4.jpg);"></div>
              <div class="container g-bg-cover__inner g-py-100">
                <!-- Testimonials -->
                <div class="row justify-content-center">
                  <div class="col-lg-8">
        ...
        <div class="container">
          ...
          <div id="shortcode24">
            <div class="shortcode-html">
              <!-- Testimonials -->
              <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4 g-hidden-sm-down g-bg-size-cover g-bg-pos-center g-min-height-300" data-bg-img-src="../../assets/img-temp/900x900/img1.jpg"></div>
        ...
        <div id="shortcode25">
          <div class="shortcode-html">
            ...
            <div class="dzsparallaxer auto-init height-is-based-on-content use-loading" data-options='{direction: "reverse", settings_mode_oneelement_max_offset: "150"}'>
              <div class="divimage dzsparallaxer--target w-100 g-bg-size-cover g-bg-img-hero g-bg-cover g-bg-black-opacity-0_6--after" style="height: 130%; background-image: url(../../assets/img-temp/1920x1080/img50.jpg);"></div>
