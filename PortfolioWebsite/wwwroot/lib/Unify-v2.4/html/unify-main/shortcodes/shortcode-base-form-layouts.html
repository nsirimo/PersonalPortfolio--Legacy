...
<head>
  <!-- Title -->
  <title>Form Layouts | Unify - Responsive Website Template</title>
...
<body class="u-body--header-side-push-left u-body--header-side-opened u-has-sidebar-navigation g-overflow-x-hidden">
  <main>
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall" data-options="{direction: 'reverse', settings_mode_oneelement_max_offset: '150'}">
      ...
      <div class="container g-z-index-1 g-py-100">
        <h1 class="g-font-weight-300 g-letter-spacing-1 g-mb-15">Form Layouts</h1>
    ...
    <section>
              ...
              <div class="container g-pt-100 g-pb-70">
                ...
                <div class="row justify-content-center align-items-center g-mb-30">
                  ...
                  <div class="col-sm-6 col-md-2">
                    <!-- Campus -->
                    <select class="js-custom-select w-100 u-select-v2 u-shadow-v32 g-brd-none g-color-black g-color-primary--hover g-bg-white text-left g-rounded-30 g-pl-25 g-py-12" data-placeholder="Campus" data-open-icon="fa fa-angle-down" data-close-icon="fa fa-angle-up">
                      <option></option>
                ...
                <div class="row">
                  <div class="col-sm-6 col-md-3 g-mb-30">
                    <!-- Intake -->
                    <select class="js-custom-select w-100 u-select-v2 u-shadow-v32 g-brd-none g-color-black g-color-primary--hover g-bg-white text-left g-rounded-30 g-pl-25 g-py-12" data-placeholder="Intake" data-open-icon="fa fa-angle-down" data-close-icon="fa fa-angle-up">
                      <option></option>
                  ...
                  <div class="col-sm-6 col-md-3 g-mb-30">
                    <!-- Attendance Type -->
                    <select class="js-custom-select w-100 u-select-v2 u-shadow-v32 g-brd-none g-color-black g-color-primary--hover g-bg-white text-left g-rounded-30 g-pl-25 g-py-12" data-placeholder="Attendance Type" data-open-icon="fa fa-angle-down" data-close-icon="fa fa-angle-up">
                      <option></option>
                  ...
                  <div class="col-sm-6 col-md-3 g-mb-30">
                    <!-- Level of Study -->
                    <select class="js-custom-select w-100 u-select-v2 u-shadow-v32 g-brd-none g-color-black g-color-primary--hover g-bg-white text-left g-rounded-30 g-pl-25 g-py-12" data-placeholder="Level of Study" data-open-icon="fa fa-angle-down" data-close-icon="fa fa-angle-up">
                      <option></option>
                  ...
                  <div class="col-sm-6 col-md-3 g-mb-30">
                    <!-- Area of Study -->
                    <select class="js-custom-select w-100 u-select-v2 u-shadow-v32 g-brd-none g-color-black g-color-primary--hover g-bg-white text-left g-rounded-30 g-pl-25 g-py-12" data-placeholder="Area of Study" data-open-icon="fa fa-angle-down" data-close-icon="fa fa-angle-up">
                      <option></option>
      ...
      <section class="g-py-100">
        ...
        <div id="shortcode2">
          <div class="shortcode-html">
            <!-- Find a Course -->
            <div class="g-bg-img-hero g-bg-pos-top-center g-pos-rel g-z-index-1 g-mt-minus-150" style="background-image: url(../../assets/include/svg/svg-bg5.svg);">
                  ...
                  <div class="col-xl-8 g-mb-30">
                    ...
                    <div class="row">
                      <div class="col-sm-6 g-mb-50">
                        ...
                        <select class="js-custom-select w-100 u-select-v2 u-shadow-v19 g-brd-none g-color-black g-color-primary--hover g-bg-white text-left g-rounded-30 g-pl-30 g-py-12" data-placeholder="Area of Interest" data-open-icon="fa fa-angle-down" data-close-icon="fa fa-angle-up">
  ...
  <script src="../../assets/js/helpers/hs.dropdown.js"></script>
  <script src="../../assets/js/components/hs.select.js"></script>
  <script src="../../assets/js/components/hs.datepicker.js"></script>
