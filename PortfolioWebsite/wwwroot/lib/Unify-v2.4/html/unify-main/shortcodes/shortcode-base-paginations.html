  ...
  <main>
      ...
      <div class="u-header__sections-container">
        <div class="u-sidebar-navigation-inner">
          ...
          <ul class="js-shortcode-filter-result nav flex-column u-sidebar-navigation-list">
            ...
            <li class="js-shortcode-filter__item nav-item bases">
              <a href="../../unify-main/shortcodes/shortcode-base-paginations.html" class="nav-link active">Paginations</a>
            </li>
            <li class="js-shortcode-filter__item nav-item bases">
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall" data-options="{direction: 'reverse', settings_mode_oneelement_max_offset: '150'}">
      ...
      <div class="container g-z-index-1 g-py-100">
        <h1 class="g-font-weight-300 g-letter-spacing-1 g-mb-15">Paginations</h1>
    ...
    <section>
      ...
      <section class="g-py-50">
        <div class="container">
          ...
          <div>
            <!-- Heading -->
            <header class="text-center mx-auto g-width-80x--md g-mb-50">
              <h2 class="h4 g-mb-20">Pagination
                <span class="g-color-primary g-ml-5">#01</span>
              </h2>
              <p>Pagination links indicate a series of related content exists across multiple pages. Typically these are used where a multi-page approach to long lists of content improves general performance, such as in search results or inboxes.</p>
            </header>
            <!-- End Heading -->
                ...
                <nav aria-label="Page Navigation">
                  <ul class="list-inline">
                    ...
                    <li class="list-inline-item float-right">
                      <span class="u-pagination-v1__item-info g-pa-12-19">Page 1 of 15</span>
                    </li>
                  </ul>
                </nav>
                <!-- End Pagination #01 -->
              ...
              <div class="shortcode-html">
                ...
                <nav aria-label="Page Navigation">
                  <ul class="list-inline">
                    ...
                    <li class="list-inline-item float-right">
                      <span class="u-pagination-v1__item-info g-pa-7-14">Page 2 of 80</span>
                    </li>
                  </ul>
                </nav>
                <!-- End Pagination #02 -->
            ...
            <div id="shortcode3">
              <div class="shortcode-html">
                ...
                <nav aria-label="Page Navigation">
                  <ul class="list-inline">
                    <li class="list-inline-item">
                      <a class="u-pagination-v1__item u-pagination-v1-3 g-pa-4-13" href="#!" aria-label="Previous">
                        <span aria-hidden="true">
                          <i class="fa fa-angle-left"></i>
                        </span>
                        <span class="sr-only">Previous</span>
                    ...
                    <li class="list-inline-item g-hidden-sm-down">
                      <a class="u-pagination-v1__item u-pagination-v1-3 u-pagination-v1-3--active g-pa-4-11" href="#!">1</a>
                    </li>
                    <li class="list-inline-item g-hidden-sm-down">
                      <a class="u-pagination-v1__item u-pagination-v1-3 g-pa-4-11" href="#!">2</a>
                    </li>
                    <li class="list-inline-item g-hidden-sm-down">
                      <a class="u-pagination-v1__item u-pagination-v1-3 g-pa-4-11" href="#!">3</a>
                    </li>
                    <li class="list-inline-item g-hidden-sm-down">
                      <span class="g-pa-4-11">...</span>
                    </li>
                    <li class="list-inline-item g-hidden-sm-down">
                      <a class="u-pagination-v1__item u-pagination-v1-3 g-pa-4-11" href="#!">80</a>
                    </li>
                    <li class="list-inline-item">
                      <a class="u-pagination-v1__item u-pagination-v1-3 g-pa-4-13" href="#!" aria-label="Next">
                        <span aria-hidden="true">
                          <i class="fa fa-angle-right"></i>
                        </span>
                        <span class="sr-only">Next</span>
            ...
            <div id="shortcode4">
              <div class="shortcode-html">
                ...
                <nav aria-label="Page Navigation">
                  <ul class="list-inline">
                    <li class="list-inline-item">
                      <a class="u-pagination-v1__item u-pagination-v1-1 u-pagination-v1__item--disabled g-rounded-50 g-pa-12-21" href="#!" aria-label="Previous">
                        <span aria-hidden="true">
                          <i class="fa fa-angle-left"></i>
                        </span>
                        <span class="sr-only">Previous</span>
                    ...
                    <li class="list-inline-item g-hidden-sm-down">
                      <a class="u-pagination-v1__item u-pagination-v1-1 u-pagination-v1-1--active g-rounded-50 g-pa-12-19" href="#!">1</a>
                    </li>
                    <li class="list-inline-item g-hidden-sm-down">
                      <a class="u-pagination-v1__item u-pagination-v1-1 g-rounded-50 g-pa-12-19" href="#!">2</a>
                    </li>
                    <li class="list-inline-item g-hidden-sm-down">
                      <a class="u-pagination-v1__item u-pagination-v1-1 g-rounded-50 g-pa-12-19" href="#!">3</a>
                    </li>
                    <li class="list-inline-item g-hidden-sm-down">
                      <span class="g-pa-12-19">...</span>
                    </li>
                    <li class="list-inline-item g-hidden-sm-down">
                      <a class="u-pagination-v1__item u-pagination-v1-1 g-rounded-50 g-pa-12-19" href="#!">15</a>
                    </li>
                    <li class="list-inline-item">
                      <a class="u-pagination-v1__item u-pagination-v1-1 g-rounded-50 g-pa-12-21" href="#!" aria-label="Next">
                        <span aria-hidden="true">
                          <i class="fa fa-angle-right"></i>
                        </span>
                        <span class="sr-only">Next</span>
            ...
            <div id="shortcode5">
              <div class="shortcode-html">
                ...
                <nav aria-label="Page Navigation">
                  <ul class="list-inline">
                    <li class="list-inline-item">
                      <a class="u-pagination-v1__item u-pagination-v1-2 g-rounded-50 g-pa-7-16" href="#!" aria-label="Previous">
                        <span aria-hidden="true">
                          <i class="fa fa-angle-left"></i>
                        </span>
                        <span class="sr-only">Previous</span>
                    ...
                    <li class="list-inline-item g-hidden-sm-down">
                      <a class="u-pagination-v1__item u-pagination-v1-2 g-rounded-50 g-pa-7-14" href="#!">1</a>
                    </li>
                    <li class="list-inline-item g-hidden-sm-down">
                      <a class="u-pagination-v1__item u-pagination-v1-2 u-pagination-v1-2--active g-rounded-50 g-pa-7-14" href="#!">2</a>
                    </li>
                    <li class="list-inline-item g-hidden-sm-down">
                      <a class="u-pagination-v1__item u-pagination-v1-2 g-rounded-50 g-pa-7-14" href="#!">3</a>
                    </li>
                    <li class="list-inline-item g-hidden-sm-down">
                      <a class="g-rounded-50 g-pa-7-14">...</a>
                    </li>
                    <li class="list-inline-item g-hidden-sm-down">
                      <a class="u-pagination-v1__item u-pagination-v1-2 g-rounded-50 g-pa-7-14" href="#!">80</a>
                    </li>
                    <li class="list-inline-item">
                      <a class="u-pagination-v1__item u-pagination-v1-2 g-rounded-50 g-pa-7-16" href="#!" aria-label="Next">
                        <span aria-hidden="true">
                          <i class="fa fa-angle-right"></i>
                        </span>
                        <span class="sr-only">Next</span>
            ...
            <div id="shortcode6">
              <div class="shortcode-html">
                ...
                <nav aria-label="Page Navigation">
                  <ul class="list-inline">
                    <li class="list-inline-item">
                      <a class="u-pagination-v1__item u-pagination-v1-3 g-rounded-50 g-pa-4-13" href="#!" aria-label="Previous">
                        <span aria-hidden="true">
                          <i class="fa fa-angle-left"></i>
                        </span>
                        <span class="sr-only">Previous</span>
                    ...
                    <li class="list-inline-item g-hidden-sm-down">
                      <a class="u-pagination-v1__item u-pagination-v1-3 u-pagination-v1-3--active g-rounded-50 g-pa-4-11" href="#!">1</a>
                    </li>
                    <li class="list-inline-item g-hidden-sm-down">
                      <a class="u-pagination-v1__item u-pagination-v1-3 g-rounded-50 g-pa-4-11" href="#!">2</a>
                    </li>
                    <li class="list-inline-item g-hidden-sm-down">
                      <a class="u-pagination-v1__item u-pagination-v1-3 g-rounded-50 g-pa-4-11" href="#!">3</a>
                    </li>
                    <li class="list-inline-item g-hidden-sm-down">
                      <span class="g-rounded-50 g-pa-4-11">...</span>
                    </li>
                    <li class="list-inline-item g-hidden-sm-down">
                      <a class="u-pagination-v1__item u-pagination-v1-3 g-rounded-50 g-pa-4-11" href="#!">80</a>
                    </li>
                    <li class="list-inline-item">
                      <a class="u-pagination-v1__item u-pagination-v1-3 g-rounded-50 g-pa-4-13" href="#!" aria-label="Next">
                        <span aria-hidden="true">
                          <i class="fa fa-angle-right"></i>
                        </span>
                        <span class="sr-only">Next</span>
      ...
      <!-- End Rounded Paginations -->

      <hr class="g-brd-gray-light-v4 g-my-50">

      <!-- Centered Paginations -->
      <section class="g-py-50">
        <div class="container">
          <!-- Pagination #07 -->
          <div>
              ...
              <div class="shortcode-html">
                ...
                <nav class="text-center" aria-label="Page Navigation">
                  <ul class="list-inline">
                    ...
                    <li class="list-inline-item g-hidden-sm-down">
                      <a class="u-pagination-v1__item u-pagination-v1-2 u-pagination-v1__item--disabled g-pa-12-19" href="#!">1</a>
                    </li>
                    <li class="list-inline-item g-hidden-sm-down">
                      <a class="u-pagination-v1__item u-pagination-v1-2 u-pagination-v1-2--active g-pa-12-19" href="#!">2</a>
                    </li>
                    <li class="list-inline-item g-hidden-sm-down">
                      <a class="u-pagination-v1__item u-pagination-v1-2 g-pa-12-19" href="#!">3</a>
                    </li>
                    <li class="list-inline-item g-hidden-sm-down">
                      <span class="g-pa-12-19">...</span>
                    </li>
                    <li class="list-inline-item g-hidden-sm-down">
                      <a class="u-pagination-v1__item u-pagination-v1-2 g-pa-12-19" href="#!">15</a>
                    </li>
            ...
            <div id="shortcode12">
              <div class="shortcode-html">
                ...
                <nav class="text-center" aria-label="Page Navigation">
                  <ul class="list-inline">
                    <li class="list-inline-item float-sm-left">
                      <a class="u-pagination-v1__item u-pagination-v1-3 g-brd-2 g-pa-4-13" href="#!" aria-label="Previous">
                        <span aria-hidden="true">
                          <i class="fa fa-angle-left g-mr-5"></i>
                          Previous
                        </span>
                    ...
                    <li class="list-inline-item g-hidden-sm-down">
                      <a class="u-pagination-v1__item u-pagination-v1-3 u-pagination-v1-3--active g-brd-2 g-pa-4-11" href="#!">1</a>
                    </li>
                    <li class="list-inline-item g-hidden-sm-down">
                      <a class="u-pagination-v1__item u-pagination-v1-3 g-brd-2 g-pa-4-11" href="#!">2</a>
                    </li>
                    <li class="list-inline-item g-hidden-sm-down">
                      <a class="u-pagination-v1__item u-pagination-v1-3 g-brd-2 g-pa-4-11" href="#!">3</a>
                    </li>
                    <li class="list-inline-item g-hidden-sm-down">
                      <span class="g-pa-4-11">...</span>
                    </li>
                    <li class="list-inline-item g-hidden-sm-down">
                      <a class="u-pagination-v1__item u-pagination-v1-3 g-brd-2 g-pa-4-11" href="#!">80</a>
                    </li>
                    <li class="list-inline-item float-sm-right">
                      <a class="u-pagination-v1__item u-pagination-v1-3 g-brd-2 g-pa-4-13" href="#!" aria-label="Next">
                        <span aria-hidden="true">
                          Next
                          <i class="fa fa-angle-right g-ml-5"></i>
                        </span>
            ...
            <div id="shortcode13">
              <div class="shortcode-html">
                ...
                <nav class="text-center" aria-label="Page Navigation">
                  <ul class="list-inline">
                    <li class="list-inline-item float-sm-left">
                      <a class="u-pagination-v1__item g-brd-around g-bg-gray-dark-v3 g-color-white g-bg-gray-dark-v2--hover g-rounded-50 g-pa-12-21" href="#!" aria-label="Previous">
                        <span aria-hidden="true">
                          <i class="fa fa-angle-left g-mr-5"></i>
                          Previous
                        </span>
                    ...
                    <li class="list-inline-item hidden-down">
                      <a class="u-pagination-v1__item g-color-gray-dark-v3 g-pa-12-19">Page 2 of 15</a>
                    </li>
                    <li class="list-inline-item float-sm-right">
                      <a class="u-pagination-v1__item g-brd-around g-bg-gray-dark-v3 g-color-white g-bg-gray-dark-v2--hover g-rounded-50 g-pa-12-21" href="#!" aria-label="Next">
                        <span aria-hidden="true">
                          Next
                          <i class="fa fa-angle-right g-ml-5"></i>
                        </span>
            ...
            <div id="shortcode14">
              <div class="shortcode-html">
                ...
                <nav class="text-center" aria-label="Page Navigation">
                  <ul class="list-inline">
                    <li class="list-inline-item float-sm-left">
                      <a class="u-pagination-v1__item g-brd-around g-color-primary g-brd-gray-light-v3 g-bg-gray-dark-v2--hover g-brd-gray-dark-v2--hover g-color-white--hover g-rounded-50 g-pa-7-16" href="#!" aria-label="Previous">
                        <span aria-hidden="true">
                          <i class="fa fa-angle-left g-mr-5"></i>
                          Previous
                        </span>
                    ...
                    <li class="list-inline-item font-italic">
                      <a class="g-color-gray-dark-v3 g-pa-7-14">3 of 116</a>
                    </li>
                    <li class="list-inline-item float-sm-right">
                      <a class="u-pagination-v1__item g-brd-around g-color-primary g-brd-gray-light-v3 g-bg-gray-dark-v2--hover g-brd-gray-dark-v2--hover g-color-white--hover g-rounded-50 g-pa-7-16" href="#!" aria-label="Next">
                        <span aria-hidden="true">
                          Next
                          <i class="fa fa-angle-right g-ml-5"></i>
                        </span>
      ...
      <section class="g-pt-50 g-pb-100">
        <div class="container">
          <!-- Heading -->
          <header class="text-center mx-auto g-width-80x--md g-mb-50">
            <h2 class="h4 g-mb-20">Bootstrap Paginations</h2>
            <p>Pagination links indicate a series of related content exists across multiple pages. Typically these are used where a multi-page approach to long lists of content improves general performance, such as in search results or inboxes.</p>
          </header>
          <!-- End Heading -->
          ...
          <div class="row">
            ...
            <div class="col-lg-4">
              <h3 class="h5">Disabled and active states</h3>
