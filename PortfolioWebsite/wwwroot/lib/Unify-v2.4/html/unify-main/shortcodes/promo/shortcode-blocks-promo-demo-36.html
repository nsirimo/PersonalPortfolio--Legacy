...
<head>
  <!-- Title -->
  <title>Promo Blocks 36 | Unify - Responsive Website Template</title>
...
<body>
  <main>
    ...
    <!-- Promo Block -->
    <div class="g-bg-cover g-bg-pos-top-center g-bg-img-hero g-bg-cover g-bg-black-opacity-0_5--after g-py-120" style="background-image: url(../../../assets/img-temp/1920x800/img33.jpg);">
        ...
        <form>
          ...
          <div class="row justify-content-center">
            <div class="col-sm-4 col-lg-3 g-mb-30">
              <!-- Button Group -->
              <select class="js-custom-select w-100 u-select-v1 g-brd-gray-light-v3 g-color-black g-color-primary--hover g-bg-white g-py-12" required data-placeholder="All Property Types" data-open-icon="fa fa-angle-down" data-close-icon="fa fa-angle-up">
                <option></option>
            ...
            <div class="col-sm-4 col-lg-3 g-mb-30">
              <!-- Button Group -->
              <select class="js-custom-select w-100 u-select-v1 g-brd-gray-light-v3 g-color-black g-color-primary--hover g-bg-white g-py-12" required data-placeholder="Min Price" data-open-icon="fa fa-angle-down" data-close-icon="fa fa-angle-up">
                <option></option>
            ...
            <div class="col-sm-4 col-lg-3 g-mb-30">
              <!-- Button Group -->
              <select class="js-custom-select w-100 u-select-v1 g-brd-gray-light-v3 g-color-black g-color-primary--hover g-bg-white g-py-12" required data-placeholder="Max Price" data-open-icon="fa fa-angle-down" data-close-icon="fa fa-angle-up">
                <option></option>
