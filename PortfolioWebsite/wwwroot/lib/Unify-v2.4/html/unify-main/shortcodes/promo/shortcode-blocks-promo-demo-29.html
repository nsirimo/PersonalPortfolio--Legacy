...
<head>
  <!-- Title -->
  <title>Promo Blocks 29 | Unify - Responsive Website Template</title>
  ...
  <main>
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall g-bg-cover g-bg-black-opacity-0_3--after" data-options='{direction: "fromtop", animation_duration: 25, direction: "reverse"}'>
      ...
      <div class="dzsparallaxer--target" style="width: 100%; height: 130%;" data-forcewidth_ratio="1.77">
        <div class="js-bg-video g-pos-abs w-100 h-100" data-hs-bgv-type="vimeo" data-hs-bgv-id="167434033" data-hs-bgv-loop="true"></div>
      </div>
      ...
      <div class="g-pt-120">
        <div class="container g-color-white text-center g-pos-rel g-z-index-3">
          ...
          <a class="js-fancybox d-block g-mb-130" href="javascript:;" data-src="//vimeo.com/167434033" data-caption="Single Image" data-animate-in="fadeInUp" data-animate-out="fadeOutUp" data-speed="1000">
          ...
          <ul class="row list-inline text-center g-pb-60 mb-0">
            <li class="col" data-animation="fadeIn" data-animation-delay="1800" data-animation-duration="1500">
              <img class="g-width-100 g-opacity-0_6 g-opacity-1--hover g-cursor-pointer g-transition-0_3" src="../../../assets/img-temp/200x100/img1.png" alt="Image Description">
            </li>
            <li class="col mx-5" data-animation="fadeIn" data-animation-delay="1700" data-animation-duration="1500">
              <img class="g-width-100 g-opacity-0_6 g-opacity-1--hover g-cursor-pointer g-transition-0_3" src="../../../assets/img-temp/200x100/img2.png" alt="Image Description">
            </li>
            <li class="col mx-5" data-animation="fadeIn" data-animation-delay="1600" data-animation-duration="1500">
              <img class="g-width-100 g-opacity-0_6 g-opacity-1--hover g-cursor-pointer g-transition-0_3" src="../../../assets/img-temp/200x100/img3.png" alt="Image Description">
            </li>
            <li class="col mx-5" data-animation="fadeIn" data-animation-delay="1500" data-animation-duration="1500">
              <img class="g-width-100 g-opacity-0_6 g-opacity-1--hover g-cursor-pointer g-transition-0_3" src="../../../assets/img-temp/200x100/img4.png" alt="Image Description">
            </li>
            <li class="col" data-animation="fadeIn" data-animation-delay="1400" data-animation-duration="1500">
              <img class="g-width-100 g-opacity-0_6 g-opacity-1--hover g-cursor-pointer g-transition-0_3" src="../../../assets/img-temp/200x100/img5.png" alt="Image Description">
            </li>
          </ul>
        </div>
      </div>
