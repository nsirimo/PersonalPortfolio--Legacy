  ...
  <main>
    ...
    <section class="container-fluid g-px-0">
      <div class="row no-gutters">
        <div class="col-md-6 order-md-2 g-bg-lightred">
          <div class="g-pa-15x">
            <div class="g-mb-100">
            ...
            <div class="row">
              ...
              <div class="col-md-5 col-lg-6 align-self-end order-md-1 g-mb-minus-20">
                <img class="g-width-200" src="../../../assets/img-temp/525x300/img1.png" alt="Image Description">
              </div>
            </div>
          </div>
        </div>
        <div class="col-md-6 order-md-1 g-bg-size-cover g-bg-pos-top-center g-min-height-400" data-bg-img-src="../../../assets/img-temp/900x900/img1.jpg"></div>
      </div>
    </section>
    <!-- End Promo Block -->
