...
<head>
  <!-- Title -->
  <title>Promo Blocks 23 | Unify - Responsive Website Template</title>
...
<body>
  <main>
    ...
    <!-- Promo Block -->
    <section class="g-bg-cover g-flex-centered g-bg-pos-top-center g-bg-img-hero g-bg-black-opacity-0_3--after" style="background-image: url(../../../assets/img-temp/1920x1080/img24.jpg);" data-calc-target="#js-header">
          ...
          <div class="col-lg-5 align-self-center g-mb-40 g-mb-0--lg">
            <div class="g-bg-white g-rounded-5 g-pa-40">
              ...
              <form>
                ...
                <div class="form-group g-mb-20">
                  <select class="js-custom-select u-select-v1 form-control g-brd-gray-light-v5 g-color-gray-light-v1 g-bg-gray-light-v5 g-px-10 g-py-13" style="width: 100%;" data-placeholder="Product Type" data-control-classes="g-color-gray-dark-v2 g-bg-gray-light-v5"
                  data-disable-search="1" data-open-icon="fa fa-angle-down" data-close-icon="fa fa-angle-up">
                    <option></option>
