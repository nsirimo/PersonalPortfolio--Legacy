...
<head>
  <!-- Title -->
  <title>Promo Blocks 4 | Unify - Responsive Website Template</title>
...
<body>
  <main>
    ...
    <!-- Promo Block -->
    <section class="g-bg-cover g-bg-pos-bottom-center g-bg-img-hero g-bg-bluegray-opacity-0_3--after g-min-height-100vh g-flex-centered g-py-150" style="background-image: url(../../../assets/img-temp/1920x1080/img7.jpg);">
  ...
  <script>
    $(document).ready(function () {
      ...
      // initialization of popspu with media
