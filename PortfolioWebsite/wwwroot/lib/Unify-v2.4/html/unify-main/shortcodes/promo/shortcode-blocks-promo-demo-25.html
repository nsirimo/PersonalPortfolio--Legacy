...
<head>
  <!-- Title -->
  <title>Promo Blocks 25 | Unify - Responsive Website Template</title>
...
<body>
  <main>
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall" data-options='{direction: "reverse", settings_mode_oneelement_max_offset: "150"}' data-calc-target="#js-header">
      <div class="divimage dzsparallaxer--target w-100 g-min-height-100vh" style="height: 130%; background-image: url(../../../assets/img-temp/1920x1080/img26.jpg);"></div>

      <div class="g-pos-abs g-top-0 g-left-0" data-parallaxanimation='[{property: "transform", value:" translate3d(0,px,0)", initial:"-50", mid:"0", final:"50"}]' data-animation="fadeInDown" data-animation-delay="100" data-animation-duration="1500">
        <img class="img-fluid" src="../../../assets/img-temp/1920x1080/img27.png" alt="Image Description">
      </div>
      <div class="g-pos-abs g-top-0 g-left-0" data-parallaxanimation='[{property: "transform", value:" translate3d(0,px,0)", initial:"-50", mid:"0", final:"50"}]' data-animation="fadeInDown" data-animation-delay="600" data-animation-duration="1500">
        <img class="img-fluid" src="../../../assets/img-temp/1920x1080/img28.png" alt="Image Description">
      </div>
      <div class="g-pos-abs g-top-minus-70 g-right-0" data-parallaxanimation='[{property: "transform", value:" translate3d(0,px,0)", initial:"80", mid:"0", final:"-50"}]' data-animation="fadeInDown" data-animation-delay="500" data-animation-duration="1500">
        <img class="img-fluid" src="../../../assets/img-temp/1920x1080/img34.png" alt="Image Description">
      </div>
      <div class="g-pos-abs g-bottom-0 g-left-0" data-parallaxanimation='[{property: "transform", value:" translate3d(0,px,0)", initial:"-50", mid:"0", final:"50"}]' data-animation="fadeInUp" data-animation-delay="1200" data-animation-duration="1500">
        <img class="img-fluid" src="../../../assets/img-temp/1920x1080/img29.png" alt="Image Description">
      </div>
      <div class="g-pos-abs g-bottom-0 g-left-0" data-parallaxanimation='[{property: "transform", value:" translate3d(0,px,0)", initial:"-50", mid:"0", final:"50"}]' data-animation="fadeInUp" data-animation-delay="1500" data-animation-duration="1500">
        <img class="img-fluid" src="../../../assets/img-temp/1920x1080/img30.png" alt="Image Description">
      </div>
      <div class="g-pos-abs g-bottom-0 g-right-0" data-parallaxanimation='[{property: "transform", value:" translate3d(0,px,0)", initial:"-50", mid:"0", final:"50"}]' data-animation="fadeInRight" data-animation-delay="1500" data-animation-duration="1500">
        <img class="img-fluid" src="../../../assets/img-temp/1920x1080/img31.png" alt="Image Description">
      </div>
      <div class="g-pos-abs g-bottom-0 g-right-0" data-parallaxanimation='[{property: "transform", value:" translate3d(0,px,0)", initial:"-50", mid:"0", final:"50"}]' data-animation="fadeInUp" data-animation-delay="2300" data-animation-duration="1500">
        <img class="img-fluid" src="../../../assets/img-temp/1920x1080/img32.png" alt="Image Description">
      </div>
      <div class="g-pos-abs g-bottom-0 g-right-0" data-parallaxanimation='[{property: "transform", value:" translate3d(0,px,0)", initial:"-50", mid:"0", final:"50"}]' data-animation="fadeInUp" data-animation-delay="2600" data-animation-duration="1500">
        <img class="img-fluid" src="../../../assets/img-temp/1920x1080/img33.png" alt="Image Description">
      </div>

      <div class="g-absolute-centered--y g-left-0 g-right-0">
        <div class="container text-center g-z-index-1">
          <h2 class="h2 d-inline-block g-brd-1 g-brd-y g-brd-white g-color-white text-uppercase g-pos-rel g-px-60 g-py-15 g-mb-50" data-animation="fadeInDown" data-animation-delay="200" data-animation-duration="1500">
          ...
          <div class="u-heading-v2-3--bottom g-brd-white g-mb-40" data-animation="fadeInDown" data-animation-delay="500" data-animation-duration="1500">
          ...
          <div data-animation="fadeInDown" data-animation-delay="800" data-animation-duration="1500">
