...
<head>
  <!-- Title -->
  <title>Promo Blocks 10 | Unify - Responsive Website Template</title>
...
<body>
  <main>
    ...
    <!-- Promo Block -->
    <section class="g-bg-cover g-bg-pos-center g-bg-img-hero g-bg-black-opacity-0_3--after g-flex-centered g-py-150" style="background-image: url(../../../assets/img-temp/1920x1080/img12.jpg);">
          ...
          <div class="col-md-7 g-overflow-hidden">
            <div class="g-brd-around g-brd-7 g-brd-white" data-animation="fadeInRight" data-animation-delay="1700" data-animation-duration="1500">
              ...
              <div class="embed-responsive embed-responsive-16by9">
                <video class="js-video-audio u-video-v1 mb-0" poster="../../../assets/media-temp/video-bg/video-bg-poster.jpg" preload data-plyr='{"controls" : ["play-large"]}'>
                  <source src="../../../assets/media-temp/video-bg/video-bg.mp4" type="video/mp4;">
                    <source src="../../../assets/media-temp/video-bg/video-bg.webm" type="video/webm;">
                      <a href="../../../assets/media-temp/video-bg/video-bg.mp4" download>Download</a>
                </video>
              </div>
