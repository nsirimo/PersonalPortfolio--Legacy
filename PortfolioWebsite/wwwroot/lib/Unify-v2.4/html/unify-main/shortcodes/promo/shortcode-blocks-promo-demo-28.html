...
<head>
  <!-- Title -->
  <title>Promo Blocks 28 | Unify - Responsive Website Template</title>
...
<body>
  <main>
    ...
    <!-- Promo Block -->
    <section class="js-carousel" data-infinite="true" data-fade="true" data-speed="5000" data-pagi-classes="u-carousel-indicators-v1 g-absolute-centered--x g-bottom-30">
      <div class="js-slide g-min-height-600 g-flex-centered g-bg-cover g-bg-pos-top-center g-bg-img-hero g-bg-black-opacity-0_3--after" style="background-image: url(../../../assets/img-temp/1920x1080/img35.jpg);">
        <!-- Promo Block Content -->
      ...
      <div class="js-slide g-min-height-600 g-flex-centered g-bg-cover g-bg-pos-top-center g-bg-img-hero g-bg-black-opacity-0_3--after" style="background-image: url(../../../assets/img-temp/1920x1080/img2.jpg);">
        <!-- Promo Block Content -->
