...
<head>
  <!-- Title -->
  <title>Team Blocks | Unify - Responsive Website Template</title>
  ...
  <main>
          ...
          <ul class="js-shortcode-filter-result nav flex-column u-sidebar-navigation-list">
            ...
            <li class="js-shortcode-filter__item nav-item dropdown blocks">
              ...
              <div class="dropdown-menu u-dropdown-static">
                <ul class="nav flex-column">
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../unify-main/shortcodes/shortcode-blocks-team.html" class="nav-link active">Team</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item blocks">
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall g-overflow-hidden" data-options="{direction: 'reverse', settings_mode_oneelement_max_offset: '150'}">
      ...
      <div class="container g-z-index-1 g-py-100">
        <h1 class="g-font-weight-300 g-letter-spacing-1 g-mb-15">Team Blocks</h1>
              ...
              <div class="row">
                <div class="col-lg-3 col-sm-6 g-mb-20">
                  <div class="text-center">
                    ...
                    <figure class="u-block-hover g-mb-20">
                      <!-- Figure Image -->
                      <img class="w-100 u-block-hover__img" src="../../assets/img-temp/400x450/img1.jpg" alt="Image Description">
                      <!-- Figure Image -->
                ...
                <div class="col-lg-3 col-sm-6 g-mb-20">
                  <div class="text-center">
                    ...
                    <figure class="u-block-hover g-mb-20">
                      <!-- Figure Image -->
                      <img class="w-100 u-block-hover__img" src="../../assets/img-temp/400x450/img2.jpg" alt="Image Description">
                      <!-- Figure Image -->
                ...
                <div class="col-lg-3 col-sm-6 g-mb-20">
                  <div class="text-center">
                    ...
                    <figure class="u-block-hover g-mb-20">
                      <!-- Figure Image -->
                      <img class="w-100 u-block-hover__img" src="../../assets/img-temp/400x450/img3.jpg" alt="Image Description">
                      <!-- Figure Image -->
                ...
                <div class="col-lg-3 col-sm-6 g-mb-20">
                  <div class="text-center">
                    ...
                    <figure class="u-block-hover g-mb-20">
                      <!-- Figure Image -->
                      <img class="w-100 u-block-hover__img" src="../../assets/img-temp/400x450/img4.jpg" alt="Image Description">
                      <!-- Figure Image -->
              ...
              <figure class="row">
                ...
                <div class="col-lg-8">
                  ...
                  <div class="g-mb-50">
                    ...
                    <p>As creatives, it's important that I strive to do work outside of obligation. This lets us stay ahead of the curve for our clients and internal projects. At the end of the day, it's important to not let being busy distract us from having
                      fun. Smiling, laughing, and hanging helps us work together to achieve this.</p>
                  </div>
                  <!-- End Info -->
              ...
              <div class="row">
                <div class="col-lg-3 col-sm-6 g-mb-30">
                  ...
                  <figure class="g-color-gray-dark-v2">
                    <!-- Figure Image -->
                    <img class="w-100 g-mb-30" src="../../assets/img-temp/400x450/img4.jpg" alt="Image Description">
                    <!-- End Figure Image -->
                ...
                <div class="col-lg-3 col-sm-6 g-mb-30">
                  ...
                  <figure class="g-color-gray-dark-v2">
                    <!-- Figure Image -->
                    <img class="w-100 g-mb-30" src="../../assets/img-temp/400x450/img1.jpg" alt="Image Description">
                    <!-- End Figure Image -->
                ...
                <div class="col-lg-3 col-sm-6 g-mb-30">
                  ...
                  <figure class="g-color-gray-dark-v2">
                    <!-- Figure Image -->
                    <img class="w-100 g-mb-30" src="../../assets/img-temp/400x450/img2.jpg" alt="Image Description">
                    <!-- End Figure Image -->
                ...
                <div class="col-lg-3 col-sm-6 g-mb-30">
                  ...
                  <figure class="g-color-gray-dark-v2">
                    <!-- Figure Image -->
                    <img class="w-100 g-mb-30" src="../../assets/img-temp/400x450/img3.jpg" alt="Image Description">
                    <!-- End Figure Image -->
              ...
              <div class="row">
                <div class="col-sm-4 g-mb-60">
                  ...
                  <figure class="text-center">
                    ...
                    <div class="d-block mx-auto rounded-circle g-max-width-200 g-bg-white g-pa-5 g-mb-15">
                      <img class="rounded-circle g-max-width-190" src="../../assets/img-temp/200x200/img3.jpg" alt="Image Description">
                    </div>
                    <!-- End Figure Image -->
                ...
                <div class="col-sm-4 g-mb-60">
                  ...
                  <figure class="text-center">
                    <!-- Figure Image -->
                    <div class="d-block mx-auto rounded-circle g-max-width-200 g-bg-white g-pa-5 g-mb-15">
                      <img class="rounded-circle g-max-width-190" src="../../assets/img-temp/200x200/img4.jpg" alt="Image Description">
                    </div>
                    <!-- End Figure Image -->
                ...
                <div class="col-sm-4 g-mb-60">
                  ...
                  <figure class="text-center">
                    <!-- Figure Image -->
                    <div class="d-block mx-auto rounded-circle g-max-width-200 g-bg-white g-pa-5 g-mb-15">
                      <img class="rounded-circle g-max-width-190" src="../../assets/img-temp/200x200/img6.jpg" alt="Image Description">
                    </div>
                    <!-- End Figure Image -->
                        ...
                        <div class="col-md-5">
                          ...
                          <div class="g-bg-secondary text-center g-pa-20">
                            <div class="u-shadow-v19 g-width-110 g-height-110 g-brd-around g-brd-5 g-brd-white rounded-circle mx-auto mb-4">
                              <img class="img-fluid rounded-circle" src="../../assets/img-temp/200x200/img3.jpg" alt="Image description">
                            </div>
