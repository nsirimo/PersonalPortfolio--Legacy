...
<head>
  <!-- Title -->
  <title>Media Videos | Unify - Responsive Website Template</title>
  ...
  <main>
            ...
            <li class="js-shortcode-filter__item nav-item dropdown bases">
              ...
              <div class="dropdown-menu u-dropdown-static">
                <ul class="nav flex-column">
                  ...
                  <li class="js-shortcode-filter__item nav-item bases">
                    <a href="../../unify-main/shortcodes/shortcode-base-media-videos.html" class="nav-link active">Media Videos</a>
                  </li>
                </ul>
              </div>
            </li>
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall" data-options="{direction: 'reverse', settings_mode_oneelement_max_offset: '150'}">
      ...
      <div class="container g-z-index-1 g-py-100">
        <h1 class="g-font-weight-300 g-letter-spacing-1 g-mb-15">Media Videos</h1>
          ...
          <header class="g-mb-80">
            ...
            <div class="g-pl-90">
              <p>You may use Vimoe, Youtube, Facebook and HTML5 videos by using resonsive aspect ratio utility classes. In these examples, we use Aspect ratio (16:9) by default using the following classes
                <code>.embed-responsive</code> and <code>.embed-responsive-16by9</code>
              </p>
            </div>
          </header>
          <!-- End Heading -->
            ...
            <div class="col-md-9">
              <div id="shortcode4">
                <div class="shortcode-html">
                  <!-- Facebook Example -->
                  <div class="embed-responsive embed-responsive-16by9 g-mb-60">
                    <iframe src="https://www.facebook.com/plugins/video.php?href=https%3A%2F%2Fwww.facebook.com%2FSpaceX%2Fvideos%2Fvb.353851465130%2F10156509755310131%2F%3Ftype%3D3&show_text=0&width=560" width="560" height="315" style="border:none;overflow:hidden" scrolling="no"
                  ...
                  <section class="container-fluid px-0">
                    <div class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall g-bg-cover g-bg-black-opacity-0_6--after" data-options='{direction: "fromtop", animation_duration: 25, direction: "reverse"}'>
                      ...
                      <div class="text-center g-pos-rel g-z-index-1 g-px-50 g-py-200">
                        <a class="js-fancybox d-block mb-5" href="javascript:;" data-src="//www.youtube.com/embed/BNpiwOkKIJ8?autoplay=1" data-speed="350" data-caption="Single Image">
