...
<head>
  <!-- Title -->
  <title>Media Images | Unify - Responsive Website Template</title>
  ...
  <main>
        ...
        <div class="u-sidebar-navigation-inner">
          ...
          <ul class="js-shortcode-filter-result nav flex-column u-sidebar-navigation-list">
            ...
            <li class="js-shortcode-filter__item nav-item dropdown bases">
              <a class="nav-link dropdown-toggle active" href="#!" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Media</a>
              <div class="dropdown-menu u-dropdown-static">
                <ul class="nav flex-column">
                  ...
                  <li class="js-shortcode-filter__item nav-item bases">
                    <a href="../../unify-main/shortcodes/shortcode-base-media-images.html" class="nav-link active">Media Images</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item bases">
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall" data-options="{direction: 'reverse', settings_mode_oneelement_max_offset: '150'}">
      ...
      <div class="container g-z-index-1 g-py-100">
        <h1 class="g-font-weight-300 g-letter-spacing-1 g-mb-15">Media Images</h1>
    ...
    <section>
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-sm-3 col-6">
              <div id="shortcode1">
                <div class="shortcode-html">
                  <img class="img-fluid" src="../../assets/img-temp/demo-square.jpg" alt="Image Description">
                </div>
              </div>
            ...
            <div class="col-sm-3 col-6">
              <div id="shortcode2">
                <div class="shortcode-html">
                  <img class="img-fluid g-rounded-3" src="../../assets/img-temp/demo-square.jpg" alt="Image Description">
                </div>
              </div>
            ...
            <div class="col-sm-3 col-6">
              <div id="shortcode3">
                <div class="shortcode-html">
                  <img class="img-fluid g-rounded-10" src="../../assets/img-temp/demo-square.jpg" alt="Image Description">
                </div>
              </div>
            ...
            <div class="col-sm-3 col-6 text-center">
              <div id="shortcode4">
                <div class="shortcode-html">
                  <img class="img-fluid rounded-circle" src="../../assets/img-temp/demo-square.jpg" alt="Image Description">
                </div>
              </div>
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-sm-3 col-6">
              <div id="shortcode5">
                <div class="shortcode-html">
                  <img class="img-fluid img-thumbnail" src="../../assets/img-temp/demo-square.jpg" alt="Image Description">
                </div>
              </div>
            ...
            <div class="col-sm-3 col-6">
              <div id="shortcode6">
                <div class="shortcode-html">
                  <img class="img-fluid img-thumbnail g-rounded-3" src="../../assets/img-temp/demo-square.jpg" alt="Image Description">
                </div>
              </div>
            ...
            <div class="col-sm-3 col-6">
              <div id="shortcode7">
                <div class="shortcode-html">
                  <img class="img-fluid img-thumbnail g-rounded-10" src="../../assets/img-temp/demo-square.jpg" alt="Image Description">
                </div>
              </div>
            ...
            <div class="col-sm-3 col-6 text-center">
              <div id="shortcode8">
                <div class="shortcode-html">
                  <img class="img-fluid img-thumbnail rounded-circle" src="../../assets/img-temp/demo-square.jpg" alt="Image Description">
                </div>
              </div>
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-sm-3 col-6">
              <div id="shortcode9">
                <div class="shortcode-html">
                  <img class="img-fluid g-brd-around g-brd-gray-light-v2" src="../../assets/img-temp/demo-square.jpg" alt="Image Description">
                </div>
              </div>
            ...
            <div class="col-sm-3 col-6">
              <div id="shortcode10">
                <div class="shortcode-html">
                  <img class="img-fluid g-brd-around g-brd-gray-light-v2 g-rounded-3" src="../../assets/img-temp/demo-square.jpg" alt="Image Description">
                </div>
              </div>
            ...
            <div class="col-sm-3 col-6">
              <div id="shortcode11">
                <div class="shortcode-html">
                  <img class="img-fluid g-brd-around g-brd-gray-light-v2 g-rounded-10" src="../../assets/img-temp/demo-square.jpg" alt="Image Description">
                </div>
              </div>
            ...
            <div class="col-sm-3 col-6 text-center">
              <div id="shortcode12">
                <div class="shortcode-html">
                  <img class="img-fluid g-brd-around g-brd-gray-light-v2 rounded-circle" src="../../assets/img-temp/demo-square.jpg" alt="Image Description">
                </div>
              </div>
      ...
      <!-- End Image Bordered #03 -->

      <hr class="g-brd-gray-light-v4 m-0">

      <!-- Image Box Shadows #04 -->
      <section class="g-py-100">
        <div class="container">
          <div class="text-center g-mb-50">
            <h2 class="h4">Image Box Shadows
          ...
          <div class="row">
            <div class="col-sm-3 col-6">
              <div id="shortcode13">
                <div class="shortcode-html">
                  <img class="img-fluid u-shadow-v2" src="../../assets/img-temp/demo-square.jpg" alt="Image Description">
                </div>
              </div>
            ...
            <div class="col-sm-3 col-6">
              <div id="shortcode14">
                <div class="shortcode-html">
                  <img class="img-fluid u-shadow-v2 g-rounded-3" src="../../assets/img-temp/demo-square.jpg" alt="Image Description">
                </div>
              </div>
            ...
            <div class="col-sm-3 col-6">
              <div id="shortcode15">
                <div class="shortcode-html">
                  <img class="img-fluid u-shadow-v2 g-rounded-10" src="../../assets/img-temp/demo-square.jpg" alt="Image Description">
                </div>
              </div>
            ...
            <div class="col-sm-3 col-6 text-center">
              <div id="shortcode16">
                <div class="shortcode-html">
                  <img class="img-fluid u-shadow-v2 rounded-circle" src="../../assets/img-temp/demo-square.jpg" alt="Image Description">
                </div>
              </div>
