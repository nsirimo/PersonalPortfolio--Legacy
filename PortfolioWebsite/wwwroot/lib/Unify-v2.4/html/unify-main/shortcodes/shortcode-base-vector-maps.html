            ...
            <li class="js-shortcode-filter__item nav-item dropdown bases">
              ...
              <div class="dropdown-menu u-dropdown-static">
                <ul class="nav flex-column">
                  ...
                  <li class="js-shortcode-filter__item nav-item bases">
                    <a href="../../unify-main/shortcodes/shortcode-base-vector-maps.html" class="nav-link active">Vector Maps</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item bases">
          ...
          <div class="col-md-9">
            <div id="shortcode1">
              ...
              <div class="shortcode-styles">
                ...
                <link type="text/plain" rel="stylesheet" href="../../assets/vendor/jvectormap/jquery-jvectormap-2.0.3.css">
              </div>
