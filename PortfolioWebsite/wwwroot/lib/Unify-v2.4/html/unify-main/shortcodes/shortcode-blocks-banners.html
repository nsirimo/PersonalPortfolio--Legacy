...
<head>
  <!-- Title -->
  <title>Banners | Unify - Responsive Website Template</title>
  ...
  <main>
      ...
      <div class="u-header__sections-container">
        <div class="u-sidebar-navigation-inner">
          ...
          <ul class="js-shortcode-filter-result nav flex-column u-sidebar-navigation-list">
            ...
            <li class="js-shortcode-filter__item nav-item blocks">
              <a href="../../unify-main/shortcodes/shortcode-blocks-banners.html" class="nav-link active">Banners</a>
            </li>
            <li class="js-shortcode-filter__item nav-item blocks">
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall g-overflow-hidden" data-options="{direction: 'reverse', settings_mode_oneelement_max_offset: '150'}">
      ...
      <div class="container g-z-index-1 g-py-100">
        <h1 class="g-font-weight-300 g-letter-spacing-1 g-mb-15">Banners</h1>
          ...
          <div id="shortcode5">
            <div class="shortcode-html">
              ...
              <div class="row no-gutters">
                <div class="col-lg-4">
                  <!-- Article -->
                  <article class="h-100 text-center info-v3-3 g-bg-gray-light-v5 g-bg-cover g-bg-primary-opacity-0_6--after g-color-gray-dark-v3 g-color-white--hover">
                    <!-- Article Image -->
                    <img class="info-v3-3__img" src="../../assets/img-temp/230x338/img1.png" alt="Image Description">
                    <!-- End Article Image -->

                    <!-- Article Content -->
                    <div class="info-v3-3__description u-link-v2 g-flex-middle">
