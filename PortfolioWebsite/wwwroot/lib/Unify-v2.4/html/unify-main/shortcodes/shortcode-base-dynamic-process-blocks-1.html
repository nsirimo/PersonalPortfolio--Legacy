...
<head>
  <!-- Title -->
  <title>Dynamic Process Blocks | Unify - Responsive Website Template</title>
  ...
  <main>
        ...
        <div class="u-sidebar-navigation-inner">
          ...
          <ul class="js-shortcode-filter-result nav flex-column u-sidebar-navigation-list">
            ...
            <li class="js-shortcode-filter__item nav-item dropdown blocks">
              <a class="nav-link dropdown-toggle active" href="#!" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Process Blocks</a>
              <div class="dropdown-menu u-dropdown-static">
                <ul class="nav flex-column">
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../unify-main/shortcodes/shortcode-base-dynamic-process-blocks-1.html" class="nav-link active">Dynamic Process Blocks</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item blocks">
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall" data-options="{direction: 'reverse', settings_mode_oneelement_max_offset: '150'}">
      ...
      <div class="container g-z-index-1 g-py-100">
        <h1 class="g-font-weight-300 g-letter-spacing-1 g-mb-15">Dynamic Process Blocks</h1>
    ...
    <section>
      ...
      <section class="container g-py-100">
        ...
        <div id="shortcode1">
          <div class="shortcode-html">
            ...
            <div id="carousel1" class="js-carousel" data-infinite="true" data-pagi-classes="js-pagination u-carousel-indicators-v30 g-pos-abs g-top-0">
              <div class="js-slide g-pt-70 g-pt-150--sm" data-title="Tax preparation">
                <!-- Dynamic Process -->
                <div class="row no-gutters">
                  <div class="col-lg-6 g-bg-black g-pa-60 g-pa-100--sm">
                    <h3 class="h4 g-color-white g-font-weight-700 g-mb-25">Tax preparation</h3>

                    <div class="g-mb-50">
                      <p class="g-color-white-opacity-0_7 g-mb-30">We aim high at being focused on building relationships with our clients and community. Using our creative gifts drives this foundation. Working together on the daily requires each individual to let the greater good of the team’s
                        work surface above their own ego.</p>
                      <p class="g-color-white-opacity-0_7 g-mb-30">It’s important to stay detail oriented with every project we tackle. Staying focused allows us to turn every project we complete into something we love. We strive to embrace and drive change in our industry which allows us to keep
                    ...
                    <a class="btn btn-lg u-btn-primary g-font-weight-600 g-font-size-default text-uppercase g-rounded-50" href="#!">Contact us for more info</a>
                  </div>

                  <div class="col-lg-6 g-min-height-400 g-bg-size-cover g-bg-pos-center" style="background-image: url(../../assets/img-temp/900x900/img1.jpg);"></div>
                </div>
                <!-- End Dynamic Process -->
              </div>

              <div class="js-slide g-pt-70 g-pt-150--sm" data-title="Tax issues">
                <!-- Dynamic Process -->
                <div class="row no-gutters">
                  <div class="col-lg-6 g-bg-black g-pa-60 g-pa-100--sm">
                    <h3 class="h4 g-color-white g-font-weight-700 g-mb-25">Tax issues</h3>
                  ...
                  <div class="col-lg-6 g-min-height-400 g-bg-size-cover g-bg-pos-center" style="background-image: url(../../assets/img-temp/900x900/img2.jpg);"></div>
                </div>
                <!-- End Dynamic Process -->
              </div>

              <div class="js-slide g-pt-70 g-pt-150--sm" data-title="Part-time cfo/controller">
                <!-- Dynamic Process -->
                <div class="row no-gutters">
                  <div class="col-lg-6 g-bg-black g-pa-60 g-pa-100--sm">
                    <h3 class="h4 g-color-white g-font-weight-700 g-mb-25">Part-time cfo/controller</h3>
                  ...
                  <div class="col-lg-6 g-min-height-400 g-bg-size-cover g-bg-pos-center" style="background-image: url(../../assets/img-temp/900x900/img3.jpg);"></div>
                </div>
                <!-- End Dynamic Process -->
              </div>

              <div class="js-slide g-pt-70 g-pt-150--sm" data-title="Small business accounting">
                <!-- Dynamic Process -->
                <div class="row no-gutters">
                  <div class="col-lg-6 g-bg-black g-pa-60 g-pa-100--sm">
                    <h3 class="h4 g-color-white g-font-weight-700 g-mb-25">Small business accounting</h3>
                  ...
                  <div class="col-lg-6 g-min-height-400 g-bg-size-cover g-bg-pos-center" style="background-image: url(../../assets/img-temp/900x900/img4.jpg);"></div>
                </div>
                <!-- End Dynamic Process -->
              </div>

              <div class="js-slide g-pt-70 g-pt-150--sm" data-title="Non-profit accountiong">
                <!-- Dynamic Process -->
                <div class="row no-gutters">
                  <div class="col-lg-6 g-bg-black g-pa-60 g-pa-100--sm">
                    <h3 class="h4 g-color-white g-font-weight-700 g-mb-25">Non-profit accountiong</h3>
                  ...
                  <div class="col-lg-6 g-min-height-400 g-bg-size-cover g-bg-pos-center" style="background-image: url(../../assets/img-temp/900x900/img5.jpg);"></div>
                </div>
                <!-- End Dynamic Process -->
              </div>
              ...
              <div class="js-slide g-pt-70 g-pt-150--sm" data-title="Non-profit accountiong">
                ...
                <div class="row no-gutters">
                  ...
                  <div class="col-lg-6 g-min-height-400 g-bg-size-cover g-bg-pos-center" style="background-image: url(../../assets/img-temp/900x900/img6.jpg);"></div>
                </div>
                <!-- End Dynamic Process -->
              </div>
            </div>
        ...
        <!-- Show Code -->
        <div class="g-font-size-12 g-my-30 container g-pos-rel">
        ...
        <div id="shortcode2">
          <div class="shortcode-html">
            ...
            <div id="carousel2" class="js-carousel" data-infinite="true">
              <div class="js-slide" data-title="Tax preparation">
                <!-- Dynamic Process -->
                <div class="row no-gutters">
                  <div class="col-lg-6 g-bg-black g-pa-60 g-pa-100--sm">
                    <h3 class="h4 g-color-white g-font-weight-700 g-mb-25">Tax preparation</h3>
              ...
              <div class="js-slide" data-title="Tax issues">
                <!-- Dynamic Process -->
                <div class="row no-gutters">
                  <div class="col-lg-6 g-bg-black g-pa-60 g-pa-100--sm">
                    <h3 class="h4 g-color-white g-font-weight-700 g-mb-25">Tax issues</h3>
              ...
              <div class="js-slide" data-title="Part-time cfo/controller">
                <!-- Dynamic Process -->
                <div class="row no-gutters">
                  <div class="col-lg-6 g-bg-black g-pa-60 g-pa-100--sm">
                    <h3 class="h4 g-color-white g-font-weight-700 g-mb-25">Part-time cfo/controller</h3>
              ...
              <div class="js-slide" data-title="Small business accounting">
                <!-- Dynamic Process -->
                <div class="row no-gutters">
                  <div class="col-lg-6 g-bg-black g-pa-60 g-pa-100--sm">
                    <h3 class="h4 g-color-white g-font-weight-700 g-mb-25">Small business accounting</h3>
              ...
              <div class="js-slide" data-title="Non-profit accountiong">
                <!-- Dynamic Process -->
                <div class="row no-gutters">
                  <div class="col-lg-6 g-bg-black g-pa-60 g-pa-100--sm">
                    <h3 class="h4 g-color-white g-font-weight-700 g-mb-25">Non-profit accountiong</h3>
              ...
              <div class="js-slide" data-title="Non-profit accountiong" data-pagi-classes="js-pagination u-carousel-indicators-v30 g-pos-abs g-bottom-0">
                <!-- Dynamic Process -->
                <div class="row no-gutters">
                  <div class="col-lg-6 g-bg-black g-pa-60 g-pa-100--sm">
                    <h3 class="h4 g-color-white g-font-weight-700 g-mb-25">Non-profit accountiong</h3>
      ...
      <section class="container g-py-100">
        ...
        <div id="shortcode3">
          <div class="shortcode-html">
            <!-- Dynamic Process -->
            <div id="carousel3" class="js-carousel" data-infinite="true" data-pagi-classes="js-pagination u-carousel-indicators-v30 g-pos-abs g-top-0">
              <div class="js-slide g-pt-70 g-pt-150--sm" data-title="Tax preparation">
                <!-- Dynamic Process -->
                <div class="row no-gutters">
                  <div class="col-lg-6 g-bg-black g-pa-60 g-pa-100--sm">
      ...
      <section class="container g-py-100">
        ...
        <div id="shortcode4">
          <div class="shortcode-html">
            <!-- Dynamic Process -->
            <div id="carousel4" class="js-carousel" data-infinite="true" data-pagi-classes="js-pagination u-carousel-indicators-v30 g-pos-abs g-bottom-0">
              <div class="js-slide g-pb-70 g-pb-150--sm" data-title="Tax preparation">
                <!-- Dynamic Process -->
                <div class="row no-gutters">
                  <div class="col-lg-6 g-bg-black g-pa-60 g-pa-100--sm">
                    <h3 class="h4 g-color-white g-font-weight-700 g-mb-25">Tax preparation</h3>
              ...
              <div class="js-slide g-pb-70 g-pb-150--sm" data-title="Tax issues">
                <!-- Dynamic Process -->
                <div class="row no-gutters">
                  <div class="col-lg-6 g-bg-black g-pa-60 g-pa-100--sm">
                    <h3 class="h4 g-color-white g-font-weight-700 g-mb-25">Tax issues</h3>
              ...
              <div class="js-slide g-pb-70 g-pb-150--sm" data-title="Part-time cfo/controller">
                <!-- Dynamic Process -->
                <div class="row no-gutters">
                  <div class="col-lg-6 g-bg-black g-pa-60 g-pa-100--sm">
                    <h3 class="h4 g-color-white g-font-weight-700 g-mb-25">Part-time cfo/controller</h3>
              ...
              <div class="js-slide g-pb-70 g-pb-150--sm" data-title="Small business accounting">
                <!-- Dynamic Process -->
                <div class="row no-gutters">
                  <div class="col-lg-6 g-bg-black g-pa-60 g-pa-100--sm">
                    <h3 class="h4 g-color-white g-font-weight-700 g-mb-25">Small business accounting</h3>
              ...
              <div class="js-slide g-pb-70 g-pb-150--sm" data-title="Non-profit accountiong">
                <!-- Dynamic Process -->
                <div class="row no-gutters">
                  <div class="col-lg-6 g-bg-black g-pa-60 g-pa-100--sm">
                    <h3 class="h4 g-color-white g-font-weight-700 g-mb-25">Non-profit accountiong</h3>
