...
<head>
  <!-- Title -->
  <title>Countdowns | Unify - Responsive Website Template</title>
  ...
  <main>
      ...
      <div class="u-header__sections-container">
        <div class="u-sidebar-navigation-inner">
          ...
          <ul class="js-shortcode-filter-result nav flex-column u-sidebar-navigation-list">
            ...
            <li class="js-shortcode-filter__item nav-item blocks">
              <a href="../../unify-main/shortcodes/shortcode-blocks-countdowns.html" class="nav-link active">Countdowns</a>
            </li>
            <li class="js-shortcode-filter__item nav-item blocks">
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall g-overflow-hidden" data-options="{direction: 'reverse', settings_mode_oneelement_max_offset: '150'}">
      ...
      <div class="container g-z-index-1 g-py-100">
        <h1 class="g-font-weight-300 g-letter-spacing-1 g-mb-15">Countdowns</h1>
    ...
    <section>
        ...
        <div class="container">
          ...
          <div id="shortcode1">
            <div class="shortcode-html">
              <div class="js-countdown u-countdown-v3 g-line-height-1_2 g-font-weight-300 g-color-black text-center text-uppercase" data-end-date="2019/08/10" data-month-format="%m" data-days-format="%D" data-hours-format="%H" data-minutes-format="%M" data-seconds-format="%S">
            ...
            <div class="shortcode-scripts">
              ...
              <script type="text/plain" src="../../assets/vendor/jquery.countdown.min.js"></script>
      ...
      <section class="g-bg-gray-dark-v1 g-color-white g-py-100">
        <div class="container">
          ...
          <div id="shortcode2">
            <div class="shortcode-html">
              <div class="js-countdown u-countdown-v3 g-line-height-1_2 g-font-weight-300 text-center text-uppercase" data-end-date="2019/08/09" data-month-format="%m" data-days-format="%D" data-hours-format="%H" data-minutes-format="%M" data-seconds-format="%S">
                <div class="d-inline-block g-mx-20 g-mb-20">
                  <div class="js-cd-days g-font-size-36 mb-0">12</div>
                  <span class="g-font-size-12">Days</span>
                </div>
      ...
      <section class="g-py-100">
        <div class="container">
          ...
          <div id="shortcode3">
            <div class="shortcode-html">
              <div class="js-countdown u-countdown-v4 text-center" data-end-date="2019/08/09" data-month-format="%m" data-days-format="%D" data-hours-format="%H" data-minutes-format="%M" data-seconds-format="%S">
      ...
      <section class="dzsparallaxer auto-init height-is-based-on-content">
        <!-- Parallax Image -->
        <div class="divimage dzsparallaxer--target w-100 g-bg-size-cover u-bg-overlay g-bg-black-opacity-0_7--after" style="height: 140%; background: url(../../assets/img-temp/1920x800/img2.jpg)"></div>
        <!-- End Parallax Image -->
        ...
        <div class="container u-bg-overlay__inner g-py-100">
          ...
          <div id="shortcode4">
            <div class="shortcode-html">
              <div class="js-countdown u-countdown-v4 g-color-white text-center" data-end-date="2019/08/09" data-month-format="%m" data-days-format="%D" data-hours-format="%H" data-minutes-format="%M" data-seconds-format="%S">
                <div class="d-inline-block g-px-40 g-mx-15 g-mb-30">
                  <div class="js-cd-days g-font-size-45 g-font-weight-300 g-line-height-1 mb-0"></div>
                  <span>Days</span>
                </div>
      ...
      <section class="g-py-100">
        <div class="container">
          ...
          <div id="shortcode5">
            <div class="shortcode-html">
              <div class="js-countdown u-countdown-v5 text-center" data-end-date="2019/08/09" data-days-format="%D" data-hours-format="%H" data-minutes-format="%M" data-seconds-format="%S">
      ...
      <section class="dzsparallaxer auto-init height-is-based-on-content">
        <!-- Parallax Image -->
        <div class="divimage dzsparallaxer--target w-100 g-bg-size-cover u-bg-overlay g-bg-black-opacity-0_5--after" style="height: 140%; background: url(../../assets/img-temp/1920x800/img11.jpg)"></div>
        <!-- End Parallax Image -->
        ...
        <div class="container u-bg-overlay__inner g-py-100">
          ...
          <div id="shortcode6">
            <div class="shortcode-html">
              <div class="js-countdown u-countdown-v5 g-color-white text-center" data-end-date="2019/08/09" data-days-format="%D" data-hours-format="%H" data-minutes-format="%M" data-seconds-format="%S">
                <div class="d-inline-block g-mx-20 g-mb-40">
                  <div class="js-cd-days g-font-size-56 g-font-weight-300 g-line-height-1"></div>
                  <span>Days</span>
                </div>
      ...
      <section class="g-py-100">
        <div class="container">
          ...
          <div id="shortcode7">
            <div class="shortcode-html">
              <div class="js-countdown u-countdown-v1 text-center text-uppercase g-color-white g-line-height-1" data-end-date="2019/08/09" data-month-format="%m" data-days-format="%d" data-hours-format="%H" data-minutes-format="%M" data-seconds-format="%S">
      ...
      <section class="dzsparallaxer auto-init height-is-based-on-content">
        <!-- Parallax Image -->
        <div class="divimage dzsparallaxer--target w-100 g-bg-size-cover u-bg-overlay g-bg-black-opacity-0_6--after" style="height: 140%; background: url(../../assets/img-temp/1920x800/img4.jpg)"></div>
        <!-- End Parallax Image -->
        ...
        <div class="container u-bg-overlay__inner g-py-100">
          ...
          <div id="shortcode8">
            <div class="shortcode-html">
              <div class="js-countdown u-countdown-v1 g-color-white text-center text-uppercase g-line-height-1" data-end-date="2019/08/09" data-month-format="%m" data-days-format="%d" data-hours-format="%H" data-minutes-format="%M" data-seconds-format="%S">
      ...
      <section class="g-py-100">
        <div class="container u-bg-overlay__inner text-center">
          ...
          <div id="shortcode9">
            <div class="shortcode-html">
              <div class="js-countdown u-countdown-v2 g-color-white g-font-weight-300" data-end-date="2019/08/09" data-month-format="%m" data-days-format="%D" data-hours-format="%H" data-minutes-format="%M" data-seconds-format="%S">
      ...
      <section class="dzsparallaxer auto-init height-is-based-on-content">
        <!-- Parallax Image -->
        <div class="divimage dzsparallaxer--target w-100 g-bg-size-cover u-bg-overlay g-bg-bluegray-opacity-0_2--after" style="height: 140%; background: url(../../assets/img-temp/1920x800/img12.jpg)"></div>
        <!-- End Parallax Image -->
        ...
        <div class="container u-bg-overlay__inner g-color-white text-center g-py-100">
          ...
          <div id="shortcode10">
            <div class="shortcode-html">
              <div class="js-countdown u-countdown-v2" data-end-date="2019/08/09" data-month-format="%m" data-days-format="%D" data-hours-format="%H" data-minutes-format="%M" data-seconds-format="%S">
      ...
      <section class="g-py-100">
        <div class="container">
          ...
          <div id="shortcode11">
            <div class="shortcode-html">
              <div class="js-countdown-pies u-cd-v6 text-center text-uppercase" data-start-date="2015/06/17" data-end-date="2018/08/09" data-days-format="%D" data-hours-format="%H" data-minutes-format="%M" data-seconds-format="%S" data-circles-bg-color="#f8f8f8" data-circles-fg-color="#72c02c"
              data-circles-radius="80" data-circles-stroke-width="7" data-circles-font-size="35">
                <div class="row">
      ...
      <section class="g-bg-gray-dark-v1 g-color-white g-py-100">
        <div class="container">
          ...
          <div id="shortcode12">
            <div class="shortcode-html">
              <div class="js-countdown-pies u-cd-v6 text-center g-color-white-opacity-0_8 g-font-weight-300 text-uppercase" data-start-date="2015/01/12" data-end-date="2018/05/27" data-days-format="%D" data-hours-format="%H" data-minutes-format="%M" data-seconds-format="%S"
              data-circles-bg-color="#222" data-circles-fg-color="#72c02c" data-circles-radius="80" data-circles-stroke-width="2" data-circles-font-size="35">
                <div class="row">
                  <div class="col-lg-3 col-sm-6 g-mb-50">
                    <div class="js-cd-days g-mb-20"></div>
                    <span class="g-font-size-18">Days</span>
      ...
      <section class="g-py-100">
        <div class="container">
          ...
          <div id="shortcode13">
            <div class="shortcode-html">
              <div class="js-countdown-pies u-cd-v6 text-center g-color-gray-light-v3 text-uppercase" data-start-date="2015/06/17" data-end-date="2018/08/09" data-days-format="%D" data-hours-format="%H" data-minutes-format="%M" data-seconds-format="%S" data-circles-bg-color="#f8f8f8"
              data-circles-fg-color="#333333" data-circles-radius="80" data-circles-stroke-width="15" data-circles-font-size="35">
                <div class="row">
                  <div class="col-lg-3 col-sm-6 g-mb-50">
                    <div class="js-cd-days g-mb-20"></div>
