...
<head>
  <!-- Title -->
  <title>Media Audios | Unify - Responsive Website Template</title>
  ...
  <main>
            ...
            <li class="js-shortcode-filter__item nav-item dropdown bases">
              ...
              <div class="dropdown-menu u-dropdown-static">
                <ul class="nav flex-column">
                  <li class="js-shortcode-filter__item nav-item bases">
                    <a href="../../unify-main/shortcodes/shortcode-base-media-audios.html" class="nav-link active">Media Audios</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item bases">
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall" data-options="{direction: 'reverse', settings_mode_oneelement_max_offset: '150'}">
      ...
      <div class="container g-z-index-1 g-py-100">
        <h1 class="g-font-weight-300 g-letter-spacing-1 g-mb-15">Media Audios</h1>
        ...
        <div class="container">
          ...
          <header class="g-mb-80">
            <div class="u-heading-v6-2 text-uppercase">
              <h2 class="h4 u-heading-v6__title g-font-weight-300">HTML5 and Embeds Audios</h2>
            </div>
            <div class="g-pl-90">
          ...
          <div class="row">
            <div class="col-md-3">
              <h3 class="h4 g-font-weight-300">HTML5 Audio</h3>
            </div>
            <div class="col-md-9">
              <div id="shortcode1">
                <div class="shortcode-html">
                  <audio controls="controls">
                    <source src="../../assets/media-temp/audio-bg/tiesto.mp3" type="audio/mpeg">
                  </audio>
                </div>
              </div>
          ...
          <!-- Sound Cloud Widget 1 -->
          <div class="row">
            <div class="col-md-3">
              <h3 class="h4 g-font-weight-300">Sound cloud widget 1</h3>
            </div>
            <div class="col-md-9">
              <div id="shortcode2">
                <div class="shortcode-html">
          ...
          <!-- End Sound Cloud Widget 1 -->

          <hr class="g-brd-gray-light-v4 g-my-50">

          <!-- Sound Cloud Widget 2 -->
          <div class="row">
            <div class="col-md-3">
              <h3 class="h4 g-font-weight-300">Sound cloud widget 2</h3>
            </div>
            <div class="col-md-9">
              <div id="shortcode3">
                <div class="shortcode-html">
                  <iframe width="100%" height="166" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/31532505&amp;color=ff5500&amp;auto_play=false&amp;hide_related=false&amp;show_artwork=true"></iframe>
                </div>
              </div>
          ...
          <!-- End Sound Cloud Widget 2 -->

          <hr class="g-brd-gray-light-v4 g-my-50">

          <!-- Spotify Cloud Widget 1 -->
          <div class="row">
            <div class="col-md-3">
              <h3 class="h4 g-font-weight-300">Spotify cloud widget 1</h3>
            </div>
            <div class="col-md-9">
              <div id="shortcode4">
                <div class="shortcode-html">
                  <iframe src="https://embed.spotify.com/?uri=spotify%3Atrack%3A33Q6ldVXuJyQmqs8BmAa0k" width="300" height="380" frameborder="0" allowtransparency="true"></iframe>
                </div>
              </div>
          ...
          <!-- End Spotify Cloud Widget 1 -->

          <hr class="g-brd-gray-light-v4 g-my-50">

          <!-- Spotify Cloud Widget 2 -->
          <div class="row">
            <div class="col-md-3">
              <h3 class="h4 g-font-weight-300">Spotify cloud widget 2</h3>
            </div>
            <div class="col-md-9">
              <div id="shortcode5">
                <div class="shortcode-html">
          ...
          <!-- End Spotify Cloud Widget 2 -->

          <hr class="g-brd-gray-light-v4 g-my-50">

          <!-- Spotify Cloud Widget 3 -->
          <div class="row">
            <div class="col-md-3">
              <h3 class="h4 g-font-weight-300">Spotify cloud widget 3</h3>
            </div>
            <div class="col-md-9">
              <div id="shortcode6">
                <div class="shortcode-html">
