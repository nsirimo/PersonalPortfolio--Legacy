...
<head>
  <!-- Title -->
  <title>Cube Portfolio Grid 6 Fullwidth | Unify - Responsive Website Template</title>
  ...
  <main>
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall g-overflow-hidden" data-options="{direction: 'reverse', settings_mode_oneelement_max_offset: '150'}">
      ...
      <div class="container g-z-index-1 g-py-100">
        <h1 class="g-font-weight-300 g-letter-spacing-1 g-mb-15">Cube Portfolio Grid 6 Fullwidth</h1>
      ...
      <div id="shortcode">
        <div class="shortcode-html">
          ...
          <div class="clearfix">
            ...
            <div class="cbp" data-controls="#filterControls" data-animation="quicksand" data-x-gap="10" data-y-gap="10" data-media-queries='[
                     {"width": 1500, "cols": 6},
                     {"width": 1100, "cols": 6},
                     {"width": 800, "cols": 4},
                     {"width": 480, "cols": 3},
