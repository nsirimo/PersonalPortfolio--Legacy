...
<head>
  <!-- Title -->
  <title>Cube Portfolio Grid 5 Fullwidth (no space &amp;amp; text) | Unify - Responsive Website Template</title>
  ...
  <main>
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall g-overflow-hidden" data-options="{direction: 'reverse', settings_mode_oneelement_max_offset: '150'}">
      ...
      <div class="container g-z-index-1 g-py-100">
        <h1 class="g-font-weight-300 g-letter-spacing-1 g-mb-15">Cube Portfolio Grid 5 Fullwidth (no space &amp;amp; text)</h1>
    ...
    <section class="g-py-100">
        ...
        <div class="shortcode-html">
          ...
          <div class="clearfix">
            ...
            <ul id="filterControls" class="d-block list-inline text-center g-mb-50">
              ...
              <li class="list-inline-item cbp-filter-item g-brd-around g-brd-gray-light-v4 g-brd-primary--active g-color-gray-dark-v4 g-color-primary--hover g-color-primary--active g-font-size-12 rounded g-transition-0_3 g-px-20 g-py-7 mb-2" role="button" data-filter=".identity">Identity
              </li>
              <li class="list-inline-item cbp-filter-item g-brd-around g-brd-gray-light-v4 g-brd-primary--active g-color-gray-dark-v4 g-color-primary--hover g-color-primary--active g-font-size-12 rounded g-transition-0_3 g-px-20 g-py-7 mb-2" role="button" data-filter=".design">Design
              </li>
              <li class="list-inline-item cbp-filter-item g-brd-around g-brd-gray-light-v4 g-brd-primary--active g-color-gray-dark-v4 g-color-primary--hover g-color-primary--active g-font-size-12 rounded g-transition-0_3 g-px-20 g-py-7 mb-2" role="button" data-filter=".graphic">Graphic
              </li>
              <li class="list-inline-item cbp-filter-item g-brd-around g-brd-gray-light-v4 g-brd-primary--active g-color-gray-dark-v4 g-color-primary--hover g-color-primary--active g-font-size-12 rounded g-transition-0_3 g-px-20 g-py-7 mb-2" role="button" data-filter=".graphic, .identity">Design & Identity
              </li>
            </ul>
            <!-- End Cube Portfolio Blocks - Filter -->

            <!-- Cube Portfolio Blocks - Content -->
            <div class="cbp" data-controls="#filterControls" data-animation="quicksand" data-x-gap="0" data-y-gap="0" data-media-queries='[
                     {"width": 1500, "cols": 5},
                     {"width": 1100, "cols": 5},
                     {"width": 800, "cols": 3},
                     {"width": 480, "cols": 2},
                ...
                <div class="u-block-hover g-parent">
                  ...
                  <div class="d-flex w-100 h-100 g-bg-black-opacity-0_6 opacity-0 g-opacity-1--parent-hover g-pos-abs g-top-0 g-left-0 g-transition-0_3 g-transition--ease-in u-block-hover__additional--fade u-block-hover__additional--fade-in g-pa-20">
                    <div class="d-flex align-items-start flex-column mb-auto">
                      <h3 class="h6 g-color-white g-font-weight-700 mb-0">Branding work</h3>
                      <p class="g-color-white-opacity-0_7 g-font-size-13 mb-0">Identity, Design</p>
                    </div>
                    <ul class="align-items-end flex-column list-inline mt-auto ml-auto mb-0">
                      ...
                      <li class="list-inline-item">
                        <a class="cbp-lightbox u-icon-v2 u-icon-size--xs g-brd-white g-color-black g-bg-white rounded-circle" href="../../../assets/img-temp/400x270/img13.jpg">
              ...
              <div class="cbp-item design">
                <div class="u-block-hover g-parent">
                  ...
                  <div class="d-flex w-100 h-100 g-bg-black-opacity-0_6 opacity-0 g-opacity-1--parent-hover g-pos-abs g-top-0 g-left-0 g-transition-0_3 g-transition--ease-in u-block-hover__additional--fade u-block-hover__additional--fade-in g-pa-20">
                    <div class="d-flex align-items-start flex-column mb-auto">
                      <h3 class="h6 g-color-white g-font-weight-700 mb-0">Development</h3>
                      <p class="g-color-white-opacity-0_7 g-font-size-13 mb-0">Design</p>
                    </div>
                    <ul class="align-items-end flex-column list-inline mt-auto ml-auto mb-0">
                      <li class="list-inline-item">
                        <a class="u-icon-v2 u-icon-size--xs g-brd-white g-color-black g-bg-white rounded-circle" href="#!">
              ...
              <div class="cbp-item graphic identity">
                <div class="u-block-hover g-parent">
                  ...
                  <div class="d-flex w-100 h-100 g-bg-black-opacity-0_6 opacity-0 g-opacity-1--parent-hover g-pos-abs g-top-0 g-left-0 g-transition-0_3 g-transition--ease-in u-block-hover__additional--fade u-block-hover__additional--fade-in g-pa-20">
                    <div class="d-flex align-items-start flex-column mb-auto">
                      <h3 class="h6 g-color-white g-font-weight-700 mb-0">Project planner</h3>
                      <p class="g-color-white-opacity-0_7 g-font-size-13 mb-0">Graphic, Identity</p>
                    </div>
                    <ul class="align-items-end flex-column list-inline mt-auto ml-auto mb-0">
                      <li class="list-inline-item">
                        <a class="u-icon-v2 u-icon-size--xs g-brd-white g-color-black g-bg-white rounded-circle" href="#!">
                      ...
                      <li class="list-inline-item">
                        <a class="cbp-lightbox u-icon-v2 u-icon-size--xs g-brd-white g-color-black g-bg-white rounded-circle" href="../../../assets/img-temp/400x270/img15.jpg">
                          <i class="icon-communication-017 u-line-icon-pro"></i>
                        </a>
                      </li>
                    </ul>
              ...
              <div class="cbp-item graphic">
                <div class="u-block-hover g-parent">
                  ...
                  <div class="d-flex w-100 h-100 g-bg-black-opacity-0_6 opacity-0 g-opacity-1--parent-hover g-pos-abs g-top-0 g-left-0 g-transition-0_3 g-transition--ease-in u-block-hover__additional--fade u-block-hover__additional--fade-in g-pa-20">
                    <div class="d-flex align-items-start flex-column mb-auto">
                      <h3 class="h6 g-color-white g-font-weight-700 mb-0">Design</h3>
                      <p class="g-color-white-opacity-0_7 g-font-size-13 mb-0">Graphic</p>
                    </div>
                    <ul class="align-items-end flex-column list-inline mt-auto ml-auto mb-0">
                      <li class="list-inline-item">
                        <a class="u-icon-v2 u-icon-size--xs g-brd-white g-color-black g-bg-white rounded-circle" href="#!">
                      ...
                      <li class="list-inline-item">
                        <a class="cbp-lightbox u-icon-v2 u-icon-size--xs g-brd-white g-color-black g-bg-white rounded-circle" href="../../../assets/img-temp/400x270/img16.jpg">
                          <i class="icon-communication-017 u-line-icon-pro"></i>
                        </a>
                      </li>
                    </ul>
              ...
              <div class="cbp-item identity">
                <div class="u-block-hover g-parent">
                  ...
                  <div class="d-flex w-100 h-100 g-bg-black-opacity-0_6 opacity-0 g-opacity-1--parent-hover g-pos-abs g-top-0 g-left-0 g-transition-0_3 g-transition--ease-in u-block-hover__additional--fade u-block-hover__additional--fade-in g-pa-20">
                    <div class="d-flex align-items-start flex-column mb-auto">
                      <h3 class="h6 g-color-white g-font-weight-700 mb-0">Creative agency</h3>
                      <p class="g-color-white-opacity-0_7 g-font-size-13 mb-0">Identity</p>
                    </div>
                    <ul class="align-items-end flex-column list-inline mt-auto ml-auto mb-0">
                      <li class="list-inline-item">
                        <a class="u-icon-v2 u-icon-size--xs g-brd-white g-color-black g-bg-white rounded-circle" href="#!">
                      ...
                      <li class="list-inline-item">
                        <a class="cbp-lightbox u-icon-v2 u-icon-size--xs g-brd-white g-color-black g-bg-white rounded-circle" href="../../../assets/img-temp/400x270/img9.jpg">
                          <i class="icon-communication-017 u-line-icon-pro"></i>
                        </a>
                      </li>
                    </ul>
              ...
              <div class="cbp-item graphic">
                <div class="u-block-hover g-parent">
                  ...
                  <div class="d-flex w-100 h-100 g-bg-black-opacity-0_6 opacity-0 g-opacity-1--parent-hover g-pos-abs g-top-0 g-left-0 g-transition-0_3 g-transition--ease-in u-block-hover__additional--fade u-block-hover__additional--fade-in g-pa-20">
                    <div class="d-flex align-items-start flex-column mb-auto">
                      <h3 class="h6 g-color-white g-font-weight-700 mb-0">Production</h3>
                      <p class="g-color-white-opacity-0_7 g-font-size-13 mb-0">Graphic</p>
                    </div>
                    <ul class="align-items-end flex-column list-inline mt-auto ml-auto mb-0">
                      <li class="list-inline-item">
                      ...
                      <li class="list-inline-item">
                        <a class="cbp-lightbox u-icon-v2 u-icon-size--xs g-brd-white g-color-black g-bg-white rounded-circle" href="../../../assets/img-temp/400x270/img10.jpg">
                          <i class="icon-communication-017 u-line-icon-pro"></i>
                        </a>
                      </li>
                    </ul>
              ...
              <div class="cbp-item design">
                <div class="u-block-hover g-parent">
                  <img class="img-fluid g-transform-scale-1_1--parent-hover g-transition-0_5 g-transition--ease-in-out" src="../../../assets/img-temp/400x270/img23.jpg" alt="Image description">
                  <div class="d-flex w-100 h-100 g-bg-black-opacity-0_6 opacity-0 g-opacity-1--parent-hover g-pos-abs g-top-0 g-left-0 g-transition-0_3 g-transition--ease-in u-block-hover__additional--fade u-block-hover__additional--fade-in g-pa-20">
                    <div class="d-flex align-items-start flex-column mb-auto">
                      <h3 class="h6 g-color-white g-font-weight-700 mb-0">Photography</h3>
                      <p class="g-color-white-opacity-0_7 g-font-size-13 mb-0">Design</p>
                    </div>
                    <ul class="align-items-end flex-column list-inline mt-auto ml-auto mb-0">
                      <li class="list-inline-item">
                      ...
                      <li class="list-inline-item">
                        <a class="cbp-lightbox u-icon-v2 u-icon-size--xs g-brd-white g-color-black g-bg-white rounded-circle" href="../../../assets/img-temp/400x270/img23.jpg">
                          <i class="icon-communication-017 u-line-icon-pro"></i>
                        </a>
                      </li>
                    </ul>
              ...
              <div class="cbp-item graphic identity">
                <div class="u-block-hover g-parent">
                  <img class="img-fluid g-transform-scale-1_1--parent-hover g-transition-0_5 g-transition--ease-in-out" src="../../../assets/img-temp/400x270/img18.jpg" alt="Image description">
                  <div class="d-flex w-100 h-100 g-bg-black-opacity-0_6 opacity-0 g-opacity-1--parent-hover g-pos-abs g-top-0 g-left-0 g-transition-0_3 g-transition--ease-in u-block-hover__additional--fade u-block-hover__additional--fade-in g-pa-20">
                    <div class="d-flex align-items-start flex-column mb-auto">
                      <h3 class="h6 g-color-white g-font-weight-700 mb-0">Social strategy</h3>
                      <p class="g-color-white-opacity-0_7 g-font-size-13 mb-0">Graphic, Identity</p>
                    </div>
                    <ul class="align-items-end flex-column list-inline mt-auto ml-auto mb-0">
                      <li class="list-inline-item">
                      ...
                      <li class="list-inline-item">
                        <a class="cbp-lightbox u-icon-v2 u-icon-size--xs g-brd-white g-color-black g-bg-white rounded-circle" href="../../../assets/img-temp/400x270/img18.jpg">
                          <i class="icon-communication-017 u-line-icon-pro"></i>
                        </a>
                      </li>
                    </ul>
              ...
              <div class="cbp-item identity design">
                <div class="u-block-hover g-parent">
                  <img class="img-fluid g-transform-scale-1_1--parent-hover g-transition-0_5 g-transition--ease-in-out" src="../../../assets/img-temp/400x270/img19.jpg" alt="Image description">
                  <div class="d-flex w-100 h-100 g-bg-black-opacity-0_6 opacity-0 g-opacity-1--parent-hover g-pos-abs g-top-0 g-left-0 g-transition-0_3 g-transition--ease-in u-block-hover__additional--fade u-block-hover__additional--fade-in g-pa-20">
                    <div class="d-flex align-items-start flex-column mb-auto">
                      <h3 class="h6 g-color-white g-font-weight-700 mb-0">Videography</h3>
                      <p class="g-color-white-opacity-0_7 g-font-size-13 mb-0">Identity, Design</p>
                    </div>
                    <ul class="align-items-end flex-column list-inline mt-auto ml-auto mb-0">
                      <li class="list-inline-item">
                      ...
                      <li class="list-inline-item">
                        <a class="cbp-lightbox u-icon-v2 u-icon-size--xs g-brd-white g-color-black g-bg-white rounded-circle" href="../../../assets/img-temp/400x270/img19.jpg">
                          <i class="icon-communication-017 u-line-icon-pro"></i>
                        </a>
                      </li>
                    </ul>
              ...
              <div class="cbp-item design">
                <div class="u-block-hover g-parent">
                  <img class="img-fluid g-transform-scale-1_1--parent-hover g-transition-0_5 g-transition--ease-in-out" src="../../../assets/img-temp/400x270/img28.jpg" alt="Image description">
                  <div class="d-flex w-100 h-100 g-bg-black-opacity-0_6 opacity-0 g-opacity-1--parent-hover g-pos-abs g-top-0 g-left-0 g-transition-0_3 g-transition--ease-in u-block-hover__additional--fade u-block-hover__additional--fade-in g-pa-20">
                    <div class="d-flex align-items-start flex-column mb-auto">
                      <h3 class="h6 g-color-white g-font-weight-700 mb-0">Capabilities</h3>
                      <p class="g-color-white-opacity-0_7 g-font-size-13 mb-0">Design</p>
                    </div>
                    <ul class="align-items-end flex-column list-inline mt-auto ml-auto mb-0">
                      <li class="list-inline-item">
                      ...
                      <li class="list-inline-item">
                        <a class="cbp-lightbox u-icon-v2 u-icon-size--xs g-brd-white g-color-black g-bg-white rounded-circle" href="../../../assets/img-temp/400x270/img28.jpg">
                          <i class="icon-communication-017 u-line-icon-pro"></i>
                        </a>
                      </li>
                    </ul>
              ...
              <div class="cbp-item graphic identity">
                <div class="u-block-hover g-parent">
                  <img class="img-fluid g-transform-scale-1_1--parent-hover g-transition-0_5 g-transition--ease-in-out" src="../../../assets/img-temp/400x270/img27.jpg" alt="Image description">
                  <div class="d-flex w-100 h-100 g-bg-black-opacity-0_6 opacity-0 g-opacity-1--parent-hover g-pos-abs g-top-0 g-left-0 g-transition-0_3 g-transition--ease-in u-block-hover__additional--fade u-block-hover__additional--fade-in g-pa-20">
                    <div class="d-flex align-items-start flex-column mb-auto">
                      <h3 class="h6 g-color-white g-font-weight-700 mb-0">Project planner</h3>
                      <p class="g-color-white-opacity-0_7 g-font-size-13 mb-0">Graphic, Identity</p>
                    ...
                    <ul class="align-items-end flex-column list-inline mt-auto ml-auto mb-0">
                      ...
                      <li class="list-inline-item">
                        <a class="cbp-lightbox u-icon-v2 u-icon-size--xs g-brd-white g-color-black g-bg-white rounded-circle" href="../../../assets/img-temp/400x270/img27.jpg">
                          <i class="icon-communication-017 u-line-icon-pro"></i>
                        </a>
                      </li>
                    </ul>
              ...
              <div class="cbp-item graphic">
                <div class="u-block-hover g-parent">
                  <img class="img-fluid g-transform-scale-1_1--parent-hover g-transition-0_5 g-transition--ease-in-out" src="../../../assets/img-temp/400x270/img25.jpg" alt="Image description">
                  <div class="d-flex w-100 h-100 g-bg-black-opacity-0_6 opacity-0 g-opacity-1--parent-hover g-pos-abs g-top-0 g-left-0 g-transition-0_3 g-transition--ease-in u-block-hover__additional--fade u-block-hover__additional--fade-in g-pa-20">
                    <div class="d-flex align-items-start flex-column mb-auto">
                      <h3 class="h6 g-color-white g-font-weight-700 mb-0">Design</h3>
                      <p class="g-color-white-opacity-0_7 g-font-size-13 mb-0">Graphic</p>
                    ...
                    <ul class="align-items-end flex-column list-inline mt-auto ml-auto mb-0">
                      ...
                      <li class="list-inline-item">
                        <a class="cbp-lightbox u-icon-v2 u-icon-size--xs g-brd-white g-color-black g-bg-white rounded-circle" href="../../../assets/img-temp/400x270/img25.jpg">
                          <i class="icon-communication-017 u-line-icon-pro"></i>
                        </a>
                      </li>
                    </ul>
                ...
                <div class="u-block-hover g-parent">
                  ...
                  <div class="d-flex w-100 h-100 g-bg-black-opacity-0_6 opacity-0 g-opacity-1--parent-hover g-pos-abs g-top-0 g-left-0 g-transition-0_3 g-transition--ease-in u-block-hover__additional--fade u-block-hover__additional--fade-in g-pa-20">
                    ...
                    <ul class="align-items-end flex-column list-inline mt-auto ml-auto mb-0">
                      ...
                      <li class="list-inline-item">
                        <a class="cbp-lightbox u-icon-v2 u-icon-size--xs g-brd-white g-color-black g-bg-white rounded-circle" href="../../../assets/img-temp/400x270/img12.jpg">
                          <i class="icon-communication-017 u-line-icon-pro"></i>
                        </a>
                      </li>
                    </ul>
              ...
              <div class="cbp-item identity design">
                <div class="u-block-hover g-parent">
                  <img class="img-fluid g-transform-scale-1_1--parent-hover g-transition-0_5 g-transition--ease-in-out" src="../../../assets/img-temp/400x270/img24.jpg" alt="Image description">
                  <div class="d-flex w-100 h-100 g-bg-black-opacity-0_6 opacity-0 g-opacity-1--parent-hover g-pos-abs g-top-0 g-left-0 g-transition-0_3 g-transition--ease-in u-block-hover__additional--fade u-block-hover__additional--fade-in g-pa-20">
                    <div class="d-flex align-items-start flex-column mb-auto">
                      <h3 class="h6 g-color-white g-font-weight-700 mb-0">Branding work</h3>
                      <p class="g-color-white-opacity-0_7 g-font-size-13 mb-0">Identity, Design</p>
                    ...
                    <ul class="align-items-end flex-column list-inline mt-auto ml-auto mb-0">
                      ...
                      <li class="list-inline-item">
                        <a class="cbp-lightbox u-icon-v2 u-icon-size--xs g-brd-white g-color-black g-bg-white rounded-circle" href="../../../assets/img-temp/400x270/img24.jpg">
                          <i class="icon-communication-017 u-line-icon-pro"></i>
                        </a>
                      </li>
                    </ul>
              ...
              <div class="cbp-item design">
                <div class="u-block-hover g-parent">
                  <img class="img-fluid g-transform-scale-1_1--parent-hover g-transition-0_5 g-transition--ease-in-out" src="../../../assets/img-temp/400x270/img26.jpg" alt="Image description">
                  <div class="d-flex w-100 h-100 g-bg-black-opacity-0_6 opacity-0 g-opacity-1--parent-hover g-pos-abs g-top-0 g-left-0 g-transition-0_3 g-transition--ease-in u-block-hover__additional--fade u-block-hover__additional--fade-in g-pa-20">
                    <div class="d-flex align-items-start flex-column mb-auto">
                      <h3 class="h6 g-color-white g-font-weight-700 mb-0">Development</h3>
                      <p class="g-color-white-opacity-0_7 g-font-size-13 mb-0">Design</p>
                    ...
                    <ul class="align-items-end flex-column list-inline mt-auto ml-auto mb-0">
                      ...
                      <li class="list-inline-item">
                        <a class="cbp-lightbox u-icon-v2 u-icon-size--xs g-brd-white g-color-black g-bg-white rounded-circle" href="../../../assets/img-temp/400x270/img26.jpg">
                          <i class="icon-communication-017 u-line-icon-pro"></i>
                        </a>
                      </li>
                    </ul>
      ...
      <div class="container">
        ...
        <div class="g-font-size-12 g-my-30 ">
          <a class="js-modal-markup u-link-v5 g-color-main g-color-primary--hover g-mr-15" href="#!" data-content-target="#shortcode" data-modal-target="#modalMarkup" data-modal-effect="fadein">
            <i class="fa fa-code"></i>
            Show code
          </a>
          <a class="js-copy u-link-v5 g-color-main g-color-primary--hover" href="#!" data-content-target="#shortcode" data-success-text="Copied">
